...
public final class GLATIVertexAttribArrayObject {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glVertexAttribArrayObjectATI = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_BYTE, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glGetVertexAttribArrayObjectfvATI = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetVertexAttribArrayObjectivATI = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void VertexAttribArrayObjectATI(int index, int size, int type, boolean normalized, int stride, int buffer, int offset) {
        ...
        Handles.MH_glVertexAttribArrayObjectATI.get().invokeExact(handles.PFN_glVertexAttribArrayObjectATI, index, size, type, ((normalized) ? (byte)1 : (byte)0), stride, buffer, offset); }
    ...
    public void GetVertexAttribArrayObjectfvATI(int index, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetVertexAttribArrayObjectfvATI.get().invokeExact(handles.PFN_glGetVertexAttribArrayObjectfvATI, index, pname, params); }
    ...
    public void GetVertexAttribArrayObjectivATI(int index, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetVertexAttribArrayObjectivATI.get().invokeExact(handles.PFN_glGetVertexAttribArrayObjectivATI, index, pname, params); }
