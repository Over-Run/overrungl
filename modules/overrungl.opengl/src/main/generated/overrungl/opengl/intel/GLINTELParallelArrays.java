...
public final class GLINTELParallelArrays {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glVertexPointervINTEL = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glNormalPointervINTEL = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glColorPointervINTEL = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTexCoordPointervINTEL = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void VertexPointervINTEL(int size, int type, @NonNull MemorySegment pointer) {
        ...
        Handles.MH_glVertexPointervINTEL.get().invokeExact(handles.PFN_glVertexPointervINTEL, size, type, pointer); }
    ...
    public void NormalPointervINTEL(int type, @NonNull MemorySegment pointer) {
        ...
        Handles.MH_glNormalPointervINTEL.get().invokeExact(handles.PFN_glNormalPointervINTEL, type, pointer); }
    ...
    public void ColorPointervINTEL(int size, int type, @NonNull MemorySegment pointer) {
        ...
        Handles.MH_glColorPointervINTEL.get().invokeExact(handles.PFN_glColorPointervINTEL, size, type, pointer); }
    ...
    public void TexCoordPointervINTEL(int size, int type, @NonNull MemorySegment pointer) {
        ...
        Handles.MH_glTexCoordPointervINTEL.get().invokeExact(handles.PFN_glTexCoordPointervINTEL, size, type, pointer); }
