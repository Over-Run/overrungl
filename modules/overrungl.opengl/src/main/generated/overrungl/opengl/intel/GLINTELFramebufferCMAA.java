...
public final class GLINTELFramebufferCMAA {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glApplyFramebufferAttachmentCMAAINTEL = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid()));
    ...
    public void ApplyFramebufferAttachmentCMAAINTEL() {
        ...
        Handles.MH_glApplyFramebufferAttachmentCMAAINTEL.get().invokeExact(handles.PFN_glApplyFramebufferAttachmentCMAAINTEL); }
