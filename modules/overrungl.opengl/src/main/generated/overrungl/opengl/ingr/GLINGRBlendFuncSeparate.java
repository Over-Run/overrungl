...
public final class GLINGRBlendFuncSeparate {
    ...
    public static final class Handles {
        public static final MethodHandle MH_glBlendFuncSeparateINGR = downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT));
    ...
    public void BlendFuncSeparateINGR(int sfactorRGB, int dfactorRGB, int sfactorAlpha, int dfactorAlpha) {
        ...
        Handles.MH_glBlendFuncSeparateINGR.invokeExact(handles.PFN_glBlendFuncSeparateINGR, sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha); }
