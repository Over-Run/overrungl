...
public final class GLGREMEDYStringMarker {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glStringMarkerGREMEDY = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void StringMarkerGREMEDY(int len, @NonNull MemorySegment string) {
        ...
        Handles.MH_glStringMarkerGREMEDY.get().invokeExact(handles.PFN_glStringMarkerGREMEDY, len, string); }
