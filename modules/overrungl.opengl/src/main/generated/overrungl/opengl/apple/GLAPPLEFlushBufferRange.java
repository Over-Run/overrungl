...
public final class GLAPPLEFlushBufferRange {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glBufferParameteriAPPLE = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glFlushMappedBufferRangeAPPLE = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG)));
    ...
    public void BufferParameteriAPPLE(int target, int pname, int param) {
        ...
        Handles.MH_glBufferParameteriAPPLE.get().invokeExact(handles.PFN_glBufferParameteriAPPLE, target, pname, param); }
    ...
    public void FlushMappedBufferRangeAPPLE(int target, long offset, long size) {
        ...
        Handles.MH_glFlushMappedBufferRangeAPPLE.get().invokeExact(handles.PFN_glFlushMappedBufferRangeAPPLE, target, offset, size); }
