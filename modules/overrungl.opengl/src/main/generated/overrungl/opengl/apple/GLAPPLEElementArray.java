...
public final class GLAPPLEElementArray {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glElementPointerAPPLE = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glDrawElementArrayAPPLE = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glDrawRangeElementArrayAPPLE = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glMultiDrawElementArrayAPPLE = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glMultiDrawRangeElementArrayAPPLE = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_INT)));
    ...
    public void ElementPointerAPPLE(int type, @NonNull MemorySegment pointer) {
        ...
        Handles.MH_glElementPointerAPPLE.get().invokeExact(handles.PFN_glElementPointerAPPLE, type, pointer); }
    ...
    public void DrawElementArrayAPPLE(int mode, int first, int count) {
        ...
        Handles.MH_glDrawElementArrayAPPLE.get().invokeExact(handles.PFN_glDrawElementArrayAPPLE, mode, first, count); }
    ...
    public void DrawRangeElementArrayAPPLE(int mode, int start, int end, int first, int count) {
        ...
        Handles.MH_glDrawRangeElementArrayAPPLE.get().invokeExact(handles.PFN_glDrawRangeElementArrayAPPLE, mode, start, end, first, count); }
    ...
    public void MultiDrawElementArrayAPPLE(int mode, @NonNull MemorySegment first, @NonNull MemorySegment count, int primcount) {
        ...
        Handles.MH_glMultiDrawElementArrayAPPLE.get().invokeExact(handles.PFN_glMultiDrawElementArrayAPPLE, mode, first, count, primcount); }
    ...
    public void MultiDrawRangeElementArrayAPPLE(int mode, int start, int end, @NonNull MemorySegment first, @NonNull MemorySegment count, int primcount) {
        ...
        Handles.MH_glMultiDrawRangeElementArrayAPPLE.get().invokeExact(handles.PFN_glMultiDrawRangeElementArrayAPPLE, mode, start, end, first, count, primcount); }
