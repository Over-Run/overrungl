...
public final class GLSGIXTagSampleBuffer {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glTagSampleBufferSGIX = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid()));
    ...
    public void TagSampleBufferSGIX() {
        ...
        Handles.MH_glTagSampleBufferSGIX.get().invokeExact(handles.PFN_glTagSampleBufferSGIX); }
