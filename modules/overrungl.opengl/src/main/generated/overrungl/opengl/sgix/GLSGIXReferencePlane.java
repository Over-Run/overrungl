...
public final class GLSGIXReferencePlane {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glReferencePlaneSGIX = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)));
    ...
    public void ReferencePlaneSGIX(@NonNull MemorySegment equation) {
        ...
        Handles.MH_glReferencePlaneSGIX.get().invokeExact(handles.PFN_glReferencePlaneSGIX, equation); }
