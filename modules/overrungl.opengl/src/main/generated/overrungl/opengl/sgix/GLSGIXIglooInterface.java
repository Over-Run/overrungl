...
public final class GLSGIXIglooInterface {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glIglooInterfaceSGIX = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void IglooInterfaceSGIX(int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glIglooInterfaceSGIX.get().invokeExact(handles.PFN_glIglooInterfaceSGIX, pname, params); }
