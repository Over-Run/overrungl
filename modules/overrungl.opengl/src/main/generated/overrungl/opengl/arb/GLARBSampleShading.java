...
public final class GLARBSampleShading {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glMinSampleShadingARB = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_FLOAT)));
    ...
    public void MinSampleShadingARB(float value) {
        ...
        Handles.MH_glMinSampleShadingARB.get().invokeExact(handles.PFN_glMinSampleShadingARB, value); }
