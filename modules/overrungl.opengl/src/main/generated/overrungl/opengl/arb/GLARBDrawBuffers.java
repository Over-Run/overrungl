...
public final class GLARBDrawBuffers {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glDrawBuffersARB = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public GLARBDrawBuffers(GLLoadFunc func) {
        this.handles = new Handles(func);
    }

    /// Invokes `glDrawBuffersARB`.
    /// ```
    /// void glDrawBuffersARB((int) GLsizei n, const GLenum* bufs);
    /// ```
    public void DrawBuffersARB(int n, @NonNull MemorySegment bufs) {
        ...
        Handles.MH_glDrawBuffersARB.get().invokeExact(handles.PFN_glDrawBuffersARB, n, bufs); }
