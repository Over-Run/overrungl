...
public final class GLARBViewportArray {
    ...
    public static final class Handles {
        ...
        public static final Supplier<MethodHandle> MH_glDepthRangeArraydvNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glDepthRangeIndexeddNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_DOUBLE, ValueLayout.JAVA_DOUBLE)));
    ...
    public void DepthRangeArraydvNV(int first, int count, @NonNull MemorySegment v) {
        ...
        Handles.MH_glDepthRangeArraydvNV.get().invokeExact(handles.PFN_glDepthRangeArraydvNV, first, count, v); }
    ...
    public void DepthRangeIndexeddNV(int index, double n, double f) {
        ...
        Handles.MH_glDepthRangeIndexeddNV.get().invokeExact(handles.PFN_glDepthRangeIndexeddNV, index, n, f); }
