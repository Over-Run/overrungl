...
public final class GLARBImaging {
    ...
    public static final class Handles {
        ...
        private Handles(GLLoadFunc func) {
            ...
            PFN_glColorTable = func.invoke("glColorTable", "glColorTableEXT", "glColorTableSGI");
            PFN_glColorTableParameterfv = func.invoke("glColorTableParameterfv", "glColorTableParameterfvSGI");
            PFN_glColorTableParameteriv = func.invoke("glColorTableParameteriv", "glColorTableParameterivSGI");
            PFN_glCopyColorTable = func.invoke("glCopyColorTable", "glCopyColorTableSGI");
            PFN_glGetColorTable = func.invoke("glGetColorTable", "glGetColorTableEXT");
            PFN_glGetColorTableParameterfv = func.invoke("glGetColorTableParameterfv", "glGetColorTableParameterfvEXT");
            PFN_glGetColorTableParameteriv = func.invoke("glGetColorTableParameteriv", "glGetColorTableParameterivEXT");
            PFN_glColorSubTable = func.invoke("glColorSubTable", "glColorSubTableEXT");
            PFN_glCopyColorSubTable = func.invoke("glCopyColorSubTable", "glCopyColorSubTableEXT");
            PFN_glConvolutionFilter1D = func.invoke("glConvolutionFilter1D", "glConvolutionFilter1DEXT");
            PFN_glConvolutionFilter2D = func.invoke("glConvolutionFilter2D", "glConvolutionFilter2DEXT");
            PFN_glConvolutionParameterf = func.invoke("glConvolutionParameterf", "glConvolutionParameterfEXT");
            PFN_glConvolutionParameterfv = func.invoke("glConvolutionParameterfv", "glConvolutionParameterfvEXT");
            PFN_glConvolutionParameteri = func.invoke("glConvolutionParameteri", "glConvolutionParameteriEXT");
            PFN_glConvolutionParameteriv = func.invoke("glConvolutionParameteriv", "glConvolutionParameterivEXT");
            PFN_glCopyConvolutionFilter1D = func.invoke("glCopyConvolutionFilter1D", "glCopyConvolutionFilter1DEXT");
            PFN_glCopyConvolutionFilter2D = func.invoke("glCopyConvolutionFilter2D", "glCopyConvolutionFilter2DEXT");
            ...
            PFN_glSeparableFilter2D = func.invoke("glSeparableFilter2D", "glSeparableFilter2DEXT");
            ...
            PFN_glHistogram = func.invoke("glHistogram", "glHistogramEXT");
            PFN_glMinmax = func.invoke("glMinmax", "glMinmaxEXT");
            PFN_glResetHistogram = func.invoke("glResetHistogram", "glResetHistogramEXT");
            PFN_glResetMinmax = func.invoke("glResetMinmax", "glResetMinmaxEXT");
        }
    }
