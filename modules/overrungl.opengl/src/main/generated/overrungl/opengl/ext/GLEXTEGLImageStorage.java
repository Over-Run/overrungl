...
public final class GLEXTEGLImageStorage {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glEGLImageTargetTexStorageEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glEGLImageTargetTextureStorageEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
    ...
    public void EGLImageTargetTexStorageEXT(int target, @NonNull MemorySegment image, @NonNull MemorySegment attrib_list) {
        ...
        Handles.MH_glEGLImageTargetTexStorageEXT.get().invokeExact(handles.PFN_glEGLImageTargetTexStorageEXT, target, image, attrib_list); }
    ...
    public void EGLImageTargetTextureStorageEXT(int texture, @NonNull MemorySegment image, @NonNull MemorySegment attrib_list) {
        ...
        Handles.MH_glEGLImageTargetTextureStorageEXT.get().invokeExact(handles.PFN_glEGLImageTargetTextureStorageEXT, texture, image, attrib_list); }
