...
public final class GLEXTStencilClearTag {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glStencilClearTagEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
    ...
    public void StencilClearTagEXT(int stencilTagBits, int stencilClearTag) {
        ...
        Handles.MH_glStencilClearTagEXT.get().invokeExact(handles.PFN_glStencilClearTagEXT, stencilTagBits, stencilClearTag); }
