...
public final class GLEXTFramebufferObject {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glIsRenderbufferEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_BYTE, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glBindRenderbufferEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glDeleteRenderbuffersEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGenRenderbuffersEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glRenderbufferStorageEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glGetRenderbufferParameterivEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glIsFramebufferEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_BYTE, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glBindFramebufferEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glDeleteFramebuffersEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGenFramebuffersEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCheckFramebufferStatusEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glFramebufferTexture1DEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glFramebufferTexture2DEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glFramebufferTexture3DEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glFramebufferRenderbufferEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glGetFramebufferAttachmentParameterivEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGenerateMipmapEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT)));
    ...
    public boolean IsRenderbufferEXT(int renderbuffer) {
        ...
        return (((byte) Handles.MH_glIsRenderbufferEXT.get().invokeExact(handles.PFN_glIsRenderbufferEXT, renderbuffer)) != 0); }
    ...
    public void BindRenderbufferEXT(int target, int renderbuffer) {
        ...
        Handles.MH_glBindRenderbufferEXT.get().invokeExact(handles.PFN_glBindRenderbufferEXT, target, renderbuffer); }
    ...
    public void DeleteRenderbuffersEXT(int n, @NonNull MemorySegment renderbuffers) {
        ...
        Handles.MH_glDeleteRenderbuffersEXT.get().invokeExact(handles.PFN_glDeleteRenderbuffersEXT, n, renderbuffers); }
    ...
    public void GenRenderbuffersEXT(int n, @NonNull MemorySegment renderbuffers) {
        ...
        Handles.MH_glGenRenderbuffersEXT.get().invokeExact(handles.PFN_glGenRenderbuffersEXT, n, renderbuffers); }
    ...
    public void RenderbufferStorageEXT(int target, int internalformat, int width, int height) {
        ...
        Handles.MH_glRenderbufferStorageEXT.get().invokeExact(handles.PFN_glRenderbufferStorageEXT, target, internalformat, width, height); }
    ...
    public void GetRenderbufferParameterivEXT(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetRenderbufferParameterivEXT.get().invokeExact(handles.PFN_glGetRenderbufferParameterivEXT, target, pname, params); }
    ...
    public boolean IsFramebufferEXT(int framebuffer) {
        ...
        return (((byte) Handles.MH_glIsFramebufferEXT.get().invokeExact(handles.PFN_glIsFramebufferEXT, framebuffer)) != 0); }
    ...
    public void BindFramebufferEXT(int target, int framebuffer) {
        ...
        Handles.MH_glBindFramebufferEXT.get().invokeExact(handles.PFN_glBindFramebufferEXT, target, framebuffer); }
    ...
    public void DeleteFramebuffersEXT(int n, @NonNull MemorySegment framebuffers) {
        ...
        Handles.MH_glDeleteFramebuffersEXT.get().invokeExact(handles.PFN_glDeleteFramebuffersEXT, n, framebuffers); }
    ...
    public void GenFramebuffersEXT(int n, @NonNull MemorySegment framebuffers) {
        ...
        Handles.MH_glGenFramebuffersEXT.get().invokeExact(handles.PFN_glGenFramebuffersEXT, n, framebuffers); }
    ...
    public int CheckFramebufferStatusEXT(int target) {
        ...
        return (int) Handles.MH_glCheckFramebufferStatusEXT.get().invokeExact(handles.PFN_glCheckFramebufferStatusEXT, target); }
    ...
    public void FramebufferTexture1DEXT(int target, int attachment, int textarget, int texture, int level) {
        ...
        Handles.MH_glFramebufferTexture1DEXT.get().invokeExact(handles.PFN_glFramebufferTexture1DEXT, target, attachment, textarget, texture, level); }
    ...
    public void FramebufferTexture2DEXT(int target, int attachment, int textarget, int texture, int level) {
        ...
        Handles.MH_glFramebufferTexture2DEXT.get().invokeExact(handles.PFN_glFramebufferTexture2DEXT, target, attachment, textarget, texture, level); }
    ...
    public void FramebufferTexture3DEXT(int target, int attachment, int textarget, int texture, int level, int zoffset) {
        ...
        Handles.MH_glFramebufferTexture3DEXT.get().invokeExact(handles.PFN_glFramebufferTexture3DEXT, target, attachment, textarget, texture, level, zoffset); }
    ...
    public void FramebufferRenderbufferEXT(int target, int attachment, int renderbuffertarget, int renderbuffer) {
        ...
        Handles.MH_glFramebufferRenderbufferEXT.get().invokeExact(handles.PFN_glFramebufferRenderbufferEXT, target, attachment, renderbuffertarget, renderbuffer); }
    ...
    public void GetFramebufferAttachmentParameterivEXT(int target, int attachment, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetFramebufferAttachmentParameterivEXT.get().invokeExact(handles.PFN_glGetFramebufferAttachmentParameterivEXT, target, attachment, pname, params); }
    ...
    public void GenerateMipmapEXT(int target) {
        ...
        Handles.MH_glGenerateMipmapEXT.get().invokeExact(handles.PFN_glGenerateMipmapEXT, target); }
