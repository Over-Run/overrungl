...
public final class GLEXTTextureInteger {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glTexParameterIivEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTexParameterIuivEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTexParameterIivEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTexParameterIuivEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glClearColorIiEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glClearColorIuiEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
    ...
    public void TexParameterIivEXT(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glTexParameterIivEXT.get().invokeExact(handles.PFN_glTexParameterIivEXT, target, pname, params); }
    ...
    public void TexParameterIuivEXT(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glTexParameterIuivEXT.get().invokeExact(handles.PFN_glTexParameterIuivEXT, target, pname, params); }
    ...
    public void GetTexParameterIivEXT(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetTexParameterIivEXT.get().invokeExact(handles.PFN_glGetTexParameterIivEXT, target, pname, params); }
    ...
    public void GetTexParameterIuivEXT(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetTexParameterIuivEXT.get().invokeExact(handles.PFN_glGetTexParameterIuivEXT, target, pname, params); }
    ...
    public void ClearColorIiEXT(int red, int green, int blue, int alpha) {
        ...
        Handles.MH_glClearColorIiEXT.get().invokeExact(handles.PFN_glClearColorIiEXT, red, green, blue, alpha); }
    ...
    public void ClearColorIuiEXT(int red, int green, int blue, int alpha) {
        ...
        Handles.MH_glClearColorIuiEXT.get().invokeExact(handles.PFN_glClearColorIuiEXT, red, green, blue, alpha); }
