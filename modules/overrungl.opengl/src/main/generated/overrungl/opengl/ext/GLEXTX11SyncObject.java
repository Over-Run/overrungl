...
public final class GLEXTX11SyncObject {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glImportSyncEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
    ...
    public @NonNull MemorySegment ImportSyncEXT(int external_sync_type, long external_sync, int flags) {
        ...
        return (MemorySegment) Handles.MH_glImportSyncEXT.get().invokeExact(handles.PFN_glImportSyncEXT, external_sync_type, external_sync, flags); }
