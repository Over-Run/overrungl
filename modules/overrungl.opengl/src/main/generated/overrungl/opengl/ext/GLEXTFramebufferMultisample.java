...
public final class GLEXTFramebufferMultisample {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glRenderbufferStorageMultisampleEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
    ...
    public void RenderbufferStorageMultisampleEXT(int target, int samples, int internalformat, int width, int height) {
        ...
        Handles.MH_glRenderbufferStorageMultisampleEXT.get().invokeExact(handles.PFN_glRenderbufferStorageMultisampleEXT, target, samples, internalformat, width, height); }
