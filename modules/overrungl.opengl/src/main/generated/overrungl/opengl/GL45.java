...
/// Constants and functions of OpenGL 4.5.
public class GL45 extends GL44 {
    ...
    public static final class Handles {
        ...
        public static final Supplier<MethodHandle> MH_glCreateTransformFeedbacks = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTransformFeedbackBufferBase = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glTransformFeedbackBufferRange = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glGetTransformFeedbackiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTransformFeedbacki_v = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTransformFeedbacki64_v = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCreateBuffers = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glNamedBufferStorage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glNamedBufferData = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glNamedBufferSubData = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCopyNamedBufferSubData = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glClearNamedBufferData = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glClearNamedBufferSubData = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glMapNamedBuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glMapNamedBufferRange = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glUnmapNamedBuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_BYTE, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glFlushMappedNamedBufferRange = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glGetNamedBufferParameteriv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetNamedBufferParameteri64v = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetNamedBufferPointerv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetNamedBufferSubData = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCreateFramebuffers = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glNamedFramebufferRenderbuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glNamedFramebufferParameteri = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glNamedFramebufferTexture = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glNamedFramebufferTextureLayer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glNamedFramebufferDrawBuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glNamedFramebufferDrawBuffers = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glNamedFramebufferReadBuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glInvalidateNamedFramebufferData = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glInvalidateNamedFramebufferSubData = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glClearNamedFramebufferiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glClearNamedFramebufferuiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glClearNamedFramebufferfv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glClearNamedFramebufferfi = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glBlitNamedFramebuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glCheckNamedFramebufferStatus = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glGetNamedFramebufferParameteriv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetNamedFramebufferAttachmentParameteriv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCreateRenderbuffers = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glNamedRenderbufferStorage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glNamedRenderbufferStorageMultisample = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glGetNamedRenderbufferParameteriv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCreateTextures = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTextureBuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glTextureBufferRange = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glTextureStorage1D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glTextureStorage2D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glTextureStorage3D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glTextureStorage2DMultisample = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_BYTE)));
        public static final Supplier<MethodHandle> MH_glTextureStorage3DMultisample = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_BYTE)));
        public static final Supplier<MethodHandle> MH_glTextureSubImage1D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTextureSubImage2D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTextureSubImage3D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCompressedTextureSubImage1D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCompressedTextureSubImage2D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCompressedTextureSubImage3D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCopyTextureSubImage1D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glCopyTextureSubImage2D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glCopyTextureSubImage3D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glTextureParameterf = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_FLOAT)));
        public static final Supplier<MethodHandle> MH_glTextureParameterfv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTextureParameteri = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glTextureParameterIiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTextureParameterIuiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTextureParameteriv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGenerateTextureMipmap = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glBindTextureUnit = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glGetTextureImage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetCompressedTextureImage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTextureLevelParameterfv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTextureLevelParameteriv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTextureParameterfv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTextureParameterIiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTextureParameterIuiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTextureParameteriv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCreateVertexArrays = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glDisableVertexArrayAttrib = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glEnableVertexArrayAttrib = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glVertexArrayElementBuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glVertexArrayVertexBuffer = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glVertexArrayVertexBuffers = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glVertexArrayAttribBinding = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glVertexArrayAttribFormat = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_BYTE, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glVertexArrayAttribIFormat = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glVertexArrayAttribLFormat = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glVertexArrayBindingDivisor = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glGetVertexArrayiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetVertexArrayIndexediv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetVertexArrayIndexed64iv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCreateSamplers = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCreateProgramPipelines = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCreateQueries = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetQueryBufferObjecti64v = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glGetQueryBufferObjectiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glGetQueryBufferObjectui64v = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glGetQueryBufferObjectuiv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG)));
        ...
        public static final Supplier<MethodHandle> MH_glGetTextureSubImage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetCompressedTextureSubImage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        ...
        public static final Supplier<MethodHandle> MH_glGetnCompressedTexImage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetnTexImage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetnUniformdv = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void CreateTransformFeedbacks(int n, @NonNull MemorySegment ids) {
        ...
        Handles.MH_glCreateTransformFeedbacks.get().invokeExact(handles.PFN_glCreateTransformFeedbacks, n, ids); }
    ...
    public void TransformFeedbackBufferBase(int xfb, int index, int buffer) {
        ...
        Handles.MH_glTransformFeedbackBufferBase.get().invokeExact(handles.PFN_glTransformFeedbackBufferBase, xfb, index, buffer); }
    ...
    public void TransformFeedbackBufferRange(int xfb, int index, int buffer, long offset, long size) {
        ...
        Handles.MH_glTransformFeedbackBufferRange.get().invokeExact(handles.PFN_glTransformFeedbackBufferRange, xfb, index, buffer, offset, size); }
    ...
    public void GetTransformFeedbackiv(int xfb, int pname, @NonNull MemorySegment param) {
        ...
        Handles.MH_glGetTransformFeedbackiv.get().invokeExact(handles.PFN_glGetTransformFeedbackiv, xfb, pname, param); }
    ...
    public void GetTransformFeedbacki_v(int xfb, int pname, int index, @NonNull MemorySegment param) {
        ...
        Handles.MH_glGetTransformFeedbacki_v.get().invokeExact(handles.PFN_glGetTransformFeedbacki_v, xfb, pname, index, param); }
    ...
    public void GetTransformFeedbacki64_v(int xfb, int pname, int index, @NonNull MemorySegment param) {
        ...
        Handles.MH_glGetTransformFeedbacki64_v.get().invokeExact(handles.PFN_glGetTransformFeedbacki64_v, xfb, pname, index, param); }
    ...
    public void CreateBuffers(int n, @NonNull MemorySegment buffers) {
        ...
        Handles.MH_glCreateBuffers.get().invokeExact(handles.PFN_glCreateBuffers, n, buffers); }
    ...
    public void NamedBufferStorage(int buffer, long size, @NonNull MemorySegment data, int flags) {
        ...
        Handles.MH_glNamedBufferStorage.get().invokeExact(handles.PFN_glNamedBufferStorage, buffer, size, data, flags); }
    ...
    public void NamedBufferData(int buffer, long size, @NonNull MemorySegment data, int usage) {
        ...
        Handles.MH_glNamedBufferData.get().invokeExact(handles.PFN_glNamedBufferData, buffer, size, data, usage); }
    ...
    public void NamedBufferSubData(int buffer, long offset, long size, @NonNull MemorySegment data) {
        ...
        Handles.MH_glNamedBufferSubData.get().invokeExact(handles.PFN_glNamedBufferSubData, buffer, offset, size, data); }
    ...
    public void CopyNamedBufferSubData(int readBuffer, int writeBuffer, long readOffset, long writeOffset, long size) {
        ...
        Handles.MH_glCopyNamedBufferSubData.get().invokeExact(handles.PFN_glCopyNamedBufferSubData, readBuffer, writeBuffer, readOffset, writeOffset, size); }
    ...
    public void ClearNamedBufferData(int buffer, int internalformat, int format, int type, @NonNull MemorySegment data) {
        ...
        Handles.MH_glClearNamedBufferData.get().invokeExact(handles.PFN_glClearNamedBufferData, buffer, internalformat, format, type, data); }
    ...
    public void ClearNamedBufferSubData(int buffer, int internalformat, long offset, long size, int format, int type, @NonNull MemorySegment data) {
        ...
        Handles.MH_glClearNamedBufferSubData.get().invokeExact(handles.PFN_glClearNamedBufferSubData, buffer, internalformat, offset, size, format, type, data); }
    ...
    public @NonNull MemorySegment MapNamedBuffer(int buffer, int access) {
        ...
        return (MemorySegment) Handles.MH_glMapNamedBuffer.get().invokeExact(handles.PFN_glMapNamedBuffer, buffer, access); }
    ...
    public @NonNull MemorySegment MapNamedBufferRange(int buffer, long offset, long length, int access) {
        ...
        return (MemorySegment) Handles.MH_glMapNamedBufferRange.get().invokeExact(handles.PFN_glMapNamedBufferRange, buffer, offset, length, access); }
    ...
    public boolean UnmapNamedBuffer(int buffer) {
        ...
        return (((byte) Handles.MH_glUnmapNamedBuffer.get().invokeExact(handles.PFN_glUnmapNamedBuffer, buffer)) != 0); }
    ...
    public void FlushMappedNamedBufferRange(int buffer, long offset, long length) {
        ...
        Handles.MH_glFlushMappedNamedBufferRange.get().invokeExact(handles.PFN_glFlushMappedNamedBufferRange, buffer, offset, length); }
    ...
    public void GetNamedBufferParameteriv(int buffer, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetNamedBufferParameteriv.get().invokeExact(handles.PFN_glGetNamedBufferParameteriv, buffer, pname, params); }
    ...
    public void GetNamedBufferParameteri64v(int buffer, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetNamedBufferParameteri64v.get().invokeExact(handles.PFN_glGetNamedBufferParameteri64v, buffer, pname, params); }
    ...
    public void GetNamedBufferPointerv(int buffer, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetNamedBufferPointerv.get().invokeExact(handles.PFN_glGetNamedBufferPointerv, buffer, pname, params); }
    ...
    public void GetNamedBufferSubData(int buffer, long offset, long size, @NonNull MemorySegment data) {
        ...
        Handles.MH_glGetNamedBufferSubData.get().invokeExact(handles.PFN_glGetNamedBufferSubData, buffer, offset, size, data); }
    ...
    public void CreateFramebuffers(int n, @NonNull MemorySegment framebuffers) {
        ...
        Handles.MH_glCreateFramebuffers.get().invokeExact(handles.PFN_glCreateFramebuffers, n, framebuffers); }
    ...
    public void NamedFramebufferRenderbuffer(int framebuffer, int attachment, int renderbuffertarget, int renderbuffer) {
        ...
        Handles.MH_glNamedFramebufferRenderbuffer.get().invokeExact(handles.PFN_glNamedFramebufferRenderbuffer, framebuffer, attachment, renderbuffertarget, renderbuffer); }
    ...
    public void NamedFramebufferParameteri(int framebuffer, int pname, int param) {
        ...
        Handles.MH_glNamedFramebufferParameteri.get().invokeExact(handles.PFN_glNamedFramebufferParameteri, framebuffer, pname, param); }
    ...
    public void NamedFramebufferTexture(int framebuffer, int attachment, int texture, int level) {
        ...
        Handles.MH_glNamedFramebufferTexture.get().invokeExact(handles.PFN_glNamedFramebufferTexture, framebuffer, attachment, texture, level); }
    ...
    public void NamedFramebufferTextureLayer(int framebuffer, int attachment, int texture, int level, int layer) {
        ...
        Handles.MH_glNamedFramebufferTextureLayer.get().invokeExact(handles.PFN_glNamedFramebufferTextureLayer, framebuffer, attachment, texture, level, layer); }
    ...
    public void NamedFramebufferDrawBuffer(int framebuffer, int buf) {
        ...
        Handles.MH_glNamedFramebufferDrawBuffer.get().invokeExact(handles.PFN_glNamedFramebufferDrawBuffer, framebuffer, buf); }
    ...
    public void NamedFramebufferDrawBuffers(int framebuffer, int n, @NonNull MemorySegment bufs) {
        ...
        Handles.MH_glNamedFramebufferDrawBuffers.get().invokeExact(handles.PFN_glNamedFramebufferDrawBuffers, framebuffer, n, bufs); }
    ...
    public void NamedFramebufferReadBuffer(int framebuffer, int src) {
        ...
        Handles.MH_glNamedFramebufferReadBuffer.get().invokeExact(handles.PFN_glNamedFramebufferReadBuffer, framebuffer, src); }
    ...
    public void InvalidateNamedFramebufferData(int framebuffer, int numAttachments, @NonNull MemorySegment attachments) {
        ...
        Handles.MH_glInvalidateNamedFramebufferData.get().invokeExact(handles.PFN_glInvalidateNamedFramebufferData, framebuffer, numAttachments, attachments); }
    ...
    public void InvalidateNamedFramebufferSubData(int framebuffer, int numAttachments, @NonNull MemorySegment attachments, int x, int y, int width, int height) {
        ...
        Handles.MH_glInvalidateNamedFramebufferSubData.get().invokeExact(handles.PFN_glInvalidateNamedFramebufferSubData, framebuffer, numAttachments, attachments, x, y, width, height); }
    ...
    public void ClearNamedFramebufferiv(int framebuffer, int buffer, int drawbuffer, @NonNull MemorySegment value) {
        ...
        Handles.MH_glClearNamedFramebufferiv.get().invokeExact(handles.PFN_glClearNamedFramebufferiv, framebuffer, buffer, drawbuffer, value); }
    ...
    public void ClearNamedFramebufferuiv(int framebuffer, int buffer, int drawbuffer, @NonNull MemorySegment value) {
        ...
        Handles.MH_glClearNamedFramebufferuiv.get().invokeExact(handles.PFN_glClearNamedFramebufferuiv, framebuffer, buffer, drawbuffer, value); }
    ...
    public void ClearNamedFramebufferfv(int framebuffer, int buffer, int drawbuffer, @NonNull MemorySegment value) {
        ...
        Handles.MH_glClearNamedFramebufferfv.get().invokeExact(handles.PFN_glClearNamedFramebufferfv, framebuffer, buffer, drawbuffer, value); }
    ...
    public void ClearNamedFramebufferfi(int framebuffer, int buffer, int drawbuffer, float depth, int stencil) {
        ...
        Handles.MH_glClearNamedFramebufferfi.get().invokeExact(handles.PFN_glClearNamedFramebufferfi, framebuffer, buffer, drawbuffer, depth, stencil); }
    ...
    public void BlitNamedFramebuffer(int readFramebuffer, int drawFramebuffer, int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, int mask, int filter) {
        ...
        Handles.MH_glBlitNamedFramebuffer.get().invokeExact(handles.PFN_glBlitNamedFramebuffer, readFramebuffer, drawFramebuffer, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter); }
    ...
    public int CheckNamedFramebufferStatus(int framebuffer, int target) {
        ...
        return (int) Handles.MH_glCheckNamedFramebufferStatus.get().invokeExact(handles.PFN_glCheckNamedFramebufferStatus, framebuffer, target); }
    ...
    public void GetNamedFramebufferParameteriv(int framebuffer, int pname, @NonNull MemorySegment param) {
        ...
        Handles.MH_glGetNamedFramebufferParameteriv.get().invokeExact(handles.PFN_glGetNamedFramebufferParameteriv, framebuffer, pname, param); }
    ...
    public void GetNamedFramebufferAttachmentParameteriv(int framebuffer, int attachment, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetNamedFramebufferAttachmentParameteriv.get().invokeExact(handles.PFN_glGetNamedFramebufferAttachmentParameteriv, framebuffer, attachment, pname, params); }
    ...
    public void CreateRenderbuffers(int n, @NonNull MemorySegment renderbuffers) {
        ...
        Handles.MH_glCreateRenderbuffers.get().invokeExact(handles.PFN_glCreateRenderbuffers, n, renderbuffers); }
    ...
    public void NamedRenderbufferStorage(int renderbuffer, int internalformat, int width, int height) {
        ...
        Handles.MH_glNamedRenderbufferStorage.get().invokeExact(handles.PFN_glNamedRenderbufferStorage, renderbuffer, internalformat, width, height); }
    ...
    public void NamedRenderbufferStorageMultisample(int renderbuffer, int samples, int internalformat, int width, int height) {
        ...
        Handles.MH_glNamedRenderbufferStorageMultisample.get().invokeExact(handles.PFN_glNamedRenderbufferStorageMultisample, renderbuffer, samples, internalformat, width, height); }
    ...
    public void GetNamedRenderbufferParameteriv(int renderbuffer, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetNamedRenderbufferParameteriv.get().invokeExact(handles.PFN_glGetNamedRenderbufferParameteriv, renderbuffer, pname, params); }
    ...
    public void CreateTextures(int target, int n, @NonNull MemorySegment textures) {
        ...
        Handles.MH_glCreateTextures.get().invokeExact(handles.PFN_glCreateTextures, target, n, textures); }
    ...
    public void TextureBuffer(int texture, int internalformat, int buffer) {
        ...
        Handles.MH_glTextureBuffer.get().invokeExact(handles.PFN_glTextureBuffer, texture, internalformat, buffer); }
    ...
    public void TextureBufferRange(int texture, int internalformat, int buffer, long offset, long size) {
        ...
        Handles.MH_glTextureBufferRange.get().invokeExact(handles.PFN_glTextureBufferRange, texture, internalformat, buffer, offset, size); }
    ...
    public void TextureStorage1D(int texture, int levels, int internalformat, int width) {
        ...
        Handles.MH_glTextureStorage1D.get().invokeExact(handles.PFN_glTextureStorage1D, texture, levels, internalformat, width); }
    ...
    public void TextureStorage2D(int texture, int levels, int internalformat, int width, int height) {
        ...
        Handles.MH_glTextureStorage2D.get().invokeExact(handles.PFN_glTextureStorage2D, texture, levels, internalformat, width, height); }
    ...
    public void TextureStorage3D(int texture, int levels, int internalformat, int width, int height, int depth) {
        ...
        Handles.MH_glTextureStorage3D.get().invokeExact(handles.PFN_glTextureStorage3D, texture, levels, internalformat, width, height, depth); }
    ...
    public void TextureStorage2DMultisample(int texture, int samples, int internalformat, int width, int height, boolean fixedsamplelocations) {
        ...
        Handles.MH_glTextureStorage2DMultisample.get().invokeExact(handles.PFN_glTextureStorage2DMultisample, texture, samples, internalformat, width, height, ((fixedsamplelocations) ? (byte)1 : (byte)0)); }
    ...
    public void TextureStorage3DMultisample(int texture, int samples, int internalformat, int width, int height, int depth, boolean fixedsamplelocations) {
        ...
        Handles.MH_glTextureStorage3DMultisample.get().invokeExact(handles.PFN_glTextureStorage3DMultisample, texture, samples, internalformat, width, height, depth, ((fixedsamplelocations) ? (byte)1 : (byte)0)); }
    ...
    public void TextureSubImage1D(int texture, int level, int xoffset, int width, int format, int type, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glTextureSubImage1D.get().invokeExact(handles.PFN_glTextureSubImage1D, texture, level, xoffset, width, format, type, pixels); }
    ...
    public void TextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, int type, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glTextureSubImage2D.get().invokeExact(handles.PFN_glTextureSubImage2D, texture, level, xoffset, yoffset, width, height, format, type, pixels); }
    ...
    public void TextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glTextureSubImage3D.get().invokeExact(handles.PFN_glTextureSubImage3D, texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels); }
    ...
    public void CompressedTextureSubImage1D(int texture, int level, int xoffset, int width, int format, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTextureSubImage1D.get().invokeExact(handles.PFN_glCompressedTextureSubImage1D, texture, level, xoffset, width, format, imageSize, data); }
    ...
    public void CompressedTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTextureSubImage2D.get().invokeExact(handles.PFN_glCompressedTextureSubImage2D, texture, level, xoffset, yoffset, width, height, format, imageSize, data); }
    ...
    public void CompressedTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTextureSubImage3D.get().invokeExact(handles.PFN_glCompressedTextureSubImage3D, texture, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data); }
    ...
    public void CopyTextureSubImage1D(int texture, int level, int xoffset, int x, int y, int width) {
        ...
        Handles.MH_glCopyTextureSubImage1D.get().invokeExact(handles.PFN_glCopyTextureSubImage1D, texture, level, xoffset, x, y, width); }
    ...
    public void CopyTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int x, int y, int width, int height) {
        ...
        Handles.MH_glCopyTextureSubImage2D.get().invokeExact(handles.PFN_glCopyTextureSubImage2D, texture, level, xoffset, yoffset, x, y, width, height); }
    ...
    public void CopyTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int x, int y, int width, int height) {
        ...
        Handles.MH_glCopyTextureSubImage3D.get().invokeExact(handles.PFN_glCopyTextureSubImage3D, texture, level, xoffset, yoffset, zoffset, x, y, width, height); }
    ...
    public void TextureParameterf(int texture, int pname, float param) {
        ...
        Handles.MH_glTextureParameterf.get().invokeExact(handles.PFN_glTextureParameterf, texture, pname, param); }
    ...
    public void TextureParameterfv(int texture, int pname, @NonNull MemorySegment param) {
        ...
        Handles.MH_glTextureParameterfv.get().invokeExact(handles.PFN_glTextureParameterfv, texture, pname, param); }
    ...
    public void TextureParameteri(int texture, int pname, int param) {
        ...
        Handles.MH_glTextureParameteri.get().invokeExact(handles.PFN_glTextureParameteri, texture, pname, param); }
    ...
    public void TextureParameterIiv(int texture, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glTextureParameterIiv.get().invokeExact(handles.PFN_glTextureParameterIiv, texture, pname, params); }
    ...
    public void TextureParameterIuiv(int texture, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glTextureParameterIuiv.get().invokeExact(handles.PFN_glTextureParameterIuiv, texture, pname, params); }
    ...
    public void TextureParameteriv(int texture, int pname, @NonNull MemorySegment param) {
        ...
        Handles.MH_glTextureParameteriv.get().invokeExact(handles.PFN_glTextureParameteriv, texture, pname, param); }
    ...
    public void GenerateTextureMipmap(int texture) {
        ...
        Handles.MH_glGenerateTextureMipmap.get().invokeExact(handles.PFN_glGenerateTextureMipmap, texture); }
    ...
    public void BindTextureUnit(int unit, int texture) {
        ...
        Handles.MH_glBindTextureUnit.get().invokeExact(handles.PFN_glBindTextureUnit, unit, texture); }
    ...
    public void GetTextureImage(int texture, int level, int format, int type, int bufSize, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glGetTextureImage.get().invokeExact(handles.PFN_glGetTextureImage, texture, level, format, type, bufSize, pixels); }
    ...
    public void GetCompressedTextureImage(int texture, int level, int bufSize, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glGetCompressedTextureImage.get().invokeExact(handles.PFN_glGetCompressedTextureImage, texture, level, bufSize, pixels); }
    ...
    public void GetTextureLevelParameterfv(int texture, int level, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetTextureLevelParameterfv.get().invokeExact(handles.PFN_glGetTextureLevelParameterfv, texture, level, pname, params); }
    ...
    public void GetTextureLevelParameteriv(int texture, int level, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetTextureLevelParameteriv.get().invokeExact(handles.PFN_glGetTextureLevelParameteriv, texture, level, pname, params); }
    ...
    public void GetTextureParameterfv(int texture, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetTextureParameterfv.get().invokeExact(handles.PFN_glGetTextureParameterfv, texture, pname, params); }
    ...
    public void GetTextureParameterIiv(int texture, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetTextureParameterIiv.get().invokeExact(handles.PFN_glGetTextureParameterIiv, texture, pname, params); }
    ...
    public void GetTextureParameterIuiv(int texture, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetTextureParameterIuiv.get().invokeExact(handles.PFN_glGetTextureParameterIuiv, texture, pname, params); }
    ...
    public void GetTextureParameteriv(int texture, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetTextureParameteriv.get().invokeExact(handles.PFN_glGetTextureParameteriv, texture, pname, params); }
    ...
    public void CreateVertexArrays(int n, @NonNull MemorySegment arrays) {
        ...
        Handles.MH_glCreateVertexArrays.get().invokeExact(handles.PFN_glCreateVertexArrays, n, arrays); }
    ...
    public void DisableVertexArrayAttrib(int vaobj, int index) {
        ...
        Handles.MH_glDisableVertexArrayAttrib.get().invokeExact(handles.PFN_glDisableVertexArrayAttrib, vaobj, index); }
    ...
    public void EnableVertexArrayAttrib(int vaobj, int index) {
        ...
        Handles.MH_glEnableVertexArrayAttrib.get().invokeExact(handles.PFN_glEnableVertexArrayAttrib, vaobj, index); }
    ...
    public void VertexArrayElementBuffer(int vaobj, int buffer) {
        ...
        Handles.MH_glVertexArrayElementBuffer.get().invokeExact(handles.PFN_glVertexArrayElementBuffer, vaobj, buffer); }
    ...
    public void VertexArrayVertexBuffer(int vaobj, int bindingindex, int buffer, long offset, int stride) {
        ...
        Handles.MH_glVertexArrayVertexBuffer.get().invokeExact(handles.PFN_glVertexArrayVertexBuffer, vaobj, bindingindex, buffer, offset, stride); }
    ...
    public void VertexArrayVertexBuffers(int vaobj, int first, int count, @NonNull MemorySegment buffers, @NonNull MemorySegment offsets, @NonNull MemorySegment strides) {
        ...
        Handles.MH_glVertexArrayVertexBuffers.get().invokeExact(handles.PFN_glVertexArrayVertexBuffers, vaobj, first, count, buffers, offsets, strides); }
    ...
    public void VertexArrayAttribBinding(int vaobj, int attribindex, int bindingindex) {
        ...
        Handles.MH_glVertexArrayAttribBinding.get().invokeExact(handles.PFN_glVertexArrayAttribBinding, vaobj, attribindex, bindingindex); }
    ...
    public void VertexArrayAttribFormat(int vaobj, int attribindex, int size, int type, boolean normalized, int relativeoffset) {
        ...
        Handles.MH_glVertexArrayAttribFormat.get().invokeExact(handles.PFN_glVertexArrayAttribFormat, vaobj, attribindex, size, type, ((normalized) ? (byte)1 : (byte)0), relativeoffset); }
    ...
    public void VertexArrayAttribIFormat(int vaobj, int attribindex, int size, int type, int relativeoffset) {
        ...
        Handles.MH_glVertexArrayAttribIFormat.get().invokeExact(handles.PFN_glVertexArrayAttribIFormat, vaobj, attribindex, size, type, relativeoffset); }
    ...
    public void VertexArrayAttribLFormat(int vaobj, int attribindex, int size, int type, int relativeoffset) {
        ...
        Handles.MH_glVertexArrayAttribLFormat.get().invokeExact(handles.PFN_glVertexArrayAttribLFormat, vaobj, attribindex, size, type, relativeoffset); }
    ...
    public void VertexArrayBindingDivisor(int vaobj, int bindingindex, int divisor) {
        ...
        Handles.MH_glVertexArrayBindingDivisor.get().invokeExact(handles.PFN_glVertexArrayBindingDivisor, vaobj, bindingindex, divisor); }
    ...
    public void GetVertexArrayiv(int vaobj, int pname, @NonNull MemorySegment param) {
        ...
        Handles.MH_glGetVertexArrayiv.get().invokeExact(handles.PFN_glGetVertexArrayiv, vaobj, pname, param); }
    ...
    public void GetVertexArrayIndexediv(int vaobj, int index, int pname, @NonNull MemorySegment param) {
        ...
        Handles.MH_glGetVertexArrayIndexediv.get().invokeExact(handles.PFN_glGetVertexArrayIndexediv, vaobj, index, pname, param); }
    ...
    public void GetVertexArrayIndexed64iv(int vaobj, int index, int pname, @NonNull MemorySegment param) {
        ...
        Handles.MH_glGetVertexArrayIndexed64iv.get().invokeExact(handles.PFN_glGetVertexArrayIndexed64iv, vaobj, index, pname, param); }
    ...
    public void CreateSamplers(int n, @NonNull MemorySegment samplers) {
        ...
        Handles.MH_glCreateSamplers.get().invokeExact(handles.PFN_glCreateSamplers, n, samplers); }
    ...
    public void CreateProgramPipelines(int n, @NonNull MemorySegment pipelines) {
        ...
        Handles.MH_glCreateProgramPipelines.get().invokeExact(handles.PFN_glCreateProgramPipelines, n, pipelines); }
    ...
    public void CreateQueries(int target, int n, @NonNull MemorySegment ids) {
        ...
        Handles.MH_glCreateQueries.get().invokeExact(handles.PFN_glCreateQueries, target, n, ids); }
    ...
    public void GetQueryBufferObjecti64v(int id, int buffer, int pname, long offset) {
        ...
        Handles.MH_glGetQueryBufferObjecti64v.get().invokeExact(handles.PFN_glGetQueryBufferObjecti64v, id, buffer, pname, offset); }
    ...
    public void GetQueryBufferObjectiv(int id, int buffer, int pname, long offset) {
        ...
        Handles.MH_glGetQueryBufferObjectiv.get().invokeExact(handles.PFN_glGetQueryBufferObjectiv, id, buffer, pname, offset); }
    ...
    public void GetQueryBufferObjectui64v(int id, int buffer, int pname, long offset) {
        ...
        Handles.MH_glGetQueryBufferObjectui64v.get().invokeExact(handles.PFN_glGetQueryBufferObjectui64v, id, buffer, pname, offset); }
    ...
    public void GetQueryBufferObjectuiv(int id, int buffer, int pname, long offset) {
        ...
        Handles.MH_glGetQueryBufferObjectuiv.get().invokeExact(handles.PFN_glGetQueryBufferObjectuiv, id, buffer, pname, offset); }
    ...
    public void GetTextureSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, int bufSize, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glGetTextureSubImage.get().invokeExact(handles.PFN_glGetTextureSubImage, texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, bufSize, pixels); }
    ...
    public void GetCompressedTextureSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int bufSize, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glGetCompressedTextureSubImage.get().invokeExact(handles.PFN_glGetCompressedTextureSubImage, texture, level, xoffset, yoffset, zoffset, width, height, depth, bufSize, pixels); }
    ...
    /// ```
    public void GetnCompressedTexImage(int target, int lod, int bufSize, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glGetnCompressedTexImage.get().invokeExact(handles.PFN_glGetnCompressedTexImage, target, lod, bufSize, pixels); }
    ...
    /// ```
    public void GetnTexImage(int target, int level, int format, int type, int bufSize, @NonNull MemorySegment pixels) {
        ...
        Handles.MH_glGetnTexImage.get().invokeExact(handles.PFN_glGetnTexImage, target, level, format, type, bufSize, pixels); }
    ...
    /// ```
    public void GetnUniformdv(int program, int location, int bufSize, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetnUniformdv.get().invokeExact(handles.PFN_glGetnUniformdv, program, location, bufSize, params); }
