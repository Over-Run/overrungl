...
public final class GLKHRParallelShaderCompile {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glMaxShaderCompilerThreadsKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT)));
    ...
    public void MaxShaderCompilerThreadsKHR(int count) {
        ...
        Handles.MH_glMaxShaderCompilerThreadsKHR.get().invokeExact(handles.PFN_glMaxShaderCompilerThreadsKHR, count); }
