...
public final class GLNVGpuProgram5 {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glProgramSubroutineParametersuivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetProgramSubroutineParameteruivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void ProgramSubroutineParametersuivNV(int target, int count, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramSubroutineParametersuivNV.get().invokeExact(handles.PFN_glProgramSubroutineParametersuivNV, target, count, params); }
    ...
    public void GetProgramSubroutineParameteruivNV(int target, int index, @NonNull MemorySegment param) {
        ...
        Handles.MH_glGetProgramSubroutineParameteruivNV.get().invokeExact(handles.PFN_glGetProgramSubroutineParameteruivNV, target, index, param); }
