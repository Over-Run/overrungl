...
public final class GLNVPrimitiveRestart {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glPrimitiveRestartNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid()));
        public static final Supplier<MethodHandle> MH_glPrimitiveRestartIndexNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT)));
    ...
    public void PrimitiveRestartNV() {
        ...
        Handles.MH_glPrimitiveRestartNV.get().invokeExact(handles.PFN_glPrimitiveRestartNV); }
    ...
    public void PrimitiveRestartIndexNV(int index) {
        ...
        Handles.MH_glPrimitiveRestartIndexNV.get().invokeExact(handles.PFN_glPrimitiveRestartIndexNV, index); }
