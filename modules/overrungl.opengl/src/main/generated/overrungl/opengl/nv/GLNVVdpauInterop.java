...
public final class GLNVVdpauInterop {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glVDPAUInitNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glVDPAUFiniNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid()));
        public static final Supplier<MethodHandle> MH_glVDPAURegisterVideoSurfaceNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glVDPAURegisterOutputSurfaceNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glVDPAUIsSurfaceNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_BYTE, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glVDPAUUnregisterSurfaceNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glVDPAUGetSurfaceivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glVDPAUSurfaceAccessNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glVDPAUMapSurfacesNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glVDPAUUnmapSurfacesNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void VDPAUInitNV(@NonNull MemorySegment vdpDevice, @NonNull MemorySegment getProcAddress) {
        ...
        Handles.MH_glVDPAUInitNV.get().invokeExact(handles.PFN_glVDPAUInitNV, vdpDevice, getProcAddress); }
    ...
    public void VDPAUFiniNV() {
        ...
        Handles.MH_glVDPAUFiniNV.get().invokeExact(handles.PFN_glVDPAUFiniNV); }
    ...
    public long VDPAURegisterVideoSurfaceNV(@NonNull MemorySegment vdpSurface, int target, int numTextureNames, @NonNull MemorySegment textureNames) {
        ...
        return (long) Handles.MH_glVDPAURegisterVideoSurfaceNV.get().invokeExact(handles.PFN_glVDPAURegisterVideoSurfaceNV, vdpSurface, target, numTextureNames, textureNames); }
    ...
    public long VDPAURegisterOutputSurfaceNV(@NonNull MemorySegment vdpSurface, int target, int numTextureNames, @NonNull MemorySegment textureNames) {
        ...
        return (long) Handles.MH_glVDPAURegisterOutputSurfaceNV.get().invokeExact(handles.PFN_glVDPAURegisterOutputSurfaceNV, vdpSurface, target, numTextureNames, textureNames); }
    ...
    public boolean VDPAUIsSurfaceNV(long surface) {
        ...
        return (((byte) Handles.MH_glVDPAUIsSurfaceNV.get().invokeExact(handles.PFN_glVDPAUIsSurfaceNV, surface)) != 0); }
    ...
    public void VDPAUUnregisterSurfaceNV(long surface) {
        ...
        Handles.MH_glVDPAUUnregisterSurfaceNV.get().invokeExact(handles.PFN_glVDPAUUnregisterSurfaceNV, surface); }
    ...
    public void VDPAUGetSurfaceivNV(long surface, int pname, int count, @NonNull MemorySegment length, @NonNull MemorySegment values) {
        ...
        Handles.MH_glVDPAUGetSurfaceivNV.get().invokeExact(handles.PFN_glVDPAUGetSurfaceivNV, surface, pname, count, length, values); }
    ...
    public void VDPAUSurfaceAccessNV(long surface, int access) {
        ...
        Handles.MH_glVDPAUSurfaceAccessNV.get().invokeExact(handles.PFN_glVDPAUSurfaceAccessNV, surface, access); }
    ...
    public void VDPAUMapSurfacesNV(int numSurfaces, @NonNull MemorySegment surfaces) {
        ...
        Handles.MH_glVDPAUMapSurfacesNV.get().invokeExact(handles.PFN_glVDPAUMapSurfacesNV, numSurfaces, surfaces); }
    ...
    public void VDPAUUnmapSurfacesNV(int numSurface, @NonNull MemorySegment surfaces) {
        ...
        Handles.MH_glVDPAUUnmapSurfacesNV.get().invokeExact(handles.PFN_glVDPAUUnmapSurfacesNV, numSurface, surfaces); }
