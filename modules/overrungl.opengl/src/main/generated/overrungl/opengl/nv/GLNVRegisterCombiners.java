...
public final class GLNVRegisterCombiners {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glCombinerParameterfvNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCombinerParameterfNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_FLOAT)));
        public static final Supplier<MethodHandle> MH_glCombinerParameterivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCombinerParameteriNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glCombinerInputNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glCombinerOutputNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_BYTE, ValueLayout.JAVA_BYTE, ValueLayout.JAVA_BYTE)));
        public static final Supplier<MethodHandle> MH_glFinalCombinerInputNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glGetCombinerInputParameterfvNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetCombinerInputParameterivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetCombinerOutputParameterfvNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetCombinerOutputParameterivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetFinalCombinerInputParameterfvNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetFinalCombinerInputParameterivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void CombinerParameterfvNV(int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glCombinerParameterfvNV.get().invokeExact(handles.PFN_glCombinerParameterfvNV, pname, params); }
    ...
    public void CombinerParameterfNV(int pname, float param) {
        ...
        Handles.MH_glCombinerParameterfNV.get().invokeExact(handles.PFN_glCombinerParameterfNV, pname, param); }
    ...
    public void CombinerParameterivNV(int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glCombinerParameterivNV.get().invokeExact(handles.PFN_glCombinerParameterivNV, pname, params); }
    ...
    public void CombinerParameteriNV(int pname, int param) {
        ...
        Handles.MH_glCombinerParameteriNV.get().invokeExact(handles.PFN_glCombinerParameteriNV, pname, param); }
    ...
    public void CombinerInputNV(int stage, int portion, int variable, int input, int mapping, int componentUsage) {
        ...
        Handles.MH_glCombinerInputNV.get().invokeExact(handles.PFN_glCombinerInputNV, stage, portion, variable, input, mapping, componentUsage); }
    ...
    public void CombinerOutputNV(int stage, int portion, int abOutput, int cdOutput, int sumOutput, int scale, int bias, boolean abDotProduct, boolean cdDotProduct, boolean muxSum) {
        ...
        Handles.MH_glCombinerOutputNV.get().invokeExact(handles.PFN_glCombinerOutputNV, stage, portion, abOutput, cdOutput, sumOutput, scale, bias, ((abDotProduct) ? (byte)1 : (byte)0), ((cdDotProduct) ? (byte)1 : (byte)0), ((muxSum) ? (byte)1 : (byte)0)); }
    ...
    public void FinalCombinerInputNV(int variable, int input, int mapping, int componentUsage) {
        ...
        Handles.MH_glFinalCombinerInputNV.get().invokeExact(handles.PFN_glFinalCombinerInputNV, variable, input, mapping, componentUsage); }
    ...
    public void GetCombinerInputParameterfvNV(int stage, int portion, int variable, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetCombinerInputParameterfvNV.get().invokeExact(handles.PFN_glGetCombinerInputParameterfvNV, stage, portion, variable, pname, params); }
    ...
    public void GetCombinerInputParameterivNV(int stage, int portion, int variable, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetCombinerInputParameterivNV.get().invokeExact(handles.PFN_glGetCombinerInputParameterivNV, stage, portion, variable, pname, params); }
    ...
    public void GetCombinerOutputParameterfvNV(int stage, int portion, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetCombinerOutputParameterfvNV.get().invokeExact(handles.PFN_glGetCombinerOutputParameterfvNV, stage, portion, pname, params); }
    ...
    public void GetCombinerOutputParameterivNV(int stage, int portion, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetCombinerOutputParameterivNV.get().invokeExact(handles.PFN_glGetCombinerOutputParameterivNV, stage, portion, pname, params); }
    ...
    public void GetFinalCombinerInputParameterfvNV(int variable, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetFinalCombinerInputParameterfvNV.get().invokeExact(handles.PFN_glGetFinalCombinerInputParameterfvNV, variable, pname, params); }
    ...
    public void GetFinalCombinerInputParameterivNV(int variable, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetFinalCombinerInputParameterivNV.get().invokeExact(handles.PFN_glGetFinalCombinerInputParameterivNV, variable, pname, params); }
