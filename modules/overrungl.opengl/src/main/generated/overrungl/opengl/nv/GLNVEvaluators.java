...
public final class GLNVEvaluators {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glMapControlPointsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_BYTE, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glMapParameterivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glMapParameterfvNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetMapControlPointsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_BYTE, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetMapParameterivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetMapParameterfvNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetMapAttribParameterivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetMapAttribParameterfvNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glEvalMapsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
    ...
    public GLNVEvaluators(GLLoadFunc func) {
        this.handles = new Handles(func);
    }

    /// Invokes `glMapControlPointsNV`.
    /// ```
    ...
    /// ```
    public void MapControlPointsNV(int target, int index, int type, int ustride, int vstride, int uorder, int vorder, boolean packed, @NonNull MemorySegment points) {
        ...
        Handles.MH_glMapControlPointsNV.get().invokeExact(handles.PFN_glMapControlPointsNV, target, index, type, ustride, vstride, uorder, vorder, ((packed) ? (byte)1 : (byte)0), points); }
        catch (Throwable e) { throw new RuntimeException("error in MapControlPointsNV", e); }
    }

    /// Invokes `glMapParameterivNV`.
    /// ```
    /// void glMapParameterivNV((unsigned int) GLenum target, (unsigned int) GLenum pname, const GLint* params);
    /// ```
    public void MapParameterivNV(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glMapParameterivNV.get().invokeExact(handles.PFN_glMapParameterivNV, target, pname, params); }
        catch (Throwable e) { throw new RuntimeException("error in MapParameterivNV", e); }
    }

    /// Invokes `glMapParameterfvNV`.
    /// ```
    /// void glMapParameterfvNV((unsigned int) GLenum target, (unsigned int) GLenum pname, const GLfloat* params);
    /// ```
    public void MapParameterfvNV(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glMapParameterfvNV.get().invokeExact(handles.PFN_glMapParameterfvNV, target, pname, params); }
        catch (Throwable e) { throw new RuntimeException("error in MapParameterfvNV", e); }
    }

    /// Invokes `glGetMapControlPointsNV`.
    /// ```
    ...
    /// ```
    public void GetMapControlPointsNV(int target, int index, int type, int ustride, int vstride, boolean packed, @NonNull MemorySegment points) {
        ...
        Handles.MH_glGetMapControlPointsNV.get().invokeExact(handles.PFN_glGetMapControlPointsNV, target, index, type, ustride, vstride, ((packed) ? (byte)1 : (byte)0), points); }
        catch (Throwable e) { throw new RuntimeException("error in GetMapControlPointsNV", e); }
    }

    /// Invokes `glGetMapParameterivNV`.
    /// ```
    /// void glGetMapParameterivNV((unsigned int) GLenum target, (unsigned int) GLenum pname, GLint* params);
    /// ```
    public void GetMapParameterivNV(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetMapParameterivNV.get().invokeExact(handles.PFN_glGetMapParameterivNV, target, pname, params); }
        catch (Throwable e) { throw new RuntimeException("error in GetMapParameterivNV", e); }
    }

    /// Invokes `glGetMapParameterfvNV`.
    /// ```
    /// void glGetMapParameterfvNV((unsigned int) GLenum target, (unsigned int) GLenum pname, GLfloat* params);
    /// ```
    public void GetMapParameterfvNV(int target, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetMapParameterfvNV.get().invokeExact(handles.PFN_glGetMapParameterfvNV, target, pname, params); }
        catch (Throwable e) { throw new RuntimeException("error in GetMapParameterfvNV", e); }
    }

    /// Invokes `glGetMapAttribParameterivNV`.
    /// ```
    ...
    /// ```
    public void GetMapAttribParameterivNV(int target, int index, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetMapAttribParameterivNV.get().invokeExact(handles.PFN_glGetMapAttribParameterivNV, target, index, pname, params); }
        catch (Throwable e) { throw new RuntimeException("error in GetMapAttribParameterivNV", e); }
    }

    /// Invokes `glGetMapAttribParameterfvNV`.
    /// ```
    ...
    /// ```
    public void GetMapAttribParameterfvNV(int target, int index, int pname, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetMapAttribParameterfvNV.get().invokeExact(handles.PFN_glGetMapAttribParameterfvNV, target, index, pname, params); }
        catch (Throwable e) { throw new RuntimeException("error in GetMapAttribParameterfvNV", e); }
    }

    /// Invokes `glEvalMapsNV`.
    /// ```
    ...
    public void EvalMapsNV(int target, int mode) {
        ...
        Handles.MH_glEvalMapsNV.get().invokeExact(handles.PFN_glEvalMapsNV, target, mode); }
