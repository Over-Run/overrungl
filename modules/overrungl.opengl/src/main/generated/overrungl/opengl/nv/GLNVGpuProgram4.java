...
public final class GLNVGpuProgram4 {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glProgramLocalParameterI4iNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glProgramLocalParameterI4ivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glProgramLocalParametersI4ivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glProgramLocalParameterI4uiNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glProgramLocalParameterI4uivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glProgramLocalParametersI4uivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glProgramEnvParameterI4iNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glProgramEnvParameterI4ivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glProgramEnvParametersI4ivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glProgramEnvParameterI4uiNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glProgramEnvParameterI4uivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glProgramEnvParametersI4uivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetProgramLocalParameterIivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetProgramLocalParameterIuivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetProgramEnvParameterIivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetProgramEnvParameterIuivNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void ProgramLocalParameterI4iNV(int target, int index, int x, int y, int z, int w) {
        ...
        Handles.MH_glProgramLocalParameterI4iNV.get().invokeExact(handles.PFN_glProgramLocalParameterI4iNV, target, index, x, y, z, w); }
    ...
    public void ProgramLocalParameterI4ivNV(int target, int index, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramLocalParameterI4ivNV.get().invokeExact(handles.PFN_glProgramLocalParameterI4ivNV, target, index, params); }
    ...
    public void ProgramLocalParametersI4ivNV(int target, int index, int count, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramLocalParametersI4ivNV.get().invokeExact(handles.PFN_glProgramLocalParametersI4ivNV, target, index, count, params); }
    ...
    public void ProgramLocalParameterI4uiNV(int target, int index, int x, int y, int z, int w) {
        ...
        Handles.MH_glProgramLocalParameterI4uiNV.get().invokeExact(handles.PFN_glProgramLocalParameterI4uiNV, target, index, x, y, z, w); }
    ...
    public void ProgramLocalParameterI4uivNV(int target, int index, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramLocalParameterI4uivNV.get().invokeExact(handles.PFN_glProgramLocalParameterI4uivNV, target, index, params); }
    ...
    public void ProgramLocalParametersI4uivNV(int target, int index, int count, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramLocalParametersI4uivNV.get().invokeExact(handles.PFN_glProgramLocalParametersI4uivNV, target, index, count, params); }
    ...
    public void ProgramEnvParameterI4iNV(int target, int index, int x, int y, int z, int w) {
        ...
        Handles.MH_glProgramEnvParameterI4iNV.get().invokeExact(handles.PFN_glProgramEnvParameterI4iNV, target, index, x, y, z, w); }
    ...
    public void ProgramEnvParameterI4ivNV(int target, int index, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramEnvParameterI4ivNV.get().invokeExact(handles.PFN_glProgramEnvParameterI4ivNV, target, index, params); }
    ...
    public void ProgramEnvParametersI4ivNV(int target, int index, int count, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramEnvParametersI4ivNV.get().invokeExact(handles.PFN_glProgramEnvParametersI4ivNV, target, index, count, params); }
    ...
    public void ProgramEnvParameterI4uiNV(int target, int index, int x, int y, int z, int w) {
        ...
        Handles.MH_glProgramEnvParameterI4uiNV.get().invokeExact(handles.PFN_glProgramEnvParameterI4uiNV, target, index, x, y, z, w); }
    ...
    public void ProgramEnvParameterI4uivNV(int target, int index, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramEnvParameterI4uivNV.get().invokeExact(handles.PFN_glProgramEnvParameterI4uivNV, target, index, params); }
    ...
    public void ProgramEnvParametersI4uivNV(int target, int index, int count, @NonNull MemorySegment params) {
        ...
        Handles.MH_glProgramEnvParametersI4uivNV.get().invokeExact(handles.PFN_glProgramEnvParametersI4uivNV, target, index, count, params); }
    ...
    public void GetProgramLocalParameterIivNV(int target, int index, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetProgramLocalParameterIivNV.get().invokeExact(handles.PFN_glGetProgramLocalParameterIivNV, target, index, params); }
    ...
    public void GetProgramLocalParameterIuivNV(int target, int index, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetProgramLocalParameterIuivNV.get().invokeExact(handles.PFN_glGetProgramLocalParameterIuivNV, target, index, params); }
    ...
    public void GetProgramEnvParameterIivNV(int target, int index, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetProgramEnvParameterIivNV.get().invokeExact(handles.PFN_glGetProgramEnvParameterIivNV, target, index, params); }
    ...
    public void GetProgramEnvParameterIuivNV(int target, int index, @NonNull MemorySegment params) {
        ...
        Handles.MH_glGetProgramEnvParameterIuivNV.get().invokeExact(handles.PFN_glGetProgramEnvParameterIuivNV, target, index, params); }
