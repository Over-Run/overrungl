...
public final class GLNVTransformFeedback {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glBeginTransformFeedbackNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glEndTransformFeedbackNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid()));
        public static final Supplier<MethodHandle> MH_glTransformFeedbackAttribsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glBindBufferRangeNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glBindBufferOffsetNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_glBindBufferBaseNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glTransformFeedbackVaryingsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glActiveVaryingNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetVaryingLocationNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetActiveVaryingNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetTransformFeedbackVaryingNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glTransformFeedbackStreamAttribsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT)));
    ...
    public void BeginTransformFeedbackNV(int primitiveMode) {
        ...
        Handles.MH_glBeginTransformFeedbackNV.get().invokeExact(handles.PFN_glBeginTransformFeedbackNV, primitiveMode); }
    ...
    public void EndTransformFeedbackNV() {
        ...
        Handles.MH_glEndTransformFeedbackNV.get().invokeExact(handles.PFN_glEndTransformFeedbackNV); }
    ...
    public void TransformFeedbackAttribsNV(int count, @NonNull MemorySegment attribs, int bufferMode) {
        ...
        Handles.MH_glTransformFeedbackAttribsNV.get().invokeExact(handles.PFN_glTransformFeedbackAttribsNV, count, attribs, bufferMode); }
    ...
    public void BindBufferRangeNV(int target, int index, int buffer, long offset, long size) {
        ...
        Handles.MH_glBindBufferRangeNV.get().invokeExact(handles.PFN_glBindBufferRangeNV, target, index, buffer, offset, size); }
    ...
    public void BindBufferOffsetNV(int target, int index, int buffer, long offset) {
        ...
        Handles.MH_glBindBufferOffsetNV.get().invokeExact(handles.PFN_glBindBufferOffsetNV, target, index, buffer, offset); }
    ...
    public void BindBufferBaseNV(int target, int index, int buffer) {
        ...
        Handles.MH_glBindBufferBaseNV.get().invokeExact(handles.PFN_glBindBufferBaseNV, target, index, buffer); }
    ...
    public void TransformFeedbackVaryingsNV(int program, int count, @NonNull MemorySegment locations, int bufferMode) {
        ...
        Handles.MH_glTransformFeedbackVaryingsNV.get().invokeExact(handles.PFN_glTransformFeedbackVaryingsNV, program, count, locations, bufferMode); }
    ...
    public void ActiveVaryingNV(int program, @NonNull MemorySegment name) {
        ...
        Handles.MH_glActiveVaryingNV.get().invokeExact(handles.PFN_glActiveVaryingNV, program, name); }
    ...
    public int GetVaryingLocationNV(int program, @NonNull MemorySegment name) {
        ...
        return (int) Handles.MH_glGetVaryingLocationNV.get().invokeExact(handles.PFN_glGetVaryingLocationNV, program, name); }
    ...
    public void GetActiveVaryingNV(int program, int index, int bufSize, @NonNull MemorySegment length, @NonNull MemorySegment size, @NonNull MemorySegment type, @NonNull MemorySegment name) {
        ...
        Handles.MH_glGetActiveVaryingNV.get().invokeExact(handles.PFN_glGetActiveVaryingNV, program, index, bufSize, length, size, type, name); }
    ...
    public void GetTransformFeedbackVaryingNV(int program, int index, @NonNull MemorySegment location) {
        ...
        Handles.MH_glGetTransformFeedbackVaryingNV.get().invokeExact(handles.PFN_glGetTransformFeedbackVaryingNV, program, index, location); }
    ...
    public void TransformFeedbackStreamAttribsNV(int count, @NonNull MemorySegment attribs, int nbuffers, @NonNull MemorySegment bufstreams, int bufferMode) {
        ...
        Handles.MH_glTransformFeedbackStreamAttribsNV.get().invokeExact(handles.PFN_glTransformFeedbackStreamAttribsNV, count, attribs, nbuffers, bufstreams, bufferMode); }
