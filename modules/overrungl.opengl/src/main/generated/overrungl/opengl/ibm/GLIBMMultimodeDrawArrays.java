...
public final class GLIBMMultimodeDrawArrays {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glMultiModeDrawArraysIBM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glMultiModeDrawElementsIBM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
    ...
    public void MultiModeDrawArraysIBM(@NonNull MemorySegment mode, @NonNull MemorySegment first, @NonNull MemorySegment count, int primcount, int modestride) {
        ...
        Handles.MH_glMultiModeDrawArraysIBM.get().invokeExact(handles.PFN_glMultiModeDrawArraysIBM, mode, first, count, primcount, modestride); }
    ...
    public void MultiModeDrawElementsIBM(@NonNull MemorySegment mode, @NonNull MemorySegment count, int type, @NonNull MemorySegment indices, int primcount, int modestride) {
        ...
        Handles.MH_glMultiModeDrawElementsIBM.get().invokeExact(handles.PFN_glMultiModeDrawElementsIBM, mode, count, type, indices, primcount, modestride); }
