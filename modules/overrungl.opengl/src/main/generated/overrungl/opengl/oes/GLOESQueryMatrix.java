...
public final class GLOESQueryMatrix {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glQueryMatrixxOES = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
    ...
    public int QueryMatrixxOES(@NonNull MemorySegment mantissa, @NonNull MemorySegment exponent) {
        ...
        return (int) Handles.MH_glQueryMatrixxOES.get().invokeExact(handles.PFN_glQueryMatrixxOES, mantissa, exponent); }
