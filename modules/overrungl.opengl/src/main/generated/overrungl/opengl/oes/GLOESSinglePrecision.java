...
public final class GLOESSinglePrecision {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glClearDepthfOES = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_FLOAT)));
        public static final Supplier<MethodHandle> MH_glClipPlanefOES = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glDepthRangefOES = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT)));
        public static final Supplier<MethodHandle> MH_glFrustumfOES = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT)));
        public static final Supplier<MethodHandle> MH_glGetClipPlanefOES = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glOrthofOES = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT)));
    ...
    public void ClearDepthfOES(float depth) {
        ...
        Handles.MH_glClearDepthfOES.get().invokeExact(handles.PFN_glClearDepthfOES, depth); }
    ...
    public void ClipPlanefOES(int plane, @NonNull MemorySegment equation) {
        ...
        Handles.MH_glClipPlanefOES.get().invokeExact(handles.PFN_glClipPlanefOES, plane, equation); }
    ...
    public void DepthRangefOES(float n, float f) {
        ...
        Handles.MH_glDepthRangefOES.get().invokeExact(handles.PFN_glDepthRangefOES, n, f); }
    ...
    public void FrustumfOES(float l, float r, float b, float t, float n, float f) {
        ...
        Handles.MH_glFrustumfOES.get().invokeExact(handles.PFN_glFrustumfOES, l, r, b, t, n, f); }
    ...
    public void GetClipPlanefOES(int plane, @NonNull MemorySegment equation) {
        ...
        Handles.MH_glGetClipPlanefOES.get().invokeExact(handles.PFN_glGetClipPlanefOES, plane, equation); }
    ...
    public void OrthofOES(float l, float r, float b, float t, float n, float f) {
        ...
        Handles.MH_glOrthofOES.get().invokeExact(handles.PFN_glOrthofOES, l, r, b, t, n, f); }
