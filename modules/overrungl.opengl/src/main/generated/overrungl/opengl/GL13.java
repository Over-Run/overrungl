...
public class GL13 extends GL12 {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_glActiveTexture = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_glSampleCoverage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_BYTE)));
        public static final Supplier<MethodHandle> MH_glCompressedTexImage3D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCompressedTexImage2D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCompressedTexImage1D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCompressedTexSubImage3D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCompressedTexSubImage2D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glCompressedTexSubImage1D = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_glGetCompressedTexImage = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
    ...
    public void ActiveTexture(int texture) {
        ...
        Handles.MH_glActiveTexture.get().invokeExact(handles.PFN_glActiveTexture, texture); }
    ...
    public void SampleCoverage(float value, boolean invert) {
        ...
        Handles.MH_glSampleCoverage.get().invokeExact(handles.PFN_glSampleCoverage, value, ((invert) ? (byte)1 : (byte)0)); }
    ...
    public void CompressedTexImage3D(int target, int level, int internalformat, int width, int height, int depth, int border, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTexImage3D.get().invokeExact(handles.PFN_glCompressedTexImage3D, target, level, internalformat, width, height, depth, border, imageSize, data); }
    ...
    public void CompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTexImage2D.get().invokeExact(handles.PFN_glCompressedTexImage2D, target, level, internalformat, width, height, border, imageSize, data); }
    ...
    public void CompressedTexImage1D(int target, int level, int internalformat, int width, int border, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTexImage1D.get().invokeExact(handles.PFN_glCompressedTexImage1D, target, level, internalformat, width, border, imageSize, data); }
    ...
    public void CompressedTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTexSubImage3D.get().invokeExact(handles.PFN_glCompressedTexSubImage3D, target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data); }
    ...
    public void CompressedTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTexSubImage2D.get().invokeExact(handles.PFN_glCompressedTexSubImage2D, target, level, xoffset, yoffset, width, height, format, imageSize, data); }
    ...
    public void CompressedTexSubImage1D(int target, int level, int xoffset, int width, int format, int imageSize, @NonNull MemorySegment data) {
        ...
        Handles.MH_glCompressedTexSubImage1D.get().invokeExact(handles.PFN_glCompressedTexSubImage1D, target, level, xoffset, width, format, imageSize, data); }
    ...
    public void GetCompressedTexImage(int target, int level, @NonNull MemorySegment img) {
        ...
        Handles.MH_glGetCompressedTexImage.get().invokeExact(handles.PFN_glGetCompressedTexImage, target, level, img); }
