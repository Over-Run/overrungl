...
public final class STBRPRect extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_was_packed = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("was_packed")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int was_packed(MemorySegment segment, long index) { return (int) VH_was_packed.get().get(segment, 0L, index); }
    /// {@return `was_packed`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void was_packed(MemorySegment segment, long index, int value) { VH_was_packed.get().set(segment, 0L, index, value); }
