...
/// };
/// ```
public final class STBTTVertex extends GroupType {
    ...
    public STBTTVertex(MemorySegment segment, long elementCount) { super(segment, LAYOUT, elementCount); }

    /// Creates `STBTTVertex` with the given segment.
    /// @param segment the memory segment
    /// @return the created instance or `null` if the segment is `NULL`
    public static STBTTVertex of(MemorySegment segment) { return MemoryUtil.isNullPointer(segment) ? null : new STBTTVertex(segment, estimateCount(segment, LAYOUT)); }
    ...
    /// @param segment the memory segment
    /// @return the created instance or `null` if the segment is `NULL`
    public static STBTTVertex ofNative(MemorySegment segment) { return MemoryUtil.isNullPointer(segment) ? null : new STBTTVertex(segment.reinterpret(LAYOUT.byteSize()), 1); }
    ...
    /// @return the created instance or `null` if the segment is `NULL`
    public static STBTTVertex ofNative(MemorySegment segment, long count) { return MemoryUtil.isNullPointer(segment) ? null : new STBTTVertex(segment.reinterpret(LAYOUT.scale(0, count)), count); }

    /// Allocates a `STBTTVertex` with the given segment allocator.
    /// @param allocator the segment allocator
    /// @return the allocated `STBTTVertex`
    public static STBTTVertex alloc(SegmentAllocator allocator) { return new STBTTVertex(allocator.allocate(LAYOUT), 1); }

    /// Allocates a `STBTTVertex` with the given segment allocator and count.
    /// @param allocator the segment allocator
    /// @param count     the count
    /// @return the allocated `STBTTVertex`
    public static STBTTVertex alloc(SegmentAllocator allocator, long count) { return new STBTTVertex(allocator.allocate(LAYOUT, count), count); }
    ...
    public STBTTVertex reinterpret(long count) { return new STBTTVertex(this.segment().reinterpret(LAYOUT.scale(0, count)), count); }
    ...
    public STBTTVertex asSlice(long index) { return new STBTTVertex(this.segment().asSlice(LAYOUT.scale(0L, index), LAYOUT), 1); }

    /// Creates a slice of `STBTTVertex`.
    /// @param index the index of the struct buffer
    /// @param count the count
    /// @return the slice of `STBTTVertex`
    public STBTTVertex asSlice(long index, long count) { return new STBTTVertex(this.segment().asSlice(LAYOUT.scale(0L, index), LAYOUT.byteSize() * count), count); }

    /// Visits `STBTTVertex` buffer at the given index.
    /// @param index the index of this buffer
    /// @param func  the function to run with the slice of this buffer
    /// @return `this`
    public STBTTVertex at(long index, Consumer<STBTTVertex> func) { func.accept(asSlice(index)); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public STBTTVertex xAt(long index, short value) { x(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public STBTTVertex yAt(long index, short value) { y(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public STBTTVertex cxAt(long index, short value) { cx(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public STBTTVertex cyAt(long index, short value) { cy(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public STBTTVertex cx1At(long index, short value) { cx1(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public STBTTVertex cy1At(long index, short value) { cy1(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public STBTTVertex typeAt(long index, byte value) { type(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public STBTTVertex paddingAt(long index, byte value) { padding(this.segment(), index, value); return this; }
