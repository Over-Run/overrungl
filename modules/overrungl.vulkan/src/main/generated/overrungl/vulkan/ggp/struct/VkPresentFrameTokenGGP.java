...
public final class VkPresentFrameTokenGGP extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_frameToken = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("frameToken")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long frameToken(MemorySegment segment, long index) { return (long) VH_frameToken.get().get(segment, 0L, index); }
    /// {@return `frameToken`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void frameToken(MemorySegment segment, long index, long value) { VH_frameToken.get().set(segment, 0L, index, value); }
