...
public final class VkStreamDescriptorSurfaceCreateInfoGGP extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_streamDescriptor = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("streamDescriptor")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int streamDescriptor(MemorySegment segment, long index) { return (int) VH_streamDescriptor.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void streamDescriptor(MemorySegment segment, long index, int value) { VH_streamDescriptor.get().set(segment, 0L, index, value); }
