...
public interface VkAllocationFunction extends Upcall {
    ...
    default MemorySegment invokeP(MemorySegment pUserData, long size, long alignment, int allocationScope) {
        return invoke(pUserData, size, alignment, allocationScope);
    }
    default MemorySegment invokeP(MemorySegment pUserData, int size, int alignment, int allocationScope) {
        return invoke(pUserData, size, alignment, allocationScope);
    }
