...
public final class VKNVCopyMemoryIndirect {
    ...
    public static final int VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_PROPERTIES_NV = 1000549001;
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCmdCopyMemoryIndirectNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_vkCmdCopyMemoryToImageIndirectNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static void vkCmdCopyMemoryIndirectNV(@NonNull VkCommandBuffer commandBuffer, long copyBufferAddress, int copyCount, int stride) {
        ...
        Handles.MH_vkCmdCopyMemoryIndirectNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdCopyMemoryIndirectNV, commandBuffer.segment(), copyBufferAddress, copyCount, stride); }
    ...
    public static void vkCmdCopyMemoryToImageIndirectNV(@NonNull VkCommandBuffer commandBuffer, long copyBufferAddress, int copyCount, int stride, long dstImage, int dstImageLayout, @NonNull MemorySegment pImageSubresources) {
        ...
        Handles.MH_vkCmdCopyMemoryToImageIndirectNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdCopyMemoryToImageIndirectNV, commandBuffer.segment(), copyBufferAddress, copyCount, stride, dstImage, dstImageLayout, pImageSubresources); }
