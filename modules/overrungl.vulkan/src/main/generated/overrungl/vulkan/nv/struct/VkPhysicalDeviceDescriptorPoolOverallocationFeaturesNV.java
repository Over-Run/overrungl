...
public final class VkPhysicalDeviceDescriptorPoolOverallocationFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_descriptorPoolOverallocation = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("descriptorPoolOverallocation")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int descriptorPoolOverallocation(MemorySegment segment, long index) { return (int) VH_descriptorPoolOverallocation.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void descriptorPoolOverallocation(MemorySegment segment, long index, int value) { VH_descriptorPoolOverallocation.get().set(segment, 0L, index, value); }
