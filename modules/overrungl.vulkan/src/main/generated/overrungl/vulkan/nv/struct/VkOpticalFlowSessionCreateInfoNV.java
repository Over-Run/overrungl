...
public final class VkOpticalFlowSessionCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_flowVectorFormat = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("flowVectorFormat")));
    ...
    public static final Supplier<VarHandle> VH_costFormat = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("costFormat")));
    ...
    public static final Supplier<VarHandle> VH_outputGridSize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("outputGridSize")));
    ...
    public static final Supplier<VarHandle> VH_hintGridSize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("hintGridSize")));
    ...
    public static final Supplier<VarHandle> VH_performanceLevel = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("performanceLevel")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int flowVectorFormat(MemorySegment segment, long index) { return (int) VH_flowVectorFormat.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void flowVectorFormat(MemorySegment segment, long index, int value) { VH_flowVectorFormat.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int costFormat(MemorySegment segment, long index) { return (int) VH_costFormat.get().get(segment, 0L, index); }
    /// {@return `costFormat`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void costFormat(MemorySegment segment, long index, int value) { VH_costFormat.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int outputGridSize(MemorySegment segment, long index) { return (int) VH_outputGridSize.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void outputGridSize(MemorySegment segment, long index, int value) { VH_outputGridSize.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int hintGridSize(MemorySegment segment, long index) { return (int) VH_hintGridSize.get().get(segment, 0L, index); }
    /// {@return `hintGridSize`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void hintGridSize(MemorySegment segment, long index, int value) { VH_hintGridSize.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int performanceLevel(MemorySegment segment, long index) { return (int) VH_performanceLevel.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void performanceLevel(MemorySegment segment, long index, int value) { VH_performanceLevel.get().set(segment, 0L, index, value); }
