...
public final class VkPhysicalDevicePresentBarrierFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_presentBarrier = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentBarrier")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int presentBarrier(MemorySegment segment, long index) { return (int) VH_presentBarrier.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void presentBarrier(MemorySegment segment, long index, int value) { VH_presentBarrier.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPhysicalDevicePresentBarrierFeaturesNV` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDevicePresentBarrierFeaturesNV sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDevicePresentBarrierFeaturesNV pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDevicePresentBarrierFeaturesNV presentBarrierAt(long index, int value) { presentBarrier(this.segment(), index, value); return this; }
