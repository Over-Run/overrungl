...
public final class VkPhysicalDevicePartitionedAccelerationStructurePropertiesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxPartitionCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxPartitionCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxPartitionCount(MemorySegment segment, long index) { return (int) VH_maxPartitionCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxPartitionCount(MemorySegment segment, long index, int value) { VH_maxPartitionCount.get().set(segment, 0L, index, value); }
