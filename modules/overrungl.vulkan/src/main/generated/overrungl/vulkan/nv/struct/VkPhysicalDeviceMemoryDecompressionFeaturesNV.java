...
public final class VkPhysicalDeviceMemoryDecompressionFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_memoryDecompression = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("memoryDecompression")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int memoryDecompression(MemorySegment segment, long index) { return (int) VH_memoryDecompression.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void memoryDecompression(MemorySegment segment, long index, int value) { VH_memoryDecompression.get().set(segment, 0L, index, value); }
