...
public final class VkPhysicalDeviceClusterAccelerationStructureFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_clusterAccelerationStructure = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("clusterAccelerationStructure")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int clusterAccelerationStructure(MemorySegment segment, long index) { return (int) VH_clusterAccelerationStructure.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void clusterAccelerationStructure(MemorySegment segment, long index, int value) { VH_clusterAccelerationStructure.get().set(segment, 0L, index, value); }
