...
public final class VkPhysicalDevicePartitionedAccelerationStructureFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_partitionedAccelerationStructure = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("partitionedAccelerationStructure")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int partitionedAccelerationStructure(MemorySegment segment, long index) { return (int) VH_partitionedAccelerationStructure.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void partitionedAccelerationStructure(MemorySegment segment, long index, int value) { VH_partitionedAccelerationStructure.get().set(segment, 0L, index, value); }
