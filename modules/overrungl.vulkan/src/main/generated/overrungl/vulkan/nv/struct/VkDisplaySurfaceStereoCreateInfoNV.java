...
public final class VkDisplaySurfaceStereoCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_stereoType = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("stereoType")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int stereoType(MemorySegment segment, long index) { return (int) VH_stereoType.get().get(segment, 0L, index); }
    /// {@return `stereoType`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void stereoType(MemorySegment segment, long index, int value) { VH_stereoType.get().set(segment, 0L, index, value); }
