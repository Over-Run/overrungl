...
public final class VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_allowClusterAccelerationStructure = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("allowClusterAccelerationStructure")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int allowClusterAccelerationStructure(MemorySegment segment, long index) { return (int) VH_allowClusterAccelerationStructure.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void allowClusterAccelerationStructure(MemorySegment segment, long index, int value) { VH_allowClusterAccelerationStructure.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkRayTracingPipelineClusterAccelerationStructureCreateInfoNV allowClusterAccelerationStructureAt(long index, int value) { allowClusterAccelerationStructure(this.segment(), index, value); return this; }
