...
public final class VkQueueFamilyCheckpointPropertiesNV extends GroupType {
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int checkpointExecutionStageMask(MemorySegment segment, long index) { return (int) VH_checkpointExecutionStageMask.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void checkpointExecutionStageMask(MemorySegment segment, long index, int value) { VH_checkpointExecutionStageMask.get().set(segment, 0L, index, value); }
