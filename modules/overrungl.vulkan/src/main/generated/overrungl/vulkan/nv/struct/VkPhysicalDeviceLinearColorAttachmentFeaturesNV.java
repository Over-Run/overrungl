...
public final class VkPhysicalDeviceLinearColorAttachmentFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_linearColorAttachment = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("linearColorAttachment")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int linearColorAttachment(MemorySegment segment, long index) { return (int) VH_linearColorAttachment.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void linearColorAttachment(MemorySegment segment, long index, int value) { VH_linearColorAttachment.get().set(segment, 0L, index, value); }
