...
public final class VkPhysicalDeviceExtendedSparseAddressSpaceFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_extendedSparseAddressSpace = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("extendedSparseAddressSpace")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int extendedSparseAddressSpace(MemorySegment segment, long index) { return (int) VH_extendedSparseAddressSpace.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void extendedSparseAddressSpace(MemorySegment segment, long index, int value) { VH_extendedSparseAddressSpace.get().set(segment, 0L, index, value); }
