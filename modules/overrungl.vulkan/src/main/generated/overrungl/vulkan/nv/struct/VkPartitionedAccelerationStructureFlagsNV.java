...
public final class VkPartitionedAccelerationStructureFlagsNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_enablePartitionTranslation = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("enablePartitionTranslation")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int enablePartitionTranslation(MemorySegment segment, long index) { return (int) VH_enablePartitionTranslation.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void enablePartitionTranslation(MemorySegment segment, long index, int value) { VH_enablePartitionTranslation.get().set(segment, 0L, index, value); }
