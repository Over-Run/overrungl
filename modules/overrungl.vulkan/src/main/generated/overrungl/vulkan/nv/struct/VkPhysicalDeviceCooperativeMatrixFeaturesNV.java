...
public final class VkPhysicalDeviceCooperativeMatrixFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_cooperativeMatrix = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("cooperativeMatrix")));
    ...
    public static final Supplier<VarHandle> VH_cooperativeMatrixRobustBufferAccess = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("cooperativeMatrixRobustBufferAccess")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int cooperativeMatrix(MemorySegment segment, long index) { return (int) VH_cooperativeMatrix.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void cooperativeMatrix(MemorySegment segment, long index, int value) { VH_cooperativeMatrix.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int cooperativeMatrixRobustBufferAccess(MemorySegment segment, long index) { return (int) VH_cooperativeMatrixRobustBufferAccess.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void cooperativeMatrixRobustBufferAccess(MemorySegment segment, long index, int value) { VH_cooperativeMatrixRobustBufferAccess.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPhysicalDeviceCooperativeMatrixFeaturesNV` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceCooperativeMatrixFeaturesNV sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceCooperativeMatrixFeaturesNV pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceCooperativeMatrixFeaturesNV cooperativeMatrixAt(long index, int value) { cooperativeMatrix(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceCooperativeMatrixFeaturesNV cooperativeMatrixRobustBufferAccessAt(long index, int value) { cooperativeMatrixRobustBufferAccess(this.segment(), index, value); return this; }
