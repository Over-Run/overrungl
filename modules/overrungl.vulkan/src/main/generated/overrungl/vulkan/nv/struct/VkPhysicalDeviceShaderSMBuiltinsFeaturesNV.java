...
public final class VkPhysicalDeviceShaderSMBuiltinsFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderSMBuiltins = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderSMBuiltins")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderSMBuiltins(MemorySegment segment, long index) { return (int) VH_shaderSMBuiltins.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderSMBuiltins(MemorySegment segment, long index, int value) { VH_shaderSMBuiltins.get().set(segment, 0L, index, value); }
