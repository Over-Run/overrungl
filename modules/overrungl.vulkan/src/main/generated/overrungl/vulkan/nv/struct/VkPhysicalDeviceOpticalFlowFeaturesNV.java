...
public final class VkPhysicalDeviceOpticalFlowFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_opticalFlow = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("opticalFlow")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int opticalFlow(MemorySegment segment, long index) { return (int) VH_opticalFlow.get().get(segment, 0L, index); }
    /// {@return `opticalFlow`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void opticalFlow(MemorySegment segment, long index, int value) { VH_opticalFlow.get().set(segment, 0L, index, value); }
