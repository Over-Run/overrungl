...
public final class VkPhysicalDeviceDiagnosticsConfigFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_diagnosticsConfig = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("diagnosticsConfig")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int diagnosticsConfig(MemorySegment segment, long index) { return (int) VH_diagnosticsConfig.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void diagnosticsConfig(MemorySegment segment, long index, int value) { VH_diagnosticsConfig.get().set(segment, 0L, index, value); }
