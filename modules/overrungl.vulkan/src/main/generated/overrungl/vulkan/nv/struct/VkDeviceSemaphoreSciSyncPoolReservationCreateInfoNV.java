...
public final class VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_semaphoreSciSyncPoolRequestCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("semaphoreSciSyncPoolRequestCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int semaphoreSciSyncPoolRequestCount(MemorySegment segment, long index) { return (int) VH_semaphoreSciSyncPoolRequestCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void semaphoreSciSyncPoolRequestCount(MemorySegment segment, long index, int value) { VH_semaphoreSciSyncPoolRequestCount.get().set(segment, 0L, index, value); }
