...
public final class VkCheckpointData2NV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pCheckpointMarker = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pCheckpointMarker")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long stage(MemorySegment segment, long index) { return (long) VH_stage.get().get(segment, 0L, index); }
    /// {@return `stage`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void stage(MemorySegment segment, long index, long value) { VH_stage.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pCheckpointMarker(MemorySegment segment, long index) { return (MemorySegment) VH_pCheckpointMarker.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pCheckpointMarker(MemorySegment segment, long index, MemorySegment value) { VH_pCheckpointMarker.get().set(segment, 0L, index, value); }
