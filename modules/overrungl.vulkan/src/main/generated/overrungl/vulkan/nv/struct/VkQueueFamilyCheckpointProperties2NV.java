...
public final class VkQueueFamilyCheckpointProperties2NV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_checkpointExecutionStageMask = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("checkpointExecutionStageMask")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long checkpointExecutionStageMask(MemorySegment segment, long index) { return (long) VH_checkpointExecutionStageMask.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void checkpointExecutionStageMask(MemorySegment segment, long index, long value) { VH_checkpointExecutionStageMask.get().set(segment, 0L, index, value); }
