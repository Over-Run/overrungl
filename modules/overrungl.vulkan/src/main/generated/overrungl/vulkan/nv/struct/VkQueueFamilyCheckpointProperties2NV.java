...
/// Represents `VkQueueFamilyCheckpointProperties2NV`.
/// ## Layout
/// ```
...
public final class VkQueueFamilyCheckpointProperties2NV extends GroupType {
    ...
    public static VkQueueFamilyCheckpointProperties2NV allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.nv.VKNVDeviceDiagnosticCheckpoints.VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV); }
    public static VkQueueFamilyCheckpointProperties2NV allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.nv.VKNVDeviceDiagnosticCheckpoints.VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV);
        return s;
    }
    ...
    public long checkpointExecutionStageMaskAt(long index) { return (long) VH_checkpointExecutionStageMask.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public long checkpointExecutionStageMask() { return (long) VH_checkpointExecutionStageMask.get(this.segment(), 0L, 0L); }
    public VkQueueFamilyCheckpointProperties2NV sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkQueueFamilyCheckpointProperties2NV pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkQueueFamilyCheckpointProperties2NV checkpointExecutionStageMaskAt(long index, long value) { VH_checkpointExecutionStageMask.set(this.segment(), 0L, index, value); return this; }
    public VkQueueFamilyCheckpointProperties2NV sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkQueueFamilyCheckpointProperties2NV pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkQueueFamilyCheckpointProperties2NV checkpointExecutionStageMask(long value) { VH_checkpointExecutionStageMask.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkQueueFamilyCheckpointProperties2NV _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkQueueFamilyCheckpointProperties2NV _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkQueueFamilyCheckpointProperties2NV _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkQueueFamilyCheckpointProperties2NV _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkQueueFamilyCheckpointProperties2NV _checkpointExecutionStageMaskAt(long index, MemorySegment src) { _checkpointExecutionStageMaskAt(index).copyFrom(src); return this; }
    public VkQueueFamilyCheckpointProperties2NV _checkpointExecutionStageMask(MemorySegment src) { return _checkpointExecutionStageMaskAt(0L, src); }
}
