...
public final class VkPhysicalDeviceCudaKernelLaunchFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_cudaKernelLaunchFeatures = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("cudaKernelLaunchFeatures")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int cudaKernelLaunchFeatures(MemorySegment segment, long index) { return (int) VH_cudaKernelLaunchFeatures.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void cudaKernelLaunchFeatures(MemorySegment segment, long index, int value) { VH_cudaKernelLaunchFeatures.get().set(segment, 0L, index, value); }
