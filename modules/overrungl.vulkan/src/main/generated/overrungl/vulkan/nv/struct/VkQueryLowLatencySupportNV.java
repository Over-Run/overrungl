...
public final class VkQueryLowLatencySupportNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pQueriedLowLatencyData = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pQueriedLowLatencyData")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pQueriedLowLatencyData(MemorySegment segment, long index) { return (MemorySegment) VH_pQueriedLowLatencyData.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pQueriedLowLatencyData(MemorySegment segment, long index, MemorySegment value) { VH_pQueriedLowLatencyData.get().set(segment, 0L, index, value); }
