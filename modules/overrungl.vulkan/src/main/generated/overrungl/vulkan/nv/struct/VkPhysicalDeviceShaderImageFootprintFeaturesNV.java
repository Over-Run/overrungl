...
public final class VkPhysicalDeviceShaderImageFootprintFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_imageFootprint = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("imageFootprint")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int imageFootprint(MemorySegment segment, long index) { return (int) VH_imageFootprint.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void imageFootprint(MemorySegment segment, long index, int value) { VH_imageFootprint.get().set(segment, 0L, index, value); }
