...
public final class VkPhysicalDeviceRawAccessChainsFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderRawAccessChains = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderRawAccessChains")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderRawAccessChains(MemorySegment segment, long index) { return (int) VH_shaderRawAccessChains.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderRawAccessChains(MemorySegment segment, long index, int value) { VH_shaderRawAccessChains.get().set(segment, 0L, index, value); }
