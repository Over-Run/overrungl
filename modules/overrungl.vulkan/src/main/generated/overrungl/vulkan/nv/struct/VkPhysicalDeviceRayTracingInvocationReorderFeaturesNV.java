...
public final class VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_rayTracingInvocationReorder = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("rayTracingInvocationReorder")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int rayTracingInvocationReorder(MemorySegment segment, long index) { return (int) VH_rayTracingInvocationReorder.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void rayTracingInvocationReorder(MemorySegment segment, long index, int value) { VH_rayTracingInvocationReorder.get().set(segment, 0L, index, value); }
