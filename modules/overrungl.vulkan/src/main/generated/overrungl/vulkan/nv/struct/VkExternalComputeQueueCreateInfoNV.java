...
public final class VkExternalComputeQueueCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_preferredQueue = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("preferredQueue")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment preferredQueue(MemorySegment segment, long index) { return (MemorySegment) VH_preferredQueue.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void preferredQueue(MemorySegment segment, long index, MemorySegment value) { VH_preferredQueue.get().set(segment, 0L, index, value); }
