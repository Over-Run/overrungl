...
public final class VKNVCooperativeMatrix {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(@NonNull VkPhysicalDevice physicalDevice, @NonNull MemorySegment pPropertyCount, @NonNull MemorySegment pProperties) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV, physicalDevice.segment(), pPropertyCount, pProperties); }
