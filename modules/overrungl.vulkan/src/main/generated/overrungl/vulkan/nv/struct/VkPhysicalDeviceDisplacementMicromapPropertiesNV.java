...
public final class VkPhysicalDeviceDisplacementMicromapPropertiesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxDisplacementMicromapSubdivisionLevel = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxDisplacementMicromapSubdivisionLevel")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxDisplacementMicromapSubdivisionLevel(MemorySegment segment, long index) { return (int) VH_maxDisplacementMicromapSubdivisionLevel.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxDisplacementMicromapSubdivisionLevel(MemorySegment segment, long index, int value) { VH_maxDisplacementMicromapSubdivisionLevel.get().set(segment, 0L, index, value); }
