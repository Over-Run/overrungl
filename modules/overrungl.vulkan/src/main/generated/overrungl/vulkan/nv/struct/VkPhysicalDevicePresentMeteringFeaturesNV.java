...
public final class VkPhysicalDevicePresentMeteringFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_presentMetering = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentMetering")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int presentMetering(MemorySegment segment, long index) { return (int) VH_presentMetering.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void presentMetering(MemorySegment segment, long index, int value) { VH_presentMetering.get().set(segment, 0L, index, value); }
