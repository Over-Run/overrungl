...
/// Represents `VkPhysicalDeviceExternalMemorySciBufFeaturesNV`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceExternalMemorySciBufFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_sciBufImport = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("sciBufImport")));
    ...
    public static final Supplier<VarHandle> VH_sciBufExport = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("sciBufExport")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int sciBufImport(MemorySegment segment, long index) { return (int) VH_sciBufImport.get().get(segment, 0L, index); }
    /// {@return `sciBufImport`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void sciBufImport(MemorySegment segment, long index, int value) { VH_sciBufImport.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int sciBufExport(MemorySegment segment, long index) { return (int) VH_sciBufExport.get().get(segment, 0L, index); }
    /// {@return `sciBufExport`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void sciBufExport(MemorySegment segment, long index, int value) { VH_sciBufExport.get().set(segment, 0L, index, value); }
