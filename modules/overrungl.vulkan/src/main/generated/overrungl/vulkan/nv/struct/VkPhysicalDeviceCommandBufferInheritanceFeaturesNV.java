...
public final class VkPhysicalDeviceCommandBufferInheritanceFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_commandBufferInheritance = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("commandBufferInheritance")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int commandBufferInheritance(MemorySegment segment, long index) { return (int) VH_commandBufferInheritance.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void commandBufferInheritance(MemorySegment segment, long index, int value) { VH_commandBufferInheritance.get().set(segment, 0L, index, value); }
