...
public final class VKNVDeviceGeneratedCommandsCompute {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetPipelineIndirectMemoryRequirementsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdUpdatePipelineIndirectBufferNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_vkGetPipelineIndirectDeviceAddressNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static void vkGetPipelineIndirectMemoryRequirementsNV(@NonNull VkDevice device, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pMemoryRequirements) {
        ...
        Handles.MH_vkGetPipelineIndirectMemoryRequirementsNV.get().invokeExact(device.capabilities().PFN_vkGetPipelineIndirectMemoryRequirementsNV, device.segment(), pCreateInfo, pMemoryRequirements); }
    ...
    public static void vkCmdUpdatePipelineIndirectBufferNV(@NonNull VkCommandBuffer commandBuffer, int pipelineBindPoint, long pipeline) {
        ...
        Handles.MH_vkCmdUpdatePipelineIndirectBufferNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdUpdatePipelineIndirectBufferNV, commandBuffer.segment(), pipelineBindPoint, pipeline); }
    ...
    public static long vkGetPipelineIndirectDeviceAddressNV(@NonNull VkDevice device, @NonNull MemorySegment pInfo) {
        ...
        return (long) Handles.MH_vkGetPipelineIndirectDeviceAddressNV.get().invokeExact(device.capabilities().PFN_vkGetPipelineIndirectDeviceAddressNV, device.segment(), pInfo); }
