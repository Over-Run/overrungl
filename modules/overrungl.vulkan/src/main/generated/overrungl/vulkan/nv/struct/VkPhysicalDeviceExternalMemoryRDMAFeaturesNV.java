...
public final class VkPhysicalDeviceExternalMemoryRDMAFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_externalMemoryRDMA = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("externalMemoryRDMA")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int externalMemoryRDMA(MemorySegment segment, long index) { return (int) VH_externalMemoryRDMA.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void externalMemoryRDMA(MemorySegment segment, long index, int value) { VH_externalMemoryRDMA.get().set(segment, 0L, index, value); }
