...
/// Represents `VkClusterAccelerationStructureBuildTriangleClusterTemplateInfoNV`.
/// ## Layout
/// ```
...
public final class VkClusterAccelerationStructureBuildTriangleClusterTemplateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_instantiationBoundingBoxLimit = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("instantiationBoundingBoxLimit")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long instantiationBoundingBoxLimit(MemorySegment segment, long index) { return (long) VH_instantiationBoundingBoxLimit.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void instantiationBoundingBoxLimit(MemorySegment segment, long index, long value) { VH_instantiationBoundingBoxLimit.get().set(segment, 0L, index, value); }
