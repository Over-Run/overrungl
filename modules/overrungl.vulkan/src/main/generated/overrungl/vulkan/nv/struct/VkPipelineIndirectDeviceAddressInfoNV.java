...
/// Represents `VkPipelineIndirectDeviceAddressInfoNV`.
/// ## Layout
/// ```
...
public final class VkPipelineIndirectDeviceAddressInfoNV extends GroupType {
    ...
    public static VkPipelineIndirectDeviceAddressInfoNV allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.nv.VKNVDeviceGeneratedCommandsCompute.VK_STRUCTURE_TYPE_PIPELINE_INDIRECT_DEVICE_ADDRESS_INFO_NV); }
    public static VkPipelineIndirectDeviceAddressInfoNV allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.nv.VKNVDeviceGeneratedCommandsCompute.VK_STRUCTURE_TYPE_PIPELINE_INDIRECT_DEVICE_ADDRESS_INFO_NV);
        return s;
    }
    ...
    public VkPipelineIndirectDeviceAddressInfoNV sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV pipelineBindPointAt(long index, int value) { VH_pipelineBindPoint.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV pipelineAt(long index, long value) { VH_pipeline.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV pipelineBindPoint(int value) { VH_pipelineBindPoint.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV pipeline(long value) { VH_pipeline.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPipelineIndirectDeviceAddressInfoNV _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPipelineIndirectDeviceAddressInfoNV _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPipelineIndirectDeviceAddressInfoNV _pipelineBindPointAt(long index, MemorySegment src) { _pipelineBindPointAt(index).copyFrom(src); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV _pipelineBindPoint(MemorySegment src) { return _pipelineBindPointAt(0L, src); }
    ...
    public VkPipelineIndirectDeviceAddressInfoNV _pipelineAt(long index, MemorySegment src) { _pipelineAt(index).copyFrom(src); return this; }
    public VkPipelineIndirectDeviceAddressInfoNV _pipeline(MemorySegment src) { return _pipelineAt(0L, src); }
}
