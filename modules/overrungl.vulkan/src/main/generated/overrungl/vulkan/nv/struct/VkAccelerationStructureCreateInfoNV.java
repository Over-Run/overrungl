...
public final class VkAccelerationStructureCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_compactedSize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("compactedSize")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long compactedSize(MemorySegment segment, long index) { return (long) VH_compactedSize.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void compactedSize(MemorySegment segment, long index, long value) { VH_compactedSize.get().set(segment, 0L, index, value); }
