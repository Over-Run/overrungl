...
public final class VkAccelerationStructureMotionInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxInstances = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxInstances")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxInstances(MemorySegment segment, long index) { return (int) VH_maxInstances.get().get(segment, 0L, index); }
    /// {@return `maxInstances`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxInstances(MemorySegment segment, long index, int value) { VH_maxInstances.get().set(segment, 0L, index, value); }
