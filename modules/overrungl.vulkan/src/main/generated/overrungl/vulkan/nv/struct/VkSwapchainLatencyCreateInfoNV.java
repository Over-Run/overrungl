...
public final class VkSwapchainLatencyCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_latencyModeEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("latencyModeEnable")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int latencyModeEnable(MemorySegment segment, long index) { return (int) VH_latencyModeEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void latencyModeEnable(MemorySegment segment, long index, int value) { VH_latencyModeEnable.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkSwapchainLatencyCreateInfoNV` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainLatencyCreateInfoNV sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainLatencyCreateInfoNV pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainLatencyCreateInfoNV latencyModeEnableAt(long index, int value) { latencyModeEnable(this.segment(), index, value); return this; }
