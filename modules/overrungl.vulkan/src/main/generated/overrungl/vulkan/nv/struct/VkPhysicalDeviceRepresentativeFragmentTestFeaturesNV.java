...
public final class VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_representativeFragmentTest = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("representativeFragmentTest")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int representativeFragmentTest(MemorySegment segment, long index) { return (int) VH_representativeFragmentTest.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void representativeFragmentTest(MemorySegment segment, long index, int value) { VH_representativeFragmentTest.get().set(segment, 0L, index, value); }
