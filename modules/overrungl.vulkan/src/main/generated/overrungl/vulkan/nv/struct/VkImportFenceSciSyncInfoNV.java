...
/// Represents `VkImportFenceSciSyncInfoNV`.
/// ## Layout
/// ```
...
/// };
/// ```
public final class VkImportFenceSciSyncInfoNV extends GroupType {
    ...
    public VkImportFenceSciSyncInfoNV(MemorySegment segment, long elementCount) { super(segment, LAYOUT, elementCount); }

    /// Creates `VkImportFenceSciSyncInfoNV` with the given segment.
    /// @param segment the memory segment
    /// @return the created instance or `null` if the segment is `NULL`
    public static VkImportFenceSciSyncInfoNV of(MemorySegment segment) { return MemoryUtil.isNullPointer(segment) ? null : new VkImportFenceSciSyncInfoNV(segment, estimateCount(segment, LAYOUT)); }
    ...
    /// @param segment the memory segment
    /// @return the created instance or `null` if the segment is `NULL`
    public static VkImportFenceSciSyncInfoNV ofNative(MemorySegment segment) { return MemoryUtil.isNullPointer(segment) ? null : new VkImportFenceSciSyncInfoNV(segment.reinterpret(LAYOUT.byteSize()), 1); }
    ...
    /// @return the created instance or `null` if the segment is `NULL`
    public static VkImportFenceSciSyncInfoNV ofNative(MemorySegment segment, long count) { return MemoryUtil.isNullPointer(segment) ? null : new VkImportFenceSciSyncInfoNV(segment.reinterpret(LAYOUT.scale(0, count)), count); }
    ...
    public static VkImportFenceSciSyncInfoNV alloc(SegmentAllocator allocator) { return new VkImportFenceSciSyncInfoNV(allocator.allocate(LAYOUT), 1); }
    ...
    public VkImportFenceSciSyncInfoNV reinterpret(long count) { return new VkImportFenceSciSyncInfoNV(this.segment().reinterpret(LAYOUT.scale(0, count)), count); }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV fence(long value) { fence(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV handleType(int value) { handleType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV handle(MemorySegment value) { handle(this.segment(), 0L, value); return this; }

    /// Creates a slice of `VkImportFenceSciSyncInfoNV`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkImportFenceSciSyncInfoNV`
    public VkImportFenceSciSyncInfoNV asSlice(long index) { return new VkImportFenceSciSyncInfoNV(this.segment().asSlice(LAYOUT.scale(0L, index), LAYOUT), 1); }

    /// Creates a slice of `VkImportFenceSciSyncInfoNV`.
    /// @param index the index of the struct buffer
    /// @param count the count
    /// @return the slice of `VkImportFenceSciSyncInfoNV`
    public VkImportFenceSciSyncInfoNV asSlice(long index, long count) { return new VkImportFenceSciSyncInfoNV(this.segment().asSlice(LAYOUT.scale(0L, index), LAYOUT.byteSize() * count), count); }

    /// Visits `VkImportFenceSciSyncInfoNV` buffer at the given index.
    /// @param index the index of this buffer
    /// @param func  the function to run with the slice of this buffer
    /// @return `this`
    public VkImportFenceSciSyncInfoNV at(long index, Consumer<VkImportFenceSciSyncInfoNV> func) { func.accept(asSlice(index)); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV fenceAt(long index, long value) { fence(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV handleTypeAt(long index, int value) { handleType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkImportFenceSciSyncInfoNV handleAt(long index, MemorySegment value) { handle(this.segment(), index, value); return this; }
