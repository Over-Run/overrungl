...
public final class VKNVShadingRateImage {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCmdBindShadingRateImageNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_vkCmdSetViewportShadingRatePaletteNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdSetCoarseSampleOrderNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static void vkCmdBindShadingRateImageNV(@NonNull VkCommandBuffer commandBuffer, long imageView, int imageLayout) {
        ...
        Handles.MH_vkCmdBindShadingRateImageNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdBindShadingRateImageNV, commandBuffer.segment(), imageView, imageLayout); }
    ...
    public static void vkCmdSetViewportShadingRatePaletteNV(@NonNull VkCommandBuffer commandBuffer, int firstViewport, int viewportCount, @NonNull MemorySegment pShadingRatePalettes) {
        ...
        Handles.MH_vkCmdSetViewportShadingRatePaletteNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdSetViewportShadingRatePaletteNV, commandBuffer.segment(), firstViewport, viewportCount, pShadingRatePalettes); }
    ...
    public static void vkCmdSetCoarseSampleOrderNV(@NonNull VkCommandBuffer commandBuffer, int sampleOrderType, int customSampleOrderCount, @NonNull MemorySegment pCustomSampleOrders) {
        ...
        Handles.MH_vkCmdSetCoarseSampleOrderNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdSetCoarseSampleOrderNV, commandBuffer.segment(), sampleOrderType, customSampleOrderCount, pCustomSampleOrders); }
