...
public final class VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_rayTracingInvocationReorderReorderingHint = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("rayTracingInvocationReorderReorderingHint")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int rayTracingInvocationReorderReorderingHint(MemorySegment segment, long index) { return (int) VH_rayTracingInvocationReorderReorderingHint.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void rayTracingInvocationReorderReorderingHint(MemorySegment segment, long index, int value) { VH_rayTracingInvocationReorderReorderingHint.get().set(segment, 0L, index, value); }
