...
public final class VkGeneratedCommandsMemoryRequirementsInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxSequencesCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxSequencesCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxSequencesCount(MemorySegment segment, long index) { return (int) VH_maxSequencesCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxSequencesCount(MemorySegment segment, long index, int value) { VH_maxSequencesCount.get().set(segment, 0L, index, value); }
