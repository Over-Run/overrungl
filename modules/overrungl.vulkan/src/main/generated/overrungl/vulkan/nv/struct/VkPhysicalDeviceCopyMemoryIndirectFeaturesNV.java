...
public final class VkPhysicalDeviceCopyMemoryIndirectFeaturesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_indirectCopy = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("indirectCopy")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int indirectCopy(MemorySegment segment, long index) { return (int) VH_indirectCopy.get().get(segment, 0L, index); }
    /// {@return `indirectCopy`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void indirectCopy(MemorySegment segment, long index, int value) { VH_indirectCopy.get().set(segment, 0L, index, value); }
