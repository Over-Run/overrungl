...
public final class VkDedicatedAllocationBufferCreateInfoNV extends GroupType {
    ...
    public static VkDedicatedAllocationBufferCreateInfoNV allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.nv.VKNVDedicatedAllocation.VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV); }
    public static VkDedicatedAllocationBufferCreateInfoNV allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.nv.VKNVDedicatedAllocation.VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV);
        return s;
    }
    ...
    public VkDedicatedAllocationBufferCreateInfoNV sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkDedicatedAllocationBufferCreateInfoNV pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkDedicatedAllocationBufferCreateInfoNV dedicatedAllocationAt(long index, int value) { VH_dedicatedAllocation.set(this.segment(), 0L, index, value); return this; }
    public VkDedicatedAllocationBufferCreateInfoNV sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDedicatedAllocationBufferCreateInfoNV pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkDedicatedAllocationBufferCreateInfoNV dedicatedAllocation(int value) { VH_dedicatedAllocation.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkDedicatedAllocationBufferCreateInfoNV _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkDedicatedAllocationBufferCreateInfoNV _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkDedicatedAllocationBufferCreateInfoNV _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkDedicatedAllocationBufferCreateInfoNV _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkDedicatedAllocationBufferCreateInfoNV _dedicatedAllocationAt(long index, MemorySegment src) { _dedicatedAllocationAt(index).copyFrom(src); return this; }
    public VkDedicatedAllocationBufferCreateInfoNV _dedicatedAllocation(MemorySegment src) { return _dedicatedAllocationAt(0L, src); }
}
