...
public final class VkWin32KeyedMutexAcquireReleaseInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pAcquireTimeoutMilliseconds = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pAcquireTimeoutMilliseconds")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pAcquireTimeoutMilliseconds(MemorySegment segment, long index) { return (MemorySegment) VH_pAcquireTimeoutMilliseconds.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pAcquireTimeoutMilliseconds(MemorySegment segment, long index, MemorySegment value) { VH_pAcquireTimeoutMilliseconds.get().set(segment, 0L, index, value); }
