...
public final class VkSetPresentConfigNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_numFramesPerBatch = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("numFramesPerBatch")));
    ...
    public static final Supplier<VarHandle> VH_presentConfigFeedback = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentConfigFeedback")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int numFramesPerBatch(MemorySegment segment, long index) { return (int) VH_numFramesPerBatch.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void numFramesPerBatch(MemorySegment segment, long index, int value) { VH_numFramesPerBatch.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int presentConfigFeedback(MemorySegment segment, long index) { return (int) VH_presentConfigFeedback.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void presentConfigFeedback(MemorySegment segment, long index, int value) { VH_presentConfigFeedback.get().set(segment, 0L, index, value); }
