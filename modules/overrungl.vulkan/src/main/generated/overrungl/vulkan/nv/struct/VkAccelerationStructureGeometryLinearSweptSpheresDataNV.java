...
public final class VkAccelerationStructureGeometryLinearSweptSpheresDataNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_indexingMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("indexingMode")));
    ...
    public static final Supplier<VarHandle> VH_endCapsMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("endCapsMode")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int indexingMode(MemorySegment segment, long index) { return (int) VH_indexingMode.get().get(segment, 0L, index); }
    /// {@return `indexingMode`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void indexingMode(MemorySegment segment, long index, int value) { VH_indexingMode.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int endCapsMode(MemorySegment segment, long index) { return (int) VH_endCapsMode.get().get(segment, 0L, index); }
    /// {@return `endCapsMode`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void endCapsMode(MemorySegment segment, long index, int value) { VH_endCapsMode.get().set(segment, 0L, index, value); }
