...
public final class VkPhysicalDeviceMemoryDecompressionPropertiesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_decompressionMethods = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("decompressionMethods")));
    ...
    public static final Supplier<VarHandle> VH_maxDecompressionIndirectCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxDecompressionIndirectCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long decompressionMethods(MemorySegment segment, long index) { return (long) VH_decompressionMethods.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void decompressionMethods(MemorySegment segment, long index, long value) { VH_decompressionMethods.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long maxDecompressionIndirectCount(MemorySegment segment, long index) { return (long) VH_maxDecompressionIndirectCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxDecompressionIndirectCount(MemorySegment segment, long index, long value) { VH_maxDecompressionIndirectCount.get().set(segment, 0L, index, value); }
