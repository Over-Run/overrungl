...
public final class VkSwapchainPresentBarrierCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_presentBarrierEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentBarrierEnable")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int presentBarrierEnable(MemorySegment segment, long index) { return (int) VH_presentBarrierEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void presentBarrierEnable(MemorySegment segment, long index, int value) { VH_presentBarrierEnable.get().set(segment, 0L, index, value); }
