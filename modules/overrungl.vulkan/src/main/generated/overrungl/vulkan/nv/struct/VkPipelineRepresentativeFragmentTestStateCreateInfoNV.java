...
public final class VkPipelineRepresentativeFragmentTestStateCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_representativeFragmentTestEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("representativeFragmentTestEnable")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int representativeFragmentTestEnable(MemorySegment segment, long index) { return (int) VH_representativeFragmentTestEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void representativeFragmentTestEnable(MemorySegment segment, long index, int value) { VH_representativeFragmentTestEnable.get().set(segment, 0L, index, value); }
