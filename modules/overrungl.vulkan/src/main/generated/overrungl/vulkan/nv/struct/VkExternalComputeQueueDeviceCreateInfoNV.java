...
public final class VkExternalComputeQueueDeviceCreateInfoNV extends GroupType {
    ...
    public static VkExternalComputeQueueDeviceCreateInfoNV allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.nv.VKNVExternalComputeQueue.VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DEVICE_CREATE_INFO_NV); }
    public static VkExternalComputeQueueDeviceCreateInfoNV allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.nv.VKNVExternalComputeQueue.VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DEVICE_CREATE_INFO_NV);
        return s;
    }
    ...
    public int reservedExternalQueuesAt(long index) { return (int) VH_reservedExternalQueues.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int reservedExternalQueues() { return (int) VH_reservedExternalQueues.get(this.segment(), 0L, 0L); }
    public VkExternalComputeQueueDeviceCreateInfoNV sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkExternalComputeQueueDeviceCreateInfoNV pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkExternalComputeQueueDeviceCreateInfoNV reservedExternalQueuesAt(long index, int value) { VH_reservedExternalQueues.set(this.segment(), 0L, index, value); return this; }
    public VkExternalComputeQueueDeviceCreateInfoNV sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkExternalComputeQueueDeviceCreateInfoNV pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkExternalComputeQueueDeviceCreateInfoNV reservedExternalQueues(int value) { VH_reservedExternalQueues.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkExternalComputeQueueDeviceCreateInfoNV _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkExternalComputeQueueDeviceCreateInfoNV _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkExternalComputeQueueDeviceCreateInfoNV _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkExternalComputeQueueDeviceCreateInfoNV _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _reservedExternalQueuesAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_reservedExternalQueues, index), LAYOUT_reservedExternalQueues); }
    public MemorySegment _reservedExternalQueues() { return _reservedExternalQueuesAt(0L); }
    public VkExternalComputeQueueDeviceCreateInfoNV _reservedExternalQueuesAt(long index, MemorySegment src) { _reservedExternalQueuesAt(index).copyFrom(src); return this; }
    public VkExternalComputeQueueDeviceCreateInfoNV _reservedExternalQueues(MemorySegment src) { return _reservedExternalQueuesAt(0L, src); }
}
