...
public final class VkExternalComputeQueueDeviceCreateInfoNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_reservedExternalQueues = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("reservedExternalQueues")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int reservedExternalQueues(MemorySegment segment, long index) { return (int) VH_reservedExternalQueues.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void reservedExternalQueues(MemorySegment segment, long index, int value) { VH_reservedExternalQueues.get().set(segment, 0L, index, value); }
