...
public final class VkLatencySurfaceCapabilitiesNV extends GroupType {
    ...
    public static VkLatencySurfaceCapabilitiesNV allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.nv.VKNVLowLatency2.VK_STRUCTURE_TYPE_LATENCY_SURFACE_CAPABILITIES_NV); }
    public static VkLatencySurfaceCapabilitiesNV allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.nv.VKNVLowLatency2.VK_STRUCTURE_TYPE_LATENCY_SURFACE_CAPABILITIES_NV);
        return s;
    }
    ...
    public VkLatencySurfaceCapabilitiesNV sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkLatencySurfaceCapabilitiesNV pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkLatencySurfaceCapabilitiesNV presentModeCountAt(long index, int value) { VH_presentModeCount.set(this.segment(), 0L, index, value); return this; }
    public VkLatencySurfaceCapabilitiesNV pPresentModesAt(long index, MemorySegment value) { VH_pPresentModes.set(this.segment(), 0L, index, value); return this; }
    public VkLatencySurfaceCapabilitiesNV sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkLatencySurfaceCapabilitiesNV pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkLatencySurfaceCapabilitiesNV presentModeCount(int value) { VH_presentModeCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkLatencySurfaceCapabilitiesNV pPresentModes(MemorySegment value) { VH_pPresentModes.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkLatencySurfaceCapabilitiesNV _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkLatencySurfaceCapabilitiesNV _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkLatencySurfaceCapabilitiesNV _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkLatencySurfaceCapabilitiesNV _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkLatencySurfaceCapabilitiesNV _presentModeCountAt(long index, MemorySegment src) { _presentModeCountAt(index).copyFrom(src); return this; }
    public VkLatencySurfaceCapabilitiesNV _presentModeCount(MemorySegment src) { return _presentModeCountAt(0L, src); }
    ...
    public VkLatencySurfaceCapabilitiesNV _pPresentModesAt(long index, MemorySegment src) { _pPresentModesAt(index).copyFrom(src); return this; }
    public VkLatencySurfaceCapabilitiesNV _pPresentModes(MemorySegment src) { return _pPresentModesAt(0L, src); }
}
