...
public final class VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxFragmentShadingRateInvocationCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxFragmentShadingRateInvocationCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxFragmentShadingRateInvocationCount(MemorySegment segment, long index) { return (int) VH_maxFragmentShadingRateInvocationCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxFragmentShadingRateInvocationCount(MemorySegment segment, long index, int value) { VH_maxFragmentShadingRateInvocationCount.get().set(segment, 0L, index, value); }
