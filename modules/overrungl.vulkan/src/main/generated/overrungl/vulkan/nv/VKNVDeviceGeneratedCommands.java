...
public final class VKNVDeviceGeneratedCommands {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetGeneratedCommandsMemoryRequirementsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdPreprocessGeneratedCommandsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdExecuteGeneratedCommandsNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdBindPipelineShaderGroupNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_vkCreateIndirectCommandsLayoutNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkDestroyIndirectCommandsLayoutNV = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static void vkGetGeneratedCommandsMemoryRequirementsNV(@NonNull VkDevice device, @NonNull MemorySegment pInfo, @NonNull MemorySegment pMemoryRequirements) {
        ...
        Handles.MH_vkGetGeneratedCommandsMemoryRequirementsNV.get().invokeExact(device.capabilities().PFN_vkGetGeneratedCommandsMemoryRequirementsNV, device.segment(), pInfo, pMemoryRequirements); }
    ...
    public static void vkCmdPreprocessGeneratedCommandsNV(@NonNull VkCommandBuffer commandBuffer, @NonNull MemorySegment pGeneratedCommandsInfo) {
        ...
        Handles.MH_vkCmdPreprocessGeneratedCommandsNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdPreprocessGeneratedCommandsNV, commandBuffer.segment(), pGeneratedCommandsInfo); }
    ...
    public static void vkCmdExecuteGeneratedCommandsNV(@NonNull VkCommandBuffer commandBuffer, int isPreprocessed, @NonNull MemorySegment pGeneratedCommandsInfo) {
        ...
        Handles.MH_vkCmdExecuteGeneratedCommandsNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdExecuteGeneratedCommandsNV, commandBuffer.segment(), isPreprocessed, pGeneratedCommandsInfo); }
    ...
    public static void vkCmdBindPipelineShaderGroupNV(@NonNull VkCommandBuffer commandBuffer, int pipelineBindPoint, long pipeline, int groupIndex) {
        ...
        Handles.MH_vkCmdBindPipelineShaderGroupNV.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdBindPipelineShaderGroupNV, commandBuffer.segment(), pipelineBindPoint, pipeline, groupIndex); }
    ...
    public static int vkCreateIndirectCommandsLayoutNV(@NonNull VkDevice device, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pIndirectCommandsLayout) {
        ...
        return (int) Handles.MH_vkCreateIndirectCommandsLayoutNV.get().invokeExact(device.capabilities().PFN_vkCreateIndirectCommandsLayoutNV, device.segment(), pCreateInfo, pAllocator, pIndirectCommandsLayout); }
    ...
    public static void vkDestroyIndirectCommandsLayoutNV(@NonNull VkDevice device, long indirectCommandsLayout, @NonNull MemorySegment pAllocator) {
        ...
        Handles.MH_vkDestroyIndirectCommandsLayoutNV.get().invokeExact(device.capabilities().PFN_vkDestroyIndirectCommandsLayoutNV, device.segment(), indirectCommandsLayout, pAllocator); }
