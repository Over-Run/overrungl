...
/// Represents `VkExternalComputeQueueDataParamsNV`.
/// ## Layout
/// ```
...
public final class VkExternalComputeQueueDataParamsNV extends GroupType {
    ...
    public static VkExternalComputeQueueDataParamsNV allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.nv.VKNVExternalComputeQueue.VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DATA_PARAMS_NV); }
    public static VkExternalComputeQueueDataParamsNV allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.nv.VKNVExternalComputeQueue.VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DATA_PARAMS_NV);
        return s;
    }
    ...
    public VkExternalComputeQueueDataParamsNV sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkExternalComputeQueueDataParamsNV pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkExternalComputeQueueDataParamsNV deviceIndexAt(long index, int value) { VH_deviceIndex.set(this.segment(), 0L, index, value); return this; }
    public VkExternalComputeQueueDataParamsNV sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkExternalComputeQueueDataParamsNV pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkExternalComputeQueueDataParamsNV deviceIndex(int value) { VH_deviceIndex.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkExternalComputeQueueDataParamsNV _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkExternalComputeQueueDataParamsNV _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkExternalComputeQueueDataParamsNV _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkExternalComputeQueueDataParamsNV _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkExternalComputeQueueDataParamsNV _deviceIndexAt(long index, MemorySegment src) { _deviceIndexAt(index).copyFrom(src); return this; }
    public VkExternalComputeQueueDataParamsNV _deviceIndex(MemorySegment src) { return _deviceIndexAt(0L, src); }
}
