...
public final class VkPhysicalDevicePresentationPropertiesANDROID extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_sharedImage = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("sharedImage")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int sharedImage(MemorySegment segment, long index) { return (int) VH_sharedImage.get().get(segment, 0L, index); }
    /// {@return `sharedImage`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void sharedImage(MemorySegment segment, long index, int value) { VH_sharedImage.get().set(segment, 0L, index, value); }
