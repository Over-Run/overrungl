...
public final class VkAndroidHardwareBufferFormatProperties2ANDROID extends GroupType {
    ...
    public static VkAndroidHardwareBufferFormatProperties2ANDROID allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.android.VKANDROIDExternalMemoryAndroidHardwareBuffer.VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_2_ANDROID); }
    public static VkAndroidHardwareBufferFormatProperties2ANDROID allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.android.VKANDROIDExternalMemoryAndroidHardwareBuffer.VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_2_ANDROID);
        return s;
    }
    ...
    public long formatFeaturesAt(long index) { return (long) VH_formatFeatures.get(this.segment(), 0L, index); }
    ...
    public long formatFeatures() { return (long) VH_formatFeatures.get(this.segment(), 0L, 0L); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID formatAt(long index, int value) { VH_format.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID externalFormatAt(long index, long value) { VH_externalFormat.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID formatFeaturesAt(long index, long value) { VH_formatFeatures.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents$rAt(long index, int value) { VH_samplerYcbcrConversionComponents$r.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents$gAt(long index, int value) { VH_samplerYcbcrConversionComponents$g.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents$bAt(long index, int value) { VH_samplerYcbcrConversionComponents$b.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents$aAt(long index, int value) { VH_samplerYcbcrConversionComponents$a.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID suggestedYcbcrModelAt(long index, int value) { VH_suggestedYcbcrModel.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID suggestedYcbcrRangeAt(long index, int value) { VH_suggestedYcbcrRange.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID suggestedXChromaOffsetAt(long index, int value) { VH_suggestedXChromaOffset.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID suggestedYChromaOffsetAt(long index, int value) { VH_suggestedYChromaOffset.set(this.segment(), 0L, index, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID format(int value) { VH_format.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID externalFormat(long value) { VH_externalFormat.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID formatFeatures(long value) { VH_formatFeatures.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents$r(int value) { VH_samplerYcbcrConversionComponents$r.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents$g(int value) { VH_samplerYcbcrConversionComponents$g.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents$b(int value) { VH_samplerYcbcrConversionComponents$b.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID samplerYcbcrConversionComponents$a(int value) { VH_samplerYcbcrConversionComponents$a.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID suggestedYcbcrModel(int value) { VH_suggestedYcbcrModel.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID suggestedYcbcrRange(int value) { VH_suggestedYcbcrRange.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID suggestedXChromaOffset(int value) { VH_suggestedXChromaOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID suggestedYChromaOffset(int value) { VH_suggestedYChromaOffset.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID _formatAt(long index, MemorySegment src) { _formatAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _format(MemorySegment src) { return _formatAt(0L, src); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID _externalFormatAt(long index, MemorySegment src) { _externalFormatAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _externalFormat(MemorySegment src) { return _externalFormatAt(0L, src); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID _formatFeaturesAt(long index, MemorySegment src) { _formatFeaturesAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _formatFeatures(MemorySegment src) { return _formatFeaturesAt(0L, src); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID _samplerYcbcrConversionComponentsAt(long index, MemorySegment src) { _samplerYcbcrConversionComponentsAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _samplerYcbcrConversionComponents(MemorySegment src) { return _samplerYcbcrConversionComponentsAt(0L, src); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID _suggestedYcbcrModelAt(long index, MemorySegment src) { _suggestedYcbcrModelAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _suggestedYcbcrModel(MemorySegment src) { return _suggestedYcbcrModelAt(0L, src); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID _suggestedYcbcrRangeAt(long index, MemorySegment src) { _suggestedYcbcrRangeAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _suggestedYcbcrRange(MemorySegment src) { return _suggestedYcbcrRangeAt(0L, src); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID _suggestedXChromaOffsetAt(long index, MemorySegment src) { _suggestedXChromaOffsetAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _suggestedXChromaOffset(MemorySegment src) { return _suggestedXChromaOffsetAt(0L, src); }
    ...
    public VkAndroidHardwareBufferFormatProperties2ANDROID _suggestedYChromaOffsetAt(long index, MemorySegment src) { _suggestedYChromaOffsetAt(index).copyFrom(src); return this; }
    public VkAndroidHardwareBufferFormatProperties2ANDROID _suggestedYChromaOffset(MemorySegment src) { return _suggestedYChromaOffsetAt(0L, src); }
}
