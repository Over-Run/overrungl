...
public final class VkAndroidHardwareBufferFormatResolvePropertiesANDROID extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_colorAttachmentFormat = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("colorAttachmentFormat")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int colorAttachmentFormat(MemorySegment segment, long index) { return (int) VH_colorAttachmentFormat.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void colorAttachmentFormat(MemorySegment segment, long index, int value) { VH_colorAttachmentFormat.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkAndroidHardwareBufferFormatResolvePropertiesANDROID` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkAndroidHardwareBufferFormatResolvePropertiesANDROID sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkAndroidHardwareBufferFormatResolvePropertiesANDROID pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkAndroidHardwareBufferFormatResolvePropertiesANDROID colorAttachmentFormatAt(long index, int value) { colorAttachmentFormat(this.segment(), index, value); return this; }
