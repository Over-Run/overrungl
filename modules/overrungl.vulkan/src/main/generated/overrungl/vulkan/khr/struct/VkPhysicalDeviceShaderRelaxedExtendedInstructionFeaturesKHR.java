...
public final class VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderRelaxedExtendedInstruction = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderRelaxedExtendedInstruction")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderRelaxedExtendedInstruction(MemorySegment segment, long index) { return (int) VH_shaderRelaxedExtendedInstruction.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderRelaxedExtendedInstruction(MemorySegment segment, long index, int value) { VH_shaderRelaxedExtendedInstruction.get().set(segment, 0L, index, value); }
