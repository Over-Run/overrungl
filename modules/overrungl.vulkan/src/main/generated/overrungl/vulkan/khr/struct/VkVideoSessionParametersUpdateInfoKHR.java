...
public final class VkVideoSessionParametersUpdateInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_updateSequenceCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("updateSequenceCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int updateSequenceCount(MemorySegment segment, long index) { return (int) VH_updateSequenceCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void updateSequenceCount(MemorySegment segment, long index, int value) { VH_updateSequenceCount.get().set(segment, 0L, index, value); }
