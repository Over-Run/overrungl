...
public final class VkPhysicalDeviceRayTracingPipelinePropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxRayRecursionDepth = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxRayRecursionDepth")));
    ...
    public static final Supplier<VarHandle> VH_shaderGroupHandleCaptureReplaySize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderGroupHandleCaptureReplaySize")));
    ...
    public static final Supplier<VarHandle> VH_maxRayDispatchInvocationCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxRayDispatchInvocationCount")));
    ...
    public static final Supplier<VarHandle> VH_shaderGroupHandleAlignment = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderGroupHandleAlignment")));
    ...
    public static final Supplier<VarHandle> VH_maxRayHitAttributeSize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxRayHitAttributeSize")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxRayRecursionDepth(MemorySegment segment, long index) { return (int) VH_maxRayRecursionDepth.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxRayRecursionDepth(MemorySegment segment, long index, int value) { VH_maxRayRecursionDepth.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderGroupHandleCaptureReplaySize(MemorySegment segment, long index) { return (int) VH_shaderGroupHandleCaptureReplaySize.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderGroupHandleCaptureReplaySize(MemorySegment segment, long index, int value) { VH_shaderGroupHandleCaptureReplaySize.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxRayDispatchInvocationCount(MemorySegment segment, long index) { return (int) VH_maxRayDispatchInvocationCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxRayDispatchInvocationCount(MemorySegment segment, long index, int value) { VH_maxRayDispatchInvocationCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderGroupHandleAlignment(MemorySegment segment, long index) { return (int) VH_shaderGroupHandleAlignment.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderGroupHandleAlignment(MemorySegment segment, long index, int value) { VH_shaderGroupHandleAlignment.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxRayHitAttributeSize(MemorySegment segment, long index) { return (int) VH_maxRayHitAttributeSize.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxRayHitAttributeSize(MemorySegment segment, long index, int value) { VH_maxRayHitAttributeSize.get().set(segment, 0L, index, value); }
