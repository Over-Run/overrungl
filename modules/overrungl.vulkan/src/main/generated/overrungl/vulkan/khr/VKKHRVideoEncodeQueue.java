...
public final class VKKHRVideoEncodeQueue {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetEncodedVideoSessionParametersKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdEncodeVideoKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }

    private VKKHRVideoEncodeQueue() {}

    /// Invokes `vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR`.
    /// ```
    ...
    /// ```
    public static int vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR(@NonNull VkPhysicalDevice physicalDevice, @NonNull MemorySegment pQualityLevelInfo, @NonNull MemorySegment pQualityLevelProperties) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR, physicalDevice.segment(), pQualityLevelInfo, pQualityLevelProperties); }
        catch (Throwable e) { throw new RuntimeException("error in vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR", e); }
    }

    /// Invokes `vkGetEncodedVideoSessionParametersKHR`.
    /// ```
    ...
    /// ```
    public static int vkGetEncodedVideoSessionParametersKHR(@NonNull VkDevice device, @NonNull MemorySegment pVideoSessionParametersInfo, @NonNull MemorySegment pFeedbackInfo, @NonNull MemorySegment pDataSize, @NonNull MemorySegment pData) {
        ...
        return (int) Handles.MH_vkGetEncodedVideoSessionParametersKHR.get().invokeExact(device.capabilities().PFN_vkGetEncodedVideoSessionParametersKHR, device.segment(), pVideoSessionParametersInfo, pFeedbackInfo, pDataSize, pData); }
        catch (Throwable e) { throw new RuntimeException("error in vkGetEncodedVideoSessionParametersKHR", e); }
    }

    /// Invokes `vkCmdEncodeVideoKHR`.
    /// ```
    /// void vkCmdEncodeVideoKHR((struct VkCommandBuffer*) VkCommandBuffer commandBuffer, const VkVideoEncodeInfoKHR* pEncodeInfo);
    /// ```
    public static void vkCmdEncodeVideoKHR(@NonNull VkCommandBuffer commandBuffer, @NonNull MemorySegment pEncodeInfo) {
        ...
        Handles.MH_vkCmdEncodeVideoKHR.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdEncodeVideoKHR, commandBuffer.segment(), pEncodeInfo); }
