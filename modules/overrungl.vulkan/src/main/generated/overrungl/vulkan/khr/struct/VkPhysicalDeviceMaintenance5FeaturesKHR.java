...
/// Represents `VkPhysicalDeviceMaintenance5FeaturesKHR`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceMaintenance5FeaturesKHR extends GroupType {
    ...
    public static VkPhysicalDeviceMaintenance5FeaturesKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES); }
    public static VkPhysicalDeviceMaintenance5FeaturesKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceMaintenance5FeaturesKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceMaintenance5FeaturesKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceMaintenance5FeaturesKHR maintenance5At(long index, int value) { VH_maintenance5.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceMaintenance5FeaturesKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceMaintenance5FeaturesKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceMaintenance5FeaturesKHR maintenance5(int value) { VH_maintenance5.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceMaintenance5FeaturesKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceMaintenance5FeaturesKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceMaintenance5FeaturesKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceMaintenance5FeaturesKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceMaintenance5FeaturesKHR _maintenance5At(long index, MemorySegment src) { _maintenance5At(index).copyFrom(src); return this; }
    public VkPhysicalDeviceMaintenance5FeaturesKHR _maintenance5(MemorySegment src) { return _maintenance5At(0L, src); }
}
