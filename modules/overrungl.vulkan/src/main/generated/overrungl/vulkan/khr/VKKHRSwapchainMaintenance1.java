...
public final class VKKHRSwapchainMaintenance1 {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkReleaseSwapchainImagesKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkReleaseSwapchainImagesKHR(@NonNull VkDevice device, @NonNull MemorySegment pReleaseInfo) {
        ...
        return (int) Handles.MH_vkReleaseSwapchainImagesKHR.get().invokeExact(device.capabilities().PFN_vkReleaseSwapchainImagesKHR, device.segment(), pReleaseInfo); }
