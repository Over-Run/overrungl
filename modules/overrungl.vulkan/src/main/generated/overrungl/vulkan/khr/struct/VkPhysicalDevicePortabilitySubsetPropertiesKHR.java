...
public final class VkPhysicalDevicePortabilitySubsetPropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_minVertexInputBindingStrideAlignment = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("minVertexInputBindingStrideAlignment")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int minVertexInputBindingStrideAlignment(MemorySegment segment, long index) { return (int) VH_minVertexInputBindingStrideAlignment.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void minVertexInputBindingStrideAlignment(MemorySegment segment, long index, int value) { VH_minVertexInputBindingStrideAlignment.get().set(segment, 0L, index, value); }
