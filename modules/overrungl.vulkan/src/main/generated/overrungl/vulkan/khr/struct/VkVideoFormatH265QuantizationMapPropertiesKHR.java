...
public final class VkVideoFormatH265QuantizationMapPropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_compatibleCtbSizes = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("compatibleCtbSizes")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int compatibleCtbSizes(MemorySegment segment, long index) { return (int) VH_compatibleCtbSizes.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void compatibleCtbSizes(MemorySegment segment, long index, int value) { VH_compatibleCtbSizes.get().set(segment, 0L, index, value); }
