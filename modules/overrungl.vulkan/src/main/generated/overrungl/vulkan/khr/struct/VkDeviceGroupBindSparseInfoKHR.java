...
public final class VkDeviceGroupBindSparseInfoKHR extends GroupType {
    ...
    public static VkDeviceGroupBindSparseInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO); }
    public static VkDeviceGroupBindSparseInfoKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkDeviceGroupBindSparseInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupBindSparseInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupBindSparseInfoKHR resourceDeviceIndexAt(long index, int value) { VH_resourceDeviceIndex.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupBindSparseInfoKHR memoryDeviceIndexAt(long index, int value) { VH_memoryDeviceIndex.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupBindSparseInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceGroupBindSparseInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceGroupBindSparseInfoKHR resourceDeviceIndex(int value) { VH_resourceDeviceIndex.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceGroupBindSparseInfoKHR memoryDeviceIndex(int value) { VH_memoryDeviceIndex.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkDeviceGroupBindSparseInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkDeviceGroupBindSparseInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkDeviceGroupBindSparseInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkDeviceGroupBindSparseInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkDeviceGroupBindSparseInfoKHR _resourceDeviceIndexAt(long index, MemorySegment src) { _resourceDeviceIndexAt(index).copyFrom(src); return this; }
    public VkDeviceGroupBindSparseInfoKHR _resourceDeviceIndex(MemorySegment src) { return _resourceDeviceIndexAt(0L, src); }
    ...
    public VkDeviceGroupBindSparseInfoKHR _memoryDeviceIndexAt(long index, MemorySegment src) { _memoryDeviceIndexAt(index).copyFrom(src); return this; }
    public VkDeviceGroupBindSparseInfoKHR _memoryDeviceIndex(MemorySegment src) { return _memoryDeviceIndexAt(0L, src); }
}
