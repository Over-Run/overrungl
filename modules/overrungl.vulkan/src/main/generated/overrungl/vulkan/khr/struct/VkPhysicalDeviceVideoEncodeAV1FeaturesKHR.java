...
public final class VkPhysicalDeviceVideoEncodeAV1FeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_videoEncodeAV1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("videoEncodeAV1")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int videoEncodeAV1(MemorySegment segment, long index) { return (int) VH_videoEncodeAV1.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void videoEncodeAV1(MemorySegment segment, long index, int value) { VH_videoEncodeAV1.get().set(segment, 0L, index, value); }
