...
/// Represents `VkPhysicalDeviceVideoEncodeAV1FeaturesKHR`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceVideoEncodeAV1FeaturesKHR extends GroupType {
    ...
    public static VkPhysicalDeviceVideoEncodeAV1FeaturesKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoEncodeAv1.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR); }
    public static VkPhysicalDeviceVideoEncodeAV1FeaturesKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoEncodeAv1.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR);
        return s;
    }
    ...
    public int videoEncodeAV1At(long index) { return (int) VH_videoEncodeAV1.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int videoEncodeAV1() { return (int) VH_videoEncodeAV1.get(this.segment(), 0L, 0L); }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR videoEncodeAV1At(long index, int value) { VH_videoEncodeAV1.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR videoEncodeAV1(int value) { VH_videoEncodeAV1.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _videoEncodeAV1At(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_videoEncodeAV1, index), LAYOUT_videoEncodeAV1); }
    public MemorySegment _videoEncodeAV1() { return _videoEncodeAV1At(0L); }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR _videoEncodeAV1At(long index, MemorySegment src) { _videoEncodeAV1At(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVideoEncodeAV1FeaturesKHR _videoEncodeAV1(MemorySegment src) { return _videoEncodeAV1At(0L, src); }
}
