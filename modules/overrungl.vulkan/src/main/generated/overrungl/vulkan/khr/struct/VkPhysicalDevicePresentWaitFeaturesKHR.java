...
public final class VkPhysicalDevicePresentWaitFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_presentWait = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentWait")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int presentWait(MemorySegment segment, long index) { return (int) VH_presentWait.get().get(segment, 0L, index); }
    /// {@return `presentWait`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void presentWait(MemorySegment segment, long index, int value) { VH_presentWait.get().set(segment, 0L, index, value); }
