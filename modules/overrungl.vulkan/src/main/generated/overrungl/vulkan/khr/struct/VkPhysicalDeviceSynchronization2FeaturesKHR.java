...
public final class VkPhysicalDeviceSynchronization2FeaturesKHR extends GroupType {
    ...
    public static VkPhysicalDeviceSynchronization2FeaturesKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES); }
    public static VkPhysicalDeviceSynchronization2FeaturesKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceSynchronization2FeaturesKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSynchronization2FeaturesKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSynchronization2FeaturesKHR synchronization2At(long index, int value) { VH_synchronization2.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSynchronization2FeaturesKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSynchronization2FeaturesKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSynchronization2FeaturesKHR synchronization2(int value) { VH_synchronization2.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceSynchronization2FeaturesKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSynchronization2FeaturesKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceSynchronization2FeaturesKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSynchronization2FeaturesKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceSynchronization2FeaturesKHR _synchronization2At(long index, MemorySegment src) { _synchronization2At(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSynchronization2FeaturesKHR _synchronization2(MemorySegment src) { return _synchronization2At(0L, src); }
}
