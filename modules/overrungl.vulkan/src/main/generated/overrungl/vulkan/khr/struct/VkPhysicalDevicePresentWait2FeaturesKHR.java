...
public final class VkPhysicalDevicePresentWait2FeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_presentWait2 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentWait2")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int presentWait2(MemorySegment segment, long index) { return (int) VH_presentWait2.get().get(segment, 0L, index); }
    /// {@return `presentWait2`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void presentWait2(MemorySegment segment, long index, int value) { VH_presentWait2.get().set(segment, 0L, index, value); }
