...
public final class VkCopyMemoryToImageIndirectCommandKHR extends GroupType {
    ...
    public VkCopyMemoryToImageIndirectCommandKHR srcAddressAt(long index, long value) { VH_srcAddress.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR bufferRowLengthAt(long index, int value) { VH_bufferRowLength.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR bufferImageHeightAt(long index, int value) { VH_bufferImageHeight.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageSubresource$aspectMaskAt(long index, int value) { VH_imageSubresource$aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageSubresource$mipLevelAt(long index, int value) { VH_imageSubresource$mipLevel.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageSubresource$baseArrayLayerAt(long index, int value) { VH_imageSubresource$baseArrayLayer.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageSubresource$layerCountAt(long index, int value) { VH_imageSubresource$layerCount.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageOffset$xAt(long index, int value) { VH_imageOffset$x.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageOffset$yAt(long index, int value) { VH_imageOffset$y.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageOffset$zAt(long index, int value) { VH_imageOffset$z.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageExtent$widthAt(long index, int value) { VH_imageExtent$width.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageExtent$heightAt(long index, int value) { VH_imageExtent$height.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageExtent$depthAt(long index, int value) { VH_imageExtent$depth.set(this.segment(), 0L, index, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR srcAddress(long value) { VH_srcAddress.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR bufferRowLength(int value) { VH_bufferRowLength.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR bufferImageHeight(int value) { VH_bufferImageHeight.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageSubresource$aspectMask(int value) { VH_imageSubresource$aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageSubresource$mipLevel(int value) { VH_imageSubresource$mipLevel.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageSubresource$baseArrayLayer(int value) { VH_imageSubresource$baseArrayLayer.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageSubresource$layerCount(int value) { VH_imageSubresource$layerCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageOffset$x(int value) { VH_imageOffset$x.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageOffset$y(int value) { VH_imageOffset$y.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageOffset$z(int value) { VH_imageOffset$z.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageExtent$width(int value) { VH_imageExtent$width.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageExtent$height(int value) { VH_imageExtent$height.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR imageExtent$depth(int value) { VH_imageExtent$depth.set(this.segment(), 0L, 0L, value); return this; }
    ...
    public VkCopyMemoryToImageIndirectCommandKHR _srcAddressAt(long index, MemorySegment src) { _srcAddressAt(index).copyFrom(src); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR _srcAddress(MemorySegment src) { return _srcAddressAt(0L, src); }
    ...
    public VkCopyMemoryToImageIndirectCommandKHR _bufferRowLengthAt(long index, MemorySegment src) { _bufferRowLengthAt(index).copyFrom(src); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR _bufferRowLength(MemorySegment src) { return _bufferRowLengthAt(0L, src); }
    ...
    public VkCopyMemoryToImageIndirectCommandKHR _bufferImageHeightAt(long index, MemorySegment src) { _bufferImageHeightAt(index).copyFrom(src); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR _bufferImageHeight(MemorySegment src) { return _bufferImageHeightAt(0L, src); }
    ...
    public VkCopyMemoryToImageIndirectCommandKHR _imageSubresourceAt(long index, MemorySegment src) { _imageSubresourceAt(index).copyFrom(src); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR _imageSubresource(MemorySegment src) { return _imageSubresourceAt(0L, src); }
    ...
    public VkCopyMemoryToImageIndirectCommandKHR _imageOffsetAt(long index, MemorySegment src) { _imageOffsetAt(index).copyFrom(src); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR _imageOffset(MemorySegment src) { return _imageOffsetAt(0L, src); }
    ...
    public VkCopyMemoryToImageIndirectCommandKHR _imageExtentAt(long index, MemorySegment src) { _imageExtentAt(index).copyFrom(src); return this; }
    public VkCopyMemoryToImageIndirectCommandKHR _imageExtent(MemorySegment src) { return _imageExtentAt(0L, src); }
}
