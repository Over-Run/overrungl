...
public final class VkVideoDecodeH265DpbSlotInfoKHR extends GroupType {
    ...
    public static VkVideoDecodeH265DpbSlotInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoDecodeH265.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_DPB_SLOT_INFO_KHR); }
    public static VkVideoDecodeH265DpbSlotInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoDecodeH265.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_DPB_SLOT_INFO_KHR);
        return s;
    }
    ...
    public VkVideoDecodeH265DpbSlotInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH265DpbSlotInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH265DpbSlotInfoKHR pStdReferenceInfoAt(long index, MemorySegment value) { VH_pStdReferenceInfo.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH265DpbSlotInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeH265DpbSlotInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeH265DpbSlotInfoKHR pStdReferenceInfo(MemorySegment value) { VH_pStdReferenceInfo.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkVideoDecodeH265DpbSlotInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH265DpbSlotInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkVideoDecodeH265DpbSlotInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH265DpbSlotInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkVideoDecodeH265DpbSlotInfoKHR _pStdReferenceInfoAt(long index, MemorySegment src) { _pStdReferenceInfoAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH265DpbSlotInfoKHR _pStdReferenceInfo(MemorySegment src) { return _pStdReferenceInfoAt(0L, src); }
}
