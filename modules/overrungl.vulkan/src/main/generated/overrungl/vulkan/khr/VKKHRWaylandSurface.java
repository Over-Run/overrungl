...
public final class VKKHRWaylandSurface {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCreateWaylandSurfaceKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceWaylandPresentationSupportKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkCreateWaylandSurfaceKHR(@NonNull VkInstance instance, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pSurface) {
        ...
        return (int) Handles.MH_vkCreateWaylandSurfaceKHR.get().invokeExact(instance.capabilities().PFN_vkCreateWaylandSurfaceKHR, instance.segment(), pCreateInfo, pAllocator, pSurface); }
    ...
    public static int vkGetPhysicalDeviceWaylandPresentationSupportKHR(@NonNull VkPhysicalDevice physicalDevice, int queueFamilyIndex, @NonNull MemorySegment display) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceWaylandPresentationSupportKHR.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceWaylandPresentationSupportKHR, physicalDevice.segment(), queueFamilyIndex, display); }
