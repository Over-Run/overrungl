...
public final class VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_unifiedImageLayouts = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("unifiedImageLayouts")));
    ...
    public static final Supplier<VarHandle> VH_unifiedImageLayoutsVideo = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("unifiedImageLayoutsVideo")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int unifiedImageLayouts(MemorySegment segment, long index) { return (int) VH_unifiedImageLayouts.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void unifiedImageLayouts(MemorySegment segment, long index, int value) { VH_unifiedImageLayouts.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int unifiedImageLayoutsVideo(MemorySegment segment, long index) { return (int) VH_unifiedImageLayoutsVideo.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void unifiedImageLayoutsVideo(MemorySegment segment, long index, int value) { VH_unifiedImageLayoutsVideo.get().set(segment, 0L, index, value); }
