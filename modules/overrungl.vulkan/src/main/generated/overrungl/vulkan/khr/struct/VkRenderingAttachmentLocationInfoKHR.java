...
public final class VkRenderingAttachmentLocationInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pColorAttachmentLocations = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pColorAttachmentLocations")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pColorAttachmentLocations(MemorySegment segment, long index) { return (MemorySegment) VH_pColorAttachmentLocations.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pColorAttachmentLocations(MemorySegment segment, long index, MemorySegment value) { VH_pColorAttachmentLocations.get().set(segment, 0L, index, value); }
