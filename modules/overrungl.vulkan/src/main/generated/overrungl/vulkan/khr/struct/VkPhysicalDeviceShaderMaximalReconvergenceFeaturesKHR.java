...
public final class VkPhysicalDeviceShaderMaximalReconvergenceFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderMaximalReconvergence = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderMaximalReconvergence")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderMaximalReconvergence(MemorySegment segment, long index) { return (int) VH_shaderMaximalReconvergence.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderMaximalReconvergence(MemorySegment segment, long index, int value) { VH_shaderMaximalReconvergence.get().set(segment, 0L, index, value); }
