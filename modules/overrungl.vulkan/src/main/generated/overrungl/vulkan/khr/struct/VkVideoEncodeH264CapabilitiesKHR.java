...
public final class VkVideoEncodeH264CapabilitiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxSliceCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxSliceCount")));
    ...
    public static final Supplier<VarHandle> VH_expectDyadicTemporalLayerPattern = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("expectDyadicTemporalLayerPattern")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxSliceCount(MemorySegment segment, long index) { return (int) VH_maxSliceCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxSliceCount(MemorySegment segment, long index, int value) { VH_maxSliceCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int expectDyadicTemporalLayerPattern(MemorySegment segment, long index) { return (int) VH_expectDyadicTemporalLayerPattern.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void expectDyadicTemporalLayerPattern(MemorySegment segment, long index, int value) { VH_expectDyadicTemporalLayerPattern.get().set(segment, 0L, index, value); }
