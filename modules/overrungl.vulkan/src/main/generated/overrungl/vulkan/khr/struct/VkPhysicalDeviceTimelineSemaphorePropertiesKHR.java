...
/// Represents `VkPhysicalDeviceTimelineSemaphorePropertiesKHR`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceTimelineSemaphorePropertiesKHR extends GroupType {
    ...
    public static VkPhysicalDeviceTimelineSemaphorePropertiesKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES); }
    public static VkPhysicalDeviceTimelineSemaphorePropertiesKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES);
        return s;
    }
    ...
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR maxTimelineSemaphoreValueDifferenceAt(long index, long value) { VH_maxTimelineSemaphoreValueDifference.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR maxTimelineSemaphoreValueDifference(long value) { VH_maxTimelineSemaphoreValueDifference.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR _maxTimelineSemaphoreValueDifferenceAt(long index, MemorySegment src) { _maxTimelineSemaphoreValueDifferenceAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR _maxTimelineSemaphoreValueDifference(MemorySegment src) { return _maxTimelineSemaphoreValueDifferenceAt(0L, src); }
}
