...
public final class VkPhysicalDeviceMaintenance9FeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maintenance9 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maintenance9")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maintenance9(MemorySegment segment, long index) { return (int) VH_maintenance9.get().get(segment, 0L, index); }
    /// {@return `maintenance9`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maintenance9(MemorySegment segment, long index, int value) { VH_maintenance9.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPhysicalDeviceMaintenance9FeaturesKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance9FeaturesKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance9FeaturesKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance9FeaturesKHR maintenance9At(long index, int value) { maintenance9(this.segment(), index, value); return this; }
