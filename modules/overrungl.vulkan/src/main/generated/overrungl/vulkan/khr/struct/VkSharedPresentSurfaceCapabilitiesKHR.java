...
public final class VkSharedPresentSurfaceCapabilitiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_sharedPresentSupportedUsageFlags = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("sharedPresentSupportedUsageFlags")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int sharedPresentSupportedUsageFlags(MemorySegment segment, long index) { return (int) VH_sharedPresentSupportedUsageFlags.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void sharedPresentSupportedUsageFlags(MemorySegment segment, long index, int value) { VH_sharedPresentSupportedUsageFlags.get().set(segment, 0L, index, value); }
