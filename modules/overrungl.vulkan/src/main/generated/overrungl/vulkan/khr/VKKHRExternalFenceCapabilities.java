...
public final class VKKHRExternalFenceCapabilities {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceExternalFencePropertiesKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static void vkGetPhysicalDeviceExternalFencePropertiesKHR(@NonNull VkPhysicalDevice physicalDevice, @NonNull MemorySegment pExternalFenceInfo, @NonNull MemorySegment pExternalFenceProperties) {
        ...
        Handles.MH_vkGetPhysicalDeviceExternalFencePropertiesKHR.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceExternalFencePropertiesKHR, physicalDevice.segment(), pExternalFenceInfo, pExternalFenceProperties); }
