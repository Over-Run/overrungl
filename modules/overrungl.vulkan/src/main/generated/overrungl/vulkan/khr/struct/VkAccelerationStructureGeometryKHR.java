...
public final class VkAccelerationStructureGeometryKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_geometryType = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("geometryType")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int geometryType(MemorySegment segment, long index) { return (int) VH_geometryType.get().get(segment, 0L, index); }
    /// {@return `geometryType`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void geometryType(MemorySegment segment, long index, int value) { VH_geometryType.get().set(segment, 0L, index, value); }
