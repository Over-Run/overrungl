...
public final class VkPipelineExecutableInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_executableIndex = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("executableIndex")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int executableIndex(MemorySegment segment, long index) { return (int) VH_executableIndex.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void executableIndex(MemorySegment segment, long index, int value) { VH_executableIndex.get().set(segment, 0L, index, value); }
