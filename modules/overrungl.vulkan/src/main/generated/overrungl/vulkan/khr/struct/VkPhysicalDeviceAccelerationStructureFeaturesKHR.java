...
public final class VkPhysicalDeviceAccelerationStructureFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_accelerationStructureCaptureReplay = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("accelerationStructureCaptureReplay")));
    ...
    public static final Supplier<VarHandle> VH_accelerationStructureIndirectBuild = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("accelerationStructureIndirectBuild")));
    ...
    public static final Supplier<VarHandle> VH_accelerationStructureHostCommands = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("accelerationStructureHostCommands")));
    ...
    public static final Supplier<VarHandle> VH_descriptorBindingAccelerationStructureUpdateAfterBind = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("descriptorBindingAccelerationStructureUpdateAfterBind")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int accelerationStructure(MemorySegment segment, long index) { return (int) VH_accelerationStructure.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void accelerationStructure(MemorySegment segment, long index, int value) { VH_accelerationStructure.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int accelerationStructureCaptureReplay(MemorySegment segment, long index) { return (int) VH_accelerationStructureCaptureReplay.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void accelerationStructureCaptureReplay(MemorySegment segment, long index, int value) { VH_accelerationStructureCaptureReplay.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int accelerationStructureIndirectBuild(MemorySegment segment, long index) { return (int) VH_accelerationStructureIndirectBuild.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void accelerationStructureIndirectBuild(MemorySegment segment, long index, int value) { VH_accelerationStructureIndirectBuild.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int accelerationStructureHostCommands(MemorySegment segment, long index) { return (int) VH_accelerationStructureHostCommands.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void accelerationStructureHostCommands(MemorySegment segment, long index, int value) { VH_accelerationStructureHostCommands.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int descriptorBindingAccelerationStructureUpdateAfterBind(MemorySegment segment, long index) { return (int) VH_descriptorBindingAccelerationStructureUpdateAfterBind.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void descriptorBindingAccelerationStructureUpdateAfterBind(MemorySegment segment, long index, int value) { VH_descriptorBindingAccelerationStructureUpdateAfterBind.get().set(segment, 0L, index, value); }
