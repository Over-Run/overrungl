...
public final class VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderSubgroupUniformControlFlow = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderSubgroupUniformControlFlow")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderSubgroupUniformControlFlow(MemorySegment segment, long index) { return (int) VH_shaderSubgroupUniformControlFlow.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderSubgroupUniformControlFlow(MemorySegment segment, long index, int value) { VH_shaderSubgroupUniformControlFlow.get().set(segment, 0L, index, value); }
