...
public final class VkBufferUsageFlags2CreateInfoKHR extends GroupType {
    ...
    public static VkBufferUsageFlags2CreateInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_BUFFER_USAGE_FLAGS_2_CREATE_INFO); }
    public static VkBufferUsageFlags2CreateInfoKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkBufferUsageFlags2CreateInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkBufferUsageFlags2CreateInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkBufferUsageFlags2CreateInfoKHR usageAt(long index, long value) { VH_usage.set(this.segment(), 0L, index, value); return this; }
    public VkBufferUsageFlags2CreateInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferUsageFlags2CreateInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferUsageFlags2CreateInfoKHR usage(long value) { VH_usage.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkBufferUsageFlags2CreateInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkBufferUsageFlags2CreateInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkBufferUsageFlags2CreateInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkBufferUsageFlags2CreateInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkBufferUsageFlags2CreateInfoKHR _usageAt(long index, MemorySegment src) { _usageAt(index).copyFrom(src); return this; }
    public VkBufferUsageFlags2CreateInfoKHR _usage(MemorySegment src) { return _usageAt(0L, src); }
}
