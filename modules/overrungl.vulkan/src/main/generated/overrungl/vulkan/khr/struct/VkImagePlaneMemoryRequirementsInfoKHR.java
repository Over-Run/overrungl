...
public final class VkImagePlaneMemoryRequirementsInfoKHR extends GroupType {
    ...
    public static VkImagePlaneMemoryRequirementsInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO); }
    public static VkImagePlaneMemoryRequirementsInfoKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkImagePlaneMemoryRequirementsInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkImagePlaneMemoryRequirementsInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkImagePlaneMemoryRequirementsInfoKHR planeAspectAt(long index, int value) { VH_planeAspect.set(this.segment(), 0L, index, value); return this; }
    public VkImagePlaneMemoryRequirementsInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkImagePlaneMemoryRequirementsInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkImagePlaneMemoryRequirementsInfoKHR planeAspect(int value) { VH_planeAspect.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkImagePlaneMemoryRequirementsInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkImagePlaneMemoryRequirementsInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkImagePlaneMemoryRequirementsInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkImagePlaneMemoryRequirementsInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkImagePlaneMemoryRequirementsInfoKHR _planeAspectAt(long index, MemorySegment src) { _planeAspectAt(index).copyFrom(src); return this; }
    public VkImagePlaneMemoryRequirementsInfoKHR _planeAspect(MemorySegment src) { return _planeAspectAt(0L, src); }
}
