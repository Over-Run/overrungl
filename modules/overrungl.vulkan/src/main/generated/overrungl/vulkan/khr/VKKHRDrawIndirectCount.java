...
public final class VKKHRDrawIndirectCount {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCmdDrawIndirectCountKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_vkCmdDrawIndexedIndirectCountKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT)));
        private Handles() {}
    }
    ...
    public static void vkCmdDrawIndirectCountKHR(@NonNull VkCommandBuffer commandBuffer, long buffer, long offset, long countBuffer, long countBufferOffset, int maxDrawCount, int stride) {
        ...
        Handles.MH_vkCmdDrawIndirectCountKHR.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdDrawIndirectCountKHR, commandBuffer.segment(), buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride); }
    ...
    public static void vkCmdDrawIndexedIndirectCountKHR(@NonNull VkCommandBuffer commandBuffer, long buffer, long offset, long countBuffer, long countBufferOffset, int maxDrawCount, int stride) {
        ...
        Handles.MH_vkCmdDrawIndexedIndirectCountKHR.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdDrawIndexedIndirectCountKHR, commandBuffer.segment(), buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride); }
