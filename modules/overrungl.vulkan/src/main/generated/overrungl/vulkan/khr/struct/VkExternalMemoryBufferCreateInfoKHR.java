...
public final class VkExternalMemoryBufferCreateInfoKHR extends GroupType {
    ...
    public static VkExternalMemoryBufferCreateInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO); }
    public static VkExternalMemoryBufferCreateInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO);
        return s;
    }
    ...
    public VkExternalMemoryBufferCreateInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkExternalMemoryBufferCreateInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkExternalMemoryBufferCreateInfoKHR handleTypesAt(long index, int value) { VH_handleTypes.set(this.segment(), 0L, index, value); return this; }
    public VkExternalMemoryBufferCreateInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkExternalMemoryBufferCreateInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkExternalMemoryBufferCreateInfoKHR handleTypes(int value) { VH_handleTypes.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkExternalMemoryBufferCreateInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkExternalMemoryBufferCreateInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkExternalMemoryBufferCreateInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkExternalMemoryBufferCreateInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkExternalMemoryBufferCreateInfoKHR _handleTypesAt(long index, MemorySegment src) { _handleTypesAt(index).copyFrom(src); return this; }
    public VkExternalMemoryBufferCreateInfoKHR _handleTypes(MemorySegment src) { return _handleTypesAt(0L, src); }
}
