...
public final class VkVideoEncodeAV1DpbSlotInfoKHR extends GroupType {
    ...
    /// Visits `VkVideoEncodeAV1DpbSlotInfoKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1DpbSlotInfoKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1DpbSlotInfoKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1DpbSlotInfoKHR pStdReferenceInfoAt(long index, MemorySegment value) { pStdReferenceInfo(this.segment(), index, value); return this; }
