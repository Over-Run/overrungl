...
public final class VkSubpassBeginInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_contents = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("contents")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int contents(MemorySegment segment, long index) { return (int) VH_contents.get().get(segment, 0L, index); }
    /// {@return `contents`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void contents(MemorySegment segment, long index, int value) { VH_contents.get().set(segment, 0L, index, value); }
