...
public final class VkSubpassBeginInfoKHR extends GroupType {
    ...
    public static VkSubpassBeginInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO); }
    public static VkSubpassBeginInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO);
        return s;
    }
    ...
    public int contentsAt(long index) { return (int) VH_contents.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int contents() { return (int) VH_contents.get(this.segment(), 0L, 0L); }
    public VkSubpassBeginInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassBeginInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassBeginInfoKHR contentsAt(long index, int value) { VH_contents.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassBeginInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassBeginInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassBeginInfoKHR contents(int value) { VH_contents.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkSubpassBeginInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkSubpassBeginInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkSubpassBeginInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkSubpassBeginInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _contentsAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_contents, index), LAYOUT_contents); }
    public MemorySegment _contents() { return _contentsAt(0L); }
    public VkSubpassBeginInfoKHR _contentsAt(long index, MemorySegment src) { _contentsAt(index).copyFrom(src); return this; }
    public VkSubpassBeginInfoKHR _contents(MemorySegment src) { return _contentsAt(0L, src); }
}
