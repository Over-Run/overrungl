...
public final class VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR extends GroupType {
    ...
    public static VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRSwapchainMaintenance1.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR); }
    public static VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR swapchainMaintenance1At(long index, int value) { VH_swapchainMaintenance1.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR swapchainMaintenance1(int value) { VH_swapchainMaintenance1.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR _swapchainMaintenance1At(long index, MemorySegment src) { _swapchainMaintenance1At(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR _swapchainMaintenance1(MemorySegment src) { return _swapchainMaintenance1At(0L, src); }
}
