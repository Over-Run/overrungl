...
public final class VkPhysicalDeviceMaintenance8FeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maintenance8 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maintenance8")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maintenance8(MemorySegment segment, long index) { return (int) VH_maintenance8.get().get(segment, 0L, index); }
    /// {@return `maintenance8`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maintenance8(MemorySegment segment, long index, int value) { VH_maintenance8.get().set(segment, 0L, index, value); }
