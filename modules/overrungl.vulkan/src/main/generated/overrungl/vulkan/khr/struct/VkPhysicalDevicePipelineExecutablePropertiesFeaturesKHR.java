...
public final class VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pipelineExecutableInfo = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pipelineExecutableInfo")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int pipelineExecutableInfo(MemorySegment segment, long index) { return (int) VH_pipelineExecutableInfo.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pipelineExecutableInfo(MemorySegment segment, long index, int value) { VH_pipelineExecutableInfo.get().set(segment, 0L, index, value); }
