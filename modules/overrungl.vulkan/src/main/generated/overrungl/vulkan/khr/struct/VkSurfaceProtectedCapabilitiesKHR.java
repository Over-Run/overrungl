...
public final class VkSurfaceProtectedCapabilitiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_supportsProtected = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("supportsProtected")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int supportsProtected(MemorySegment segment, long index) { return (int) VH_supportsProtected.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void supportsProtected(MemorySegment segment, long index, int value) { VH_supportsProtected.get().set(segment, 0L, index, value); }
