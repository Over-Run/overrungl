...
public final class VKKHRFragmentShadingRate {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceFragmentShadingRatesKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdSetFragmentShadingRateKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkGetPhysicalDeviceFragmentShadingRatesKHR(@NonNull VkPhysicalDevice physicalDevice, @NonNull MemorySegment pFragmentShadingRateCount, @NonNull MemorySegment pFragmentShadingRates) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceFragmentShadingRatesKHR.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceFragmentShadingRatesKHR, physicalDevice.segment(), pFragmentShadingRateCount, pFragmentShadingRates); }
    ...
    public static void vkCmdSetFragmentShadingRateKHR(@NonNull VkCommandBuffer commandBuffer, @NonNull MemorySegment pFragmentSize, @NonNull MemorySegment combinerOps) {
        ...
        Handles.MH_vkCmdSetFragmentShadingRateKHR.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdSetFragmentShadingRateKHR, commandBuffer.segment(), pFragmentSize, combinerOps); }
