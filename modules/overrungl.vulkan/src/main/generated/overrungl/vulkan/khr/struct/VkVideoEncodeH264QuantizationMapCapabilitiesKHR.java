...
public final class VkVideoEncodeH264QuantizationMapCapabilitiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_minQpDelta = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("minQpDelta")));
    ...
    public static final Supplier<VarHandle> VH_maxQpDelta = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxQpDelta")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int minQpDelta(MemorySegment segment, long index) { return (int) VH_minQpDelta.get().get(segment, 0L, index); }
    /// {@return `minQpDelta`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void minQpDelta(MemorySegment segment, long index, int value) { VH_minQpDelta.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxQpDelta(MemorySegment segment, long index) { return (int) VH_maxQpDelta.get().get(segment, 0L, index); }
    /// {@return `maxQpDelta`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxQpDelta(MemorySegment segment, long index, int value) { VH_maxQpDelta.get().set(segment, 0L, index, value); }
