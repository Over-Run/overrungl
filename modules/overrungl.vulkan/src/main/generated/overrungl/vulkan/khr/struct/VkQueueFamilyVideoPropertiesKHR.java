...
public final class VkQueueFamilyVideoPropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_videoCodecOperations = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("videoCodecOperations")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int videoCodecOperations(MemorySegment segment, long index) { return (int) VH_videoCodecOperations.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void videoCodecOperations(MemorySegment segment, long index, int value) { VH_videoCodecOperations.get().set(segment, 0L, index, value); }
