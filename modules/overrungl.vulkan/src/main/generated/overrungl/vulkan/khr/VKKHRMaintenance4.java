...
public final class VKKHRMaintenance4 {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetDeviceBufferMemoryRequirementsKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetDeviceImageMemoryRequirementsKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetDeviceImageSparseMemoryRequirementsKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static void vkGetDeviceBufferMemoryRequirementsKHR(@NonNull VkDevice device, @NonNull MemorySegment pInfo, @NonNull MemorySegment pMemoryRequirements) {
        ...
        Handles.MH_vkGetDeviceBufferMemoryRequirementsKHR.get().invokeExact(device.capabilities().PFN_vkGetDeviceBufferMemoryRequirementsKHR, device.segment(), pInfo, pMemoryRequirements); }
    ...
    public static void vkGetDeviceImageMemoryRequirementsKHR(@NonNull VkDevice device, @NonNull MemorySegment pInfo, @NonNull MemorySegment pMemoryRequirements) {
        ...
        Handles.MH_vkGetDeviceImageMemoryRequirementsKHR.get().invokeExact(device.capabilities().PFN_vkGetDeviceImageMemoryRequirementsKHR, device.segment(), pInfo, pMemoryRequirements); }
    ...
    public static void vkGetDeviceImageSparseMemoryRequirementsKHR(@NonNull VkDevice device, @NonNull MemorySegment pInfo, @NonNull MemorySegment pSparseMemoryRequirementCount, @NonNull MemorySegment pSparseMemoryRequirements) {
        ...
        Handles.MH_vkGetDeviceImageSparseMemoryRequirementsKHR.get().invokeExact(device.capabilities().PFN_vkGetDeviceImageSparseMemoryRequirementsKHR, device.segment(), pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements); }
