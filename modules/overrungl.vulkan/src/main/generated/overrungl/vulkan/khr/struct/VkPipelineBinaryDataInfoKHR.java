...
public final class VkPipelineBinaryDataInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pipelineBinary = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pipelineBinary")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long pipelineBinary(MemorySegment segment, long index) { return (long) VH_pipelineBinary.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pipelineBinary(MemorySegment segment, long index, long value) { VH_pipelineBinary.get().set(segment, 0L, index, value); }
