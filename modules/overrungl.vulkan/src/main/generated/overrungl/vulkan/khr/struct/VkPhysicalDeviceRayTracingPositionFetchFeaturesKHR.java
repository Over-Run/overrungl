...
public final class VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_rayTracingPositionFetch = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("rayTracingPositionFetch")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int rayTracingPositionFetch(MemorySegment segment, long index) { return (int) VH_rayTracingPositionFetch.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void rayTracingPositionFetch(MemorySegment segment, long index, int value) { VH_rayTracingPositionFetch.get().set(segment, 0L, index, value); }
