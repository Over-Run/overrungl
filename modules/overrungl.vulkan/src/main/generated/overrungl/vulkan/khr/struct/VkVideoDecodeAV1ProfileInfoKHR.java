...
/// Represents `VkVideoDecodeAV1ProfileInfoKHR`.
/// ## Layout
/// ```
...
public final class VkVideoDecodeAV1ProfileInfoKHR extends GroupType {
    ...
    public static VkVideoDecodeAV1ProfileInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoDecodeAv1.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_PROFILE_INFO_KHR); }
    public static VkVideoDecodeAV1ProfileInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoDecodeAv1.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_PROFILE_INFO_KHR);
        return s;
    }
    ...
    public int filmGrainSupportAt(long index) { return (int) VH_filmGrainSupport.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int stdProfile() { return (int) VH_stdProfile.get(this.segment(), 0L, 0L); }
    public int filmGrainSupport() { return (int) VH_filmGrainSupport.get(this.segment(), 0L, 0L); }
    public VkVideoDecodeAV1ProfileInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR stdProfileAt(long index, int value) { VH_stdProfile.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR filmGrainSupportAt(long index, int value) { VH_filmGrainSupport.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR stdProfile(int value) { VH_stdProfile.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR filmGrainSupport(int value) { VH_filmGrainSupport.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkVideoDecodeAV1ProfileInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkVideoDecodeAV1ProfileInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkVideoDecodeAV1ProfileInfoKHR _stdProfileAt(long index, MemorySegment src) { _stdProfileAt(index).copyFrom(src); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR _stdProfile(MemorySegment src) { return _stdProfileAt(0L, src); }
    public MemorySegment _filmGrainSupportAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_filmGrainSupport, index), LAYOUT_filmGrainSupport); }
    public MemorySegment _filmGrainSupport() { return _filmGrainSupportAt(0L); }
    public VkVideoDecodeAV1ProfileInfoKHR _filmGrainSupportAt(long index, MemorySegment src) { _filmGrainSupportAt(index).copyFrom(src); return this; }
    public VkVideoDecodeAV1ProfileInfoKHR _filmGrainSupport(MemorySegment src) { return _filmGrainSupportAt(0L, src); }
}
