...
public final class VkPipelineLibraryCreateInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_libraryCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("libraryCount")));
    ...
    public static final Supplier<VarHandle> VH_pLibraries = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pLibraries")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int libraryCount(MemorySegment segment, long index) { return (int) VH_libraryCount.get().get(segment, 0L, index); }
    /// {@return `libraryCount`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void libraryCount(MemorySegment segment, long index, int value) { VH_libraryCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pLibraries(MemorySegment segment, long index) { return (MemorySegment) VH_pLibraries.get().get(segment, 0L, index); }
    /// {@return `pLibraries`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pLibraries(MemorySegment segment, long index, MemorySegment value) { VH_pLibraries.get().set(segment, 0L, index, value); }
