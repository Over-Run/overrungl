...
public final class VkPhysicalDevicePipelineBinaryFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pipelineBinaries = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pipelineBinaries")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int pipelineBinaries(MemorySegment segment, long index) { return (int) VH_pipelineBinaries.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pipelineBinaries(MemorySegment segment, long index, int value) { VH_pipelineBinaries.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPhysicalDevicePipelineBinaryFeaturesKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDevicePipelineBinaryFeaturesKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDevicePipelineBinaryFeaturesKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDevicePipelineBinaryFeaturesKHR pipelineBinariesAt(long index, int value) { pipelineBinaries(this.segment(), index, value); return this; }
