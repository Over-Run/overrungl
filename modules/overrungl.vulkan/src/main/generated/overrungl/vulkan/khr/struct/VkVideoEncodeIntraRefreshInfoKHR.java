...
public final class VkVideoEncodeIntraRefreshInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_intraRefreshCycleDuration = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("intraRefreshCycleDuration")));
    ...
    public static final Supplier<VarHandle> VH_intraRefreshIndex = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("intraRefreshIndex")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int intraRefreshCycleDuration(MemorySegment segment, long index) { return (int) VH_intraRefreshCycleDuration.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void intraRefreshCycleDuration(MemorySegment segment, long index, int value) { VH_intraRefreshCycleDuration.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int intraRefreshIndex(MemorySegment segment, long index) { return (int) VH_intraRefreshIndex.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void intraRefreshIndex(MemorySegment segment, long index, int value) { VH_intraRefreshIndex.get().set(segment, 0L, index, value); }
