...
public final class VkBindImageMemorySwapchainInfoKHR extends GroupType {
    ...
    public static VkBindImageMemorySwapchainInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRDeviceGroup.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_SWAPCHAIN_INFO_KHR); }
    public static VkBindImageMemorySwapchainInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRDeviceGroup.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_SWAPCHAIN_INFO_KHR);
        return s;
    }
    ...
    public int imageIndexAt(long index) { return (int) VH_imageIndex.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public long swapchain() { return (long) VH_swapchain.get(this.segment(), 0L, 0L); }
    public int imageIndex() { return (int) VH_imageIndex.get(this.segment(), 0L, 0L); }
    public VkBindImageMemorySwapchainInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkBindImageMemorySwapchainInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkBindImageMemorySwapchainInfoKHR swapchainAt(long index, long value) { VH_swapchain.set(this.segment(), 0L, index, value); return this; }
    public VkBindImageMemorySwapchainInfoKHR imageIndexAt(long index, int value) { VH_imageIndex.set(this.segment(), 0L, index, value); return this; }
    public VkBindImageMemorySwapchainInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkBindImageMemorySwapchainInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkBindImageMemorySwapchainInfoKHR swapchain(long value) { VH_swapchain.set(this.segment(), 0L, 0L, value); return this; }
    public VkBindImageMemorySwapchainInfoKHR imageIndex(int value) { VH_imageIndex.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkBindImageMemorySwapchainInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkBindImageMemorySwapchainInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkBindImageMemorySwapchainInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkBindImageMemorySwapchainInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkBindImageMemorySwapchainInfoKHR _swapchainAt(long index, MemorySegment src) { _swapchainAt(index).copyFrom(src); return this; }
    public VkBindImageMemorySwapchainInfoKHR _swapchain(MemorySegment src) { return _swapchainAt(0L, src); }
    public MemorySegment _imageIndexAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_imageIndex, index), LAYOUT_imageIndex); }
    public MemorySegment _imageIndex() { return _imageIndexAt(0L); }
    public VkBindImageMemorySwapchainInfoKHR _imageIndexAt(long index, MemorySegment src) { _imageIndexAt(index).copyFrom(src); return this; }
    public VkBindImageMemorySwapchainInfoKHR _imageIndex(MemorySegment src) { return _imageIndexAt(0L, src); }
}
