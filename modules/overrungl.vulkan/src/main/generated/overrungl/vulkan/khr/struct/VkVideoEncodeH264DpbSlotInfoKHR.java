...
public final class VkVideoEncodeH264DpbSlotInfoKHR extends GroupType {
    ...
    public static VkVideoEncodeH264DpbSlotInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoEncodeH264.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_DPB_SLOT_INFO_KHR); }
    public static VkVideoEncodeH264DpbSlotInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoEncodeH264.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_DPB_SLOT_INFO_KHR);
        return s;
    }
    ...
    public VkVideoEncodeH264DpbSlotInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH264DpbSlotInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH264DpbSlotInfoKHR pStdReferenceInfoAt(long index, MemorySegment value) { VH_pStdReferenceInfo.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH264DpbSlotInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH264DpbSlotInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH264DpbSlotInfoKHR pStdReferenceInfo(MemorySegment value) { VH_pStdReferenceInfo.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkVideoEncodeH264DpbSlotInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH264DpbSlotInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkVideoEncodeH264DpbSlotInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH264DpbSlotInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkVideoEncodeH264DpbSlotInfoKHR _pStdReferenceInfoAt(long index, MemorySegment src) { _pStdReferenceInfoAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH264DpbSlotInfoKHR _pStdReferenceInfo(MemorySegment src) { return _pStdReferenceInfoAt(0L, src); }
}
