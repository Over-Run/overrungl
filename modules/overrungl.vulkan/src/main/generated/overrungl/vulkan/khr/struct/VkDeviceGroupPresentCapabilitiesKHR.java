...
public final class VkDeviceGroupPresentCapabilitiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_presentMask = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentMask"), PathElement.sequenceElement()));
    ...
    public static int presentMask(MemorySegment segment, long index, long index0) { return (int) VH_presentMask.get().get(segment, 0L, index, index0); }
    /// {@return `presentMask`}
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void presentMask(MemorySegment segment, long index, long index0, int value) { VH_presentMask.get().set(segment, 0L, index, index0, value); }
