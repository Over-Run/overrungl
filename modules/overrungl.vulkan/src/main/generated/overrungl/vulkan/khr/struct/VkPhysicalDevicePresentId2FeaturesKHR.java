...
public final class VkPhysicalDevicePresentId2FeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_presentId2 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentId2")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int presentId2(MemorySegment segment, long index) { return (int) VH_presentId2.get().get(segment, 0L, index); }
    /// {@return `presentId2`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void presentId2(MemorySegment segment, long index, int value) { VH_presentId2.get().set(segment, 0L, index, value); }
