...
public final class VkPhysicalDeviceMaintenance7FeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maintenance7 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maintenance7")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maintenance7(MemorySegment segment, long index) { return (int) VH_maintenance7.get().get(segment, 0L, index); }
    /// {@return `maintenance7`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maintenance7(MemorySegment segment, long index, int value) { VH_maintenance7.get().set(segment, 0L, index, value); }
