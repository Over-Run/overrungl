...
public final class VkPerformanceQuerySubmitInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_counterPassIndex = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("counterPassIndex")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int counterPassIndex(MemorySegment segment, long index) { return (int) VH_counterPassIndex.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void counterPassIndex(MemorySegment segment, long index, int value) { VH_counterPassIndex.get().set(segment, 0L, index, value); }
