...
public final class VkPhysicalDevicePerformanceQueryPropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_allowCommandBufferQueryCopies = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("allowCommandBufferQueryCopies")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int allowCommandBufferQueryCopies(MemorySegment segment, long index) { return (int) VH_allowCommandBufferQueryCopies.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void allowCommandBufferQueryCopies(MemorySegment segment, long index, int value) { VH_allowCommandBufferQueryCopies.get().set(segment, 0L, index, value); }
