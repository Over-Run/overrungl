...
public final class VkQueueFamilyOwnershipTransferPropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_optimalImageTransferToQueueFamilies = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("optimalImageTransferToQueueFamilies")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int optimalImageTransferToQueueFamilies(MemorySegment segment, long index) { return (int) VH_optimalImageTransferToQueueFamilies.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void optimalImageTransferToQueueFamilies(MemorySegment segment, long index, int value) { VH_optimalImageTransferToQueueFamilies.get().set(segment, 0L, index, value); }
