...
public final class VkVideoDecodeH265ProfileInfoKHR extends GroupType {
    ...
    public static VkVideoDecodeH265ProfileInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoDecodeH265.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_PROFILE_INFO_KHR); }
    public static VkVideoDecodeH265ProfileInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoDecodeH265.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_PROFILE_INFO_KHR);
        return s;
    }
    ...
    public VkVideoDecodeH265ProfileInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH265ProfileInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH265ProfileInfoKHR stdProfileIdcAt(long index, int value) { VH_stdProfileIdc.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH265ProfileInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeH265ProfileInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeH265ProfileInfoKHR stdProfileIdc(int value) { VH_stdProfileIdc.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkVideoDecodeH265ProfileInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH265ProfileInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkVideoDecodeH265ProfileInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH265ProfileInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkVideoDecodeH265ProfileInfoKHR _stdProfileIdcAt(long index, MemorySegment src) { _stdProfileIdcAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH265ProfileInfoKHR _stdProfileIdc(MemorySegment src) { return _stdProfileIdcAt(0L, src); }
}
