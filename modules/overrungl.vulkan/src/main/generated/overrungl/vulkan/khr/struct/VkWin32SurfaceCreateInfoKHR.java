...
public final class VkWin32SurfaceCreateInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_hinstance = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("hinstance")));
    ...
    public static final Supplier<VarHandle> VH_hwnd = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("hwnd")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment hinstance(MemorySegment segment, long index) { return (MemorySegment) VH_hinstance.get().get(segment, 0L, index); }
    /// {@return `hinstance`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void hinstance(MemorySegment segment, long index, MemorySegment value) { VH_hinstance.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment hwnd(MemorySegment segment, long index) { return (MemorySegment) VH_hwnd.get().get(segment, 0L, index); }
    /// {@return `hwnd`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void hwnd(MemorySegment segment, long index, MemorySegment value) { VH_hwnd.get().set(segment, 0L, index, value); }
