...
public final class VkPerformanceCounterDescriptionKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_category = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("category"), PathElement.sequenceElement()));
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static byte category(MemorySegment segment, long index, long index0) { return (byte) VH_category.get().get(segment, 0L, index, index0); }
    /// {@return `category`}
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void category(MemorySegment segment, long index, long index0, byte value) { VH_category.get().set(segment, 0L, index, index0, value); }
