...
public final class VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_fragmentShaderBarycentric = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("fragmentShaderBarycentric")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int fragmentShaderBarycentric(MemorySegment segment, long index) { return (int) VH_fragmentShaderBarycentric.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void fragmentShaderBarycentric(MemorySegment segment, long index, int value) { VH_fragmentShaderBarycentric.get().set(segment, 0L, index, value); }
