...
/// Represents `VkPhysicalDeviceRobustness2FeaturesKHR`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceRobustness2FeaturesKHR extends GroupType {
    ...
    public static VkPhysicalDeviceRobustness2FeaturesKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRRobustness2.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR); }
    public static VkPhysicalDeviceRobustness2FeaturesKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceRobustness2FeaturesKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR robustBufferAccess2At(long index, int value) { VH_robustBufferAccess2.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR robustImageAccess2At(long index, int value) { VH_robustImageAccess2.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR nullDescriptorAt(long index, int value) { VH_nullDescriptor.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR robustBufferAccess2(int value) { VH_robustBufferAccess2.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR robustImageAccess2(int value) { VH_robustImageAccess2.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR nullDescriptor(int value) { VH_nullDescriptor.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceRobustness2FeaturesKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceRobustness2FeaturesKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceRobustness2FeaturesKHR _robustBufferAccess2At(long index, MemorySegment src) { _robustBufferAccess2At(index).copyFrom(src); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR _robustBufferAccess2(MemorySegment src) { return _robustBufferAccess2At(0L, src); }
    ...
    public VkPhysicalDeviceRobustness2FeaturesKHR _robustImageAccess2At(long index, MemorySegment src) { _robustImageAccess2At(index).copyFrom(src); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR _robustImageAccess2(MemorySegment src) { return _robustImageAccess2At(0L, src); }
    ...
    public VkPhysicalDeviceRobustness2FeaturesKHR _nullDescriptorAt(long index, MemorySegment src) { _nullDescriptorAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceRobustness2FeaturesKHR _nullDescriptor(MemorySegment src) { return _nullDescriptorAt(0L, src); }
}
