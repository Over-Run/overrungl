...
public final class VkXcbSurfaceCreateInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_connection = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("connection")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment connection(MemorySegment segment, long index) { return (MemorySegment) VH_connection.get().get(segment, 0L, index); }
    /// {@return `connection`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void connection(MemorySegment segment, long index, MemorySegment value) { VH_connection.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int window(MemorySegment segment, long index) { return (int) VH_window.get().get(segment, 0L, index); }
    /// {@return `window`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void window(MemorySegment segment, long index, int value) { VH_window.get().set(segment, 0L, index, value); }
