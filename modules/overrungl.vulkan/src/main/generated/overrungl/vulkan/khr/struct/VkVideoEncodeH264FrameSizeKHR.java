...
/// Represents `VkVideoEncodeH264FrameSizeKHR`.
/// ## Layout
/// ```
...
public final class VkVideoEncodeH264FrameSizeKHR extends GroupType {
    ...
    public VkVideoEncodeH264FrameSizeKHR frameISizeAt(long index, int value) { VH_frameISize.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH264FrameSizeKHR framePSizeAt(long index, int value) { VH_framePSize.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH264FrameSizeKHR frameBSizeAt(long index, int value) { VH_frameBSize.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH264FrameSizeKHR frameISize(int value) { VH_frameISize.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH264FrameSizeKHR framePSize(int value) { VH_framePSize.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH264FrameSizeKHR frameBSize(int value) { VH_frameBSize.set(this.segment(), 0L, 0L, value); return this; }
    ...
    public VkVideoEncodeH264FrameSizeKHR _frameISizeAt(long index, MemorySegment src) { _frameISizeAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH264FrameSizeKHR _frameISize(MemorySegment src) { return _frameISizeAt(0L, src); }
    ...
    public VkVideoEncodeH264FrameSizeKHR _framePSizeAt(long index, MemorySegment src) { _framePSizeAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH264FrameSizeKHR _framePSize(MemorySegment src) { return _framePSizeAt(0L, src); }
    ...
    public VkVideoEncodeH264FrameSizeKHR _frameBSizeAt(long index, MemorySegment src) { _frameBSizeAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH264FrameSizeKHR _frameBSize(MemorySegment src) { return _frameBSizeAt(0L, src); }
}
