...
public final class VkPhysicalDeviceDepthClampZeroOneFeaturesKHR extends GroupType {
    ...
    /// Visits `VkPhysicalDeviceDepthClampZeroOneFeaturesKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceDepthClampZeroOneFeaturesKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceDepthClampZeroOneFeaturesKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceDepthClampZeroOneFeaturesKHR depthClampZeroOneAt(long index, int value) { depthClampZeroOne(this.segment(), index, value); return this; }
