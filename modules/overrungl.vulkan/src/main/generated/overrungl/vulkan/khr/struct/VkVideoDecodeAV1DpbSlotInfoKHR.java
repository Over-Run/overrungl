...
public final class VkVideoDecodeAV1DpbSlotInfoKHR extends GroupType {
    ...
    public static VkVideoDecodeAV1DpbSlotInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoDecodeAv1.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_DPB_SLOT_INFO_KHR); }
    public static VkVideoDecodeAV1DpbSlotInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoDecodeAv1.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_DPB_SLOT_INFO_KHR);
        return s;
    }
    ...
    public VkVideoDecodeAV1DpbSlotInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeAV1DpbSlotInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeAV1DpbSlotInfoKHR pStdReferenceInfoAt(long index, MemorySegment value) { VH_pStdReferenceInfo.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeAV1DpbSlotInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeAV1DpbSlotInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeAV1DpbSlotInfoKHR pStdReferenceInfo(MemorySegment value) { VH_pStdReferenceInfo.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkVideoDecodeAV1DpbSlotInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkVideoDecodeAV1DpbSlotInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkVideoDecodeAV1DpbSlotInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkVideoDecodeAV1DpbSlotInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkVideoDecodeAV1DpbSlotInfoKHR _pStdReferenceInfoAt(long index, MemorySegment src) { _pStdReferenceInfoAt(index).copyFrom(src); return this; }
    public VkVideoDecodeAV1DpbSlotInfoKHR _pStdReferenceInfo(MemorySegment src) { return _pStdReferenceInfoAt(0L, src); }
}
