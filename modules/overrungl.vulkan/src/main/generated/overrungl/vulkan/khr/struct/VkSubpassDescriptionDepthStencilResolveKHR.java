...
public final class VkSubpassDescriptionDepthStencilResolveKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_depthResolveMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("depthResolveMode")));
    ...
    public static final Supplier<VarHandle> VH_stencilResolveMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("stencilResolveMode")));
    ...
    public static final Supplier<VarHandle> VH_pDepthStencilResolveAttachment = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pDepthStencilResolveAttachment")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int depthResolveMode(MemorySegment segment, long index) { return (int) VH_depthResolveMode.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void depthResolveMode(MemorySegment segment, long index, int value) { VH_depthResolveMode.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int stencilResolveMode(MemorySegment segment, long index) { return (int) VH_stencilResolveMode.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void stencilResolveMode(MemorySegment segment, long index, int value) { VH_stencilResolveMode.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pDepthStencilResolveAttachment(MemorySegment segment, long index) { return (MemorySegment) VH_pDepthStencilResolveAttachment.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pDepthStencilResolveAttachment(MemorySegment segment, long index, MemorySegment value) { VH_pDepthStencilResolveAttachment.get().set(segment, 0L, index, value); }
