...
public final class VkVideoEncodeAV1RateControlInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_gopFrameCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("gopFrameCount")));
    ...
    public static final Supplier<VarHandle> VH_keyFramePeriod = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("keyFramePeriod")));
    ...
    public static final Supplier<VarHandle> VH_consecutiveBipredictiveFrameCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("consecutiveBipredictiveFrameCount")));
    ...
    public static final Supplier<VarHandle> VH_temporalLayerCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("temporalLayerCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int gopFrameCount(MemorySegment segment, long index) { return (int) VH_gopFrameCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void gopFrameCount(MemorySegment segment, long index, int value) { VH_gopFrameCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int keyFramePeriod(MemorySegment segment, long index) { return (int) VH_keyFramePeriod.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void keyFramePeriod(MemorySegment segment, long index, int value) { VH_keyFramePeriod.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int consecutiveBipredictiveFrameCount(MemorySegment segment, long index) { return (int) VH_consecutiveBipredictiveFrameCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void consecutiveBipredictiveFrameCount(MemorySegment segment, long index, int value) { VH_consecutiveBipredictiveFrameCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int temporalLayerCount(MemorySegment segment, long index) { return (int) VH_temporalLayerCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void temporalLayerCount(MemorySegment segment, long index, int value) { VH_temporalLayerCount.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkVideoEncodeAV1RateControlInfoKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1RateControlInfoKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1RateControlInfoKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1RateControlInfoKHR flagsAt(long index, int value) { flags(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1RateControlInfoKHR gopFrameCountAt(long index, int value) { gopFrameCount(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1RateControlInfoKHR keyFramePeriodAt(long index, int value) { keyFramePeriod(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1RateControlInfoKHR consecutiveBipredictiveFrameCountAt(long index, int value) { consecutiveBipredictiveFrameCount(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkVideoEncodeAV1RateControlInfoKHR temporalLayerCountAt(long index, int value) { temporalLayerCount(this.segment(), index, value); return this; }
