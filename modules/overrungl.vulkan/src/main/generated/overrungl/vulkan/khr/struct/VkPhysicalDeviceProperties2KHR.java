...
public final class VkPhysicalDeviceProperties2KHR extends GroupType {
    ...
    public static VkPhysicalDeviceProperties2KHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2); }
    public static VkPhysicalDeviceProperties2KHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceProperties2KHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$apiVersionAt(long index, int value) { VH_properties$apiVersion.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$driverVersionAt(long index, int value) { VH_properties$driverVersion.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$vendorIDAt(long index, int value) { VH_properties$vendorID.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$deviceIDAt(long index, int value) { VH_properties$deviceID.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$deviceTypeAt(long index, int value) { VH_properties$deviceType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$deviceNameAt(long index, long index0, byte value) { VH_properties$deviceName.set(this.segment(), 0L, index, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$pipelineCacheUUIDAt(long index, long index0, byte value) { VH_properties$pipelineCacheUUID.set(this.segment(), 0L, index, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageDimension1DAt(long index, int value) { VH_properties$limits$maxImageDimension1D.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageDimension2DAt(long index, int value) { VH_properties$limits$maxImageDimension2D.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageDimension3DAt(long index, int value) { VH_properties$limits$maxImageDimension3D.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageDimensionCubeAt(long index, int value) { VH_properties$limits$maxImageDimensionCube.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageArrayLayersAt(long index, int value) { VH_properties$limits$maxImageArrayLayers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTexelBufferElementsAt(long index, int value) { VH_properties$limits$maxTexelBufferElements.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxUniformBufferRangeAt(long index, int value) { VH_properties$limits$maxUniformBufferRange.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxStorageBufferRangeAt(long index, int value) { VH_properties$limits$maxStorageBufferRange.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPushConstantsSizeAt(long index, int value) { VH_properties$limits$maxPushConstantsSize.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxMemoryAllocationCountAt(long index, int value) { VH_properties$limits$maxMemoryAllocationCount.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxSamplerAllocationCountAt(long index, int value) { VH_properties$limits$maxSamplerAllocationCount.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$bufferImageGranularityAt(long index, long value) { VH_properties$limits$bufferImageGranularity.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sparseAddressSpaceSizeAt(long index, long value) { VH_properties$limits$sparseAddressSpaceSize.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxBoundDescriptorSetsAt(long index, int value) { VH_properties$limits$maxBoundDescriptorSets.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorSamplersAt(long index, int value) { VH_properties$limits$maxPerStageDescriptorSamplers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorUniformBuffersAt(long index, int value) { VH_properties$limits$maxPerStageDescriptorUniformBuffers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorStorageBuffersAt(long index, int value) { VH_properties$limits$maxPerStageDescriptorStorageBuffers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorSampledImagesAt(long index, int value) { VH_properties$limits$maxPerStageDescriptorSampledImages.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorStorageImagesAt(long index, int value) { VH_properties$limits$maxPerStageDescriptorStorageImages.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorInputAttachmentsAt(long index, int value) { VH_properties$limits$maxPerStageDescriptorInputAttachments.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageResourcesAt(long index, int value) { VH_properties$limits$maxPerStageResources.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetSamplersAt(long index, int value) { VH_properties$limits$maxDescriptorSetSamplers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetUniformBuffersAt(long index, int value) { VH_properties$limits$maxDescriptorSetUniformBuffers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetUniformBuffersDynamicAt(long index, int value) { VH_properties$limits$maxDescriptorSetUniformBuffersDynamic.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetStorageBuffersAt(long index, int value) { VH_properties$limits$maxDescriptorSetStorageBuffers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetStorageBuffersDynamicAt(long index, int value) { VH_properties$limits$maxDescriptorSetStorageBuffersDynamic.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetSampledImagesAt(long index, int value) { VH_properties$limits$maxDescriptorSetSampledImages.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetStorageImagesAt(long index, int value) { VH_properties$limits$maxDescriptorSetStorageImages.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetInputAttachmentsAt(long index, int value) { VH_properties$limits$maxDescriptorSetInputAttachments.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexInputAttributesAt(long index, int value) { VH_properties$limits$maxVertexInputAttributes.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexInputBindingsAt(long index, int value) { VH_properties$limits$maxVertexInputBindings.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexInputAttributeOffsetAt(long index, int value) { VH_properties$limits$maxVertexInputAttributeOffset.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexInputBindingStrideAt(long index, int value) { VH_properties$limits$maxVertexInputBindingStride.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexOutputComponentsAt(long index, int value) { VH_properties$limits$maxVertexOutputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationGenerationLevelAt(long index, int value) { VH_properties$limits$maxTessellationGenerationLevel.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationPatchSizeAt(long index, int value) { VH_properties$limits$maxTessellationPatchSize.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationControlPerVertexInputComponentsAt(long index, int value) { VH_properties$limits$maxTessellationControlPerVertexInputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationControlPerVertexOutputComponentsAt(long index, int value) { VH_properties$limits$maxTessellationControlPerVertexOutputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationControlPerPatchOutputComponentsAt(long index, int value) { VH_properties$limits$maxTessellationControlPerPatchOutputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationControlTotalOutputComponentsAt(long index, int value) { VH_properties$limits$maxTessellationControlTotalOutputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationEvaluationInputComponentsAt(long index, int value) { VH_properties$limits$maxTessellationEvaluationInputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationEvaluationOutputComponentsAt(long index, int value) { VH_properties$limits$maxTessellationEvaluationOutputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryShaderInvocationsAt(long index, int value) { VH_properties$limits$maxGeometryShaderInvocations.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryInputComponentsAt(long index, int value) { VH_properties$limits$maxGeometryInputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryOutputComponentsAt(long index, int value) { VH_properties$limits$maxGeometryOutputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryOutputVerticesAt(long index, int value) { VH_properties$limits$maxGeometryOutputVertices.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryTotalOutputComponentsAt(long index, int value) { VH_properties$limits$maxGeometryTotalOutputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFragmentInputComponentsAt(long index, int value) { VH_properties$limits$maxFragmentInputComponents.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFragmentOutputAttachmentsAt(long index, int value) { VH_properties$limits$maxFragmentOutputAttachments.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFragmentDualSrcAttachmentsAt(long index, int value) { VH_properties$limits$maxFragmentDualSrcAttachments.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFragmentCombinedOutputResourcesAt(long index, int value) { VH_properties$limits$maxFragmentCombinedOutputResources.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxComputeSharedMemorySizeAt(long index, int value) { VH_properties$limits$maxComputeSharedMemorySize.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxComputeWorkGroupCountAt(long index, long index0, int value) { VH_properties$limits$maxComputeWorkGroupCount.set(this.segment(), 0L, index, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxComputeWorkGroupInvocationsAt(long index, int value) { VH_properties$limits$maxComputeWorkGroupInvocations.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxComputeWorkGroupSizeAt(long index, long index0, int value) { VH_properties$limits$maxComputeWorkGroupSize.set(this.segment(), 0L, index, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$subPixelPrecisionBitsAt(long index, int value) { VH_properties$limits$subPixelPrecisionBits.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$subTexelPrecisionBitsAt(long index, int value) { VH_properties$limits$subTexelPrecisionBits.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$mipmapPrecisionBitsAt(long index, int value) { VH_properties$limits$mipmapPrecisionBits.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDrawIndexedIndexValueAt(long index, int value) { VH_properties$limits$maxDrawIndexedIndexValue.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDrawIndirectCountAt(long index, int value) { VH_properties$limits$maxDrawIndirectCount.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxSamplerLodBiasAt(long index, float value) { VH_properties$limits$maxSamplerLodBias.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxSamplerAnisotropyAt(long index, float value) { VH_properties$limits$maxSamplerAnisotropy.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxViewportsAt(long index, int value) { VH_properties$limits$maxViewports.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxViewportDimensionsAt(long index, long index0, int value) { VH_properties$limits$maxViewportDimensions.set(this.segment(), 0L, index, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$viewportBoundsRangeAt(long index, long index0, float value) { VH_properties$limits$viewportBoundsRange.set(this.segment(), 0L, index, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$viewportSubPixelBitsAt(long index, int value) { VH_properties$limits$viewportSubPixelBits.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minMemoryMapAlignmentAt(long index, long value) { VH_properties$limits$minMemoryMapAlignment.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minTexelBufferOffsetAlignmentAt(long index, long value) { VH_properties$limits$minTexelBufferOffsetAlignment.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minUniformBufferOffsetAlignmentAt(long index, long value) { VH_properties$limits$minUniformBufferOffsetAlignment.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minStorageBufferOffsetAlignmentAt(long index, long value) { VH_properties$limits$minStorageBufferOffsetAlignment.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minTexelOffsetAt(long index, int value) { VH_properties$limits$minTexelOffset.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTexelOffsetAt(long index, int value) { VH_properties$limits$maxTexelOffset.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minTexelGatherOffsetAt(long index, int value) { VH_properties$limits$minTexelGatherOffset.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTexelGatherOffsetAt(long index, int value) { VH_properties$limits$maxTexelGatherOffset.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minInterpolationOffsetAt(long index, float value) { VH_properties$limits$minInterpolationOffset.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxInterpolationOffsetAt(long index, float value) { VH_properties$limits$maxInterpolationOffset.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$subPixelInterpolationOffsetBitsAt(long index, int value) { VH_properties$limits$subPixelInterpolationOffsetBits.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFramebufferWidthAt(long index, int value) { VH_properties$limits$maxFramebufferWidth.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFramebufferHeightAt(long index, int value) { VH_properties$limits$maxFramebufferHeight.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFramebufferLayersAt(long index, int value) { VH_properties$limits$maxFramebufferLayers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$framebufferColorSampleCountsAt(long index, int value) { VH_properties$limits$framebufferColorSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$framebufferDepthSampleCountsAt(long index, int value) { VH_properties$limits$framebufferDepthSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$framebufferStencilSampleCountsAt(long index, int value) { VH_properties$limits$framebufferStencilSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$framebufferNoAttachmentsSampleCountsAt(long index, int value) { VH_properties$limits$framebufferNoAttachmentsSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxColorAttachmentsAt(long index, int value) { VH_properties$limits$maxColorAttachments.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sampledImageColorSampleCountsAt(long index, int value) { VH_properties$limits$sampledImageColorSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sampledImageIntegerSampleCountsAt(long index, int value) { VH_properties$limits$sampledImageIntegerSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sampledImageDepthSampleCountsAt(long index, int value) { VH_properties$limits$sampledImageDepthSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sampledImageStencilSampleCountsAt(long index, int value) { VH_properties$limits$sampledImageStencilSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$storageImageSampleCountsAt(long index, int value) { VH_properties$limits$storageImageSampleCounts.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxSampleMaskWordsAt(long index, int value) { VH_properties$limits$maxSampleMaskWords.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$timestampComputeAndGraphicsAt(long index, int value) { VH_properties$limits$timestampComputeAndGraphics.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$timestampPeriodAt(long index, float value) { VH_properties$limits$timestampPeriod.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxClipDistancesAt(long index, int value) { VH_properties$limits$maxClipDistances.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxCullDistancesAt(long index, int value) { VH_properties$limits$maxCullDistances.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxCombinedClipAndCullDistancesAt(long index, int value) { VH_properties$limits$maxCombinedClipAndCullDistances.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$discreteQueuePrioritiesAt(long index, int value) { VH_properties$limits$discreteQueuePriorities.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$pointSizeRangeAt(long index, long index0, float value) { VH_properties$limits$pointSizeRange.set(this.segment(), 0L, index, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$lineWidthRangeAt(long index, long index0, float value) { VH_properties$limits$lineWidthRange.set(this.segment(), 0L, index, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$pointSizeGranularityAt(long index, float value) { VH_properties$limits$pointSizeGranularity.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$lineWidthGranularityAt(long index, float value) { VH_properties$limits$lineWidthGranularity.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$strictLinesAt(long index, int value) { VH_properties$limits$strictLines.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$standardSampleLocationsAt(long index, int value) { VH_properties$limits$standardSampleLocations.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$optimalBufferCopyOffsetAlignmentAt(long index, long value) { VH_properties$limits$optimalBufferCopyOffsetAlignment.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$optimalBufferCopyRowPitchAlignmentAt(long index, long value) { VH_properties$limits$optimalBufferCopyRowPitchAlignment.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$nonCoherentAtomSizeAt(long index, long value) { VH_properties$limits$nonCoherentAtomSize.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyStandard2DBlockShapeAt(long index, int value) { VH_properties$sparseProperties$residencyStandard2DBlockShape.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyStandard2DMultisampleBlockShapeAt(long index, int value) { VH_properties$sparseProperties$residencyStandard2DMultisampleBlockShape.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyStandard3DBlockShapeAt(long index, int value) { VH_properties$sparseProperties$residencyStandard3DBlockShape.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyAlignedMipSizeAt(long index, int value) { VH_properties$sparseProperties$residencyAlignedMipSize.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyNonResidentStrictAt(long index, int value) { VH_properties$sparseProperties$residencyNonResidentStrict.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProperties2KHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$apiVersion(int value) { VH_properties$apiVersion.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$driverVersion(int value) { VH_properties$driverVersion.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$vendorID(int value) { VH_properties$vendorID.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$deviceID(int value) { VH_properties$deviceID.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$deviceType(int value) { VH_properties$deviceType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$deviceName(long index0, byte value) { VH_properties$deviceName.set(this.segment(), 0L, 0L, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$pipelineCacheUUID(long index0, byte value) { VH_properties$pipelineCacheUUID.set(this.segment(), 0L, 0L, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageDimension1D(int value) { VH_properties$limits$maxImageDimension1D.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageDimension2D(int value) { VH_properties$limits$maxImageDimension2D.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageDimension3D(int value) { VH_properties$limits$maxImageDimension3D.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageDimensionCube(int value) { VH_properties$limits$maxImageDimensionCube.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxImageArrayLayers(int value) { VH_properties$limits$maxImageArrayLayers.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTexelBufferElements(int value) { VH_properties$limits$maxTexelBufferElements.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxUniformBufferRange(int value) { VH_properties$limits$maxUniformBufferRange.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxStorageBufferRange(int value) { VH_properties$limits$maxStorageBufferRange.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPushConstantsSize(int value) { VH_properties$limits$maxPushConstantsSize.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxMemoryAllocationCount(int value) { VH_properties$limits$maxMemoryAllocationCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxSamplerAllocationCount(int value) { VH_properties$limits$maxSamplerAllocationCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$bufferImageGranularity(long value) { VH_properties$limits$bufferImageGranularity.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sparseAddressSpaceSize(long value) { VH_properties$limits$sparseAddressSpaceSize.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxBoundDescriptorSets(int value) { VH_properties$limits$maxBoundDescriptorSets.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorSamplers(int value) { VH_properties$limits$maxPerStageDescriptorSamplers.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorUniformBuffers(int value) { VH_properties$limits$maxPerStageDescriptorUniformBuffers.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorStorageBuffers(int value) { VH_properties$limits$maxPerStageDescriptorStorageBuffers.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorSampledImages(int value) { VH_properties$limits$maxPerStageDescriptorSampledImages.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorStorageImages(int value) { VH_properties$limits$maxPerStageDescriptorStorageImages.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageDescriptorInputAttachments(int value) { VH_properties$limits$maxPerStageDescriptorInputAttachments.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxPerStageResources(int value) { VH_properties$limits$maxPerStageResources.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetSamplers(int value) { VH_properties$limits$maxDescriptorSetSamplers.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetUniformBuffers(int value) { VH_properties$limits$maxDescriptorSetUniformBuffers.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetUniformBuffersDynamic(int value) { VH_properties$limits$maxDescriptorSetUniformBuffersDynamic.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetStorageBuffers(int value) { VH_properties$limits$maxDescriptorSetStorageBuffers.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetStorageBuffersDynamic(int value) { VH_properties$limits$maxDescriptorSetStorageBuffersDynamic.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetSampledImages(int value) { VH_properties$limits$maxDescriptorSetSampledImages.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetStorageImages(int value) { VH_properties$limits$maxDescriptorSetStorageImages.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDescriptorSetInputAttachments(int value) { VH_properties$limits$maxDescriptorSetInputAttachments.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexInputAttributes(int value) { VH_properties$limits$maxVertexInputAttributes.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexInputBindings(int value) { VH_properties$limits$maxVertexInputBindings.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexInputAttributeOffset(int value) { VH_properties$limits$maxVertexInputAttributeOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexInputBindingStride(int value) { VH_properties$limits$maxVertexInputBindingStride.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxVertexOutputComponents(int value) { VH_properties$limits$maxVertexOutputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationGenerationLevel(int value) { VH_properties$limits$maxTessellationGenerationLevel.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationPatchSize(int value) { VH_properties$limits$maxTessellationPatchSize.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationControlPerVertexInputComponents(int value) { VH_properties$limits$maxTessellationControlPerVertexInputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationControlPerVertexOutputComponents(int value) { VH_properties$limits$maxTessellationControlPerVertexOutputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationControlPerPatchOutputComponents(int value) { VH_properties$limits$maxTessellationControlPerPatchOutputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationControlTotalOutputComponents(int value) { VH_properties$limits$maxTessellationControlTotalOutputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationEvaluationInputComponents(int value) { VH_properties$limits$maxTessellationEvaluationInputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTessellationEvaluationOutputComponents(int value) { VH_properties$limits$maxTessellationEvaluationOutputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryShaderInvocations(int value) { VH_properties$limits$maxGeometryShaderInvocations.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryInputComponents(int value) { VH_properties$limits$maxGeometryInputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryOutputComponents(int value) { VH_properties$limits$maxGeometryOutputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryOutputVertices(int value) { VH_properties$limits$maxGeometryOutputVertices.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxGeometryTotalOutputComponents(int value) { VH_properties$limits$maxGeometryTotalOutputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFragmentInputComponents(int value) { VH_properties$limits$maxFragmentInputComponents.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFragmentOutputAttachments(int value) { VH_properties$limits$maxFragmentOutputAttachments.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFragmentDualSrcAttachments(int value) { VH_properties$limits$maxFragmentDualSrcAttachments.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFragmentCombinedOutputResources(int value) { VH_properties$limits$maxFragmentCombinedOutputResources.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxComputeSharedMemorySize(int value) { VH_properties$limits$maxComputeSharedMemorySize.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxComputeWorkGroupCount(long index0, int value) { VH_properties$limits$maxComputeWorkGroupCount.set(this.segment(), 0L, 0L, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxComputeWorkGroupInvocations(int value) { VH_properties$limits$maxComputeWorkGroupInvocations.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxComputeWorkGroupSize(long index0, int value) { VH_properties$limits$maxComputeWorkGroupSize.set(this.segment(), 0L, 0L, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$subPixelPrecisionBits(int value) { VH_properties$limits$subPixelPrecisionBits.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$subTexelPrecisionBits(int value) { VH_properties$limits$subTexelPrecisionBits.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$mipmapPrecisionBits(int value) { VH_properties$limits$mipmapPrecisionBits.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDrawIndexedIndexValue(int value) { VH_properties$limits$maxDrawIndexedIndexValue.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxDrawIndirectCount(int value) { VH_properties$limits$maxDrawIndirectCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxSamplerLodBias(float value) { VH_properties$limits$maxSamplerLodBias.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxSamplerAnisotropy(float value) { VH_properties$limits$maxSamplerAnisotropy.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxViewports(int value) { VH_properties$limits$maxViewports.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxViewportDimensions(long index0, int value) { VH_properties$limits$maxViewportDimensions.set(this.segment(), 0L, 0L, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$viewportBoundsRange(long index0, float value) { VH_properties$limits$viewportBoundsRange.set(this.segment(), 0L, 0L, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$viewportSubPixelBits(int value) { VH_properties$limits$viewportSubPixelBits.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minMemoryMapAlignment(long value) { VH_properties$limits$minMemoryMapAlignment.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minTexelBufferOffsetAlignment(long value) { VH_properties$limits$minTexelBufferOffsetAlignment.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minUniformBufferOffsetAlignment(long value) { VH_properties$limits$minUniformBufferOffsetAlignment.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minStorageBufferOffsetAlignment(long value) { VH_properties$limits$minStorageBufferOffsetAlignment.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minTexelOffset(int value) { VH_properties$limits$minTexelOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTexelOffset(int value) { VH_properties$limits$maxTexelOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minTexelGatherOffset(int value) { VH_properties$limits$minTexelGatherOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxTexelGatherOffset(int value) { VH_properties$limits$maxTexelGatherOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$minInterpolationOffset(float value) { VH_properties$limits$minInterpolationOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxInterpolationOffset(float value) { VH_properties$limits$maxInterpolationOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$subPixelInterpolationOffsetBits(int value) { VH_properties$limits$subPixelInterpolationOffsetBits.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFramebufferWidth(int value) { VH_properties$limits$maxFramebufferWidth.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFramebufferHeight(int value) { VH_properties$limits$maxFramebufferHeight.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxFramebufferLayers(int value) { VH_properties$limits$maxFramebufferLayers.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$framebufferColorSampleCounts(int value) { VH_properties$limits$framebufferColorSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$framebufferDepthSampleCounts(int value) { VH_properties$limits$framebufferDepthSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$framebufferStencilSampleCounts(int value) { VH_properties$limits$framebufferStencilSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$framebufferNoAttachmentsSampleCounts(int value) { VH_properties$limits$framebufferNoAttachmentsSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxColorAttachments(int value) { VH_properties$limits$maxColorAttachments.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sampledImageColorSampleCounts(int value) { VH_properties$limits$sampledImageColorSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sampledImageIntegerSampleCounts(int value) { VH_properties$limits$sampledImageIntegerSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sampledImageDepthSampleCounts(int value) { VH_properties$limits$sampledImageDepthSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$sampledImageStencilSampleCounts(int value) { VH_properties$limits$sampledImageStencilSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$storageImageSampleCounts(int value) { VH_properties$limits$storageImageSampleCounts.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxSampleMaskWords(int value) { VH_properties$limits$maxSampleMaskWords.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$timestampComputeAndGraphics(int value) { VH_properties$limits$timestampComputeAndGraphics.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$timestampPeriod(float value) { VH_properties$limits$timestampPeriod.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxClipDistances(int value) { VH_properties$limits$maxClipDistances.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxCullDistances(int value) { VH_properties$limits$maxCullDistances.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$maxCombinedClipAndCullDistances(int value) { VH_properties$limits$maxCombinedClipAndCullDistances.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$discreteQueuePriorities(int value) { VH_properties$limits$discreteQueuePriorities.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$pointSizeRange(long index0, float value) { VH_properties$limits$pointSizeRange.set(this.segment(), 0L, 0L, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$lineWidthRange(long index0, float value) { VH_properties$limits$lineWidthRange.set(this.segment(), 0L, 0L, index0, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$pointSizeGranularity(float value) { VH_properties$limits$pointSizeGranularity.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$lineWidthGranularity(float value) { VH_properties$limits$lineWidthGranularity.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$strictLines(int value) { VH_properties$limits$strictLines.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$standardSampleLocations(int value) { VH_properties$limits$standardSampleLocations.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$optimalBufferCopyOffsetAlignment(long value) { VH_properties$limits$optimalBufferCopyOffsetAlignment.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$optimalBufferCopyRowPitchAlignment(long value) { VH_properties$limits$optimalBufferCopyRowPitchAlignment.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$limits$nonCoherentAtomSize(long value) { VH_properties$limits$nonCoherentAtomSize.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyStandard2DBlockShape(int value) { VH_properties$sparseProperties$residencyStandard2DBlockShape.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyStandard2DMultisampleBlockShape(int value) { VH_properties$sparseProperties$residencyStandard2DMultisampleBlockShape.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyStandard3DBlockShape(int value) { VH_properties$sparseProperties$residencyStandard3DBlockShape.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyAlignedMipSize(int value) { VH_properties$sparseProperties$residencyAlignedMipSize.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProperties2KHR properties$sparseProperties$residencyNonResidentStrict(int value) { VH_properties$sparseProperties$residencyNonResidentStrict.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceProperties2KHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceProperties2KHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceProperties2KHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceProperties2KHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceProperties2KHR _propertiesAt(long index, MemorySegment src) { _propertiesAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceProperties2KHR _properties(MemorySegment src) { return _propertiesAt(0L, src); }
}
