...
public final class VKKHRBindMemory2 {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkBindBufferMemory2KHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkBindImageMemory2KHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkBindBufferMemory2KHR(@NonNull VkDevice device, int bindInfoCount, @NonNull MemorySegment pBindInfos) {
        ...
        return (int) Handles.MH_vkBindBufferMemory2KHR.get().invokeExact(device.capabilities().PFN_vkBindBufferMemory2KHR, device.segment(), bindInfoCount, pBindInfos); }
    ...
    public static int vkBindImageMemory2KHR(@NonNull VkDevice device, int bindInfoCount, @NonNull MemorySegment pBindInfos) {
        ...
        return (int) Handles.MH_vkBindImageMemory2KHR.get().invokeExact(device.capabilities().PFN_vkBindImageMemory2KHR, device.segment(), bindInfoCount, pBindInfos); }
