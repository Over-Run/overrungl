...
public final class VkPerformanceQueryReservationInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxPerformanceQueriesPerPool = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxPerformanceQueriesPerPool")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxPerformanceQueriesPerPool(MemorySegment segment, long index) { return (int) VH_maxPerformanceQueriesPerPool.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxPerformanceQueriesPerPool(MemorySegment segment, long index, int value) { VH_maxPerformanceQueriesPerPool.get().set(segment, 0L, index, value); }
