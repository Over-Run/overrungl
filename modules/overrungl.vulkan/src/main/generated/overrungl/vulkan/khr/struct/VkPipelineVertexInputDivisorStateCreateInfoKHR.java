...
public final class VkPipelineVertexInputDivisorStateCreateInfoKHR extends GroupType {
    ...
    public static VkPipelineVertexInputDivisorStateCreateInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO); }
    public static VkPipelineVertexInputDivisorStateCreateInfoKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPipelineVertexInputDivisorStateCreateInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR vertexBindingDivisorCountAt(long index, int value) { VH_vertexBindingDivisorCount.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR pVertexBindingDivisorsAt(long index, MemorySegment value) { VH_pVertexBindingDivisors.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR vertexBindingDivisorCount(int value) { VH_vertexBindingDivisorCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR pVertexBindingDivisors(MemorySegment value) { VH_pVertexBindingDivisors.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPipelineVertexInputDivisorStateCreateInfoKHR _vertexBindingDivisorCountAt(long index, MemorySegment src) { _vertexBindingDivisorCountAt(index).copyFrom(src); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR _vertexBindingDivisorCount(MemorySegment src) { return _vertexBindingDivisorCountAt(0L, src); }
    ...
    public VkPipelineVertexInputDivisorStateCreateInfoKHR _pVertexBindingDivisorsAt(long index, MemorySegment src) { _pVertexBindingDivisorsAt(index).copyFrom(src); return this; }
    public VkPipelineVertexInputDivisorStateCreateInfoKHR _pVertexBindingDivisors(MemorySegment src) { return _pVertexBindingDivisorsAt(0L, src); }
}
