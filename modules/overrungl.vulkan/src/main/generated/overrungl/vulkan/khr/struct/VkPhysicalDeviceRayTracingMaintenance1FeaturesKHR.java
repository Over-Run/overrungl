...
public final class VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_rayTracingMaintenance1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("rayTracingMaintenance1")));
    ...
    public static final Supplier<VarHandle> VH_rayTracingPipelineTraceRaysIndirect2 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("rayTracingPipelineTraceRaysIndirect2")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int rayTracingMaintenance1(MemorySegment segment, long index) { return (int) VH_rayTracingMaintenance1.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void rayTracingMaintenance1(MemorySegment segment, long index, int value) { VH_rayTracingMaintenance1.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int rayTracingPipelineTraceRaysIndirect2(MemorySegment segment, long index) { return (int) VH_rayTracingPipelineTraceRaysIndirect2.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void rayTracingPipelineTraceRaysIndirect2(MemorySegment segment, long index, int value) { VH_rayTracingPipelineTraceRaysIndirect2.get().set(segment, 0L, index, value); }
