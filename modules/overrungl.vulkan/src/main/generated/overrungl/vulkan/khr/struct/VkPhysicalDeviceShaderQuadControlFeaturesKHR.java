...
public final class VkPhysicalDeviceShaderQuadControlFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderQuadControl = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderQuadControl")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderQuadControl(MemorySegment segment, long index) { return (int) VH_shaderQuadControl.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderQuadControl(MemorySegment segment, long index, int value) { VH_shaderQuadControl.get().set(segment, 0L, index, value); }
