...
public final class VkCommandBufferSubmitInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_commandBuffer = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("commandBuffer")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment commandBuffer(MemorySegment segment, long index) { return (MemorySegment) VH_commandBuffer.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void commandBuffer(MemorySegment segment, long index, MemorySegment value) { VH_commandBuffer.get().set(segment, 0L, index, value); }
