...
public final class VkCommandBufferSubmitInfoKHR extends GroupType {
    ...
    public static VkCommandBufferSubmitInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_COMMAND_BUFFER_SUBMIT_INFO); }
    public static VkCommandBufferSubmitInfoKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkCommandBufferSubmitInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkCommandBufferSubmitInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkCommandBufferSubmitInfoKHR commandBufferAt(long index, MemorySegment value) { VH_commandBuffer.set(this.segment(), 0L, index, value); return this; }
    public VkCommandBufferSubmitInfoKHR deviceMaskAt(long index, int value) { VH_deviceMask.set(this.segment(), 0L, index, value); return this; }
    public VkCommandBufferSubmitInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkCommandBufferSubmitInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkCommandBufferSubmitInfoKHR commandBuffer(MemorySegment value) { VH_commandBuffer.set(this.segment(), 0L, 0L, value); return this; }
    public VkCommandBufferSubmitInfoKHR deviceMask(int value) { VH_deviceMask.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkCommandBufferSubmitInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkCommandBufferSubmitInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkCommandBufferSubmitInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkCommandBufferSubmitInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkCommandBufferSubmitInfoKHR _commandBufferAt(long index, MemorySegment src) { _commandBufferAt(index).copyFrom(src); return this; }
    public VkCommandBufferSubmitInfoKHR _commandBuffer(MemorySegment src) { return _commandBufferAt(0L, src); }
    ...
    public VkCommandBufferSubmitInfoKHR _deviceMaskAt(long index, MemorySegment src) { _deviceMaskAt(index).copyFrom(src); return this; }
    public VkCommandBufferSubmitInfoKHR _deviceMask(MemorySegment src) { return _deviceMaskAt(0L, src); }
}
