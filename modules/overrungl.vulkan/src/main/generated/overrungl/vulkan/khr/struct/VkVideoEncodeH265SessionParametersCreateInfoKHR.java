...
public final class VkVideoEncodeH265SessionParametersCreateInfoKHR extends GroupType {
    ...
    public static VkVideoEncodeH265SessionParametersCreateInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoEncodeH265.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_KHR); }
    public static VkVideoEncodeH265SessionParametersCreateInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoEncodeH265.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_KHR);
        return s;
    }
    ...
    public VkVideoEncodeH265SessionParametersCreateInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR maxStdVPSCountAt(long index, int value) { VH_maxStdVPSCount.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR maxStdSPSCountAt(long index, int value) { VH_maxStdSPSCount.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR maxStdPPSCountAt(long index, int value) { VH_maxStdPPSCount.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR pParametersAddInfoAt(long index, MemorySegment value) { VH_pParametersAddInfo.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR maxStdVPSCount(int value) { VH_maxStdVPSCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR maxStdSPSCount(int value) { VH_maxStdSPSCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR maxStdPPSCount(int value) { VH_maxStdPPSCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR pParametersAddInfo(MemorySegment value) { VH_pParametersAddInfo.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _maxStdVPSCountAt(long index, MemorySegment src) { _maxStdVPSCountAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _maxStdVPSCount(MemorySegment src) { return _maxStdVPSCountAt(0L, src); }
    ...
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _maxStdSPSCountAt(long index, MemorySegment src) { _maxStdSPSCountAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _maxStdSPSCount(MemorySegment src) { return _maxStdSPSCountAt(0L, src); }
    ...
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _maxStdPPSCountAt(long index, MemorySegment src) { _maxStdPPSCountAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _maxStdPPSCount(MemorySegment src) { return _maxStdPPSCountAt(0L, src); }
    ...
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _pParametersAddInfoAt(long index, MemorySegment src) { _pParametersAddInfoAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionParametersCreateInfoKHR _pParametersAddInfo(MemorySegment src) { return _pParametersAddInfoAt(0L, src); }
}
