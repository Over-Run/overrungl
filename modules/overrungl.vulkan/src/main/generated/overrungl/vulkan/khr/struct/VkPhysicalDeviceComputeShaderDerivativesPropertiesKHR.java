...
public final class VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_meshAndTaskShaderDerivatives = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("meshAndTaskShaderDerivatives")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int meshAndTaskShaderDerivatives(MemorySegment segment, long index) { return (int) VH_meshAndTaskShaderDerivatives.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void meshAndTaskShaderDerivatives(MemorySegment segment, long index, int value) { VH_meshAndTaskShaderDerivatives.get().set(segment, 0L, index, value); }
