...
public final class VkVideoFormatAV1QuantizationMapPropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_compatibleSuperblockSizes = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("compatibleSuperblockSizes")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int compatibleSuperblockSizes(MemorySegment segment, long index) { return (int) VH_compatibleSuperblockSizes.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void compatibleSuperblockSizes(MemorySegment segment, long index, int value) { VH_compatibleSuperblockSizes.get().set(segment, 0L, index, value); }
