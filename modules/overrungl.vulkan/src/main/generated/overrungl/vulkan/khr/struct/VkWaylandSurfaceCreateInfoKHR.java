...
public final class VkWaylandSurfaceCreateInfoKHR extends GroupType {
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment display(MemorySegment segment, long index) { return (MemorySegment) VH_display.get().get(segment, 0L, index); }
    /// {@return `display`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void display(MemorySegment segment, long index, MemorySegment value) { VH_display.get().set(segment, 0L, index, value); }
