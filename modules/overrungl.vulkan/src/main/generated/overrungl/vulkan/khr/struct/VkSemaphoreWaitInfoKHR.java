...
/// Represents `VkSemaphoreWaitInfoKHR`.
/// ## Layout
/// ```
...
public final class VkSemaphoreWaitInfoKHR extends GroupType {
    ...
    public static VkSemaphoreWaitInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO); }
    public static VkSemaphoreWaitInfoKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkSemaphoreWaitInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkSemaphoreWaitInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkSemaphoreWaitInfoKHR flagsAt(long index, int value) { VH_flags.set(this.segment(), 0L, index, value); return this; }
    public VkSemaphoreWaitInfoKHR semaphoreCountAt(long index, int value) { VH_semaphoreCount.set(this.segment(), 0L, index, value); return this; }
    public VkSemaphoreWaitInfoKHR pSemaphoresAt(long index, MemorySegment value) { VH_pSemaphores.set(this.segment(), 0L, index, value); return this; }
    public VkSemaphoreWaitInfoKHR pValuesAt(long index, MemorySegment value) { VH_pValues.set(this.segment(), 0L, index, value); return this; }
    public VkSemaphoreWaitInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkSemaphoreWaitInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkSemaphoreWaitInfoKHR flags(int value) { VH_flags.set(this.segment(), 0L, 0L, value); return this; }
    public VkSemaphoreWaitInfoKHR semaphoreCount(int value) { VH_semaphoreCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkSemaphoreWaitInfoKHR pSemaphores(MemorySegment value) { VH_pSemaphores.set(this.segment(), 0L, 0L, value); return this; }
    public VkSemaphoreWaitInfoKHR pValues(MemorySegment value) { VH_pValues.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkSemaphoreWaitInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkSemaphoreWaitInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkSemaphoreWaitInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkSemaphoreWaitInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _flagsAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_flags, index), LAYOUT_flags); }
    public MemorySegment _flags() { return _flagsAt(0L); }
    public VkSemaphoreWaitInfoKHR _flagsAt(long index, MemorySegment src) { _flagsAt(index).copyFrom(src); return this; }
    public VkSemaphoreWaitInfoKHR _flags(MemorySegment src) { return _flagsAt(0L, src); }
    ...
    public VkSemaphoreWaitInfoKHR _semaphoreCountAt(long index, MemorySegment src) { _semaphoreCountAt(index).copyFrom(src); return this; }
    public VkSemaphoreWaitInfoKHR _semaphoreCount(MemorySegment src) { return _semaphoreCountAt(0L, src); }
    ...
    public VkSemaphoreWaitInfoKHR _pSemaphoresAt(long index, MemorySegment src) { _pSemaphoresAt(index).copyFrom(src); return this; }
    public VkSemaphoreWaitInfoKHR _pSemaphores(MemorySegment src) { return _pSemaphoresAt(0L, src); }
    ...
    public VkSemaphoreWaitInfoKHR _pValuesAt(long index, MemorySegment src) { _pValuesAt(index).copyFrom(src); return this; }
    public VkSemaphoreWaitInfoKHR _pValues(MemorySegment src) { return _pValuesAt(0L, src); }
}
