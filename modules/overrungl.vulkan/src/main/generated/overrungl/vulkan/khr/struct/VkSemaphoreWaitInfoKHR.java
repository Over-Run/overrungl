...
public final class VkSemaphoreWaitInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_semaphoreCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("semaphoreCount")));
    ...
    public static final Supplier<VarHandle> VH_pSemaphores = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pSemaphores")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int semaphoreCount(MemorySegment segment, long index) { return (int) VH_semaphoreCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void semaphoreCount(MemorySegment segment, long index, int value) { VH_semaphoreCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pSemaphores(MemorySegment segment, long index) { return (MemorySegment) VH_pSemaphores.get().get(segment, 0L, index); }
    /// {@return `pSemaphores`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pSemaphores(MemorySegment segment, long index, MemorySegment value) { VH_pSemaphores.get().set(segment, 0L, index, value); }
