...
public final class VkPhysicalDeviceShaderClockFeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderSubgroupClock = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderSubgroupClock")));
    ...
    public static final Supplier<VarHandle> VH_shaderDeviceClock = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderDeviceClock")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderSubgroupClock(MemorySegment segment, long index) { return (int) VH_shaderSubgroupClock.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderSubgroupClock(MemorySegment segment, long index, int value) { VH_shaderSubgroupClock.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderDeviceClock(MemorySegment segment, long index) { return (int) VH_shaderDeviceClock.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderDeviceClock(MemorySegment segment, long index, int value) { VH_shaderDeviceClock.get().set(segment, 0L, index, value); }
