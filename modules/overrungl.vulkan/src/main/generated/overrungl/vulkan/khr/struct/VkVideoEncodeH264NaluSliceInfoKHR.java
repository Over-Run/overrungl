...
public final class VkVideoEncodeH264NaluSliceInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pStdSliceHeader = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pStdSliceHeader")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pStdSliceHeader(MemorySegment segment, long index) { return (MemorySegment) VH_pStdSliceHeader.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pStdSliceHeader(MemorySegment segment, long index, MemorySegment value) { VH_pStdSliceHeader.get().set(segment, 0L, index, value); }
