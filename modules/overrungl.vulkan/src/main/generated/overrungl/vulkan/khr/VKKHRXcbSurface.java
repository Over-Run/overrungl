...
public final class VKKHRXcbSurface {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCreateXcbSurfaceKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceXcbPresentationSupportKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT)));
        private Handles() {}
    }
    ...
    public static int vkCreateXcbSurfaceKHR(@NonNull VkInstance instance, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pSurface) {
        ...
        return (int) Handles.MH_vkCreateXcbSurfaceKHR.get().invokeExact(instance.capabilities().PFN_vkCreateXcbSurfaceKHR, instance.segment(), pCreateInfo, pAllocator, pSurface); }
    ...
    public static int vkGetPhysicalDeviceXcbPresentationSupportKHR(@NonNull VkPhysicalDevice physicalDevice, int queueFamilyIndex, @NonNull MemorySegment connection, int visual_id) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceXcbPresentationSupportKHR.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceXcbPresentationSupportKHR, physicalDevice.segment(), queueFamilyIndex, connection, visual_id); }
