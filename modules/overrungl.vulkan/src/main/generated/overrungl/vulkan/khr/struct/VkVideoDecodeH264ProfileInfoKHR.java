...
public final class VkVideoDecodeH264ProfileInfoKHR extends GroupType {
    ...
    public static VkVideoDecodeH264ProfileInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoDecodeH264.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_PROFILE_INFO_KHR); }
    public static VkVideoDecodeH264ProfileInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoDecodeH264.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_PROFILE_INFO_KHR);
        return s;
    }
    ...
    public int pictureLayoutAt(long index) { return (int) VH_pictureLayout.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int stdProfileIdc() { return (int) VH_stdProfileIdc.get(this.segment(), 0L, 0L); }
    public int pictureLayout() { return (int) VH_pictureLayout.get(this.segment(), 0L, 0L); }
    public VkVideoDecodeH264ProfileInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH264ProfileInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH264ProfileInfoKHR stdProfileIdcAt(long index, int value) { VH_stdProfileIdc.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH264ProfileInfoKHR pictureLayoutAt(long index, int value) { VH_pictureLayout.set(this.segment(), 0L, index, value); return this; }
    public VkVideoDecodeH264ProfileInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeH264ProfileInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeH264ProfileInfoKHR stdProfileIdc(int value) { VH_stdProfileIdc.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoDecodeH264ProfileInfoKHR pictureLayout(int value) { VH_pictureLayout.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkVideoDecodeH264ProfileInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH264ProfileInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkVideoDecodeH264ProfileInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH264ProfileInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkVideoDecodeH264ProfileInfoKHR _stdProfileIdcAt(long index, MemorySegment src) { _stdProfileIdcAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH264ProfileInfoKHR _stdProfileIdc(MemorySegment src) { return _stdProfileIdcAt(0L, src); }
    public MemorySegment _pictureLayoutAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pictureLayout, index), LAYOUT_pictureLayout); }
    public MemorySegment _pictureLayout() { return _pictureLayoutAt(0L); }
    public VkVideoDecodeH264ProfileInfoKHR _pictureLayoutAt(long index, MemorySegment src) { _pictureLayoutAt(index).copyFrom(src); return this; }
    public VkVideoDecodeH264ProfileInfoKHR _pictureLayout(MemorySegment src) { return _pictureLayoutAt(0L, src); }
}
