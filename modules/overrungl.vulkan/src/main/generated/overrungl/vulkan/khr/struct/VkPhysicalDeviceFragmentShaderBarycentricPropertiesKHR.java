...
public final class VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_triStripVertexOrderIndependentOfProvokingVertex = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("triStripVertexOrderIndependentOfProvokingVertex")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int triStripVertexOrderIndependentOfProvokingVertex(MemorySegment segment, long index) { return (int) VH_triStripVertexOrderIndependentOfProvokingVertex.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void triStripVertexOrderIndependentOfProvokingVertex(MemorySegment segment, long index, int value) { VH_triStripVertexOrderIndependentOfProvokingVertex.get().set(segment, 0L, index, value); }
