...
/// Represents `VkVideoEncodeH265SessionCreateInfoKHR`.
/// ## Layout
/// ```
...
public final class VkVideoEncodeH265SessionCreateInfoKHR extends GroupType {
    ...
    public static VkVideoEncodeH265SessionCreateInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoEncodeH265.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_CREATE_INFO_KHR); }
    public static VkVideoEncodeH265SessionCreateInfoKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoEncodeH265.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_CREATE_INFO_KHR);
        return s;
    }
    ...
    public VkVideoEncodeH265SessionCreateInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR useMaxLevelIdcAt(long index, int value) { VH_useMaxLevelIdc.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR maxLevelIdcAt(long index, int value) { VH_maxLevelIdc.set(this.segment(), 0L, index, value); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR useMaxLevelIdc(int value) { VH_useMaxLevelIdc.set(this.segment(), 0L, 0L, value); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR maxLevelIdc(int value) { VH_maxLevelIdc.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkVideoEncodeH265SessionCreateInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkVideoEncodeH265SessionCreateInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkVideoEncodeH265SessionCreateInfoKHR _useMaxLevelIdcAt(long index, MemorySegment src) { _useMaxLevelIdcAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR _useMaxLevelIdc(MemorySegment src) { return _useMaxLevelIdcAt(0L, src); }
    ...
    public VkVideoEncodeH265SessionCreateInfoKHR _maxLevelIdcAt(long index, MemorySegment src) { _maxLevelIdcAt(index).copyFrom(src); return this; }
    public VkVideoEncodeH265SessionCreateInfoKHR _maxLevelIdc(MemorySegment src) { return _maxLevelIdcAt(0L, src); }
}
