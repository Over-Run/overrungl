...
public final class VkPhysicalDeviceMaintenance3PropertiesKHR extends GroupType {
    /// The struct layout of `VkPhysicalDeviceMaintenance3PropertiesKHR`.
    ...
    /// Creates `VkPhysicalDeviceMaintenance3PropertiesKHR` with the given segment.
    ...
    /// Allocates a `VkPhysicalDeviceMaintenance3PropertiesKHR` with the given segment allocator.
    ...
    /// Allocates a `VkPhysicalDeviceMaintenance3PropertiesKHR` with the given segment allocator and count.
    /// @param allocator the segment allocator
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance3PropertiesKHR sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance3PropertiesKHR pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance3PropertiesKHR maxPerSetDescriptors(int value) { maxPerSetDescriptors(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance3PropertiesKHR maxMemoryAllocationSize(long value) { maxMemoryAllocationSize(this.segment(), 0L, value); return this; }

    /// Creates a slice of `VkPhysicalDeviceMaintenance3PropertiesKHR`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkPhysicalDeviceMaintenance3PropertiesKHR`
    ...
    /// Visits `VkPhysicalDeviceMaintenance3PropertiesKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance3PropertiesKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance3PropertiesKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance3PropertiesKHR maxPerSetDescriptorsAt(long index, int value) { maxPerSetDescriptors(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMaintenance3PropertiesKHR maxMemoryAllocationSizeAt(long index, long value) { maxMemoryAllocationSize(this.segment(), index, value); return this; }
