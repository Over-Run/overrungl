...
public final class VkVideoEncodeInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_dstBuffer = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("dstBuffer")));
    ...
    public static final Supplier<VarHandle> VH_dstBufferOffset = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("dstBufferOffset")));
    ...
    public static final Supplier<VarHandle> VH_dstBufferRange = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("dstBufferRange")));
    ...
    public static final Supplier<VarHandle> VH_pSetupReferenceSlot = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pSetupReferenceSlot")));
    ...
    public static final Supplier<VarHandle> VH_referenceSlotCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("referenceSlotCount")));
    ...
    public static final Supplier<VarHandle> VH_pReferenceSlots = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pReferenceSlots")));
    ...
    public static final Supplier<VarHandle> VH_precedingExternallyEncodedBytes = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("precedingExternallyEncodedBytes")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long dstBuffer(MemorySegment segment, long index) { return (long) VH_dstBuffer.get().get(segment, 0L, index); }
    /// {@return `dstBuffer`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void dstBuffer(MemorySegment segment, long index, long value) { VH_dstBuffer.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long dstBufferOffset(MemorySegment segment, long index) { return (long) VH_dstBufferOffset.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void dstBufferOffset(MemorySegment segment, long index, long value) { VH_dstBufferOffset.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long dstBufferRange(MemorySegment segment, long index) { return (long) VH_dstBufferRange.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void dstBufferRange(MemorySegment segment, long index, long value) { VH_dstBufferRange.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pSetupReferenceSlot(MemorySegment segment, long index) { return (MemorySegment) VH_pSetupReferenceSlot.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pSetupReferenceSlot(MemorySegment segment, long index, MemorySegment value) { VH_pSetupReferenceSlot.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int referenceSlotCount(MemorySegment segment, long index) { return (int) VH_referenceSlotCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void referenceSlotCount(MemorySegment segment, long index, int value) { VH_referenceSlotCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pReferenceSlots(MemorySegment segment, long index) { return (MemorySegment) VH_pReferenceSlots.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pReferenceSlots(MemorySegment segment, long index, MemorySegment value) { VH_pReferenceSlots.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int precedingExternallyEncodedBytes(MemorySegment segment, long index) { return (int) VH_precedingExternallyEncodedBytes.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void precedingExternallyEncodedBytes(MemorySegment segment, long index, int value) { VH_precedingExternallyEncodedBytes.get().set(segment, 0L, index, value); }
