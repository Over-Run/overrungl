...
public final class VkPresentIdKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pPresentIds = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pPresentIds")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pPresentIds(MemorySegment segment, long index) { return (MemorySegment) VH_pPresentIds.get().get(segment, 0L, index); }
    /// {@return `pPresentIds`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pPresentIds(MemorySegment segment, long index, MemorySegment value) { VH_pPresentIds.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPresentIdKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPresentIdKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPresentIdKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPresentIdKHR swapchainCountAt(long index, int value) { swapchainCount(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPresentIdKHR pPresentIdsAt(long index, MemorySegment value) { pPresentIds(this.segment(), index, value); return this; }
