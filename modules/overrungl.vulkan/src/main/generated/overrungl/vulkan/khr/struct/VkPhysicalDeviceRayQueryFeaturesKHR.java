...
public final class VkPhysicalDeviceRayQueryFeaturesKHR extends GroupType {
    ...
    public static VkPhysicalDeviceRayQueryFeaturesKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRRayQuery.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR); }
    public static VkPhysicalDeviceRayQueryFeaturesKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRRayQuery.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR);
        return s;
    }
    ...
    public int rayQueryAt(long index) { return (int) VH_rayQuery.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int rayQuery() { return (int) VH_rayQuery.get(this.segment(), 0L, 0L); }
    public VkPhysicalDeviceRayQueryFeaturesKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceRayQueryFeaturesKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceRayQueryFeaturesKHR rayQueryAt(long index, int value) { VH_rayQuery.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceRayQueryFeaturesKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceRayQueryFeaturesKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceRayQueryFeaturesKHR rayQuery(int value) { VH_rayQuery.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceRayQueryFeaturesKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceRayQueryFeaturesKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceRayQueryFeaturesKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceRayQueryFeaturesKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _rayQueryAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_rayQuery, index), LAYOUT_rayQuery); }
    public MemorySegment _rayQuery() { return _rayQueryAt(0L); }
    public VkPhysicalDeviceRayQueryFeaturesKHR _rayQueryAt(long index, MemorySegment src) { _rayQueryAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceRayQueryFeaturesKHR _rayQuery(MemorySegment src) { return _rayQueryAt(0L, src); }
}
