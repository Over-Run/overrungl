...
public final class VkVideoBeginCodingInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_videoSession = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("videoSession")));
    ...
    public static final Supplier<VarHandle> VH_videoSessionParameters = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("videoSessionParameters")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long videoSession(MemorySegment segment, long index) { return (long) VH_videoSession.get().get(segment, 0L, index); }
    /// {@return `videoSession`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void videoSession(MemorySegment segment, long index, long value) { VH_videoSession.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long videoSessionParameters(MemorySegment segment, long index) { return (long) VH_videoSessionParameters.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void videoSessionParameters(MemorySegment segment, long index, long value) { VH_videoSessionParameters.get().set(segment, 0L, index, value); }
