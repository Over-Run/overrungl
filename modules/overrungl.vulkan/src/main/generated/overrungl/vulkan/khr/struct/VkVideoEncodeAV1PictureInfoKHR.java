...
public final class VkVideoEncodeAV1PictureInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_predictionMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("predictionMode")));
    ...
    public static final Supplier<VarHandle> VH_rateControlGroup = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("rateControlGroup")));
    ...
    public static final Supplier<VarHandle> VH_constantQIndex = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("constantQIndex")));
    ...
    public static final Supplier<VarHandle> VH_referenceNameSlotIndices = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("referenceNameSlotIndices"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_primaryReferenceCdfOnly = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("primaryReferenceCdfOnly")));
    ...
    public static final Supplier<VarHandle> VH_generateObuExtensionHeader = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("generateObuExtensionHeader")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int predictionMode(MemorySegment segment, long index) { return (int) VH_predictionMode.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void predictionMode(MemorySegment segment, long index, int value) { VH_predictionMode.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int rateControlGroup(MemorySegment segment, long index) { return (int) VH_rateControlGroup.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void rateControlGroup(MemorySegment segment, long index, int value) { VH_rateControlGroup.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int constantQIndex(MemorySegment segment, long index) { return (int) VH_constantQIndex.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void constantQIndex(MemorySegment segment, long index, int value) { VH_constantQIndex.get().set(segment, 0L, index, value); }
    ...
    public static int referenceNameSlotIndices(MemorySegment segment, long index, long index0) { return (int) VH_referenceNameSlotIndices.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void referenceNameSlotIndices(MemorySegment segment, long index, long index0, int value) { VH_referenceNameSlotIndices.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int primaryReferenceCdfOnly(MemorySegment segment, long index) { return (int) VH_primaryReferenceCdfOnly.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void primaryReferenceCdfOnly(MemorySegment segment, long index, int value) { VH_primaryReferenceCdfOnly.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int generateObuExtensionHeader(MemorySegment segment, long index) { return (int) VH_generateObuExtensionHeader.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void generateObuExtensionHeader(MemorySegment segment, long index, int value) { VH_generateObuExtensionHeader.get().set(segment, 0L, index, value); }
