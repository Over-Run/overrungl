...
public final class VkVideoEncodeH265RateControlInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_subLayerCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("subLayerCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int subLayerCount(MemorySegment segment, long index) { return (int) VH_subLayerCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void subLayerCount(MemorySegment segment, long index, int value) { VH_subLayerCount.get().set(segment, 0L, index, value); }
