...
/// Represents `VkAttachmentReference2KHR`.
/// ## Layout
/// ```
...
public final class VkAttachmentReference2KHR extends GroupType {
    ...
    public static VkAttachmentReference2KHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2); }
    public static VkAttachmentReference2KHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkAttachmentReference2KHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkAttachmentReference2KHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkAttachmentReference2KHR attachmentAt(long index, int value) { VH_attachment.set(this.segment(), 0L, index, value); return this; }
    public VkAttachmentReference2KHR layoutAt(long index, int value) { VH_layout.set(this.segment(), 0L, index, value); return this; }
    public VkAttachmentReference2KHR aspectMaskAt(long index, int value) { VH_aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkAttachmentReference2KHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkAttachmentReference2KHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkAttachmentReference2KHR attachment(int value) { VH_attachment.set(this.segment(), 0L, 0L, value); return this; }
    public VkAttachmentReference2KHR layout(int value) { VH_layout.set(this.segment(), 0L, 0L, value); return this; }
    public VkAttachmentReference2KHR aspectMask(int value) { VH_aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkAttachmentReference2KHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkAttachmentReference2KHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkAttachmentReference2KHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkAttachmentReference2KHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkAttachmentReference2KHR _attachmentAt(long index, MemorySegment src) { _attachmentAt(index).copyFrom(src); return this; }
    public VkAttachmentReference2KHR _attachment(MemorySegment src) { return _attachmentAt(0L, src); }
    ...
    public VkAttachmentReference2KHR _layoutAt(long index, MemorySegment src) { _layoutAt(index).copyFrom(src); return this; }
    public VkAttachmentReference2KHR _layout(MemorySegment src) { return _layoutAt(0L, src); }
    ...
    public VkAttachmentReference2KHR _aspectMaskAt(long index, MemorySegment src) { _aspectMaskAt(index).copyFrom(src); return this; }
    public VkAttachmentReference2KHR _aspectMask(MemorySegment src) { return _aspectMaskAt(0L, src); }
}
