...
public final class VkMemoryDedicatedRequirementsKHR extends GroupType {
    ...
    public static VkMemoryDedicatedRequirementsKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_MEMORY_DEDICATED_REQUIREMENTS); }
    public static VkMemoryDedicatedRequirementsKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkMemoryDedicatedRequirementsKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkMemoryDedicatedRequirementsKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkMemoryDedicatedRequirementsKHR prefersDedicatedAllocationAt(long index, int value) { VH_prefersDedicatedAllocation.set(this.segment(), 0L, index, value); return this; }
    public VkMemoryDedicatedRequirementsKHR requiresDedicatedAllocationAt(long index, int value) { VH_requiresDedicatedAllocation.set(this.segment(), 0L, index, value); return this; }
    public VkMemoryDedicatedRequirementsKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkMemoryDedicatedRequirementsKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkMemoryDedicatedRequirementsKHR prefersDedicatedAllocation(int value) { VH_prefersDedicatedAllocation.set(this.segment(), 0L, 0L, value); return this; }
    public VkMemoryDedicatedRequirementsKHR requiresDedicatedAllocation(int value) { VH_requiresDedicatedAllocation.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkMemoryDedicatedRequirementsKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkMemoryDedicatedRequirementsKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkMemoryDedicatedRequirementsKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkMemoryDedicatedRequirementsKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkMemoryDedicatedRequirementsKHR _prefersDedicatedAllocationAt(long index, MemorySegment src) { _prefersDedicatedAllocationAt(index).copyFrom(src); return this; }
    public VkMemoryDedicatedRequirementsKHR _prefersDedicatedAllocation(MemorySegment src) { return _prefersDedicatedAllocationAt(0L, src); }
    ...
    public VkMemoryDedicatedRequirementsKHR _requiresDedicatedAllocationAt(long index, MemorySegment src) { _requiresDedicatedAllocationAt(index).copyFrom(src); return this; }
    public VkMemoryDedicatedRequirementsKHR _requiresDedicatedAllocation(MemorySegment src) { return _requiresDedicatedAllocationAt(0L, src); }
}
