...
public final class VkVideoEncodeSessionParametersFeedbackInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_hasOverrides = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("hasOverrides")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int hasOverrides(MemorySegment segment, long index) { return (int) VH_hasOverrides.get().get(segment, 0L, index); }
    /// {@return `hasOverrides`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void hasOverrides(MemorySegment segment, long index, int value) { VH_hasOverrides.get().set(segment, 0L, index, value); }
