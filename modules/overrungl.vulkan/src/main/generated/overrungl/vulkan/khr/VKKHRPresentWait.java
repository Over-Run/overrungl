...
public final class VKKHRPresentWait {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkWaitForPresentKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG)));
        private Handles() {}
    }
    ...
    public static int vkWaitForPresentKHR(@NonNull VkDevice device, long swapchain, long presentId, long timeout) {
        ...
        return (int) Handles.MH_vkWaitForPresentKHR.get().invokeExact(device.capabilities().PFN_vkWaitForPresentKHR, device.segment(), swapchain, presentId, timeout); }
