...
public final class VkDeviceMemoryOpaqueCaptureAddressInfoKHR extends GroupType {
    ...
    public static VkDeviceMemoryOpaqueCaptureAddressInfoKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO); }
    public static VkDeviceMemoryOpaqueCaptureAddressInfoKHR allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR memoryAt(long index, long value) { VH_memory.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR memory(long value) { VH_memory.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR _memoryAt(long index, MemorySegment src) { _memoryAt(index).copyFrom(src); return this; }
    public VkDeviceMemoryOpaqueCaptureAddressInfoKHR _memory(MemorySegment src) { return _memoryAt(0L, src); }
}
