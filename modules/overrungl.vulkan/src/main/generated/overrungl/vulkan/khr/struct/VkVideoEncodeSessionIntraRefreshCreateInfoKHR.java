...
public final class VkVideoEncodeSessionIntraRefreshCreateInfoKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_intraRefreshMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("intraRefreshMode")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int intraRefreshMode(MemorySegment segment, long index) { return (int) VH_intraRefreshMode.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void intraRefreshMode(MemorySegment segment, long index, int value) { VH_intraRefreshMode.get().set(segment, 0L, index, value); }
