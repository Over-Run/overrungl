...
/// Represents `VkPhysicalDeviceVideoMaintenance1FeaturesKHR`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceVideoMaintenance1FeaturesKHR extends GroupType {
    ...
    public static VkPhysicalDeviceVideoMaintenance1FeaturesKHR allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRVideoMaintenance1.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_1_FEATURES_KHR); }
    public static VkPhysicalDeviceVideoMaintenance1FeaturesKHR allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.khr.VKKHRVideoMaintenance1.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_1_FEATURES_KHR);
        return s;
    }
    ...
    public int videoMaintenance1At(long index) { return (int) VH_videoMaintenance1.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int videoMaintenance1() { return (int) VH_videoMaintenance1.get(this.segment(), 0L, 0L); }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR videoMaintenance1At(long index, int value) { VH_videoMaintenance1.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR videoMaintenance1(int value) { VH_videoMaintenance1.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _videoMaintenance1At(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_videoMaintenance1, index), LAYOUT_videoMaintenance1); }
    public MemorySegment _videoMaintenance1() { return _videoMaintenance1At(0L); }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR _videoMaintenance1At(long index, MemorySegment src) { _videoMaintenance1At(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVideoMaintenance1FeaturesKHR _videoMaintenance1(MemorySegment src) { return _videoMaintenance1At(0L, src); }
}
