...
public final class VkPhysicalDeviceVideoMaintenance1FeaturesKHR extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_videoMaintenance1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("videoMaintenance1")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int videoMaintenance1(MemorySegment segment, long index) { return (int) VH_videoMaintenance1.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void videoMaintenance1(MemorySegment segment, long index, int value) { VH_videoMaintenance1.get().set(segment, 0L, index, value); }
