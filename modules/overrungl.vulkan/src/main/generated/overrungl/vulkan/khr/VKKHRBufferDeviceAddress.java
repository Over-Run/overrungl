...
public final class VKKHRBufferDeviceAddress {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetBufferDeviceAddressKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetBufferOpaqueCaptureAddressKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetDeviceMemoryOpaqueCaptureAddressKHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static long vkGetBufferDeviceAddressKHR(@NonNull VkDevice device, @NonNull MemorySegment pInfo) {
        ...
        return (long) Handles.MH_vkGetBufferDeviceAddressKHR.get().invokeExact(device.capabilities().PFN_vkGetBufferDeviceAddressKHR, device.segment(), pInfo); }
    ...
    public static long vkGetBufferOpaqueCaptureAddressKHR(@NonNull VkDevice device, @NonNull MemorySegment pInfo) {
        ...
        return (long) Handles.MH_vkGetBufferOpaqueCaptureAddressKHR.get().invokeExact(device.capabilities().PFN_vkGetBufferOpaqueCaptureAddressKHR, device.segment(), pInfo); }
    ...
    public static long vkGetDeviceMemoryOpaqueCaptureAddressKHR(@NonNull VkDevice device, @NonNull MemorySegment pInfo) {
        ...
        return (long) Handles.MH_vkGetDeviceMemoryOpaqueCaptureAddressKHR.get().invokeExact(device.capabilities().PFN_vkGetDeviceMemoryOpaqueCaptureAddressKHR, device.segment(), pInfo); }
