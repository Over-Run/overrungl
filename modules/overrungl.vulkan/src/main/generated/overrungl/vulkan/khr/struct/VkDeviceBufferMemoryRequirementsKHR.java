...
public final class VkDeviceBufferMemoryRequirementsKHR extends GroupType {
    /// The struct layout of `VkDeviceBufferMemoryRequirementsKHR`.
    ...
    /// Creates `VkDeviceBufferMemoryRequirementsKHR` with the given segment.
    ...
    /// Allocates a `VkDeviceBufferMemoryRequirementsKHR` with the given segment allocator.
    ...
    /// Allocates a `VkDeviceBufferMemoryRequirementsKHR` with the given segment allocator and count.
    /// @param allocator the segment allocator
    ...
    /// @param value the value
    /// @return `this`
    public VkDeviceBufferMemoryRequirementsKHR sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDeviceBufferMemoryRequirementsKHR pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDeviceBufferMemoryRequirementsKHR pCreateInfo(MemorySegment value) { pCreateInfo(this.segment(), 0L, value); return this; }

    /// Creates a slice of `VkDeviceBufferMemoryRequirementsKHR`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkDeviceBufferMemoryRequirementsKHR`
    ...
    /// Visits `VkDeviceBufferMemoryRequirementsKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkDeviceBufferMemoryRequirementsKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDeviceBufferMemoryRequirementsKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDeviceBufferMemoryRequirementsKHR pCreateInfoAt(long index, MemorySegment value) { pCreateInfo(this.segment(), index, value); return this; }
