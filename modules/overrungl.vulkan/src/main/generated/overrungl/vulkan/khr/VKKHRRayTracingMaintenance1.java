...
public final class VKKHRRayTracingMaintenance1 {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCmdTraceRaysIndirect2KHR = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG)));
        private Handles() {}
    }
    ...
    public static void vkCmdTraceRaysIndirect2KHR(@NonNull VkCommandBuffer commandBuffer, long indirectDeviceAddress) {
        ...
        Handles.MH_vkCmdTraceRaysIndirect2KHR.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdTraceRaysIndirect2KHR, commandBuffer.segment(), indirectDeviceAddress); }
