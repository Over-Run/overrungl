...
public final class VkExternalBufferPropertiesKHR extends GroupType {
    /// The struct layout of `VkExternalBufferPropertiesKHR`.
    ...
    /// Creates `VkExternalBufferPropertiesKHR` with the given segment.
    ...
    /// Allocates a `VkExternalBufferPropertiesKHR` with the given segment allocator.
    ...
    /// Allocates a `VkExternalBufferPropertiesKHR` with the given segment allocator and count.
    /// @param allocator the segment allocator
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalBufferPropertiesKHR sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalBufferPropertiesKHR pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalBufferPropertiesKHR externalMemoryProperties(MemorySegment value) { externalMemoryProperties(this.segment(), 0L, value); return this; }
    /// Accepts `externalMemoryProperties` with the given function.
    /// @param func the function
    /// @return `this`
    public VkExternalBufferPropertiesKHR externalMemoryProperties(Consumer<overrungl.vulkan.struct.VkExternalMemoryProperties> func) { func.accept(overrungl.vulkan.struct.VkExternalMemoryProperties.of(externalMemoryProperties())); return this; }

    /// Creates a slice of `VkExternalBufferPropertiesKHR`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkExternalBufferPropertiesKHR`
    ...
    /// Visits `VkExternalBufferPropertiesKHR` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalBufferPropertiesKHR sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalBufferPropertiesKHR pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalBufferPropertiesKHR externalMemoryPropertiesAt(long index, MemorySegment value) { externalMemoryProperties(this.segment(), index, value); return this; }
    /// Accepts `externalMemoryProperties` with the given function.
    /// @param index the index of the struct buffer
    /// @param func the function
    /// @return `this`
    public VkExternalBufferPropertiesKHR externalMemoryPropertiesAt(long index, Consumer<overrungl.vulkan.struct.VkExternalMemoryProperties> func) { func.accept(overrungl.vulkan.struct.VkExternalMemoryProperties.of(externalMemoryPropertiesAt(index))); return this; }
