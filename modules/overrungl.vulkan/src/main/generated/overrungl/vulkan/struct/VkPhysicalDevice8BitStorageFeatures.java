...
public final class VkPhysicalDevice8BitStorageFeatures extends GroupType {
    ...
    public static VkPhysicalDevice8BitStorageFeatures allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES); }
    public static VkPhysicalDevice8BitStorageFeatures allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDevice8BitStorageFeatures sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures storageBuffer8BitAccessAt(long index, int value) { VH_storageBuffer8BitAccess.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures uniformAndStorageBuffer8BitAccessAt(long index, int value) { VH_uniformAndStorageBuffer8BitAccess.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures storagePushConstant8At(long index, int value) { VH_storagePushConstant8.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures storageBuffer8BitAccess(int value) { VH_storageBuffer8BitAccess.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures uniformAndStorageBuffer8BitAccess(int value) { VH_uniformAndStorageBuffer8BitAccess.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDevice8BitStorageFeatures storagePushConstant8(int value) { VH_storagePushConstant8.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDevice8BitStorageFeatures _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDevice8BitStorageFeatures _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDevice8BitStorageFeatures _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDevice8BitStorageFeatures _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDevice8BitStorageFeatures _storageBuffer8BitAccessAt(long index, MemorySegment src) { _storageBuffer8BitAccessAt(index).copyFrom(src); return this; }
    public VkPhysicalDevice8BitStorageFeatures _storageBuffer8BitAccess(MemorySegment src) { return _storageBuffer8BitAccessAt(0L, src); }
    ...
    public VkPhysicalDevice8BitStorageFeatures _uniformAndStorageBuffer8BitAccessAt(long index, MemorySegment src) { _uniformAndStorageBuffer8BitAccessAt(index).copyFrom(src); return this; }
    public VkPhysicalDevice8BitStorageFeatures _uniformAndStorageBuffer8BitAccess(MemorySegment src) { return _uniformAndStorageBuffer8BitAccessAt(0L, src); }
    ...
    public VkPhysicalDevice8BitStorageFeatures _storagePushConstant8At(long index, MemorySegment src) { _storagePushConstant8At(index).copyFrom(src); return this; }
    public VkPhysicalDevice8BitStorageFeatures _storagePushConstant8(MemorySegment src) { return _storagePushConstant8At(0L, src); }
}
