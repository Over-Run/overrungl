...
public final class VkFramebufferAttachmentsCreateInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_attachmentImageInfoCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("attachmentImageInfoCount")));
    ...
    public static final Supplier<VarHandle> VH_pAttachmentImageInfos = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pAttachmentImageInfos")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int attachmentImageInfoCount(MemorySegment segment, long index) { return (int) VH_attachmentImageInfoCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void attachmentImageInfoCount(MemorySegment segment, long index, int value) { VH_attachmentImageInfoCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pAttachmentImageInfos(MemorySegment segment, long index) { return (MemorySegment) VH_pAttachmentImageInfos.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pAttachmentImageInfos(MemorySegment segment, long index, MemorySegment value) { VH_pAttachmentImageInfos.get().set(segment, 0L, index, value); }
