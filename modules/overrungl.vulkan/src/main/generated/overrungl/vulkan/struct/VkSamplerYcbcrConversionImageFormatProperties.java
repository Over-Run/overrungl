...
public final class VkSamplerYcbcrConversionImageFormatProperties extends GroupType {
    ...
    public static VkSamplerYcbcrConversionImageFormatProperties allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES); }
    public static VkSamplerYcbcrConversionImageFormatProperties allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkSamplerYcbcrConversionImageFormatProperties sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkSamplerYcbcrConversionImageFormatProperties pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkSamplerYcbcrConversionImageFormatProperties combinedImageSamplerDescriptorCountAt(long index, int value) { VH_combinedImageSamplerDescriptorCount.set(this.segment(), 0L, index, value); return this; }
    public VkSamplerYcbcrConversionImageFormatProperties sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkSamplerYcbcrConversionImageFormatProperties pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkSamplerYcbcrConversionImageFormatProperties combinedImageSamplerDescriptorCount(int value) { VH_combinedImageSamplerDescriptorCount.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkSamplerYcbcrConversionImageFormatProperties _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkSamplerYcbcrConversionImageFormatProperties _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkSamplerYcbcrConversionImageFormatProperties _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkSamplerYcbcrConversionImageFormatProperties _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkSamplerYcbcrConversionImageFormatProperties _combinedImageSamplerDescriptorCountAt(long index, MemorySegment src) { _combinedImageSamplerDescriptorCountAt(index).copyFrom(src); return this; }
    public VkSamplerYcbcrConversionImageFormatProperties _combinedImageSamplerDescriptorCount(MemorySegment src) { return _combinedImageSamplerDescriptorCountAt(0L, src); }
}
