...
public final class VkProtectedSubmitInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_protectedSubmit = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("protectedSubmit")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int protectedSubmit(MemorySegment segment, long index) { return (int) VH_protectedSubmit.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void protectedSubmit(MemorySegment segment, long index, int value) { VH_protectedSubmit.get().set(segment, 0L, index, value); }
