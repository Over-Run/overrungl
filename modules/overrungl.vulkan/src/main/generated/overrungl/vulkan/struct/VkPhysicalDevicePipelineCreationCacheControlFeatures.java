...
public final class VkPhysicalDevicePipelineCreationCacheControlFeatures extends GroupType {
    ...
    public static VkPhysicalDevicePipelineCreationCacheControlFeatures allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES); }
    public static VkPhysicalDevicePipelineCreationCacheControlFeatures allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDevicePipelineCreationCacheControlFeatures sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures pipelineCreationCacheControlAt(long index, int value) { VH_pipelineCreationCacheControl.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures pipelineCreationCacheControl(int value) { VH_pipelineCreationCacheControl.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDevicePipelineCreationCacheControlFeatures _pipelineCreationCacheControlAt(long index, MemorySegment src) { _pipelineCreationCacheControlAt(index).copyFrom(src); return this; }
    public VkPhysicalDevicePipelineCreationCacheControlFeatures _pipelineCreationCacheControl(MemorySegment src) { return _pipelineCreationCacheControlAt(0L, src); }
}
