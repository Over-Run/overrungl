...
public final class VkApplicationInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pApplicationName = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pApplicationName")));
    ...
    public static final Supplier<VarHandle> VH_pEngineName = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pEngineName")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pApplicationName(MemorySegment segment, long index) { return (MemorySegment) VH_pApplicationName.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pApplicationName(MemorySegment segment, long index, MemorySegment value) { VH_pApplicationName.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pEngineName(MemorySegment segment, long index) { return (MemorySegment) VH_pEngineName.get().get(segment, 0L, index); }
    /// {@return `pEngineName`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pEngineName(MemorySegment segment, long index, MemorySegment value) { VH_pEngineName.get().set(segment, 0L, index, value); }
