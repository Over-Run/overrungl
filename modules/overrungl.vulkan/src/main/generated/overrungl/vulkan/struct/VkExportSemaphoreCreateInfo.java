...
/// Represents `VkExportSemaphoreCreateInfo`.
/// ## Layout
/// ```
...
public final class VkExportSemaphoreCreateInfo extends GroupType {
    ...
    public static VkExportSemaphoreCreateInfo allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO); }
    public static VkExportSemaphoreCreateInfo allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkExportSemaphoreCreateInfo sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkExportSemaphoreCreateInfo pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkExportSemaphoreCreateInfo handleTypesAt(long index, int value) { VH_handleTypes.set(this.segment(), 0L, index, value); return this; }
    public VkExportSemaphoreCreateInfo sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkExportSemaphoreCreateInfo pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkExportSemaphoreCreateInfo handleTypes(int value) { VH_handleTypes.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkExportSemaphoreCreateInfo _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkExportSemaphoreCreateInfo _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkExportSemaphoreCreateInfo _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkExportSemaphoreCreateInfo _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkExportSemaphoreCreateInfo _handleTypesAt(long index, MemorySegment src) { _handleTypesAt(index).copyFrom(src); return this; }
    public VkExportSemaphoreCreateInfo _handleTypes(MemorySegment src) { return _handleTypesAt(0L, src); }
}
