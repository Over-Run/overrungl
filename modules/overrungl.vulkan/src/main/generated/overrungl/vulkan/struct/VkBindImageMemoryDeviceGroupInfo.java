...
public final class VkBindImageMemoryDeviceGroupInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_deviceIndexCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("deviceIndexCount")));
    ...
    public static final Supplier<VarHandle> VH_pDeviceIndices = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pDeviceIndices")));
    ...
    public static final Supplier<VarHandle> VH_splitInstanceBindRegionCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("splitInstanceBindRegionCount")));
    ...
    public static final Supplier<VarHandle> VH_pSplitInstanceBindRegions = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pSplitInstanceBindRegions")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int deviceIndexCount(MemorySegment segment, long index) { return (int) VH_deviceIndexCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void deviceIndexCount(MemorySegment segment, long index, int value) { VH_deviceIndexCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pDeviceIndices(MemorySegment segment, long index) { return (MemorySegment) VH_pDeviceIndices.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pDeviceIndices(MemorySegment segment, long index, MemorySegment value) { VH_pDeviceIndices.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int splitInstanceBindRegionCount(MemorySegment segment, long index) { return (int) VH_splitInstanceBindRegionCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void splitInstanceBindRegionCount(MemorySegment segment, long index, int value) { VH_splitInstanceBindRegionCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pSplitInstanceBindRegions(MemorySegment segment, long index) { return (MemorySegment) VH_pSplitInstanceBindRegions.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pSplitInstanceBindRegions(MemorySegment segment, long index, MemorySegment value) { VH_pSplitInstanceBindRegions.get().set(segment, 0L, index, value); }
