...
public final class VkPhysicalDeviceVertexAttributeDivisorProperties extends GroupType {
    ...
    public static VkPhysicalDeviceVertexAttributeDivisorProperties allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES); }
    public static VkPhysicalDeviceVertexAttributeDivisorProperties allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceVertexAttributeDivisorProperties sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties maxVertexAttribDivisorAt(long index, int value) { VH_maxVertexAttribDivisor.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties supportsNonZeroFirstInstanceAt(long index, int value) { VH_supportsNonZeroFirstInstance.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties maxVertexAttribDivisor(int value) { VH_maxVertexAttribDivisor.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties supportsNonZeroFirstInstance(int value) { VH_supportsNonZeroFirstInstance.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceVertexAttributeDivisorProperties _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceVertexAttributeDivisorProperties _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceVertexAttributeDivisorProperties _maxVertexAttribDivisorAt(long index, MemorySegment src) { _maxVertexAttribDivisorAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties _maxVertexAttribDivisor(MemorySegment src) { return _maxVertexAttribDivisorAt(0L, src); }
    ...
    public VkPhysicalDeviceVertexAttributeDivisorProperties _supportsNonZeroFirstInstanceAt(long index, MemorySegment src) { _supportsNonZeroFirstInstanceAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceVertexAttributeDivisorProperties _supportsNonZeroFirstInstance(MemorySegment src) { return _supportsNonZeroFirstInstanceAt(0L, src); }
}
