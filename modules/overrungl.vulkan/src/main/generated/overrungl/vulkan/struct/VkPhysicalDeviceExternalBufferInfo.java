...
/// Represents `VkPhysicalDeviceExternalBufferInfo`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceExternalBufferInfo extends GroupType {
    ...
    public static VkPhysicalDeviceExternalBufferInfo allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO); }
    public static VkPhysicalDeviceExternalBufferInfo allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceExternalBufferInfo sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo flagsAt(long index, int value) { VH_flags.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo usageAt(long index, int value) { VH_usage.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo handleTypeAt(long index, int value) { VH_handleType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo flags(int value) { VH_flags.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo usage(int value) { VH_usage.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceExternalBufferInfo handleType(int value) { VH_handleType.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceExternalBufferInfo _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceExternalBufferInfo _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceExternalBufferInfo _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceExternalBufferInfo _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _flagsAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_flags, index), LAYOUT_flags); }
    public MemorySegment _flags() { return _flagsAt(0L); }
    public VkPhysicalDeviceExternalBufferInfo _flagsAt(long index, MemorySegment src) { _flagsAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceExternalBufferInfo _flags(MemorySegment src) { return _flagsAt(0L, src); }
    ...
    public VkPhysicalDeviceExternalBufferInfo _usageAt(long index, MemorySegment src) { _usageAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceExternalBufferInfo _usage(MemorySegment src) { return _usageAt(0L, src); }
    ...
    public VkPhysicalDeviceExternalBufferInfo _handleTypeAt(long index, MemorySegment src) { _handleTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceExternalBufferInfo _handleType(MemorySegment src) { return _handleTypeAt(0L, src); }
}
