...
public final class VkBlitImageInfo2 extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_filter = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("filter")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int filter(MemorySegment segment, long index) { return (int) VH_filter.get().get(segment, 0L, index); }
    /// {@return `filter`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void filter(MemorySegment segment, long index, int value) { VH_filter.get().set(segment, 0L, index, value); }
