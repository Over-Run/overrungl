...
public final class VkDescriptorSetLayoutCreateInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pBindings = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pBindings")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pBindings(MemorySegment segment, long index) { return (MemorySegment) VH_pBindings.get().get(segment, 0L, index); }
    /// {@return `pBindings`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pBindings(MemorySegment segment, long index, MemorySegment value) { VH_pBindings.get().set(segment, 0L, index, value); }
