...
public final class VkPipelineTessellationStateCreateInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_patchControlPoints = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("patchControlPoints")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int patchControlPoints(MemorySegment segment, long index) { return (int) VH_patchControlPoints.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void patchControlPoints(MemorySegment segment, long index, int value) { VH_patchControlPoints.get().set(segment, 0L, index, value); }
