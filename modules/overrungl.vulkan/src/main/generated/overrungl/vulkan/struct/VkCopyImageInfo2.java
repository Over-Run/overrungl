...
public final class VkCopyImageInfo2 extends GroupType {
    ...
    public static VkCopyImageInfo2 allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_COPY_IMAGE_INFO_2); }
    public static VkCopyImageInfo2 allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkCopyImageInfo2 sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkCopyImageInfo2 pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkCopyImageInfo2 srcImageAt(long index, long value) { VH_srcImage.set(this.segment(), 0L, index, value); return this; }
    public VkCopyImageInfo2 srcImageLayoutAt(long index, int value) { VH_srcImageLayout.set(this.segment(), 0L, index, value); return this; }
    public VkCopyImageInfo2 dstImageAt(long index, long value) { VH_dstImage.set(this.segment(), 0L, index, value); return this; }
    public VkCopyImageInfo2 dstImageLayoutAt(long index, int value) { VH_dstImageLayout.set(this.segment(), 0L, index, value); return this; }
    public VkCopyImageInfo2 regionCountAt(long index, int value) { VH_regionCount.set(this.segment(), 0L, index, value); return this; }
    public VkCopyImageInfo2 pRegionsAt(long index, MemorySegment value) { VH_pRegions.set(this.segment(), 0L, index, value); return this; }
    public VkCopyImageInfo2 sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyImageInfo2 pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyImageInfo2 srcImage(long value) { VH_srcImage.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyImageInfo2 srcImageLayout(int value) { VH_srcImageLayout.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyImageInfo2 dstImage(long value) { VH_dstImage.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyImageInfo2 dstImageLayout(int value) { VH_dstImageLayout.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyImageInfo2 regionCount(int value) { VH_regionCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkCopyImageInfo2 pRegions(MemorySegment value) { VH_pRegions.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkCopyImageInfo2 _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkCopyImageInfo2 _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkCopyImageInfo2 _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkCopyImageInfo2 _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkCopyImageInfo2 _srcImageAt(long index, MemorySegment src) { _srcImageAt(index).copyFrom(src); return this; }
    public VkCopyImageInfo2 _srcImage(MemorySegment src) { return _srcImageAt(0L, src); }
    ...
    public VkCopyImageInfo2 _srcImageLayoutAt(long index, MemorySegment src) { _srcImageLayoutAt(index).copyFrom(src); return this; }
    public VkCopyImageInfo2 _srcImageLayout(MemorySegment src) { return _srcImageLayoutAt(0L, src); }
    ...
    public VkCopyImageInfo2 _dstImageAt(long index, MemorySegment src) { _dstImageAt(index).copyFrom(src); return this; }
    public VkCopyImageInfo2 _dstImage(MemorySegment src) { return _dstImageAt(0L, src); }
    ...
    public VkCopyImageInfo2 _dstImageLayoutAt(long index, MemorySegment src) { _dstImageLayoutAt(index).copyFrom(src); return this; }
    public VkCopyImageInfo2 _dstImageLayout(MemorySegment src) { return _dstImageLayoutAt(0L, src); }
    ...
    public VkCopyImageInfo2 _regionCountAt(long index, MemorySegment src) { _regionCountAt(index).copyFrom(src); return this; }
    public VkCopyImageInfo2 _regionCount(MemorySegment src) { return _regionCountAt(0L, src); }
    ...
    public VkCopyImageInfo2 _pRegionsAt(long index, MemorySegment src) { _pRegionsAt(index).copyFrom(src); return this; }
    public VkCopyImageInfo2 _pRegions(MemorySegment src) { return _pRegionsAt(0L, src); }
}
