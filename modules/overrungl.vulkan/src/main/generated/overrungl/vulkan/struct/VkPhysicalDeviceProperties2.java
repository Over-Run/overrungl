...
public final class VkPhysicalDeviceProperties2 extends GroupType {
    ...
    /// Visits `VkPhysicalDeviceProperties2` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceProperties2 sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceProperties2 pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceProperties2 propertiesAt(long index, MemorySegment value) { properties(this.segment(), index, value); return this; }
    /// Accepts `properties` with the given function.
    /// @param index the index of the struct buffer
    /// @param func the function
    /// @return `this`
    public VkPhysicalDeviceProperties2 propertiesAt(long index, Consumer<overrungl.vulkan.struct.VkPhysicalDeviceProperties> func) { func.accept(overrungl.vulkan.struct.VkPhysicalDeviceProperties.of(propertiesAt(index))); return this; }
