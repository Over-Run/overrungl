...
public final class VkSubpassDescriptionDepthStencilResolve extends GroupType {
    ...
    public static VkSubpassDescriptionDepthStencilResolve allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE); }
    public static VkSubpassDescriptionDepthStencilResolve allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkSubpassDescriptionDepthStencilResolve sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve depthResolveModeAt(long index, int value) { VH_depthResolveMode.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve stencilResolveModeAt(long index, int value) { VH_stencilResolveMode.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve pDepthStencilResolveAttachmentAt(long index, MemorySegment value) { VH_pDepthStencilResolveAttachment.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve depthResolveMode(int value) { VH_depthResolveMode.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve stencilResolveMode(int value) { VH_stencilResolveMode.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDescriptionDepthStencilResolve pDepthStencilResolveAttachment(MemorySegment value) { VH_pDepthStencilResolveAttachment.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkSubpassDescriptionDepthStencilResolve _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkSubpassDescriptionDepthStencilResolve _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkSubpassDescriptionDepthStencilResolve _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkSubpassDescriptionDepthStencilResolve _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkSubpassDescriptionDepthStencilResolve _depthResolveModeAt(long index, MemorySegment src) { _depthResolveModeAt(index).copyFrom(src); return this; }
    public VkSubpassDescriptionDepthStencilResolve _depthResolveMode(MemorySegment src) { return _depthResolveModeAt(0L, src); }
    ...
    public VkSubpassDescriptionDepthStencilResolve _stencilResolveModeAt(long index, MemorySegment src) { _stencilResolveModeAt(index).copyFrom(src); return this; }
    public VkSubpassDescriptionDepthStencilResolve _stencilResolveMode(MemorySegment src) { return _stencilResolveModeAt(0L, src); }
    ...
    public VkSubpassDescriptionDepthStencilResolve _pDepthStencilResolveAttachmentAt(long index, MemorySegment src) { _pDepthStencilResolveAttachmentAt(index).copyFrom(src); return this; }
    public VkSubpassDescriptionDepthStencilResolve _pDepthStencilResolveAttachment(MemorySegment src) { return _pDepthStencilResolveAttachmentAt(0L, src); }
}
