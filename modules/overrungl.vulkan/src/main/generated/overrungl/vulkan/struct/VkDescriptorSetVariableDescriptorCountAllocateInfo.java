...
public final class VkDescriptorSetVariableDescriptorCountAllocateInfo extends GroupType {
    ...
    public static VkDescriptorSetVariableDescriptorCountAllocateInfo allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO); }
    public static VkDescriptorSetVariableDescriptorCountAllocateInfo allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkDescriptorSetVariableDescriptorCountAllocateInfo sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo descriptorSetCountAt(long index, int value) { VH_descriptorSetCount.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo pDescriptorCountsAt(long index, MemorySegment value) { VH_pDescriptorCounts.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo descriptorSetCount(int value) { VH_descriptorSetCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo pDescriptorCounts(MemorySegment value) { VH_pDescriptorCounts.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkDescriptorSetVariableDescriptorCountAllocateInfo _descriptorSetCountAt(long index, MemorySegment src) { _descriptorSetCountAt(index).copyFrom(src); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo _descriptorSetCount(MemorySegment src) { return _descriptorSetCountAt(0L, src); }
    ...
    public VkDescriptorSetVariableDescriptorCountAllocateInfo _pDescriptorCountsAt(long index, MemorySegment src) { _pDescriptorCountsAt(index).copyFrom(src); return this; }
    public VkDescriptorSetVariableDescriptorCountAllocateInfo _pDescriptorCounts(MemorySegment src) { return _pDescriptorCountsAt(0L, src); }
}
