...
public final class VkSamplerCreateInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_magFilter = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("magFilter")));
    ...
    public static final Supplier<VarHandle> VH_minFilter = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("minFilter")));
    ...
    public static final Supplier<VarHandle> VH_mipmapMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("mipmapMode")));
    ...
    public static final Supplier<VarHandle> VH_addressModeU = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("addressModeU")));
    ...
    public static final Supplier<VarHandle> VH_addressModeV = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("addressModeV")));
    ...
    public static final Supplier<VarHandle> VH_addressModeW = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("addressModeW")));
    ...
    public static final Supplier<VarHandle> VH_mipLodBias = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("mipLodBias")));
    ...
    public static final Supplier<VarHandle> VH_anisotropyEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("anisotropyEnable")));
    ...
    public static final Supplier<VarHandle> VH_maxAnisotropy = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxAnisotropy")));
    ...
    public static final Supplier<VarHandle> VH_compareEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("compareEnable")));
    ...
    public static final Supplier<VarHandle> VH_minLod = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("minLod")));
    ...
    public static final Supplier<VarHandle> VH_maxLod = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxLod")));
    ...
    public static final Supplier<VarHandle> VH_borderColor = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("borderColor")));
    ...
    public static final Supplier<VarHandle> VH_unnormalizedCoordinates = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("unnormalizedCoordinates")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int magFilter(MemorySegment segment, long index) { return (int) VH_magFilter.get().get(segment, 0L, index); }
    /// {@return `magFilter`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void magFilter(MemorySegment segment, long index, int value) { VH_magFilter.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int minFilter(MemorySegment segment, long index) { return (int) VH_minFilter.get().get(segment, 0L, index); }
    /// {@return `minFilter`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void minFilter(MemorySegment segment, long index, int value) { VH_minFilter.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int mipmapMode(MemorySegment segment, long index) { return (int) VH_mipmapMode.get().get(segment, 0L, index); }
    /// {@return `mipmapMode`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void mipmapMode(MemorySegment segment, long index, int value) { VH_mipmapMode.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int addressModeU(MemorySegment segment, long index) { return (int) VH_addressModeU.get().get(segment, 0L, index); }
    /// {@return `addressModeU`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void addressModeU(MemorySegment segment, long index, int value) { VH_addressModeU.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int addressModeV(MemorySegment segment, long index) { return (int) VH_addressModeV.get().get(segment, 0L, index); }
    /// {@return `addressModeV`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void addressModeV(MemorySegment segment, long index, int value) { VH_addressModeV.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int addressModeW(MemorySegment segment, long index) { return (int) VH_addressModeW.get().get(segment, 0L, index); }
    /// {@return `addressModeW`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void addressModeW(MemorySegment segment, long index, int value) { VH_addressModeW.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static float mipLodBias(MemorySegment segment, long index) { return (float) VH_mipLodBias.get().get(segment, 0L, index); }
    /// {@return `mipLodBias`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void mipLodBias(MemorySegment segment, long index, float value) { VH_mipLodBias.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int anisotropyEnable(MemorySegment segment, long index) { return (int) VH_anisotropyEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void anisotropyEnable(MemorySegment segment, long index, int value) { VH_anisotropyEnable.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static float maxAnisotropy(MemorySegment segment, long index) { return (float) VH_maxAnisotropy.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxAnisotropy(MemorySegment segment, long index, float value) { VH_maxAnisotropy.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int compareEnable(MemorySegment segment, long index) { return (int) VH_compareEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void compareEnable(MemorySegment segment, long index, int value) { VH_compareEnable.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static float minLod(MemorySegment segment, long index) { return (float) VH_minLod.get().get(segment, 0L, index); }
    /// {@return `minLod`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void minLod(MemorySegment segment, long index, float value) { VH_minLod.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static float maxLod(MemorySegment segment, long index) { return (float) VH_maxLod.get().get(segment, 0L, index); }
    /// {@return `maxLod`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxLod(MemorySegment segment, long index, float value) { VH_maxLod.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int borderColor(MemorySegment segment, long index) { return (int) VH_borderColor.get().get(segment, 0L, index); }
    /// {@return `borderColor`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void borderColor(MemorySegment segment, long index, int value) { VH_borderColor.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int unnormalizedCoordinates(MemorySegment segment, long index) { return (int) VH_unnormalizedCoordinates.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void unnormalizedCoordinates(MemorySegment segment, long index, int value) { VH_unnormalizedCoordinates.get().set(segment, 0L, index, value); }
