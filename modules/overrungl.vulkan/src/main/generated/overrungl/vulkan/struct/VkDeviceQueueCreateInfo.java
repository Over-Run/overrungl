...
public final class VkDeviceQueueCreateInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pQueuePriorities = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pQueuePriorities")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pQueuePriorities(MemorySegment segment, long index) { return (MemorySegment) VH_pQueuePriorities.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pQueuePriorities(MemorySegment segment, long index, MemorySegment value) { VH_pQueuePriorities.get().set(segment, 0L, index, value); }
