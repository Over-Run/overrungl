...
public final class VkAttachmentDescriptionStencilLayout extends GroupType {
    ...
    /// Visits `VkAttachmentDescriptionStencilLayout` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkAttachmentDescriptionStencilLayout sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkAttachmentDescriptionStencilLayout pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkAttachmentDescriptionStencilLayout stencilInitialLayoutAt(long index, int value) { stencilInitialLayout(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkAttachmentDescriptionStencilLayout stencilFinalLayoutAt(long index, int value) { stencilFinalLayout(this.segment(), index, value); return this; }
