...
public final class VkSubpassDependency extends GroupType {
    ...
    public VkSubpassDependency srcSubpassAt(long index, int value) { VH_srcSubpass.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDependency dstSubpassAt(long index, int value) { VH_dstSubpass.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDependency srcStageMaskAt(long index, int value) { VH_srcStageMask.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDependency dstStageMaskAt(long index, int value) { VH_dstStageMask.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDependency srcAccessMaskAt(long index, int value) { VH_srcAccessMask.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDependency dstAccessMaskAt(long index, int value) { VH_dstAccessMask.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDependency dependencyFlagsAt(long index, int value) { VH_dependencyFlags.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassDependency srcSubpass(int value) { VH_srcSubpass.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDependency dstSubpass(int value) { VH_dstSubpass.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDependency srcStageMask(int value) { VH_srcStageMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDependency dstStageMask(int value) { VH_dstStageMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDependency srcAccessMask(int value) { VH_srcAccessMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDependency dstAccessMask(int value) { VH_dstAccessMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassDependency dependencyFlags(int value) { VH_dependencyFlags.set(this.segment(), 0L, 0L, value); return this; }
    ...
    public VkSubpassDependency _srcSubpassAt(long index, MemorySegment src) { _srcSubpassAt(index).copyFrom(src); return this; }
    public VkSubpassDependency _srcSubpass(MemorySegment src) { return _srcSubpassAt(0L, src); }
    ...
    public VkSubpassDependency _dstSubpassAt(long index, MemorySegment src) { _dstSubpassAt(index).copyFrom(src); return this; }
    public VkSubpassDependency _dstSubpass(MemorySegment src) { return _dstSubpassAt(0L, src); }
    ...
    public VkSubpassDependency _srcStageMaskAt(long index, MemorySegment src) { _srcStageMaskAt(index).copyFrom(src); return this; }
    public VkSubpassDependency _srcStageMask(MemorySegment src) { return _srcStageMaskAt(0L, src); }
    ...
    public VkSubpassDependency _dstStageMaskAt(long index, MemorySegment src) { _dstStageMaskAt(index).copyFrom(src); return this; }
    public VkSubpassDependency _dstStageMask(MemorySegment src) { return _dstStageMaskAt(0L, src); }
    ...
    public VkSubpassDependency _srcAccessMaskAt(long index, MemorySegment src) { _srcAccessMaskAt(index).copyFrom(src); return this; }
    public VkSubpassDependency _srcAccessMask(MemorySegment src) { return _srcAccessMaskAt(0L, src); }
    ...
    public VkSubpassDependency _dstAccessMaskAt(long index, MemorySegment src) { _dstAccessMaskAt(index).copyFrom(src); return this; }
    public VkSubpassDependency _dstAccessMask(MemorySegment src) { return _dstAccessMaskAt(0L, src); }
    ...
    public VkSubpassDependency _dependencyFlagsAt(long index, MemorySegment src) { _dependencyFlagsAt(index).copyFrom(src); return this; }
    public VkSubpassDependency _dependencyFlags(MemorySegment src) { return _dependencyFlagsAt(0L, src); }
}
