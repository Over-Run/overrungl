...
public final class VkRenderPassBeginInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_clearValueCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("clearValueCount")));
    ...
    public static final Supplier<VarHandle> VH_pClearValues = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pClearValues")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int clearValueCount(MemorySegment segment, long index) { return (int) VH_clearValueCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void clearValueCount(MemorySegment segment, long index, int value) { VH_clearValueCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pClearValues(MemorySegment segment, long index) { return (MemorySegment) VH_pClearValues.get().get(segment, 0L, index); }
    /// {@return `pClearValues`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pClearValues(MemorySegment segment, long index, MemorySegment value) { VH_pClearValues.get().set(segment, 0L, index, value); }
