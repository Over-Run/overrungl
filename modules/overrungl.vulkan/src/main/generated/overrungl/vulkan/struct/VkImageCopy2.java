...
/// }
/// ```
public final class VkImageCopy2 extends GroupType {
    ...
    public VkImageCopy2(MemorySegment segment, long elementCount) { super(segment, LAYOUT, elementCount); }
    public static VkImageCopy2 of(MemorySegment segment) { return MemoryUtil.isNullPointer(segment) ? null : new VkImageCopy2(segment, estimateCount(segment, LAYOUT)); }
    public static VkImageCopy2 ofNative(MemorySegment segment) { return MemoryUtil.isNullPointer(segment) ? null : new VkImageCopy2(segment.reinterpret(LAYOUT.byteSize()), 1); }
    public static VkImageCopy2 ofNative(MemorySegment segment, long count) { return MemoryUtil.isNullPointer(segment) ? null : new VkImageCopy2(segment.reinterpret(LAYOUT.scale(0, count)), count); }
    public static VkImageCopy2 alloc(SegmentAllocator allocator) { return new VkImageCopy2(allocator.allocate(LAYOUT), 1); }
    public static VkImageCopy2 alloc(SegmentAllocator allocator, long count) { return new VkImageCopy2(allocator.allocate(LAYOUT, count), count); }
    public static VkImageCopy2 allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_IMAGE_COPY_2); }
    public static VkImageCopy2 allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkImageCopy2 reinterpret(long count) { return new VkImageCopy2(this.segment().reinterpret(LAYOUT.scale(0, count)), count); }
    public VkImageCopy2 asSlice(long index) { return new VkImageCopy2(this.segment().asSlice(LAYOUT.scale(0L, index), LAYOUT), 1); }
    public VkImageCopy2 asSlice(long index, long count) { return new VkImageCopy2(this.segment().asSlice(LAYOUT.scale(0L, index), LAYOUT.byteSize() * count), count); }
    public VkImageCopy2 at(long index, Consumer<VkImageCopy2> func) { func.accept(asSlice(index)); return this; }
    ...
    public VkImageCopy2 sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 srcSubresource$aspectMaskAt(long index, int value) { VH_srcSubresource$aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 srcSubresource$mipLevelAt(long index, int value) { VH_srcSubresource$mipLevel.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 srcSubresource$baseArrayLayerAt(long index, int value) { VH_srcSubresource$baseArrayLayer.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 srcSubresource$layerCountAt(long index, int value) { VH_srcSubresource$layerCount.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 srcOffset$xAt(long index, int value) { VH_srcOffset$x.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 srcOffset$yAt(long index, int value) { VH_srcOffset$y.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 srcOffset$zAt(long index, int value) { VH_srcOffset$z.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 dstSubresource$aspectMaskAt(long index, int value) { VH_dstSubresource$aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 dstSubresource$mipLevelAt(long index, int value) { VH_dstSubresource$mipLevel.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 dstSubresource$baseArrayLayerAt(long index, int value) { VH_dstSubresource$baseArrayLayer.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 dstSubresource$layerCountAt(long index, int value) { VH_dstSubresource$layerCount.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 dstOffset$xAt(long index, int value) { VH_dstOffset$x.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 dstOffset$yAt(long index, int value) { VH_dstOffset$y.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 dstOffset$zAt(long index, int value) { VH_dstOffset$z.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 extent$widthAt(long index, int value) { VH_extent$width.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 extent$heightAt(long index, int value) { VH_extent$height.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 extent$depthAt(long index, int value) { VH_extent$depth.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy2 sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 srcSubresource$aspectMask(int value) { VH_srcSubresource$aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 srcSubresource$mipLevel(int value) { VH_srcSubresource$mipLevel.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 srcSubresource$baseArrayLayer(int value) { VH_srcSubresource$baseArrayLayer.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 srcSubresource$layerCount(int value) { VH_srcSubresource$layerCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 srcOffset$x(int value) { VH_srcOffset$x.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 srcOffset$y(int value) { VH_srcOffset$y.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 srcOffset$z(int value) { VH_srcOffset$z.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 dstSubresource$aspectMask(int value) { VH_dstSubresource$aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 dstSubresource$mipLevel(int value) { VH_dstSubresource$mipLevel.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 dstSubresource$baseArrayLayer(int value) { VH_dstSubresource$baseArrayLayer.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 dstSubresource$layerCount(int value) { VH_dstSubresource$layerCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 dstOffset$x(int value) { VH_dstOffset$x.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 dstOffset$y(int value) { VH_dstOffset$y.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 dstOffset$z(int value) { VH_dstOffset$z.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 extent$width(int value) { VH_extent$width.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 extent$height(int value) { VH_extent$height.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy2 extent$depth(int value) { VH_extent$depth.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkImageCopy2 _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkImageCopy2 _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkImageCopy2 _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkImageCopy2 _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkImageCopy2 _srcSubresourceAt(long index, MemorySegment src) { _srcSubresourceAt(index).copyFrom(src); return this; }
    public VkImageCopy2 _srcSubresource(MemorySegment src) { return _srcSubresourceAt(0L, src); }
    ...
    public VkImageCopy2 _srcOffsetAt(long index, MemorySegment src) { _srcOffsetAt(index).copyFrom(src); return this; }
    public VkImageCopy2 _srcOffset(MemorySegment src) { return _srcOffsetAt(0L, src); }
    ...
    public VkImageCopy2 _dstSubresourceAt(long index, MemorySegment src) { _dstSubresourceAt(index).copyFrom(src); return this; }
    public VkImageCopy2 _dstSubresource(MemorySegment src) { return _dstSubresourceAt(0L, src); }
    ...
    public VkImageCopy2 _dstOffsetAt(long index, MemorySegment src) { _dstOffsetAt(index).copyFrom(src); return this; }
    public VkImageCopy2 _dstOffset(MemorySegment src) { return _dstOffsetAt(0L, src); }
    ...
    public VkImageCopy2 _extentAt(long index, MemorySegment src) { _extentAt(index).copyFrom(src); return this; }
    public VkImageCopy2 _extent(MemorySegment src) { return _extentAt(0L, src); }
}
