...
public final class VkBufferImageCopy extends GroupType {
    ...
    public VkBufferImageCopy bufferOffsetAt(long index, long value) { VH_bufferOffset.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy bufferRowLengthAt(long index, int value) { VH_bufferRowLength.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy bufferImageHeightAt(long index, int value) { VH_bufferImageHeight.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageSubresource$aspectMaskAt(long index, int value) { VH_imageSubresource$aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageSubresource$mipLevelAt(long index, int value) { VH_imageSubresource$mipLevel.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageSubresource$baseArrayLayerAt(long index, int value) { VH_imageSubresource$baseArrayLayer.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageSubresource$layerCountAt(long index, int value) { VH_imageSubresource$layerCount.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageOffset$xAt(long index, int value) { VH_imageOffset$x.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageOffset$yAt(long index, int value) { VH_imageOffset$y.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageOffset$zAt(long index, int value) { VH_imageOffset$z.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageExtent$widthAt(long index, int value) { VH_imageExtent$width.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageExtent$heightAt(long index, int value) { VH_imageExtent$height.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy imageExtent$depthAt(long index, int value) { VH_imageExtent$depth.set(this.segment(), 0L, index, value); return this; }
    public VkBufferImageCopy bufferOffset(long value) { VH_bufferOffset.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy bufferRowLength(int value) { VH_bufferRowLength.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy bufferImageHeight(int value) { VH_bufferImageHeight.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageSubresource$aspectMask(int value) { VH_imageSubresource$aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageSubresource$mipLevel(int value) { VH_imageSubresource$mipLevel.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageSubresource$baseArrayLayer(int value) { VH_imageSubresource$baseArrayLayer.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageSubresource$layerCount(int value) { VH_imageSubresource$layerCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageOffset$x(int value) { VH_imageOffset$x.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageOffset$y(int value) { VH_imageOffset$y.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageOffset$z(int value) { VH_imageOffset$z.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageExtent$width(int value) { VH_imageExtent$width.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageExtent$height(int value) { VH_imageExtent$height.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferImageCopy imageExtent$depth(int value) { VH_imageExtent$depth.set(this.segment(), 0L, 0L, value); return this; }
    ...
    public VkBufferImageCopy _bufferOffsetAt(long index, MemorySegment src) { _bufferOffsetAt(index).copyFrom(src); return this; }
    public VkBufferImageCopy _bufferOffset(MemorySegment src) { return _bufferOffsetAt(0L, src); }
    ...
    public VkBufferImageCopy _bufferRowLengthAt(long index, MemorySegment src) { _bufferRowLengthAt(index).copyFrom(src); return this; }
    public VkBufferImageCopy _bufferRowLength(MemorySegment src) { return _bufferRowLengthAt(0L, src); }
    ...
    public VkBufferImageCopy _bufferImageHeightAt(long index, MemorySegment src) { _bufferImageHeightAt(index).copyFrom(src); return this; }
    public VkBufferImageCopy _bufferImageHeight(MemorySegment src) { return _bufferImageHeightAt(0L, src); }
    ...
    public VkBufferImageCopy _imageSubresourceAt(long index, MemorySegment src) { _imageSubresourceAt(index).copyFrom(src); return this; }
    public VkBufferImageCopy _imageSubresource(MemorySegment src) { return _imageSubresourceAt(0L, src); }
    ...
    public VkBufferImageCopy _imageOffsetAt(long index, MemorySegment src) { _imageOffsetAt(index).copyFrom(src); return this; }
    public VkBufferImageCopy _imageOffset(MemorySegment src) { return _imageOffsetAt(0L, src); }
    ...
    public VkBufferImageCopy _imageExtentAt(long index, MemorySegment src) { _imageExtentAt(index).copyFrom(src); return this; }
    public VkBufferImageCopy _imageExtent(MemorySegment src) { return _imageExtentAt(0L, src); }
}
