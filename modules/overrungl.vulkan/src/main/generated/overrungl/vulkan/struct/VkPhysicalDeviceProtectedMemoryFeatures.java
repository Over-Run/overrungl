...
/// Represents `VkPhysicalDeviceProtectedMemoryFeatures`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceProtectedMemoryFeatures extends GroupType {
    ...
    public static VkPhysicalDeviceProtectedMemoryFeatures allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES); }
    public static VkPhysicalDeviceProtectedMemoryFeatures allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES);
        return s;
    }
    ...
    public VkPhysicalDeviceProtectedMemoryFeatures sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProtectedMemoryFeatures pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProtectedMemoryFeatures protectedMemoryAt(long index, int value) { VH_protectedMemory.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceProtectedMemoryFeatures sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProtectedMemoryFeatures pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceProtectedMemoryFeatures protectedMemory(int value) { VH_protectedMemory.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceProtectedMemoryFeatures _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceProtectedMemoryFeatures _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceProtectedMemoryFeatures _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceProtectedMemoryFeatures _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceProtectedMemoryFeatures _protectedMemoryAt(long index, MemorySegment src) { _protectedMemoryAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceProtectedMemoryFeatures _protectedMemory(MemorySegment src) { return _protectedMemoryAt(0L, src); }
}
