...
public final class VkSubpassBeginInfo extends GroupType {
    ...
    public static VkSubpassBeginInfo allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO); }
    public static VkSubpassBeginInfo allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkSubpassBeginInfo sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassBeginInfo pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassBeginInfo contentsAt(long index, int value) { VH_contents.set(this.segment(), 0L, index, value); return this; }
    public VkSubpassBeginInfo sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassBeginInfo pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkSubpassBeginInfo contents(int value) { VH_contents.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkSubpassBeginInfo _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkSubpassBeginInfo _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkSubpassBeginInfo _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkSubpassBeginInfo _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkSubpassBeginInfo _contentsAt(long index, MemorySegment src) { _contentsAt(index).copyFrom(src); return this; }
    public VkSubpassBeginInfo _contents(MemorySegment src) { return _contentsAt(0L, src); }
}
