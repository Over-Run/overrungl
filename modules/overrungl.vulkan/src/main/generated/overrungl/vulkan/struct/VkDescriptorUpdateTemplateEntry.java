...
public final class VkDescriptorUpdateTemplateEntry extends GroupType {
    ...
    public VkDescriptorUpdateTemplateEntry dstBindingAt(long index, int value) { VH_dstBinding.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorUpdateTemplateEntry dstArrayElementAt(long index, int value) { VH_dstArrayElement.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorUpdateTemplateEntry descriptorCountAt(long index, int value) { VH_descriptorCount.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorUpdateTemplateEntry descriptorTypeAt(long index, int value) { VH_descriptorType.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorUpdateTemplateEntry offsetAt(long index, long value) { VH_offset.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorUpdateTemplateEntry strideAt(long index, long value) { VH_stride.set(this.segment(), 0L, index, value); return this; }
    public VkDescriptorUpdateTemplateEntry dstBinding(int value) { VH_dstBinding.set(this.segment(), 0L, 0L, value); return this; }
    public VkDescriptorUpdateTemplateEntry dstArrayElement(int value) { VH_dstArrayElement.set(this.segment(), 0L, 0L, value); return this; }
    public VkDescriptorUpdateTemplateEntry descriptorCount(int value) { VH_descriptorCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkDescriptorUpdateTemplateEntry descriptorType(int value) { VH_descriptorType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDescriptorUpdateTemplateEntry offset(long value) { VH_offset.set(this.segment(), 0L, 0L, value); return this; }
    public VkDescriptorUpdateTemplateEntry stride(long value) { VH_stride.set(this.segment(), 0L, 0L, value); return this; }
    ...
    public VkDescriptorUpdateTemplateEntry _dstBindingAt(long index, MemorySegment src) { _dstBindingAt(index).copyFrom(src); return this; }
    public VkDescriptorUpdateTemplateEntry _dstBinding(MemorySegment src) { return _dstBindingAt(0L, src); }
    ...
    public VkDescriptorUpdateTemplateEntry _dstArrayElementAt(long index, MemorySegment src) { _dstArrayElementAt(index).copyFrom(src); return this; }
    public VkDescriptorUpdateTemplateEntry _dstArrayElement(MemorySegment src) { return _dstArrayElementAt(0L, src); }
    ...
    public VkDescriptorUpdateTemplateEntry _descriptorCountAt(long index, MemorySegment src) { _descriptorCountAt(index).copyFrom(src); return this; }
    public VkDescriptorUpdateTemplateEntry _descriptorCount(MemorySegment src) { return _descriptorCountAt(0L, src); }
    ...
    public VkDescriptorUpdateTemplateEntry _descriptorTypeAt(long index, MemorySegment src) { _descriptorTypeAt(index).copyFrom(src); return this; }
    public VkDescriptorUpdateTemplateEntry _descriptorType(MemorySegment src) { return _descriptorTypeAt(0L, src); }
    ...
    public VkDescriptorUpdateTemplateEntry _offsetAt(long index, MemorySegment src) { _offsetAt(index).copyFrom(src); return this; }
    public VkDescriptorUpdateTemplateEntry _offset(MemorySegment src) { return _offsetAt(0L, src); }
    ...
    public VkDescriptorUpdateTemplateEntry _strideAt(long index, MemorySegment src) { _strideAt(index).copyFrom(src); return this; }
    public VkDescriptorUpdateTemplateEntry _stride(MemorySegment src) { return _strideAt(0L, src); }
}
