...
public final class VkPhysicalDeviceShaderIntegerDotProductProperties extends GroupType {
    ...
    public static VkPhysicalDeviceShaderIntegerDotProductProperties allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_PROPERTIES); }
    public static VkPhysicalDeviceShaderIntegerDotProductProperties allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct8BitUnsignedAcceleratedAt(long index, int value) { VH_integerDotProduct8BitUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct8BitSignedAcceleratedAt(long index, int value) { VH_integerDotProduct8BitSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct8BitMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProduct8BitMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct4x8BitPackedUnsignedAcceleratedAt(long index, int value) { VH_integerDotProduct4x8BitPackedUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct4x8BitPackedSignedAcceleratedAt(long index, int value) { VH_integerDotProduct4x8BitPackedSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct4x8BitPackedMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProduct4x8BitPackedMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct16BitUnsignedAcceleratedAt(long index, int value) { VH_integerDotProduct16BitUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct16BitSignedAcceleratedAt(long index, int value) { VH_integerDotProduct16BitSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct16BitMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProduct16BitMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct32BitUnsignedAcceleratedAt(long index, int value) { VH_integerDotProduct32BitUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct32BitSignedAcceleratedAt(long index, int value) { VH_integerDotProduct32BitSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct32BitMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProduct32BitMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct64BitUnsignedAcceleratedAt(long index, int value) { VH_integerDotProduct64BitUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct64BitSignedAcceleratedAt(long index, int value) { VH_integerDotProduct64BitSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct64BitMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProduct64BitMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating8BitUnsignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating8BitUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating8BitSignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating8BitSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating8BitMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating8BitMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating4x8BitPackedSignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating4x8BitPackedSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating16BitUnsignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating16BitUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating16BitSignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating16BitSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating16BitMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating16BitMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating32BitUnsignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating32BitUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating32BitSignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating32BitSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating32BitMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating32BitMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating64BitUnsignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating64BitUnsignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating64BitSignedAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating64BitSignedAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating64BitMixedSignednessAcceleratedAt(long index, int value) { VH_integerDotProductAccumulatingSaturating64BitMixedSignednessAccelerated.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct8BitUnsignedAccelerated(int value) { VH_integerDotProduct8BitUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct8BitSignedAccelerated(int value) { VH_integerDotProduct8BitSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct8BitMixedSignednessAccelerated(int value) { VH_integerDotProduct8BitMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct4x8BitPackedUnsignedAccelerated(int value) { VH_integerDotProduct4x8BitPackedUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct4x8BitPackedSignedAccelerated(int value) { VH_integerDotProduct4x8BitPackedSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct4x8BitPackedMixedSignednessAccelerated(int value) { VH_integerDotProduct4x8BitPackedMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct16BitUnsignedAccelerated(int value) { VH_integerDotProduct16BitUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct16BitSignedAccelerated(int value) { VH_integerDotProduct16BitSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct16BitMixedSignednessAccelerated(int value) { VH_integerDotProduct16BitMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct32BitUnsignedAccelerated(int value) { VH_integerDotProduct32BitUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct32BitSignedAccelerated(int value) { VH_integerDotProduct32BitSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct32BitMixedSignednessAccelerated(int value) { VH_integerDotProduct32BitMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct64BitUnsignedAccelerated(int value) { VH_integerDotProduct64BitUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct64BitSignedAccelerated(int value) { VH_integerDotProduct64BitSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProduct64BitMixedSignednessAccelerated(int value) { VH_integerDotProduct64BitMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating8BitUnsignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating8BitUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating8BitSignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating8BitSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating8BitMixedSignednessAccelerated(int value) { VH_integerDotProductAccumulatingSaturating8BitMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating4x8BitPackedSignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating4x8BitPackedSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAccelerated(int value) { VH_integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating16BitUnsignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating16BitUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating16BitSignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating16BitSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating16BitMixedSignednessAccelerated(int value) { VH_integerDotProductAccumulatingSaturating16BitMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating32BitUnsignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating32BitUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating32BitSignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating32BitSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating32BitMixedSignednessAccelerated(int value) { VH_integerDotProductAccumulatingSaturating32BitMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating64BitUnsignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating64BitUnsignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating64BitSignedAccelerated(int value) { VH_integerDotProductAccumulatingSaturating64BitSignedAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties integerDotProductAccumulatingSaturating64BitMixedSignednessAccelerated(int value) { VH_integerDotProductAccumulatingSaturating64BitMixedSignednessAccelerated.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct8BitUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct8BitUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct8BitUnsignedAccelerated(MemorySegment src) { return _integerDotProduct8BitUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct8BitSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct8BitSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct8BitSignedAccelerated(MemorySegment src) { return _integerDotProduct8BitSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct8BitMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProduct8BitMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct8BitMixedSignednessAccelerated(MemorySegment src) { return _integerDotProduct8BitMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct4x8BitPackedUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct4x8BitPackedUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct4x8BitPackedUnsignedAccelerated(MemorySegment src) { return _integerDotProduct4x8BitPackedUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct4x8BitPackedSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct4x8BitPackedSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct4x8BitPackedSignedAccelerated(MemorySegment src) { return _integerDotProduct4x8BitPackedSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct4x8BitPackedMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProduct4x8BitPackedMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct4x8BitPackedMixedSignednessAccelerated(MemorySegment src) { return _integerDotProduct4x8BitPackedMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct16BitUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct16BitUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct16BitUnsignedAccelerated(MemorySegment src) { return _integerDotProduct16BitUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct16BitSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct16BitSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct16BitSignedAccelerated(MemorySegment src) { return _integerDotProduct16BitSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct16BitMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProduct16BitMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct16BitMixedSignednessAccelerated(MemorySegment src) { return _integerDotProduct16BitMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct32BitUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct32BitUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct32BitUnsignedAccelerated(MemorySegment src) { return _integerDotProduct32BitUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct32BitSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct32BitSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct32BitSignedAccelerated(MemorySegment src) { return _integerDotProduct32BitSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct32BitMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProduct32BitMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct32BitMixedSignednessAccelerated(MemorySegment src) { return _integerDotProduct32BitMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct64BitUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct64BitUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct64BitUnsignedAccelerated(MemorySegment src) { return _integerDotProduct64BitUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct64BitSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProduct64BitSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct64BitSignedAccelerated(MemorySegment src) { return _integerDotProduct64BitSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct64BitMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProduct64BitMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProduct64BitMixedSignednessAccelerated(MemorySegment src) { return _integerDotProduct64BitMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating8BitUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating8BitUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating8BitUnsignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating8BitUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating8BitSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating8BitSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating8BitSignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating8BitSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating8BitMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating8BitMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating8BitMixedSignednessAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating8BitMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating4x8BitPackedSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating4x8BitPackedSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating4x8BitPackedSignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating4x8BitPackedSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating16BitUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating16BitUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating16BitUnsignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating16BitUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating16BitSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating16BitSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating16BitSignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating16BitSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating16BitMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating16BitMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating16BitMixedSignednessAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating16BitMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating32BitUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating32BitUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating32BitUnsignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating32BitUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating32BitSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating32BitSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating32BitSignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating32BitSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating32BitMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating32BitMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating32BitMixedSignednessAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating32BitMixedSignednessAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating64BitUnsignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating64BitUnsignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating64BitUnsignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating64BitUnsignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating64BitSignedAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating64BitSignedAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating64BitSignedAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating64BitSignedAcceleratedAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating64BitMixedSignednessAcceleratedAt(long index, MemorySegment src) { _integerDotProductAccumulatingSaturating64BitMixedSignednessAcceleratedAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderIntegerDotProductProperties _integerDotProductAccumulatingSaturating64BitMixedSignednessAccelerated(MemorySegment src) { return _integerDotProductAccumulatingSaturating64BitMixedSignednessAcceleratedAt(0L, src); }
}
