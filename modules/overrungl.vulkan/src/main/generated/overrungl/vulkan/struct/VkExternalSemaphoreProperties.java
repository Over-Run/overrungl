...
public final class VkExternalSemaphoreProperties extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_externalSemaphoreFeatures = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("externalSemaphoreFeatures")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int externalSemaphoreFeatures(MemorySegment segment, long index) { return (int) VH_externalSemaphoreFeatures.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void externalSemaphoreFeatures(MemorySegment segment, long index, int value) { VH_externalSemaphoreFeatures.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkExternalSemaphoreProperties` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalSemaphoreProperties sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalSemaphoreProperties pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalSemaphoreProperties exportFromImportedHandleTypesAt(long index, int value) { exportFromImportedHandleTypes(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalSemaphoreProperties compatibleHandleTypesAt(long index, int value) { compatibleHandleTypes(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExternalSemaphoreProperties externalSemaphoreFeaturesAt(long index, int value) { externalSemaphoreFeatures(this.segment(), index, value); return this; }
