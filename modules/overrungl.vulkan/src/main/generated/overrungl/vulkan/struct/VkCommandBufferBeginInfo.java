...
public final class VkCommandBufferBeginInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pInheritanceInfo = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pInheritanceInfo")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pInheritanceInfo(MemorySegment segment, long index) { return (MemorySegment) VH_pInheritanceInfo.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pInheritanceInfo(MemorySegment segment, long index, MemorySegment value) { VH_pInheritanceInfo.get().set(segment, 0L, index, value); }
