...
public final class VkExternalFenceProperties extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_externalFenceFeatures = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("externalFenceFeatures")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int externalFenceFeatures(MemorySegment segment, long index) { return (int) VH_externalFenceFeatures.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void externalFenceFeatures(MemorySegment segment, long index, int value) { VH_externalFenceFeatures.get().set(segment, 0L, index, value); }
