...
public final class VkExportMemoryAllocateInfo extends GroupType {
    ...
    /// Visits `VkExportMemoryAllocateInfo` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkExportMemoryAllocateInfo sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExportMemoryAllocateInfo pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkExportMemoryAllocateInfo handleTypesAt(long index, int value) { handleTypes(this.segment(), index, value); return this; }
