...
public final class VkPhysicalDeviceSparseImageFormatInfo2 extends GroupType {
    ...
    public static VkPhysicalDeviceSparseImageFormatInfo2 allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2); }
    public static VkPhysicalDeviceSparseImageFormatInfo2 allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceSparseImageFormatInfo2 sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 formatAt(long index, int value) { VH_format.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 typeAt(long index, int value) { VH_type.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 samplesAt(long index, int value) { VH_samples.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 usageAt(long index, int value) { VH_usage.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 tilingAt(long index, int value) { VH_tiling.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 format(int value) { VH_format.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 type(int value) { VH_type.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 samples(int value) { VH_samples.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 usage(int value) { VH_usage.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 tiling(int value) { VH_tiling.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceSparseImageFormatInfo2 _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceSparseImageFormatInfo2 _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceSparseImageFormatInfo2 _formatAt(long index, MemorySegment src) { _formatAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 _format(MemorySegment src) { return _formatAt(0L, src); }
    ...
    public VkPhysicalDeviceSparseImageFormatInfo2 _typeAt(long index, MemorySegment src) { _typeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 _type(MemorySegment src) { return _typeAt(0L, src); }
    ...
    public VkPhysicalDeviceSparseImageFormatInfo2 _samplesAt(long index, MemorySegment src) { _samplesAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 _samples(MemorySegment src) { return _samplesAt(0L, src); }
    ...
    public VkPhysicalDeviceSparseImageFormatInfo2 _usageAt(long index, MemorySegment src) { _usageAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 _usage(MemorySegment src) { return _usageAt(0L, src); }
    ...
    public VkPhysicalDeviceSparseImageFormatInfo2 _tilingAt(long index, MemorySegment src) { _tilingAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSparseImageFormatInfo2 _tiling(MemorySegment src) { return _tilingAt(0L, src); }
}
