...
public final class VkImageCopy extends GroupType {
    ...
    public VkImageCopy srcSubresource$aspectMaskAt(long index, int value) { VH_srcSubresource$aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy srcSubresource$mipLevelAt(long index, int value) { VH_srcSubresource$mipLevel.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy srcSubresource$baseArrayLayerAt(long index, int value) { VH_srcSubresource$baseArrayLayer.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy srcSubresource$layerCountAt(long index, int value) { VH_srcSubresource$layerCount.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy srcOffset$xAt(long index, int value) { VH_srcOffset$x.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy srcOffset$yAt(long index, int value) { VH_srcOffset$y.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy srcOffset$zAt(long index, int value) { VH_srcOffset$z.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy dstSubresource$aspectMaskAt(long index, int value) { VH_dstSubresource$aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy dstSubresource$mipLevelAt(long index, int value) { VH_dstSubresource$mipLevel.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy dstSubresource$baseArrayLayerAt(long index, int value) { VH_dstSubresource$baseArrayLayer.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy dstSubresource$layerCountAt(long index, int value) { VH_dstSubresource$layerCount.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy dstOffset$xAt(long index, int value) { VH_dstOffset$x.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy dstOffset$yAt(long index, int value) { VH_dstOffset$y.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy dstOffset$zAt(long index, int value) { VH_dstOffset$z.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy extent$widthAt(long index, int value) { VH_extent$width.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy extent$heightAt(long index, int value) { VH_extent$height.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy extent$depthAt(long index, int value) { VH_extent$depth.set(this.segment(), 0L, index, value); return this; }
    public VkImageCopy srcSubresource$aspectMask(int value) { VH_srcSubresource$aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy srcSubresource$mipLevel(int value) { VH_srcSubresource$mipLevel.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy srcSubresource$baseArrayLayer(int value) { VH_srcSubresource$baseArrayLayer.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy srcSubresource$layerCount(int value) { VH_srcSubresource$layerCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy srcOffset$x(int value) { VH_srcOffset$x.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy srcOffset$y(int value) { VH_srcOffset$y.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy srcOffset$z(int value) { VH_srcOffset$z.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy dstSubresource$aspectMask(int value) { VH_dstSubresource$aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy dstSubresource$mipLevel(int value) { VH_dstSubresource$mipLevel.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy dstSubresource$baseArrayLayer(int value) { VH_dstSubresource$baseArrayLayer.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy dstSubresource$layerCount(int value) { VH_dstSubresource$layerCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy dstOffset$x(int value) { VH_dstOffset$x.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy dstOffset$y(int value) { VH_dstOffset$y.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy dstOffset$z(int value) { VH_dstOffset$z.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy extent$width(int value) { VH_extent$width.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy extent$height(int value) { VH_extent$height.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageCopy extent$depth(int value) { VH_extent$depth.set(this.segment(), 0L, 0L, value); return this; }
    ...
    public VkImageCopy _srcSubresourceAt(long index, MemorySegment src) { _srcSubresourceAt(index).copyFrom(src); return this; }
    public VkImageCopy _srcSubresource(MemorySegment src) { return _srcSubresourceAt(0L, src); }
    ...
    public VkImageCopy _srcOffsetAt(long index, MemorySegment src) { _srcOffsetAt(index).copyFrom(src); return this; }
    public VkImageCopy _srcOffset(MemorySegment src) { return _srcOffsetAt(0L, src); }
    ...
    public VkImageCopy _dstSubresourceAt(long index, MemorySegment src) { _dstSubresourceAt(index).copyFrom(src); return this; }
    public VkImageCopy _dstSubresource(MemorySegment src) { return _dstSubresourceAt(0L, src); }
    ...
    public VkImageCopy _dstOffsetAt(long index, MemorySegment src) { _dstOffsetAt(index).copyFrom(src); return this; }
    public VkImageCopy _dstOffset(MemorySegment src) { return _dstOffsetAt(0L, src); }
    ...
    public VkImageCopy _extentAt(long index, MemorySegment src) { _extentAt(index).copyFrom(src); return this; }
    public VkImageCopy _extent(MemorySegment src) { return _extentAt(0L, src); }
}
