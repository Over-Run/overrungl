...
public final class VkPhysicalDeviceVulkanSC10Features extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderAtomicInstructions = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderAtomicInstructions")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderAtomicInstructions(MemorySegment segment, long index) { return (int) VH_shaderAtomicInstructions.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderAtomicInstructions(MemorySegment segment, long index, int value) { VH_shaderAtomicInstructions.get().set(segment, 0L, index, value); }
