...
public final class VkDeviceBufferMemoryRequirements extends GroupType {
    ...
    public static VkDeviceBufferMemoryRequirements allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_DEVICE_BUFFER_MEMORY_REQUIREMENTS); }
    public static VkDeviceBufferMemoryRequirements allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkDeviceBufferMemoryRequirements sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceBufferMemoryRequirements pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceBufferMemoryRequirements pCreateInfoAt(long index, MemorySegment value) { VH_pCreateInfo.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceBufferMemoryRequirements sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceBufferMemoryRequirements pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceBufferMemoryRequirements pCreateInfo(MemorySegment value) { VH_pCreateInfo.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkDeviceBufferMemoryRequirements _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkDeviceBufferMemoryRequirements _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkDeviceBufferMemoryRequirements _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkDeviceBufferMemoryRequirements _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkDeviceBufferMemoryRequirements _pCreateInfoAt(long index, MemorySegment src) { _pCreateInfoAt(index).copyFrom(src); return this; }
    public VkDeviceBufferMemoryRequirements _pCreateInfo(MemorySegment src) { return _pCreateInfoAt(0L, src); }
}
