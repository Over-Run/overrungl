...
/// Represents `VkPhysicalDeviceGlobalPriorityQueryFeatures`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceGlobalPriorityQueryFeatures extends GroupType {
    ...
    public static VkPhysicalDeviceGlobalPriorityQueryFeatures allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES); }
    public static VkPhysicalDeviceGlobalPriorityQueryFeatures allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceGlobalPriorityQueryFeatures sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures globalPriorityQueryAt(long index, int value) { VH_globalPriorityQuery.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures globalPriorityQuery(int value) { VH_globalPriorityQuery.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceGlobalPriorityQueryFeatures _globalPriorityQueryAt(long index, MemorySegment src) { _globalPriorityQueryAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceGlobalPriorityQueryFeatures _globalPriorityQuery(MemorySegment src) { return _globalPriorityQueryAt(0L, src); }
}
