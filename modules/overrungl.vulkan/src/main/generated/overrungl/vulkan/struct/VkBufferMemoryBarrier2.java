...
public final class VkBufferMemoryBarrier2 extends GroupType {
    ...
    public static VkBufferMemoryBarrier2 allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER_2); }
    public static VkBufferMemoryBarrier2 allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkBufferMemoryBarrier2 sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 srcStageMaskAt(long index, long value) { VH_srcStageMask.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 srcAccessMaskAt(long index, long value) { VH_srcAccessMask.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 dstStageMaskAt(long index, long value) { VH_dstStageMask.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 dstAccessMaskAt(long index, long value) { VH_dstAccessMask.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 srcQueueFamilyIndexAt(long index, int value) { VH_srcQueueFamilyIndex.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 dstQueueFamilyIndexAt(long index, int value) { VH_dstQueueFamilyIndex.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 bufferAt(long index, long value) { VH_buffer.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 offsetAt(long index, long value) { VH_offset.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 sizeAt(long index, long value) { VH_size.set(this.segment(), 0L, index, value); return this; }
    public VkBufferMemoryBarrier2 sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 srcStageMask(long value) { VH_srcStageMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 srcAccessMask(long value) { VH_srcAccessMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 dstStageMask(long value) { VH_dstStageMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 dstAccessMask(long value) { VH_dstAccessMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 srcQueueFamilyIndex(int value) { VH_srcQueueFamilyIndex.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 dstQueueFamilyIndex(int value) { VH_dstQueueFamilyIndex.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 buffer(long value) { VH_buffer.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 offset(long value) { VH_offset.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferMemoryBarrier2 size(long value) { VH_size.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkBufferMemoryBarrier2 _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkBufferMemoryBarrier2 _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _srcStageMaskAt(long index, MemorySegment src) { _srcStageMaskAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _srcStageMask(MemorySegment src) { return _srcStageMaskAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _srcAccessMaskAt(long index, MemorySegment src) { _srcAccessMaskAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _srcAccessMask(MemorySegment src) { return _srcAccessMaskAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _dstStageMaskAt(long index, MemorySegment src) { _dstStageMaskAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _dstStageMask(MemorySegment src) { return _dstStageMaskAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _dstAccessMaskAt(long index, MemorySegment src) { _dstAccessMaskAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _dstAccessMask(MemorySegment src) { return _dstAccessMaskAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _srcQueueFamilyIndexAt(long index, MemorySegment src) { _srcQueueFamilyIndexAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _srcQueueFamilyIndex(MemorySegment src) { return _srcQueueFamilyIndexAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _dstQueueFamilyIndexAt(long index, MemorySegment src) { _dstQueueFamilyIndexAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _dstQueueFamilyIndex(MemorySegment src) { return _dstQueueFamilyIndexAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _bufferAt(long index, MemorySegment src) { _bufferAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _buffer(MemorySegment src) { return _bufferAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _offsetAt(long index, MemorySegment src) { _offsetAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _offset(MemorySegment src) { return _offsetAt(0L, src); }
    ...
    public VkBufferMemoryBarrier2 _sizeAt(long index, MemorySegment src) { _sizeAt(index).copyFrom(src); return this; }
    public VkBufferMemoryBarrier2 _size(MemorySegment src) { return _sizeAt(0L, src); }
}
