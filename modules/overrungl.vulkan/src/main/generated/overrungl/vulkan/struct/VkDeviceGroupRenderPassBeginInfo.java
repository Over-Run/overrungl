...
public final class VkDeviceGroupRenderPassBeginInfo extends GroupType {
    ...
    public static VkDeviceGroupRenderPassBeginInfo allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_DEVICE_GROUP_RENDER_PASS_BEGIN_INFO); }
    public static VkDeviceGroupRenderPassBeginInfo allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkDeviceGroupRenderPassBeginInfo sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo deviceMaskAt(long index, int value) { VH_deviceMask.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo deviceRenderAreaCountAt(long index, int value) { VH_deviceRenderAreaCount.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo pDeviceRenderAreasAt(long index, MemorySegment value) { VH_pDeviceRenderAreas.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo deviceMask(int value) { VH_deviceMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo deviceRenderAreaCount(int value) { VH_deviceRenderAreaCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceGroupRenderPassBeginInfo pDeviceRenderAreas(MemorySegment value) { VH_pDeviceRenderAreas.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkDeviceGroupRenderPassBeginInfo _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkDeviceGroupRenderPassBeginInfo _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkDeviceGroupRenderPassBeginInfo _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkDeviceGroupRenderPassBeginInfo _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkDeviceGroupRenderPassBeginInfo _deviceMaskAt(long index, MemorySegment src) { _deviceMaskAt(index).copyFrom(src); return this; }
    public VkDeviceGroupRenderPassBeginInfo _deviceMask(MemorySegment src) { return _deviceMaskAt(0L, src); }
    ...
    public VkDeviceGroupRenderPassBeginInfo _deviceRenderAreaCountAt(long index, MemorySegment src) { _deviceRenderAreaCountAt(index).copyFrom(src); return this; }
    public VkDeviceGroupRenderPassBeginInfo _deviceRenderAreaCount(MemorySegment src) { return _deviceRenderAreaCountAt(0L, src); }
    ...
    public VkDeviceGroupRenderPassBeginInfo _pDeviceRenderAreasAt(long index, MemorySegment src) { _pDeviceRenderAreasAt(index).copyFrom(src); return this; }
    public VkDeviceGroupRenderPassBeginInfo _pDeviceRenderAreas(MemorySegment src) { return _pDeviceRenderAreasAt(0L, src); }
}
