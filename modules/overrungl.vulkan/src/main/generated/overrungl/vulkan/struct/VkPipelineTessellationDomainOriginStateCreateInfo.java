...
public final class VkPipelineTessellationDomainOriginStateCreateInfo extends GroupType {
    ...
    public static VkPipelineTessellationDomainOriginStateCreateInfo allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO); }
    public static VkPipelineTessellationDomainOriginStateCreateInfo allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPipelineTessellationDomainOriginStateCreateInfo sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineTessellationDomainOriginStateCreateInfo pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineTessellationDomainOriginStateCreateInfo domainOriginAt(long index, int value) { VH_domainOrigin.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineTessellationDomainOriginStateCreateInfo sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineTessellationDomainOriginStateCreateInfo pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineTessellationDomainOriginStateCreateInfo domainOrigin(int value) { VH_domainOrigin.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPipelineTessellationDomainOriginStateCreateInfo _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPipelineTessellationDomainOriginStateCreateInfo _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPipelineTessellationDomainOriginStateCreateInfo _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPipelineTessellationDomainOriginStateCreateInfo _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPipelineTessellationDomainOriginStateCreateInfo _domainOriginAt(long index, MemorySegment src) { _domainOriginAt(index).copyFrom(src); return this; }
    public VkPipelineTessellationDomainOriginStateCreateInfo _domainOrigin(MemorySegment src) { return _domainOriginAt(0L, src); }
}
