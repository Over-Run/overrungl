...
/// Represents `VkPipelineCreationFeedbackCreateInfo`.
/// ## Layout
/// ```
...
public final class VkPipelineCreationFeedbackCreateInfo extends GroupType {
    ...
    public static VkPipelineCreationFeedbackCreateInfo allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO); }
    public static VkPipelineCreationFeedbackCreateInfo allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPipelineCreationFeedbackCreateInfo sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo pPipelineCreationFeedbackAt(long index, MemorySegment value) { VH_pPipelineCreationFeedback.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo pipelineStageCreationFeedbackCountAt(long index, int value) { VH_pipelineStageCreationFeedbackCount.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo pPipelineStageCreationFeedbacksAt(long index, MemorySegment value) { VH_pPipelineStageCreationFeedbacks.set(this.segment(), 0L, index, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo pPipelineCreationFeedback(MemorySegment value) { VH_pPipelineCreationFeedback.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo pipelineStageCreationFeedbackCount(int value) { VH_pipelineStageCreationFeedbackCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkPipelineCreationFeedbackCreateInfo pPipelineStageCreationFeedbacks(MemorySegment value) { VH_pPipelineStageCreationFeedbacks.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPipelineCreationFeedbackCreateInfo _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPipelineCreationFeedbackCreateInfo _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPipelineCreationFeedbackCreateInfo _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPipelineCreationFeedbackCreateInfo _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPipelineCreationFeedbackCreateInfo _pPipelineCreationFeedbackAt(long index, MemorySegment src) { _pPipelineCreationFeedbackAt(index).copyFrom(src); return this; }
    public VkPipelineCreationFeedbackCreateInfo _pPipelineCreationFeedback(MemorySegment src) { return _pPipelineCreationFeedbackAt(0L, src); }
    ...
    public VkPipelineCreationFeedbackCreateInfo _pipelineStageCreationFeedbackCountAt(long index, MemorySegment src) { _pipelineStageCreationFeedbackCountAt(index).copyFrom(src); return this; }
    public VkPipelineCreationFeedbackCreateInfo _pipelineStageCreationFeedbackCount(MemorySegment src) { return _pipelineStageCreationFeedbackCountAt(0L, src); }
    ...
    public VkPipelineCreationFeedbackCreateInfo _pPipelineStageCreationFeedbacksAt(long index, MemorySegment src) { _pPipelineStageCreationFeedbacksAt(index).copyFrom(src); return this; }
    public VkPipelineCreationFeedbackCreateInfo _pPipelineStageCreationFeedbacks(MemorySegment src) { return _pPipelineStageCreationFeedbacksAt(0L, src); }
}
