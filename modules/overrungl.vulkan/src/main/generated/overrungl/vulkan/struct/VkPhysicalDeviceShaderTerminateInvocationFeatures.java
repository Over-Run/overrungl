...
public final class VkPhysicalDeviceShaderTerminateInvocationFeatures extends GroupType {
    ...
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES); }
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceShaderTerminateInvocationFeatures sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures shaderTerminateInvocationAt(long index, int value) { VH_shaderTerminateInvocation.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures shaderTerminateInvocation(int value) { VH_shaderTerminateInvocation.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderTerminateInvocationFeatures _shaderTerminateInvocationAt(long index, MemorySegment src) { _shaderTerminateInvocationAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderTerminateInvocationFeatures _shaderTerminateInvocation(MemorySegment src) { return _shaderTerminateInvocationAt(0L, src); }
}
