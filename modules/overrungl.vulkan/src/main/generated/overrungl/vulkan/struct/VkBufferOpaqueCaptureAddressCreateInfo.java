...
public final class VkBufferOpaqueCaptureAddressCreateInfo extends GroupType {
    ...
    public static VkBufferOpaqueCaptureAddressCreateInfo allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO); }
    public static VkBufferOpaqueCaptureAddressCreateInfo allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkBufferOpaqueCaptureAddressCreateInfo sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkBufferOpaqueCaptureAddressCreateInfo pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkBufferOpaqueCaptureAddressCreateInfo opaqueCaptureAddressAt(long index, long value) { VH_opaqueCaptureAddress.set(this.segment(), 0L, index, value); return this; }
    public VkBufferOpaqueCaptureAddressCreateInfo sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferOpaqueCaptureAddressCreateInfo pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferOpaqueCaptureAddressCreateInfo opaqueCaptureAddress(long value) { VH_opaqueCaptureAddress.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkBufferOpaqueCaptureAddressCreateInfo _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkBufferOpaqueCaptureAddressCreateInfo _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkBufferOpaqueCaptureAddressCreateInfo _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkBufferOpaqueCaptureAddressCreateInfo _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkBufferOpaqueCaptureAddressCreateInfo _opaqueCaptureAddressAt(long index, MemorySegment src) { _opaqueCaptureAddressAt(index).copyFrom(src); return this; }
    public VkBufferOpaqueCaptureAddressCreateInfo _opaqueCaptureAddress(MemorySegment src) { return _opaqueCaptureAddressAt(0L, src); }
}
