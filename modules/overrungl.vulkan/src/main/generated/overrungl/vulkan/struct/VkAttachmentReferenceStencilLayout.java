...
public final class VkAttachmentReferenceStencilLayout extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_stencilLayout = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("stencilLayout")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int stencilLayout(MemorySegment segment, long index) { return (int) VH_stencilLayout.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void stencilLayout(MemorySegment segment, long index, int value) { VH_stencilLayout.get().set(segment, 0L, index, value); }
