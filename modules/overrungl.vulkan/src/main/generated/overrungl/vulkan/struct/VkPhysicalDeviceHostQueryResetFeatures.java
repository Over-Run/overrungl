...
public final class VkPhysicalDeviceHostQueryResetFeatures extends GroupType {
    ...
    public static VkPhysicalDeviceHostQueryResetFeatures allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES); }
    public static VkPhysicalDeviceHostQueryResetFeatures allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceHostQueryResetFeatures sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceHostQueryResetFeatures pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceHostQueryResetFeatures hostQueryResetAt(long index, int value) { VH_hostQueryReset.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceHostQueryResetFeatures sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceHostQueryResetFeatures pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceHostQueryResetFeatures hostQueryReset(int value) { VH_hostQueryReset.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceHostQueryResetFeatures _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceHostQueryResetFeatures _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceHostQueryResetFeatures _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceHostQueryResetFeatures _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceHostQueryResetFeatures _hostQueryResetAt(long index, MemorySegment src) { _hostQueryResetAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceHostQueryResetFeatures _hostQueryReset(MemorySegment src) { return _hostQueryResetAt(0L, src); }
}
