...
/// Represents `VkImageToMemoryCopy`.
/// ## Layout
/// ```
...
/// }
/// ```
public final class VkImageToMemoryCopy extends GroupType {
    ...
    public VkImageToMemoryCopy(MemorySegment segment, long elementCount) { super(segment, LAYOUT, elementCount); }
    public static VkImageToMemoryCopy of(MemorySegment segment) { return MemoryUtil.isNullPointer(segment) ? null : new VkImageToMemoryCopy(segment, estimateCount(segment, LAYOUT)); }
    public static VkImageToMemoryCopy ofNative(MemorySegment segment) { return MemoryUtil.isNullPointer(segment) ? null : new VkImageToMemoryCopy(segment.reinterpret(LAYOUT.byteSize()), 1); }
    public static VkImageToMemoryCopy ofNative(MemorySegment segment, long count) { return MemoryUtil.isNullPointer(segment) ? null : new VkImageToMemoryCopy(segment.reinterpret(LAYOUT.scale(0, count)), count); }
    public static VkImageToMemoryCopy alloc(SegmentAllocator allocator) { return new VkImageToMemoryCopy(allocator.allocate(LAYOUT), 1); }
    public static VkImageToMemoryCopy alloc(SegmentAllocator allocator, long count) { return new VkImageToMemoryCopy(allocator.allocate(LAYOUT, count), count); }
    public static VkImageToMemoryCopy allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_IMAGE_TO_MEMORY_COPY); }
    public static VkImageToMemoryCopy allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkImageToMemoryCopy reinterpret(long count) { return new VkImageToMemoryCopy(this.segment().reinterpret(LAYOUT.scale(0, count)), count); }
    public VkImageToMemoryCopy asSlice(long index) { return new VkImageToMemoryCopy(this.segment().asSlice(LAYOUT.scale(0L, index), LAYOUT), 1); }
    public VkImageToMemoryCopy asSlice(long index, long count) { return new VkImageToMemoryCopy(this.segment().asSlice(LAYOUT.scale(0L, index), LAYOUT.byteSize() * count), count); }
    public VkImageToMemoryCopy at(long index, Consumer<VkImageToMemoryCopy> func) { func.accept(asSlice(index)); return this; }
    ...
    public VkImageToMemoryCopy sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy pHostPointerAt(long index, MemorySegment value) { VH_pHostPointer.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy memoryRowLengthAt(long index, int value) { VH_memoryRowLength.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy memoryImageHeightAt(long index, int value) { VH_memoryImageHeight.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageSubresource$aspectMaskAt(long index, int value) { VH_imageSubresource$aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageSubresource$mipLevelAt(long index, int value) { VH_imageSubresource$mipLevel.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageSubresource$baseArrayLayerAt(long index, int value) { VH_imageSubresource$baseArrayLayer.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageSubresource$layerCountAt(long index, int value) { VH_imageSubresource$layerCount.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageOffset$xAt(long index, int value) { VH_imageOffset$x.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageOffset$yAt(long index, int value) { VH_imageOffset$y.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageOffset$zAt(long index, int value) { VH_imageOffset$z.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageExtent$widthAt(long index, int value) { VH_imageExtent$width.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageExtent$heightAt(long index, int value) { VH_imageExtent$height.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy imageExtent$depthAt(long index, int value) { VH_imageExtent$depth.set(this.segment(), 0L, index, value); return this; }
    public VkImageToMemoryCopy sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy pHostPointer(MemorySegment value) { VH_pHostPointer.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy memoryRowLength(int value) { VH_memoryRowLength.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy memoryImageHeight(int value) { VH_memoryImageHeight.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageSubresource$aspectMask(int value) { VH_imageSubresource$aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageSubresource$mipLevel(int value) { VH_imageSubresource$mipLevel.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageSubresource$baseArrayLayer(int value) { VH_imageSubresource$baseArrayLayer.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageSubresource$layerCount(int value) { VH_imageSubresource$layerCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageOffset$x(int value) { VH_imageOffset$x.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageOffset$y(int value) { VH_imageOffset$y.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageOffset$z(int value) { VH_imageOffset$z.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageExtent$width(int value) { VH_imageExtent$width.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageExtent$height(int value) { VH_imageExtent$height.set(this.segment(), 0L, 0L, value); return this; }
    public VkImageToMemoryCopy imageExtent$depth(int value) { VH_imageExtent$depth.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkImageToMemoryCopy _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkImageToMemoryCopy _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkImageToMemoryCopy _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkImageToMemoryCopy _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkImageToMemoryCopy _pHostPointerAt(long index, MemorySegment src) { _pHostPointerAt(index).copyFrom(src); return this; }
    public VkImageToMemoryCopy _pHostPointer(MemorySegment src) { return _pHostPointerAt(0L, src); }
    ...
    public VkImageToMemoryCopy _memoryRowLengthAt(long index, MemorySegment src) { _memoryRowLengthAt(index).copyFrom(src); return this; }
    public VkImageToMemoryCopy _memoryRowLength(MemorySegment src) { return _memoryRowLengthAt(0L, src); }
    ...
    public VkImageToMemoryCopy _memoryImageHeightAt(long index, MemorySegment src) { _memoryImageHeightAt(index).copyFrom(src); return this; }
    public VkImageToMemoryCopy _memoryImageHeight(MemorySegment src) { return _memoryImageHeightAt(0L, src); }
    ...
    public VkImageToMemoryCopy _imageSubresourceAt(long index, MemorySegment src) { _imageSubresourceAt(index).copyFrom(src); return this; }
    public VkImageToMemoryCopy _imageSubresource(MemorySegment src) { return _imageSubresourceAt(0L, src); }
    ...
    public VkImageToMemoryCopy _imageOffsetAt(long index, MemorySegment src) { _imageOffsetAt(index).copyFrom(src); return this; }
    public VkImageToMemoryCopy _imageOffset(MemorySegment src) { return _imageOffsetAt(0L, src); }
    ...
    public VkImageToMemoryCopy _imageExtentAt(long index, MemorySegment src) { _imageExtentAt(index).copyFrom(src); return this; }
    public VkImageToMemoryCopy _imageExtent(MemorySegment src) { return _imageExtentAt(0L, src); }
}
