...
public final class VkPipelineInputAssemblyStateCreateInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_topology = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("topology")));
    ...
    public static final Supplier<VarHandle> VH_primitiveRestartEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("primitiveRestartEnable")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int topology(MemorySegment segment, long index) { return (int) VH_topology.get().get(segment, 0L, index); }
    /// {@return `topology`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void topology(MemorySegment segment, long index, int value) { VH_topology.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int primitiveRestartEnable(MemorySegment segment, long index) { return (int) VH_primitiveRestartEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void primitiveRestartEnable(MemorySegment segment, long index, int value) { VH_primitiveRestartEnable.get().set(segment, 0L, index, value); }
