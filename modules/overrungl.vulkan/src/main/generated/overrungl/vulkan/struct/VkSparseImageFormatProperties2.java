...
public final class VkSparseImageFormatProperties2 extends GroupType {
    ...
    public static VkSparseImageFormatProperties2 allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK11.VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2); }
    public static VkSparseImageFormatProperties2 allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkSparseImageFormatProperties2 sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkSparseImageFormatProperties2 pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkSparseImageFormatProperties2 properties$aspectMaskAt(long index, int value) { VH_properties$aspectMask.set(this.segment(), 0L, index, value); return this; }
    public VkSparseImageFormatProperties2 properties$imageGranularity$widthAt(long index, int value) { VH_properties$imageGranularity$width.set(this.segment(), 0L, index, value); return this; }
    public VkSparseImageFormatProperties2 properties$imageGranularity$heightAt(long index, int value) { VH_properties$imageGranularity$height.set(this.segment(), 0L, index, value); return this; }
    public VkSparseImageFormatProperties2 properties$imageGranularity$depthAt(long index, int value) { VH_properties$imageGranularity$depth.set(this.segment(), 0L, index, value); return this; }
    public VkSparseImageFormatProperties2 properties$flagsAt(long index, int value) { VH_properties$flags.set(this.segment(), 0L, index, value); return this; }
    public VkSparseImageFormatProperties2 sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkSparseImageFormatProperties2 pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkSparseImageFormatProperties2 properties$aspectMask(int value) { VH_properties$aspectMask.set(this.segment(), 0L, 0L, value); return this; }
    public VkSparseImageFormatProperties2 properties$imageGranularity$width(int value) { VH_properties$imageGranularity$width.set(this.segment(), 0L, 0L, value); return this; }
    public VkSparseImageFormatProperties2 properties$imageGranularity$height(int value) { VH_properties$imageGranularity$height.set(this.segment(), 0L, 0L, value); return this; }
    public VkSparseImageFormatProperties2 properties$imageGranularity$depth(int value) { VH_properties$imageGranularity$depth.set(this.segment(), 0L, 0L, value); return this; }
    public VkSparseImageFormatProperties2 properties$flags(int value) { VH_properties$flags.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkSparseImageFormatProperties2 _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkSparseImageFormatProperties2 _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkSparseImageFormatProperties2 _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkSparseImageFormatProperties2 _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkSparseImageFormatProperties2 _propertiesAt(long index, MemorySegment src) { _propertiesAt(index).copyFrom(src); return this; }
    public VkSparseImageFormatProperties2 _properties(MemorySegment src) { return _propertiesAt(0L, src); }
}
