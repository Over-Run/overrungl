...
public final class VkDeviceCreateInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_queueCreateInfoCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("queueCreateInfoCount")));
    ...
    public static final Supplier<VarHandle> VH_pQueueCreateInfos = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pQueueCreateInfos")));
    ...
    public static final Supplier<VarHandle> VH_pEnabledFeatures = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pEnabledFeatures")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int queueCreateInfoCount(MemorySegment segment, long index) { return (int) VH_queueCreateInfoCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void queueCreateInfoCount(MemorySegment segment, long index, int value) { VH_queueCreateInfoCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pQueueCreateInfos(MemorySegment segment, long index) { return (MemorySegment) VH_pQueueCreateInfos.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pQueueCreateInfos(MemorySegment segment, long index, MemorySegment value) { VH_pQueueCreateInfos.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pEnabledFeatures(MemorySegment segment, long index) { return (MemorySegment) VH_pEnabledFeatures.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pEnabledFeatures(MemorySegment segment, long index, MemorySegment value) { VH_pEnabledFeatures.get().set(segment, 0L, index, value); }
