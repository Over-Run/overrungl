...
public final class VkPhysicalDeviceShaderFloatControls2Features extends GroupType {
    ...
    public static VkPhysicalDeviceShaderFloatControls2Features allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES); }
    public static VkPhysicalDeviceShaderFloatControls2Features allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceShaderFloatControls2Features sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderFloatControls2Features pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderFloatControls2Features shaderFloatControls2At(long index, int value) { VH_shaderFloatControls2.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderFloatControls2Features sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderFloatControls2Features pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderFloatControls2Features shaderFloatControls2(int value) { VH_shaderFloatControls2.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceShaderFloatControls2Features _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderFloatControls2Features _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceShaderFloatControls2Features _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderFloatControls2Features _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderFloatControls2Features _shaderFloatControls2At(long index, MemorySegment src) { _shaderFloatControls2At(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderFloatControls2Features _shaderFloatControls2(MemorySegment src) { return _shaderFloatControls2At(0L, src); }
}
