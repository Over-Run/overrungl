...
public final class VkPipelinePoolSize extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_poolEntryCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("poolEntryCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int poolEntryCount(MemorySegment segment, long index) { return (int) VH_poolEntryCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void poolEntryCount(MemorySegment segment, long index, int value) { VH_poolEntryCount.get().set(segment, 0L, index, value); }
