...
public final class VkPhysicalDeviceVulkan13Features extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_robustImageAccess = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("robustImageAccess")));
    ...
    public static final Supplier<VarHandle> VH_pipelineCreationCacheControl = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pipelineCreationCacheControl")));
    ...
    public static final Supplier<VarHandle> VH_shaderTerminateInvocation = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderTerminateInvocation")));
    ...
    public static final Supplier<VarHandle> VH_subgroupSizeControl = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("subgroupSizeControl")));
    ...
    public static final Supplier<VarHandle> VH_computeFullSubgroups = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("computeFullSubgroups")));
    ...
    public static final Supplier<VarHandle> VH_synchronization2 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("synchronization2")));
    ...
    public static final Supplier<VarHandle> VH_textureCompressionASTC_HDR = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("textureCompressionASTC_HDR")));
    ...
    public static final Supplier<VarHandle> VH_shaderIntegerDotProduct = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderIntegerDotProduct")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int robustImageAccess(MemorySegment segment, long index) { return (int) VH_robustImageAccess.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void robustImageAccess(MemorySegment segment, long index, int value) { VH_robustImageAccess.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int pipelineCreationCacheControl(MemorySegment segment, long index) { return (int) VH_pipelineCreationCacheControl.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pipelineCreationCacheControl(MemorySegment segment, long index, int value) { VH_pipelineCreationCacheControl.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderTerminateInvocation(MemorySegment segment, long index) { return (int) VH_shaderTerminateInvocation.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderTerminateInvocation(MemorySegment segment, long index, int value) { VH_shaderTerminateInvocation.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int subgroupSizeControl(MemorySegment segment, long index) { return (int) VH_subgroupSizeControl.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void subgroupSizeControl(MemorySegment segment, long index, int value) { VH_subgroupSizeControl.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int computeFullSubgroups(MemorySegment segment, long index) { return (int) VH_computeFullSubgroups.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void computeFullSubgroups(MemorySegment segment, long index, int value) { VH_computeFullSubgroups.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int synchronization2(MemorySegment segment, long index) { return (int) VH_synchronization2.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void synchronization2(MemorySegment segment, long index, int value) { VH_synchronization2.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int textureCompressionASTC_HDR(MemorySegment segment, long index) { return (int) VH_textureCompressionASTC_HDR.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void textureCompressionASTC_HDR(MemorySegment segment, long index, int value) { VH_textureCompressionASTC_HDR.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderIntegerDotProduct(MemorySegment segment, long index) { return (int) VH_shaderIntegerDotProduct.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderIntegerDotProduct(MemorySegment segment, long index, int value) { VH_shaderIntegerDotProduct.get().set(segment, 0L, index, value); }
