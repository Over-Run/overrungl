...
public final class VkPhysicalDeviceUniformBufferStandardLayoutFeatures extends GroupType {
    ...
    public static VkPhysicalDeviceUniformBufferStandardLayoutFeatures allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK12.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES); }
    public static VkPhysicalDeviceUniformBufferStandardLayoutFeatures allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures uniformBufferStandardLayoutAt(long index, int value) { VH_uniformBufferStandardLayout.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures uniformBufferStandardLayout(int value) { VH_uniformBufferStandardLayout.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures _uniformBufferStandardLayoutAt(long index, MemorySegment src) { _uniformBufferStandardLayoutAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures _uniformBufferStandardLayout(MemorySegment src) { return _uniformBufferStandardLayoutAt(0L, src); }
}
