...
public final class VkRenderPassAttachmentBeginInfo extends GroupType {
    ...
    /// Visits `VkRenderPassAttachmentBeginInfo` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkRenderPassAttachmentBeginInfo sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkRenderPassAttachmentBeginInfo pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkRenderPassAttachmentBeginInfo attachmentCountAt(long index, int value) { attachmentCount(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkRenderPassAttachmentBeginInfo pAttachmentsAt(long index, MemorySegment value) { pAttachments(this.segment(), index, value); return this; }
