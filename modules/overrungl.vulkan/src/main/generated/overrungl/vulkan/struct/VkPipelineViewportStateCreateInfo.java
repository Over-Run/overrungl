...
public final class VkPipelineViewportStateCreateInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pViewports = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pViewports")));
    ...
    public static final Supplier<VarHandle> VH_scissorCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("scissorCount")));
    ...
    public static final Supplier<VarHandle> VH_pScissors = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pScissors")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pViewports(MemorySegment segment, long index) { return (MemorySegment) VH_pViewports.get().get(segment, 0L, index); }
    /// {@return `pViewports`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pViewports(MemorySegment segment, long index, MemorySegment value) { VH_pViewports.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int scissorCount(MemorySegment segment, long index) { return (int) VH_scissorCount.get().get(segment, 0L, index); }
    /// {@return `scissorCount`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void scissorCount(MemorySegment segment, long index, int value) { VH_scissorCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pScissors(MemorySegment segment, long index) { return (MemorySegment) VH_pScissors.get().get(segment, 0L, index); }
    /// {@return `pScissors`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pScissors(MemorySegment segment, long index, MemorySegment value) { VH_pScissors.get().set(segment, 0L, index, value); }
