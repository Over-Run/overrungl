...
public final class VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_relaxedLineRasterization = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("relaxedLineRasterization")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int relaxedLineRasterization(MemorySegment segment, long index) { return (int) VH_relaxedLineRasterization.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void relaxedLineRasterization(MemorySegment segment, long index, int value) { VH_relaxedLineRasterization.get().set(segment, 0L, index, value); }
