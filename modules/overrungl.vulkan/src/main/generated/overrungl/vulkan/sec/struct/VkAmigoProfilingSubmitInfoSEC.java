...
public final class VkAmigoProfilingSubmitInfoSEC extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_firstDrawTimestamp = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("firstDrawTimestamp")));
    ...
    public static final Supplier<VarHandle> VH_swapBufferTimestamp = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("swapBufferTimestamp")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long firstDrawTimestamp(MemorySegment segment, long index) { return (long) VH_firstDrawTimestamp.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void firstDrawTimestamp(MemorySegment segment, long index, long value) { VH_firstDrawTimestamp.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long swapBufferTimestamp(MemorySegment segment, long index) { return (long) VH_swapBufferTimestamp.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void swapBufferTimestamp(MemorySegment segment, long index, long value) { VH_swapBufferTimestamp.get().set(segment, 0L, index, value); }
