...
public final class VkPhysicalDeviceAmigoProfilingFeaturesSEC extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_amigoProfiling = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("amigoProfiling")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int amigoProfiling(MemorySegment segment, long index) { return (int) VH_amigoProfiling.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void amigoProfiling(MemorySegment segment, long index, int value) { VH_amigoProfiling.get().set(segment, 0L, index, value); }
