...
public final class VK10 {
    ...
    public static int VK_VERSION_MINOR(int version) { return (version >>> 12) & 0x3FF; }
    public static int VK_VERSION_PATCH(int version) { return version & 0xFFF; }
    public static int VK_MAKE_API_VERSION(int variant, int major, int minor, int patch) { return (variant << 29) | (major << 22) | (minor << 12) | patch; }
    ...
    /// ```
    public static MemorySegment vkGetInstanceProcAddr(@NonNull VkInstance instance, @NonNull MemorySegment pName) {
    ...
    /// ```
    public static MemorySegment vkGetDeviceProcAddr(@NonNull VkDevice device, @NonNull MemorySegment pName) {
