...
public final class VkPhysicalDeviceYcbcrDegammaFeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_ycbcrDegamma = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("ycbcrDegamma")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int ycbcrDegamma(MemorySegment segment, long index) { return (int) VH_ycbcrDegamma.get().get(segment, 0L, index); }
    /// {@return `ycbcrDegamma`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void ycbcrDegamma(MemorySegment segment, long index, int value) { VH_ycbcrDegamma.get().set(segment, 0L, index, value); }
