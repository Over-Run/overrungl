...
public final class VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_perViewRenderAreaCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("perViewRenderAreaCount")));
    ...
    public static final Supplier<VarHandle> VH_pPerViewRenderAreas = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pPerViewRenderAreas")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int perViewRenderAreaCount(MemorySegment segment, long index) { return (int) VH_perViewRenderAreaCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void perViewRenderAreaCount(MemorySegment segment, long index, int value) { VH_perViewRenderAreaCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pPerViewRenderAreas(MemorySegment segment, long index) { return (MemorySegment) VH_pPerViewRenderAreas.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pPerViewRenderAreas(MemorySegment segment, long index, MemorySegment value) { VH_pPerViewRenderAreas.get().set(segment, 0L, index, value); }
