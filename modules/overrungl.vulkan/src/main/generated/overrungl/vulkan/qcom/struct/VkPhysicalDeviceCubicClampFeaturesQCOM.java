...
public final class VkPhysicalDeviceCubicClampFeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_cubicRangeClamp = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("cubicRangeClamp")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int cubicRangeClamp(MemorySegment segment, long index) { return (int) VH_cubicRangeClamp.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void cubicRangeClamp(MemorySegment segment, long index, int value) { VH_cubicRangeClamp.get().set(segment, 0L, index, value); }
