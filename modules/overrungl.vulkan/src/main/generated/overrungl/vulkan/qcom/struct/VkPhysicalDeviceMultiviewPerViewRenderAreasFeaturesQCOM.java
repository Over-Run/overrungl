...
public final class VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_multiviewPerViewRenderAreas = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("multiviewPerViewRenderAreas")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int multiviewPerViewRenderAreas(MemorySegment segment, long index) { return (int) VH_multiviewPerViewRenderAreas.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void multiviewPerViewRenderAreas(MemorySegment segment, long index, int value) { VH_multiviewPerViewRenderAreas.get().set(segment, 0L, index, value); }
