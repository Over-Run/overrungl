...
public final class VkPhysicalDeviceImageProcessing2FeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_textureBlockMatch2 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("textureBlockMatch2")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int textureBlockMatch2(MemorySegment segment, long index) { return (int) VH_textureBlockMatch2.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void textureBlockMatch2(MemorySegment segment, long index, int value) { VH_textureBlockMatch2.get().set(segment, 0L, index, value); }
