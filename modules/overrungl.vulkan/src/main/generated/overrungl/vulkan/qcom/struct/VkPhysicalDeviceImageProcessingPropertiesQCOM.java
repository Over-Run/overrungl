...
public final class VkPhysicalDeviceImageProcessingPropertiesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxWeightFilterPhases = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxWeightFilterPhases")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxWeightFilterPhases(MemorySegment segment, long index) { return (int) VH_maxWeightFilterPhases.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxWeightFilterPhases(MemorySegment segment, long index, int value) { VH_maxWeightFilterPhases.get().set(segment, 0L, index, value); }
