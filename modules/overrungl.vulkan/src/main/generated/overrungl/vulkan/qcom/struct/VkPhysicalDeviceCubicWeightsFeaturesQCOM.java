...
public final class VkPhysicalDeviceCubicWeightsFeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_selectableCubicWeights = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("selectableCubicWeights")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int selectableCubicWeights(MemorySegment segment, long index) { return (int) VH_selectableCubicWeights.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void selectableCubicWeights(MemorySegment segment, long index, int value) { VH_selectableCubicWeights.get().set(segment, 0L, index, value); }
