...
public final class VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_multiviewPerViewViewports = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("multiviewPerViewViewports")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int multiviewPerViewViewports(MemorySegment segment, long index) { return (int) VH_multiviewPerViewViewports.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void multiviewPerViewViewports(MemorySegment segment, long index, int value) { VH_multiviewPerViewViewports.get().set(segment, 0L, index, value); }
