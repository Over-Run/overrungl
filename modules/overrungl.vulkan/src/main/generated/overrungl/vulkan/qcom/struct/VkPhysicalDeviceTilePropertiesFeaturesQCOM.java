...
public final class VkPhysicalDeviceTilePropertiesFeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_tileProperties = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("tileProperties")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int tileProperties(MemorySegment segment, long index) { return (int) VH_tileProperties.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void tileProperties(MemorySegment segment, long index, int value) { VH_tileProperties.get().set(segment, 0L, index, value); }
