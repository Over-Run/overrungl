...
public final class VkTileMemorySizeInfoQCOM extends GroupType {
    ...
    /// Visits `VkTileMemorySizeInfoQCOM` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkTileMemorySizeInfoQCOM sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkTileMemorySizeInfoQCOM pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkTileMemorySizeInfoQCOM sizeAt(long index, long value) { size(this.segment(), index, value); return this; }
