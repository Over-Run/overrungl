...
public final class VkRenderPassTransformBeginInfoQCOM extends GroupType {
    ...
    public static VkRenderPassTransformBeginInfoQCOM allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.qcom.VKQCOMRenderPassTransform.VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM); }
    public static VkRenderPassTransformBeginInfoQCOM allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.qcom.VKQCOMRenderPassTransform.VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM);
        return s;
    }
    ...
    public VkRenderPassTransformBeginInfoQCOM sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkRenderPassTransformBeginInfoQCOM pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkRenderPassTransformBeginInfoQCOM transformAt(long index, int value) { VH_transform.set(this.segment(), 0L, index, value); return this; }
    public VkRenderPassTransformBeginInfoQCOM sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkRenderPassTransformBeginInfoQCOM pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkRenderPassTransformBeginInfoQCOM transform(int value) { VH_transform.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkRenderPassTransformBeginInfoQCOM _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkRenderPassTransformBeginInfoQCOM _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkRenderPassTransformBeginInfoQCOM _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkRenderPassTransformBeginInfoQCOM _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkRenderPassTransformBeginInfoQCOM _transformAt(long index, MemorySegment src) { _transformAt(index).copyFrom(src); return this; }
    public VkRenderPassTransformBeginInfoQCOM _transform(MemorySegment src) { return _transformAt(0L, src); }
}
