...
public final class VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_fragmentDensityMapOffset = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("fragmentDensityMapOffset")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int fragmentDensityMapOffset(MemorySegment segment, long index) { return (int) VH_fragmentDensityMapOffset.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void fragmentDensityMapOffset(MemorySegment segment, long index, int value) { VH_fragmentDensityMapOffset.get().set(segment, 0L, index, value); }
