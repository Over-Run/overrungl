...
public final class VkPhysicalDeviceTileMemoryHeapFeaturesQCOM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_tileMemoryHeap = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("tileMemoryHeap")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int tileMemoryHeap(MemorySegment segment, long index) { return (int) VH_tileMemoryHeap.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void tileMemoryHeap(MemorySegment segment, long index, int value) { VH_tileMemoryHeap.get().set(segment, 0L, index, value); }
