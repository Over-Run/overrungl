...
public final class VKAMDBufferMarker {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCmdWriteBufferMarkerAMD = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_vkCmdWriteBufferMarker2AMD = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
        private Handles() {}
    }
    ...
    public static void vkCmdWriteBufferMarkerAMD(@NonNull VkCommandBuffer commandBuffer, int pipelineStage, long dstBuffer, long dstOffset, int marker) {
        ...
        Handles.MH_vkCmdWriteBufferMarkerAMD.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdWriteBufferMarkerAMD, commandBuffer.segment(), pipelineStage, dstBuffer, dstOffset, marker); }
    ...
    public static void vkCmdWriteBufferMarker2AMD(@NonNull VkCommandBuffer commandBuffer, long stage, long dstBuffer, long dstOffset, int marker) {
        ...
        Handles.MH_vkCmdWriteBufferMarker2AMD.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdWriteBufferMarker2AMD, commandBuffer.segment(), stage, dstBuffer, dstOffset, marker); }
