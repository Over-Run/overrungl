...
public final class VkPipelineCompilerControlCreateInfoAMD extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_compilerControlFlags = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("compilerControlFlags")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int compilerControlFlags(MemorySegment segment, long index) { return (int) VH_compilerControlFlags.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void compilerControlFlags(MemorySegment segment, long index, int value) { VH_compilerControlFlags.get().set(segment, 0L, index, value); }
