...
public final class VkPipelineRasterizationStateRasterizationOrderAMD extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_rasterizationOrder = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("rasterizationOrder")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int rasterizationOrder(MemorySegment segment, long index) { return (int) VH_rasterizationOrder.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void rasterizationOrder(MemorySegment segment, long index, int value) { VH_rasterizationOrder.get().set(segment, 0L, index, value); }
