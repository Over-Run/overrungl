...
public final class VkDisplayNativeHdrSurfaceCapabilitiesAMD extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_localDimmingSupport = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("localDimmingSupport")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int localDimmingSupport(MemorySegment segment, long index) { return (int) VH_localDimmingSupport.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void localDimmingSupport(MemorySegment segment, long index, int value) { VH_localDimmingSupport.get().set(segment, 0L, index, value); }
