...
public final class VkDeviceMemoryOverallocationCreateInfoAMD extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_overallocationBehavior = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("overallocationBehavior")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int overallocationBehavior(MemorySegment segment, long index) { return (int) VH_overallocationBehavior.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void overallocationBehavior(MemorySegment segment, long index, int value) { VH_overallocationBehavior.get().set(segment, 0L, index, value); }
