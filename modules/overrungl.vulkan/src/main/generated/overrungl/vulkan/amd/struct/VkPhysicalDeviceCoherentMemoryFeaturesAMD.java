...
public final class VkPhysicalDeviceCoherentMemoryFeaturesAMD extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_deviceCoherentMemory = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("deviceCoherentMemory")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int deviceCoherentMemory(MemorySegment segment, long index) { return (int) VH_deviceCoherentMemory.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void deviceCoherentMemory(MemorySegment segment, long index, int value) { VH_deviceCoherentMemory.get().set(segment, 0L, index, value); }
