...
public final class VkTextureLODGatherFormatPropertiesAMD extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_supportsTextureGatherLODBiasAMD = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("supportsTextureGatherLODBiasAMD")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int supportsTextureGatherLODBiasAMD(MemorySegment segment, long index) { return (int) VH_supportsTextureGatherLODBiasAMD.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void supportsTextureGatherLODBiasAMD(MemorySegment segment, long index, int value) { VH_supportsTextureGatherLODBiasAMD.get().set(segment, 0L, index, value); }
