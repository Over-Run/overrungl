...
public final class VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderEarlyAndLateFragmentTests = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderEarlyAndLateFragmentTests")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderEarlyAndLateFragmentTests(MemorySegment segment, long index) { return (int) VH_shaderEarlyAndLateFragmentTests.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderEarlyAndLateFragmentTests(MemorySegment segment, long index, int value) { VH_shaderEarlyAndLateFragmentTests.get().set(segment, 0L, index, value); }
