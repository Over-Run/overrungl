...
public final class VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD extends GroupType {
    ...
    public static VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.amd.VKAMDShaderEarlyAndLateFragmentTests.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_FEATURES_AMD); }
    public static VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.amd.VKAMDShaderEarlyAndLateFragmentTests.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_FEATURES_AMD);
        return s;
    }
    ...
    public int shaderEarlyAndLateFragmentTestsAt(long index) { return (int) VH_shaderEarlyAndLateFragmentTests.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int shaderEarlyAndLateFragmentTests() { return (int) VH_shaderEarlyAndLateFragmentTests.get(this.segment(), 0L, 0L); }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD shaderEarlyAndLateFragmentTestsAt(long index, int value) { VH_shaderEarlyAndLateFragmentTests.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD shaderEarlyAndLateFragmentTests(int value) { VH_shaderEarlyAndLateFragmentTests.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _shaderEarlyAndLateFragmentTestsAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_shaderEarlyAndLateFragmentTests, index), LAYOUT_shaderEarlyAndLateFragmentTests); }
    public MemorySegment _shaderEarlyAndLateFragmentTests() { return _shaderEarlyAndLateFragmentTestsAt(0L); }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD _shaderEarlyAndLateFragmentTestsAt(long index, MemorySegment src) { _shaderEarlyAndLateFragmentTestsAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD _shaderEarlyAndLateFragmentTests(MemorySegment src) { return _shaderEarlyAndLateFragmentTestsAt(0L, src); }
}
