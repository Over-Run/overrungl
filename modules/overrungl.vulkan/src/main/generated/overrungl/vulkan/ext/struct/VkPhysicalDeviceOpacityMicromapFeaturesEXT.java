...
public final class VkPhysicalDeviceOpacityMicromapFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_micromapCaptureReplay = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("micromapCaptureReplay")));
    ...
    public static final Supplier<VarHandle> VH_micromapHostCommands = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("micromapHostCommands")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int micromap(MemorySegment segment, long index) { return (int) VH_micromap.get().get(segment, 0L, index); }
    /// {@return `micromap`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void micromap(MemorySegment segment, long index, int value) { VH_micromap.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int micromapCaptureReplay(MemorySegment segment, long index) { return (int) VH_micromapCaptureReplay.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void micromapCaptureReplay(MemorySegment segment, long index, int value) { VH_micromapCaptureReplay.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int micromapHostCommands(MemorySegment segment, long index) { return (int) VH_micromapHostCommands.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void micromapHostCommands(MemorySegment segment, long index, int value) { VH_micromapHostCommands.get().set(segment, 0L, index, value); }
