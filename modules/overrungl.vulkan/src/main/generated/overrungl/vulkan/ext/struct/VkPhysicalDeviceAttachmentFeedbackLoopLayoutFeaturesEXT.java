...
public final class VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_attachmentFeedbackLoopLayout = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("attachmentFeedbackLoopLayout")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int attachmentFeedbackLoopLayout(MemorySegment segment, long index) { return (int) VH_attachmentFeedbackLoopLayout.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void attachmentFeedbackLoopLayout(MemorySegment segment, long index, int value) { VH_attachmentFeedbackLoopLayout.get().set(segment, 0L, index, value); }
