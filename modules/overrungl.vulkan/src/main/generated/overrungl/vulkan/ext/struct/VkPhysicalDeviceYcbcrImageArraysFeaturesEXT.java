...
public final class VkPhysicalDeviceYcbcrImageArraysFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_ycbcrImageArrays = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("ycbcrImageArrays")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int ycbcrImageArrays(MemorySegment segment, long index) { return (int) VH_ycbcrImageArrays.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void ycbcrImageArrays(MemorySegment segment, long index, int value) { VH_ycbcrImageArrays.get().set(segment, 0L, index, value); }
