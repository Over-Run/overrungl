...
public final class VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_imageCompressionControlSwapchain = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("imageCompressionControlSwapchain")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int imageCompressionControlSwapchain(MemorySegment segment, long index) { return (int) VH_imageCompressionControlSwapchain.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void imageCompressionControlSwapchain(MemorySegment segment, long index, int value) { VH_imageCompressionControlSwapchain.get().set(segment, 0L, index, value); }
