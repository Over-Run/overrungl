...
public final class VkOpaqueCaptureDescriptorDataCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_opaqueCaptureDescriptorData = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("opaqueCaptureDescriptorData")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment opaqueCaptureDescriptorData(MemorySegment segment, long index) { return (MemorySegment) VH_opaqueCaptureDescriptorData.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void opaqueCaptureDescriptorData(MemorySegment segment, long index, MemorySegment value) { VH_opaqueCaptureDescriptorData.get().set(segment, 0L, index, value); }
