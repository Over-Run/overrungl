...
public final class VkPhysicalDeviceASTCDecodeFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_decodeModeSharedExponent = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("decodeModeSharedExponent")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int decodeModeSharedExponent(MemorySegment segment, long index) { return (int) VH_decodeModeSharedExponent.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void decodeModeSharedExponent(MemorySegment segment, long index, int value) { VH_decodeModeSharedExponent.get().set(segment, 0L, index, value); }
