...
public final class VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT extends GroupType {
    ...
    /// The [VarHandle] of `shaderModuleIdentifier` of type `(MemorySegment base, long baseOffset, long index)MemorySegment`.
    public static final Supplier<VarHandle> VH_shaderModuleIdentifier = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderModuleIdentifier")));
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }

    /// {@return `shaderModuleIdentifier` at the given index}
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderModuleIdentifier(MemorySegment segment, long index) { return (int) VH_shaderModuleIdentifier.get().get(segment, 0L, index); }
    /// {@return `shaderModuleIdentifier`}
    public int shaderModuleIdentifier() { return shaderModuleIdentifier(this.segment(), 0L); }
    /// Sets `shaderModuleIdentifier` with the given value at the given index.
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderModuleIdentifier(MemorySegment segment, long index, int value) { VH_shaderModuleIdentifier.get().set(segment, 0L, index, value); }
    /// Sets `shaderModuleIdentifier` with the given value.
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT shaderModuleIdentifier(int value) { shaderModuleIdentifier(this.segment(), 0L, value); return this; }
    ...
    /// Visits `VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }

    /// {@return `shaderModuleIdentifier` at the given index}
    /// @param index the index of the struct buffer
    public int shaderModuleIdentifierAt(long index) { return shaderModuleIdentifier(this.segment(), index); }
    /// Sets `shaderModuleIdentifier` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT shaderModuleIdentifierAt(long index, int value) { shaderModuleIdentifier(this.segment(), index, value); return this; }
