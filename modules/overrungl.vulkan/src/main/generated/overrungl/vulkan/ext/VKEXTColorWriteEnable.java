...
public final class VKEXTColorWriteEnable {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCmdSetColorWriteEnableEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static void vkCmdSetColorWriteEnableEXT(@NonNull VkCommandBuffer commandBuffer, int attachmentCount, @NonNull MemorySegment pColorWriteEnables) {
        ...
        Handles.MH_vkCmdSetColorWriteEnableEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdSetColorWriteEnableEXT, commandBuffer.segment(), attachmentCount, pColorWriteEnables); }
