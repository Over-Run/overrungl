...
public final class VkSurfacePresentModeCompatibilityEXT extends GroupType {
    ...
    public static VkSurfacePresentModeCompatibilityEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRSurfaceMaintenance1.VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_COMPATIBILITY_KHR); }
    public static VkSurfacePresentModeCompatibilityEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkSurfacePresentModeCompatibilityEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkSurfacePresentModeCompatibilityEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkSurfacePresentModeCompatibilityEXT presentModeCountAt(long index, int value) { VH_presentModeCount.set(this.segment(), 0L, index, value); return this; }
    public VkSurfacePresentModeCompatibilityEXT pPresentModesAt(long index, MemorySegment value) { VH_pPresentModes.set(this.segment(), 0L, index, value); return this; }
    public VkSurfacePresentModeCompatibilityEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkSurfacePresentModeCompatibilityEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkSurfacePresentModeCompatibilityEXT presentModeCount(int value) { VH_presentModeCount.set(this.segment(), 0L, 0L, value); return this; }
    public VkSurfacePresentModeCompatibilityEXT pPresentModes(MemorySegment value) { VH_pPresentModes.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkSurfacePresentModeCompatibilityEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkSurfacePresentModeCompatibilityEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkSurfacePresentModeCompatibilityEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkSurfacePresentModeCompatibilityEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkSurfacePresentModeCompatibilityEXT _presentModeCountAt(long index, MemorySegment src) { _presentModeCountAt(index).copyFrom(src); return this; }
    public VkSurfacePresentModeCompatibilityEXT _presentModeCount(MemorySegment src) { return _presentModeCountAt(0L, src); }
    ...
    public VkSurfacePresentModeCompatibilityEXT _pPresentModesAt(long index, MemorySegment src) { _pPresentModesAt(index).copyFrom(src); return this; }
    public VkSurfacePresentModeCompatibilityEXT _pPresentModes(MemorySegment src) { return _pPresentModesAt(0L, src); }
}
