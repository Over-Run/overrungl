...
public final class VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_swapchainMaintenance1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("swapchainMaintenance1")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int swapchainMaintenance1(MemorySegment segment, long index) { return (int) VH_swapchainMaintenance1.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void swapchainMaintenance1(MemorySegment segment, long index, int value) { VH_swapchainMaintenance1.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT swapchainMaintenance1At(long index, int value) { swapchainMaintenance1(this.segment(), index, value); return this; }
