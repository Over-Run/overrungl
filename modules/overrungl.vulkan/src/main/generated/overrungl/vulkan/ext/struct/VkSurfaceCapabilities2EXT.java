...
public final class VkSurfaceCapabilities2EXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_supportedSurfaceCounters = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("supportedSurfaceCounters")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int supportedSurfaceCounters(MemorySegment segment, long index) { return (int) VH_supportedSurfaceCounters.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void supportedSurfaceCounters(MemorySegment segment, long index, int value) { VH_supportedSurfaceCounters.get().set(segment, 0L, index, value); }
