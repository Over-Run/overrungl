...
public final class VkMemoryPriorityAllocateInfoEXT extends GroupType {
    ...
    public static VkMemoryPriorityAllocateInfoEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.ext.VKEXTMemoryPriority.VK_STRUCTURE_TYPE_MEMORY_PRIORITY_ALLOCATE_INFO_EXT); }
    public static VkMemoryPriorityAllocateInfoEXT allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.ext.VKEXTMemoryPriority.VK_STRUCTURE_TYPE_MEMORY_PRIORITY_ALLOCATE_INFO_EXT);
        return s;
    }
    ...
    public float priorityAt(long index) { return (float) VH_priority.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public float priority() { return (float) VH_priority.get(this.segment(), 0L, 0L); }
    public VkMemoryPriorityAllocateInfoEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkMemoryPriorityAllocateInfoEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkMemoryPriorityAllocateInfoEXT priorityAt(long index, float value) { VH_priority.set(this.segment(), 0L, index, value); return this; }
    public VkMemoryPriorityAllocateInfoEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkMemoryPriorityAllocateInfoEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkMemoryPriorityAllocateInfoEXT priority(float value) { VH_priority.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkMemoryPriorityAllocateInfoEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkMemoryPriorityAllocateInfoEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkMemoryPriorityAllocateInfoEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkMemoryPriorityAllocateInfoEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _priorityAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_priority, index), LAYOUT_priority); }
    public MemorySegment _priority() { return _priorityAt(0L); }
    public VkMemoryPriorityAllocateInfoEXT _priorityAt(long index, MemorySegment src) { _priorityAt(index).copyFrom(src); return this; }
    public VkMemoryPriorityAllocateInfoEXT _priority(MemorySegment src) { return _priorityAt(0L, src); }
}
