...
public final class VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pipelineLibraryGroupHandles = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pipelineLibraryGroupHandles")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int pipelineLibraryGroupHandles(MemorySegment segment, long index) { return (int) VH_pipelineLibraryGroupHandles.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pipelineLibraryGroupHandles(MemorySegment segment, long index, int value) { VH_pipelineLibraryGroupHandles.get().set(segment, 0L, index, value); }
