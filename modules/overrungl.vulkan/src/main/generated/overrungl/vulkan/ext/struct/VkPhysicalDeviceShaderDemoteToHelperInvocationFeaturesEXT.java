...
public final class VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT extends GroupType {
    ...
    public static VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES); }
    public static VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT shaderDemoteToHelperInvocationAt(long index, int value) { VH_shaderDemoteToHelperInvocation.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT shaderDemoteToHelperInvocation(int value) { VH_shaderDemoteToHelperInvocation.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT _shaderDemoteToHelperInvocationAt(long index, MemorySegment src) { _shaderDemoteToHelperInvocationAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT _shaderDemoteToHelperInvocation(MemorySegment src) { return _shaderDemoteToHelperInvocationAt(0L, src); }
}
