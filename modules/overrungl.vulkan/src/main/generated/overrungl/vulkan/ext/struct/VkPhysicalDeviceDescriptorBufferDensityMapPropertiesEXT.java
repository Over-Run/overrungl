...
public final class VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_combinedImageSamplerDensityMapDescriptorSize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("combinedImageSamplerDensityMapDescriptorSize")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long combinedImageSamplerDensityMapDescriptorSize(MemorySegment segment, long index) { return MemoryUtil.wideningToLong(CanonicalTypes.SIZE_T, VH_combinedImageSamplerDensityMapDescriptorSize.get().get(segment, 0L, index)); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void combinedImageSamplerDensityMapDescriptorSize(MemorySegment segment, long index, long value) { VH_combinedImageSamplerDensityMapDescriptorSize.get().set(segment, 0L, index, MemoryUtil.narrowingLong(CanonicalTypes.SIZE_T, value)); }
