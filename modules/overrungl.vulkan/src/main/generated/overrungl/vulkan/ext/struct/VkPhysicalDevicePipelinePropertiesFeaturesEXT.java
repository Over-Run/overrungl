...
public final class VkPhysicalDevicePipelinePropertiesFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pipelinePropertiesIdentifier = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pipelinePropertiesIdentifier")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int pipelinePropertiesIdentifier(MemorySegment segment, long index) { return (int) VH_pipelinePropertiesIdentifier.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pipelinePropertiesIdentifier(MemorySegment segment, long index, int value) { VH_pipelinePropertiesIdentifier.get().set(segment, 0L, index, value); }
