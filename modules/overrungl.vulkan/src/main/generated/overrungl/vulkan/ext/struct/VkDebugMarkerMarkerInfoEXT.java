...
public final class VkDebugMarkerMarkerInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pMarkerName = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pMarkerName")));
    ...
    public static final Supplier<VarHandle> VH_color = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("color"), PathElement.sequenceElement()));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pMarkerName(MemorySegment segment, long index) { return (MemorySegment) VH_pMarkerName.get().get(segment, 0L, index); }
    /// {@return `pMarkerName`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pMarkerName(MemorySegment segment, long index, MemorySegment value) { VH_pMarkerName.get().set(segment, 0L, index, value); }
    ...
    public static float color(MemorySegment segment, long index, long index0) { return (float) VH_color.get().get(segment, 0L, index, index0); }
    /// {@return `color`}
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void color(MemorySegment segment, long index, long index0, float value) { VH_color.get().set(segment, 0L, index, index0, value); }
    ...
    /// Visits `VkDebugMarkerMarkerInfoEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkDebugMarkerMarkerInfoEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDebugMarkerMarkerInfoEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDebugMarkerMarkerInfoEXT pMarkerNameAt(long index, MemorySegment value) { pMarkerName(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDebugMarkerMarkerInfoEXT colorAt(long index, MemorySegment value) { color(this.segment(), index, value); return this; }
    /// Sets `color` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param value the value
    /// @return `this`
    public VkDebugMarkerMarkerInfoEXT colorAt(long index, long index0, float value) { color(this.segment(), index, index0, value); return this; }
