...
public final class VkSubresourceHostMemcpySizeEXT extends GroupType {
    /// The struct layout of `VkSubresourceHostMemcpySizeEXT`.
    ...
    /// Creates `VkSubresourceHostMemcpySizeEXT` with the given segment.
    ...
    /// Allocates a `VkSubresourceHostMemcpySizeEXT` with the given segment allocator.
    ...
    /// Allocates a `VkSubresourceHostMemcpySizeEXT` with the given segment allocator and count.
    /// @param allocator the segment allocator
    ...
    /// @param value the value
    /// @return `this`
    public VkSubresourceHostMemcpySizeEXT sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSubresourceHostMemcpySizeEXT pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSubresourceHostMemcpySizeEXT size(long value) { size(this.segment(), 0L, value); return this; }

    /// Creates a slice of `VkSubresourceHostMemcpySizeEXT`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkSubresourceHostMemcpySizeEXT`
    ...
    /// Visits `VkSubresourceHostMemcpySizeEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkSubresourceHostMemcpySizeEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSubresourceHostMemcpySizeEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSubresourceHostMemcpySizeEXT sizeAt(long index, long value) { size(this.segment(), index, value); return this; }
