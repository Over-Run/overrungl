...
public final class VkPhysicalDeviceDepthClampZeroOneFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_depthClampZeroOne = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("depthClampZeroOne")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int depthClampZeroOne(MemorySegment segment, long index) { return (int) VH_depthClampZeroOne.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void depthClampZeroOne(MemorySegment segment, long index, int value) { VH_depthClampZeroOne.get().set(segment, 0L, index, value); }
