...
public final class VkPhysicalDeviceShaderReplicatedCompositesFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderReplicatedComposites = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderReplicatedComposites")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderReplicatedComposites(MemorySegment segment, long index) { return (int) VH_shaderReplicatedComposites.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderReplicatedComposites(MemorySegment segment, long index, int value) { VH_shaderReplicatedComposites.get().set(segment, 0L, index, value); }
