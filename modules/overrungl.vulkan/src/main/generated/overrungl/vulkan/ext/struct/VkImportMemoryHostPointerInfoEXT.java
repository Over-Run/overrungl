...
public final class VkImportMemoryHostPointerInfoEXT extends GroupType {
    ...
    public static VkImportMemoryHostPointerInfoEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.ext.VKEXTExternalMemoryHost.VK_STRUCTURE_TYPE_IMPORT_MEMORY_HOST_POINTER_INFO_EXT); }
    public static VkImportMemoryHostPointerInfoEXT allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.ext.VKEXTExternalMemoryHost.VK_STRUCTURE_TYPE_IMPORT_MEMORY_HOST_POINTER_INFO_EXT);
        return s;
    }
    ...
    public VkImportMemoryHostPointerInfoEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkImportMemoryHostPointerInfoEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkImportMemoryHostPointerInfoEXT handleTypeAt(long index, int value) { VH_handleType.set(this.segment(), 0L, index, value); return this; }
    public VkImportMemoryHostPointerInfoEXT pHostPointerAt(long index, MemorySegment value) { VH_pHostPointer.set(this.segment(), 0L, index, value); return this; }
    public VkImportMemoryHostPointerInfoEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkImportMemoryHostPointerInfoEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkImportMemoryHostPointerInfoEXT handleType(int value) { VH_handleType.set(this.segment(), 0L, 0L, value); return this; }
    public VkImportMemoryHostPointerInfoEXT pHostPointer(MemorySegment value) { VH_pHostPointer.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkImportMemoryHostPointerInfoEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkImportMemoryHostPointerInfoEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkImportMemoryHostPointerInfoEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkImportMemoryHostPointerInfoEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkImportMemoryHostPointerInfoEXT _handleTypeAt(long index, MemorySegment src) { _handleTypeAt(index).copyFrom(src); return this; }
    public VkImportMemoryHostPointerInfoEXT _handleType(MemorySegment src) { return _handleTypeAt(0L, src); }
    ...
    public VkImportMemoryHostPointerInfoEXT _pHostPointerAt(long index, MemorySegment src) { _pHostPointerAt(index).copyFrom(src); return this; }
    public VkImportMemoryHostPointerInfoEXT _pHostPointer(MemorySegment src) { return _pHostPointerAt(0L, src); }
}
