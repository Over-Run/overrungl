...
public final class VkPhysicalDeviceMultiDrawPropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxMultiDrawCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxMultiDrawCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxMultiDrawCount(MemorySegment segment, long index) { return (int) VH_maxMultiDrawCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxMultiDrawCount(MemorySegment segment, long index, int value) { VH_maxMultiDrawCount.get().set(segment, 0L, index, value); }
