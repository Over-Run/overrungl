...
public final class VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_vertexInputDynamicState = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("vertexInputDynamicState")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int vertexInputDynamicState(MemorySegment segment, long index) { return (int) VH_vertexInputDynamicState.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void vertexInputDynamicState(MemorySegment segment, long index, int value) { VH_vertexInputDynamicState.get().set(segment, 0L, index, value); }
