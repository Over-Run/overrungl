...
public final class VkPhysicalDeviceImageRobustnessFeaturesEXT extends GroupType {
    ...
    public static VkPhysicalDeviceImageRobustnessFeaturesEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES); }
    public static VkPhysicalDeviceImageRobustnessFeaturesEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceImageRobustnessFeaturesEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT robustImageAccessAt(long index, int value) { VH_robustImageAccess.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT robustImageAccess(int value) { VH_robustImageAccess.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceImageRobustnessFeaturesEXT _robustImageAccessAt(long index, MemorySegment src) { _robustImageAccessAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceImageRobustnessFeaturesEXT _robustImageAccess(MemorySegment src) { return _robustImageAccessAt(0L, src); }
}
