...
public final class VkPhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_attachmentFeedbackLoopDynamicState = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("attachmentFeedbackLoopDynamicState")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int attachmentFeedbackLoopDynamicState(MemorySegment segment, long index) { return (int) VH_attachmentFeedbackLoopDynamicState.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void attachmentFeedbackLoopDynamicState(MemorySegment segment, long index, int value) { VH_attachmentFeedbackLoopDynamicState.get().set(segment, 0L, index, value); }
