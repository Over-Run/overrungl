...
public final class VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_nativeUnalignedPerformance = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("nativeUnalignedPerformance")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int nativeUnalignedPerformance(MemorySegment segment, long index) { return (int) VH_nativeUnalignedPerformance.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void nativeUnalignedPerformance(MemorySegment segment, long index, int value) { VH_nativeUnalignedPerformance.get().set(segment, 0L, index, value); }
