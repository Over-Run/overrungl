...
public final class VkPhysicalDeviceDeviceMemoryReportFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_deviceMemoryReport = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("deviceMemoryReport")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int deviceMemoryReport(MemorySegment segment, long index) { return (int) VH_deviceMemoryReport.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void deviceMemoryReport(MemorySegment segment, long index, int value) { VH_deviceMemoryReport.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPhysicalDeviceDeviceMemoryReportFeaturesEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceDeviceMemoryReportFeaturesEXT deviceMemoryReportAt(long index, int value) { deviceMemoryReport(this.segment(), index, value); return this; }
