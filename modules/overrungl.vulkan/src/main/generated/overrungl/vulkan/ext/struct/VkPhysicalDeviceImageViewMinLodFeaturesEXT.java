...
public final class VkPhysicalDeviceImageViewMinLodFeaturesEXT extends GroupType {
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int minLod(MemorySegment segment, long index) { return (int) VH_minLod.get().get(segment, 0L, index); }
    /// {@return `minLod`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void minLod(MemorySegment segment, long index, int value) { VH_minLod.get().set(segment, 0L, index, value); }
