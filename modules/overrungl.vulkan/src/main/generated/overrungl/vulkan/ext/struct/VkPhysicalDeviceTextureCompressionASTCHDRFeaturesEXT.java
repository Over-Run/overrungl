...
/// Represents `VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT extends GroupType {
    ...
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES); }
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT textureCompressionASTC_HDRAt(long index, int value) { VH_textureCompressionASTC_HDR.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT textureCompressionASTC_HDR(int value) { VH_textureCompressionASTC_HDR.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT _textureCompressionASTC_HDRAt(long index, MemorySegment src) { _textureCompressionASTC_HDRAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT _textureCompressionASTC_HDR(MemorySegment src) { return _textureCompressionASTC_HDRAt(0L, src); }
}
