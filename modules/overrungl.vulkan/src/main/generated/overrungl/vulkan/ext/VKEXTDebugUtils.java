...
public final class VKEXTDebugUtils {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkSetDebugUtilsObjectNameEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkSetDebugUtilsObjectTagEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkQueueBeginDebugUtilsLabelEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkQueueEndDebugUtilsLabelEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkQueueInsertDebugUtilsLabelEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdBeginDebugUtilsLabelEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdEndDebugUtilsLabelEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdInsertDebugUtilsLabelEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCreateDebugUtilsMessengerEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkDestroyDebugUtilsMessengerEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkSubmitDebugUtilsMessageEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkSetDebugUtilsObjectNameEXT(@NonNull VkDevice device, @NonNull MemorySegment pNameInfo) {
        ...
        return (int) Handles.MH_vkSetDebugUtilsObjectNameEXT.get().invokeExact(device.capabilities().PFN_vkSetDebugUtilsObjectNameEXT, device.segment(), pNameInfo); }
    ...
    public static int vkSetDebugUtilsObjectTagEXT(@NonNull VkDevice device, @NonNull MemorySegment pTagInfo) {
        ...
        return (int) Handles.MH_vkSetDebugUtilsObjectTagEXT.get().invokeExact(device.capabilities().PFN_vkSetDebugUtilsObjectTagEXT, device.segment(), pTagInfo); }
    ...
    public static void vkQueueBeginDebugUtilsLabelEXT(@NonNull VkQueue queue, @NonNull MemorySegment pLabelInfo) {
        ...
        Handles.MH_vkQueueBeginDebugUtilsLabelEXT.get().invokeExact(queue.capabilities().PFN_vkQueueBeginDebugUtilsLabelEXT, queue.segment(), pLabelInfo); }
    ...
    public static void vkQueueEndDebugUtilsLabelEXT(@NonNull VkQueue queue) {
        ...
        Handles.MH_vkQueueEndDebugUtilsLabelEXT.get().invokeExact(queue.capabilities().PFN_vkQueueEndDebugUtilsLabelEXT, queue.segment()); }
    ...
    public static void vkQueueInsertDebugUtilsLabelEXT(@NonNull VkQueue queue, @NonNull MemorySegment pLabelInfo) {
        ...
        Handles.MH_vkQueueInsertDebugUtilsLabelEXT.get().invokeExact(queue.capabilities().PFN_vkQueueInsertDebugUtilsLabelEXT, queue.segment(), pLabelInfo); }
    ...
    public static void vkCmdBeginDebugUtilsLabelEXT(@NonNull VkCommandBuffer commandBuffer, @NonNull MemorySegment pLabelInfo) {
        ...
        Handles.MH_vkCmdBeginDebugUtilsLabelEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdBeginDebugUtilsLabelEXT, commandBuffer.segment(), pLabelInfo); }
    ...
    public static void vkCmdEndDebugUtilsLabelEXT(@NonNull VkCommandBuffer commandBuffer) {
        ...
        Handles.MH_vkCmdEndDebugUtilsLabelEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdEndDebugUtilsLabelEXT, commandBuffer.segment()); }
    ...
    public static void vkCmdInsertDebugUtilsLabelEXT(@NonNull VkCommandBuffer commandBuffer, @NonNull MemorySegment pLabelInfo) {
        ...
        Handles.MH_vkCmdInsertDebugUtilsLabelEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdInsertDebugUtilsLabelEXT, commandBuffer.segment(), pLabelInfo); }
    ...
    public static int vkCreateDebugUtilsMessengerEXT(@NonNull VkInstance instance, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pMessenger) {
        ...
        return (int) Handles.MH_vkCreateDebugUtilsMessengerEXT.get().invokeExact(instance.capabilities().PFN_vkCreateDebugUtilsMessengerEXT, instance.segment(), pCreateInfo, pAllocator, pMessenger); }
    ...
    public static void vkDestroyDebugUtilsMessengerEXT(@NonNull VkInstance instance, long messenger, @NonNull MemorySegment pAllocator) {
        ...
        Handles.MH_vkDestroyDebugUtilsMessengerEXT.get().invokeExact(instance.capabilities().PFN_vkDestroyDebugUtilsMessengerEXT, instance.segment(), messenger, pAllocator); }
    ...
    public static void vkSubmitDebugUtilsMessageEXT(@NonNull VkInstance instance, int messageSeverity, int messageTypes, @NonNull MemorySegment pCallbackData) {
        ...
        Handles.MH_vkSubmitDebugUtilsMessageEXT.get().invokeExact(instance.capabilities().PFN_vkSubmitDebugUtilsMessageEXT, instance.segment(), messageSeverity, messageTypes, pCallbackData); }
