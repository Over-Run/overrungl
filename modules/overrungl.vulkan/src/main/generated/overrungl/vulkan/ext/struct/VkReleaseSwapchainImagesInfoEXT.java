...
public final class VkReleaseSwapchainImagesInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_imageIndexCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("imageIndexCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int imageIndexCount(MemorySegment segment, long index) { return (int) VH_imageIndexCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void imageIndexCount(MemorySegment segment, long index, int value) { VH_imageIndexCount.get().set(segment, 0L, index, value); }
