...
public final class VkPhysicalDeviceShaderObjectFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderObject = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderObject")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderObject(MemorySegment segment, long index) { return (int) VH_shaderObject.get().get(segment, 0L, index); }
    /// {@return `shaderObject`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderObject(MemorySegment segment, long index, int value) { VH_shaderObject.get().set(segment, 0L, index, value); }
