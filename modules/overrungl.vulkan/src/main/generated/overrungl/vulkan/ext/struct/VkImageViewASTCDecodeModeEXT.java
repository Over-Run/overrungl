...
public final class VkImageViewASTCDecodeModeEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_decodeMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("decodeMode")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int decodeMode(MemorySegment segment, long index) { return (int) VH_decodeMode.get().get(segment, 0L, index); }
    /// {@return `decodeMode`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void decodeMode(MemorySegment segment, long index, int value) { VH_decodeMode.get().set(segment, 0L, index, value); }
