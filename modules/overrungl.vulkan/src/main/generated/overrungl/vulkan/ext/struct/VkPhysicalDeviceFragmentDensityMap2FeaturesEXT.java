...
public final class VkPhysicalDeviceFragmentDensityMap2FeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_fragmentDensityMapDeferred = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("fragmentDensityMapDeferred")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int fragmentDensityMapDeferred(MemorySegment segment, long index) { return (int) VH_fragmentDensityMapDeferred.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void fragmentDensityMapDeferred(MemorySegment segment, long index, int value) { VH_fragmentDensityMapDeferred.get().set(segment, 0L, index, value); }
