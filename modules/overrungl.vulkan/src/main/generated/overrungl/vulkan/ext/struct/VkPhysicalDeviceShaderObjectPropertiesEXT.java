...
public final class VkPhysicalDeviceShaderObjectPropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderBinaryUUID = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderBinaryUUID"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_shaderBinaryVersion = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderBinaryVersion")));
    ...
    public static byte shaderBinaryUUID(MemorySegment segment, long index, long index0) { return (byte) VH_shaderBinaryUUID.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void shaderBinaryUUID(MemorySegment segment, long index, long index0, byte value) { VH_shaderBinaryUUID.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderBinaryVersion(MemorySegment segment, long index) { return (int) VH_shaderBinaryVersion.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderBinaryVersion(MemorySegment segment, long index, int value) { VH_shaderBinaryVersion.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPhysicalDeviceShaderObjectPropertiesEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderObjectPropertiesEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderObjectPropertiesEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderObjectPropertiesEXT shaderBinaryUUIDAt(long index, MemorySegment value) { shaderBinaryUUID(this.segment(), index, value); return this; }
    /// Sets `shaderBinaryUUID` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderObjectPropertiesEXT shaderBinaryUUIDAt(long index, long index0, byte value) { shaderBinaryUUID(this.segment(), index, index0, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceShaderObjectPropertiesEXT shaderBinaryVersionAt(long index, int value) { shaderBinaryVersion(this.segment(), index, value); return this; }
