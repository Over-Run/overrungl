...
public final class VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_formatRgba10x6WithoutYCbCrSampler = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("formatRgba10x6WithoutYCbCrSampler")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int formatRgba10x6WithoutYCbCrSampler(MemorySegment segment, long index) { return (int) VH_formatRgba10x6WithoutYCbCrSampler.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void formatRgba10x6WithoutYCbCrSampler(MemorySegment segment, long index, int value) { VH_formatRgba10x6WithoutYCbCrSampler.get().set(segment, 0L, index, value); }
