...
public final class VkPhysicalDeviceMemoryPriorityFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_memoryPriority = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("memoryPriority")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int memoryPriority(MemorySegment segment, long index) { return (int) VH_memoryPriority.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void memoryPriority(MemorySegment segment, long index, int value) { VH_memoryPriority.get().set(segment, 0L, index, value); }
