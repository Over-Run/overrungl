...
public final class VKEXTHeadlessSurface {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCreateHeadlessSurfaceEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkCreateHeadlessSurfaceEXT(@NonNull VkInstance instance, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pSurface) {
        ...
        return (int) Handles.MH_vkCreateHeadlessSurfaceEXT.get().invokeExact(instance.capabilities().PFN_vkCreateHeadlessSurfaceEXT, instance.segment(), pCreateInfo, pAllocator, pSurface); }
