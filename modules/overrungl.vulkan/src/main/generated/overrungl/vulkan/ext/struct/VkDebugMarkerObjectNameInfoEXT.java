...
public final class VkDebugMarkerObjectNameInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_object = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("object")));
    ...
    public static final Supplier<VarHandle> VH_pObjectName = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pObjectName")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long object(MemorySegment segment, long index) { return (long) VH_object.get().get(segment, 0L, index); }
    /// {@return `object`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void object(MemorySegment segment, long index, long value) { VH_object.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pObjectName(MemorySegment segment, long index) { return (MemorySegment) VH_pObjectName.get().get(segment, 0L, index); }
    /// {@return `pObjectName`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pObjectName(MemorySegment segment, long index, MemorySegment value) { VH_pObjectName.get().set(segment, 0L, index, value); }
