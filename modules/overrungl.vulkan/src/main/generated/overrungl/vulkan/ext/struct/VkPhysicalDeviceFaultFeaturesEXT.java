...
public final class VkPhysicalDeviceFaultFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_deviceFault = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("deviceFault")));
    ...
    public static final Supplier<VarHandle> VH_deviceFaultVendorBinary = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("deviceFaultVendorBinary")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int deviceFault(MemorySegment segment, long index) { return (int) VH_deviceFault.get().get(segment, 0L, index); }
    /// {@return `deviceFault`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void deviceFault(MemorySegment segment, long index, int value) { VH_deviceFault.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int deviceFaultVendorBinary(MemorySegment segment, long index) { return (int) VH_deviceFaultVendorBinary.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void deviceFaultVendorBinary(MemorySegment segment, long index, int value) { VH_deviceFaultVendorBinary.get().set(segment, 0L, index, value); }
