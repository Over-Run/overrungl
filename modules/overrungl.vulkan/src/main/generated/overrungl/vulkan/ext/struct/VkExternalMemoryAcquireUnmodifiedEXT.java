...
public final class VkExternalMemoryAcquireUnmodifiedEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_acquireUnmodifiedMemory = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("acquireUnmodifiedMemory")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int acquireUnmodifiedMemory(MemorySegment segment, long index) { return (int) VH_acquireUnmodifiedMemory.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void acquireUnmodifiedMemory(MemorySegment segment, long index, int value) { VH_acquireUnmodifiedMemory.get().set(segment, 0L, index, value); }
