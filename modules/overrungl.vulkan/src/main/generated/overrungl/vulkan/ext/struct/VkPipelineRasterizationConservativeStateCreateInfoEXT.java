...
public final class VkPipelineRasterizationConservativeStateCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_conservativeRasterizationMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("conservativeRasterizationMode")));
    ...
    public static final Supplier<VarHandle> VH_extraPrimitiveOverestimationSize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("extraPrimitiveOverestimationSize")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int conservativeRasterizationMode(MemorySegment segment, long index) { return (int) VH_conservativeRasterizationMode.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void conservativeRasterizationMode(MemorySegment segment, long index, int value) { VH_conservativeRasterizationMode.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static float extraPrimitiveOverestimationSize(MemorySegment segment, long index) { return (float) VH_extraPrimitiveOverestimationSize.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void extraPrimitiveOverestimationSize(MemorySegment segment, long index, float value) { VH_extraPrimitiveOverestimationSize.get().set(segment, 0L, index, value); }
