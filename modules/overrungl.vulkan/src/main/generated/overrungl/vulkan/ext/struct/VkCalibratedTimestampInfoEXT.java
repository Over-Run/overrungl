...
public final class VkCalibratedTimestampInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_timeDomain = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("timeDomain")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int timeDomain(MemorySegment segment, long index) { return (int) VH_timeDomain.get().get(segment, 0L, index); }
    /// {@return `timeDomain`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void timeDomain(MemorySegment segment, long index, int value) { VH_timeDomain.get().set(segment, 0L, index, value); }
