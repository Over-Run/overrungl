...
public final class VKEXTFullScreenExclusive {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceSurfacePresentModes2EXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkAcquireFullScreenExclusiveModeEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_vkReleaseFullScreenExclusiveModeEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_vkGetDeviceGroupSurfacePresentModes2EXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkGetPhysicalDeviceSurfacePresentModes2EXT(@NonNull VkPhysicalDevice physicalDevice, @NonNull MemorySegment pSurfaceInfo, @NonNull MemorySegment pPresentModeCount, @NonNull MemorySegment pPresentModes) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceSurfacePresentModes2EXT.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceSurfacePresentModes2EXT, physicalDevice.segment(), pSurfaceInfo, pPresentModeCount, pPresentModes); }
    ...
    public static int vkAcquireFullScreenExclusiveModeEXT(@NonNull VkDevice device, long swapchain) {
        ...
        return (int) Handles.MH_vkAcquireFullScreenExclusiveModeEXT.get().invokeExact(device.capabilities().PFN_vkAcquireFullScreenExclusiveModeEXT, device.segment(), swapchain); }
    ...
    public static int vkReleaseFullScreenExclusiveModeEXT(@NonNull VkDevice device, long swapchain) {
        ...
        return (int) Handles.MH_vkReleaseFullScreenExclusiveModeEXT.get().invokeExact(device.capabilities().PFN_vkReleaseFullScreenExclusiveModeEXT, device.segment(), swapchain); }
    ...
    public static int vkGetDeviceGroupSurfacePresentModes2EXT(@NonNull VkDevice device, @NonNull MemorySegment pSurfaceInfo, @NonNull MemorySegment pModes) {
        ...
        return (int) Handles.MH_vkGetDeviceGroupSurfacePresentModes2EXT.get().invokeExact(device.capabilities().PFN_vkGetDeviceGroupSurfacePresentModes2EXT, device.segment(), pSurfaceInfo, pModes); }
