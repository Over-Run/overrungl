...
public final class VkPhysicalDeviceDiscardRectanglePropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxDiscardRectangles = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxDiscardRectangles")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxDiscardRectangles(MemorySegment segment, long index) { return (int) VH_maxDiscardRectangles.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxDiscardRectangles(MemorySegment segment, long index, int value) { VH_maxDiscardRectangles.get().set(segment, 0L, index, value); }
