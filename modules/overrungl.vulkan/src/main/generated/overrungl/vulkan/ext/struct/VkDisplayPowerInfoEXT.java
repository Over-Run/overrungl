...
public final class VkDisplayPowerInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_powerState = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("powerState")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int powerState(MemorySegment segment, long index) { return (int) VH_powerState.get().get(segment, 0L, index); }
    /// {@return `powerState`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void powerState(MemorySegment segment, long index, int value) { VH_powerState.get().set(segment, 0L, index, value); }
