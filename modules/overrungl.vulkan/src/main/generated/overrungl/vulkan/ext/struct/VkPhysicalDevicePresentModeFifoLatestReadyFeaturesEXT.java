...
public final class VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_presentModeFifoLatestReady = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("presentModeFifoLatestReady")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int presentModeFifoLatestReady(MemorySegment segment, long index) { return (int) VH_presentModeFifoLatestReady.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void presentModeFifoLatestReady(MemorySegment segment, long index, int value) { VH_presentModeFifoLatestReady.get().set(segment, 0L, index, value); }
