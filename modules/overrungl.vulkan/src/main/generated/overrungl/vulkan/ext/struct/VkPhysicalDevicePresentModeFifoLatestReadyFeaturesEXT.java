...
/// Represents `VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT`.
/// ## Layout
/// ```
...
public final class VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT extends GroupType {
    ...
    public static VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.khr.VKKHRPresentModeFifoLatestReady.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_KHR); }
    public static VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT presentModeFifoLatestReadyAt(long index, int value) { VH_presentModeFifoLatestReady.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT presentModeFifoLatestReady(int value) { VH_presentModeFifoLatestReady.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT _presentModeFifoLatestReadyAt(long index, MemorySegment src) { _presentModeFifoLatestReadyAt(index).copyFrom(src); return this; }
    public VkPhysicalDevicePresentModeFifoLatestReadyFeaturesEXT _presentModeFifoLatestReady(MemorySegment src) { return _presentModeFifoLatestReadyAt(0L, src); }
}
