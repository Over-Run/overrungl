...
public final class VkPhysicalDeviceExtendedDynamicStateFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_extendedDynamicState = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("extendedDynamicState")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int extendedDynamicState(MemorySegment segment, long index) { return (int) VH_extendedDynamicState.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void extendedDynamicState(MemorySegment segment, long index, int value) { VH_extendedDynamicState.get().set(segment, 0L, index, value); }
