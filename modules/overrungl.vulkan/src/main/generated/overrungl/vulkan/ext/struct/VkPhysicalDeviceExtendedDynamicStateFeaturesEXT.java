...
/// Represents `VkPhysicalDeviceExtendedDynamicStateFeaturesEXT`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceExtendedDynamicStateFeaturesEXT extends GroupType {
    ...
    public static VkPhysicalDeviceExtendedDynamicStateFeaturesEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.ext.VKEXTExtendedDynamicState.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT); }
    public static VkPhysicalDeviceExtendedDynamicStateFeaturesEXT allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.ext.VKEXTExtendedDynamicState.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT);
        return s;
    }
    ...
    public int extendedDynamicStateAt(long index) { return (int) VH_extendedDynamicState.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int extendedDynamicState() { return (int) VH_extendedDynamicState.get(this.segment(), 0L, 0L); }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT extendedDynamicStateAt(long index, int value) { VH_extendedDynamicState.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT extendedDynamicState(int value) { VH_extendedDynamicState.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _extendedDynamicStateAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_extendedDynamicState, index), LAYOUT_extendedDynamicState); }
    public MemorySegment _extendedDynamicState() { return _extendedDynamicStateAt(0L); }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT _extendedDynamicStateAt(long index, MemorySegment src) { _extendedDynamicStateAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceExtendedDynamicStateFeaturesEXT _extendedDynamicState(MemorySegment src) { return _extendedDynamicStateAt(0L, src); }
}
