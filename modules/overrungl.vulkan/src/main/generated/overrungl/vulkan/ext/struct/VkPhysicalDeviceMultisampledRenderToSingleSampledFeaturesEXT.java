...
public final class VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_multisampledRenderToSingleSampled = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("multisampledRenderToSingleSampled")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int multisampledRenderToSingleSampled(MemorySegment segment, long index) { return (int) VH_multisampledRenderToSingleSampled.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void multisampledRenderToSingleSampled(MemorySegment segment, long index, int value) { VH_multisampledRenderToSingleSampled.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT multisampledRenderToSingleSampledAt(long index, int value) { multisampledRenderToSingleSampled(this.segment(), index, value); return this; }
