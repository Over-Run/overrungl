...
public final class VkPhysicalDeviceHostImageCopyFeaturesEXT extends GroupType {
    ...
    public static VkPhysicalDeviceHostImageCopyFeaturesEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES); }
    public static VkPhysicalDeviceHostImageCopyFeaturesEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceHostImageCopyFeaturesEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT hostImageCopyAt(long index, int value) { VH_hostImageCopy.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT hostImageCopy(int value) { VH_hostImageCopy.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceHostImageCopyFeaturesEXT _hostImageCopyAt(long index, MemorySegment src) { _hostImageCopyAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceHostImageCopyFeaturesEXT _hostImageCopy(MemorySegment src) { return _hostImageCopyAt(0L, src); }
}
