...
public final class VkPhysicalDeviceImageCompressionControlFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_imageCompressionControl = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("imageCompressionControl")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int imageCompressionControl(MemorySegment segment, long index) { return (int) VH_imageCompressionControl.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void imageCompressionControl(MemorySegment segment, long index, int value) { VH_imageCompressionControl.get().set(segment, 0L, index, value); }
