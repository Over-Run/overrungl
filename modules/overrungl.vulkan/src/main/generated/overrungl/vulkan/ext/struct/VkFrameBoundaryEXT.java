...
public final class VkFrameBoundaryEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_frameID = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("frameID")));
    ...
    public static final Supplier<VarHandle> VH_imageCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("imageCount")));
    ...
    public static final Supplier<VarHandle> VH_pImages = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pImages")));
    ...
    public static final Supplier<VarHandle> VH_pBuffers = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pBuffers")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long frameID(MemorySegment segment, long index) { return (long) VH_frameID.get().get(segment, 0L, index); }
    /// {@return `frameID`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void frameID(MemorySegment segment, long index, long value) { VH_frameID.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int imageCount(MemorySegment segment, long index) { return (int) VH_imageCount.get().get(segment, 0L, index); }
    /// {@return `imageCount`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void imageCount(MemorySegment segment, long index, int value) { VH_imageCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pImages(MemorySegment segment, long index) { return (MemorySegment) VH_pImages.get().get(segment, 0L, index); }
    /// {@return `pImages`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pImages(MemorySegment segment, long index, MemorySegment value) { VH_pImages.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pBuffers(MemorySegment segment, long index) { return (MemorySegment) VH_pBuffers.get().get(segment, 0L, index); }
    /// {@return `pBuffers`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pBuffers(MemorySegment segment, long index, MemorySegment value) { VH_pBuffers.get().set(segment, 0L, index, value); }
