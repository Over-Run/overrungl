...
public final class VKEXTLineRasterization {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCmdSetLineStippleEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_SHORT)));
        private Handles() {}
    }
    ...
    public static void vkCmdSetLineStippleEXT(@NonNull VkCommandBuffer commandBuffer, int lineStippleFactor, short lineStipplePattern) {
        ...
        Handles.MH_vkCmdSetLineStippleEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdSetLineStippleEXT, commandBuffer.segment(), lineStippleFactor, lineStipplePattern); }
