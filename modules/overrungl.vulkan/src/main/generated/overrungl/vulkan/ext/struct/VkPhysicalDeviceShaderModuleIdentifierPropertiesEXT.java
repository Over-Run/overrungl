...
public final class VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderModuleIdentifierAlgorithmUUID = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderModuleIdentifierAlgorithmUUID"), PathElement.sequenceElement()));
    ...
    public static byte shaderModuleIdentifierAlgorithmUUID(MemorySegment segment, long index, long index0) { return (byte) VH_shaderModuleIdentifierAlgorithmUUID.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void shaderModuleIdentifierAlgorithmUUID(MemorySegment segment, long index, long index0, byte value) { VH_shaderModuleIdentifierAlgorithmUUID.get().set(segment, 0L, index, index0, value); }
