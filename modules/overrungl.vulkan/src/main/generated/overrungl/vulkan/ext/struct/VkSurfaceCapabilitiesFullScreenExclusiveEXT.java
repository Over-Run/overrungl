...
public final class VkSurfaceCapabilitiesFullScreenExclusiveEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_fullScreenExclusiveSupported = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("fullScreenExclusiveSupported")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int fullScreenExclusiveSupported(MemorySegment segment, long index) { return (int) VH_fullScreenExclusiveSupported.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void fullScreenExclusiveSupported(MemorySegment segment, long index, int value) { VH_fullScreenExclusiveSupported.get().set(segment, 0L, index, value); }
