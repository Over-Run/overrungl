...
public final class VkRenderPassCreationControlEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_disallowMerging = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("disallowMerging")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int disallowMerging(MemorySegment segment, long index) { return (int) VH_disallowMerging.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void disallowMerging(MemorySegment segment, long index, int value) { VH_disallowMerging.get().set(segment, 0L, index, value); }
