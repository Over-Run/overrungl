...
public final class VkSurfaceFullScreenExclusiveInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_fullScreenExclusive = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("fullScreenExclusive")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int fullScreenExclusive(MemorySegment segment, long index) { return (int) VH_fullScreenExclusive.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void fullScreenExclusive(MemorySegment segment, long index, int value) { VH_fullScreenExclusive.get().set(segment, 0L, index, value); }
