...
/// Represents `VkDeviceQueueGlobalPriorityCreateInfoEXT`.
/// ## Layout
/// ```
...
public final class VkDeviceQueueGlobalPriorityCreateInfoEXT extends GroupType {
    ...
    public static VkDeviceQueueGlobalPriorityCreateInfoEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK14.VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO); }
    public static VkDeviceQueueGlobalPriorityCreateInfoEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkDeviceQueueGlobalPriorityCreateInfoEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT globalPriorityAt(long index, int value) { VH_globalPriority.set(this.segment(), 0L, index, value); return this; }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT globalPriority(int value) { VH_globalPriority.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkDeviceQueueGlobalPriorityCreateInfoEXT _globalPriorityAt(long index, MemorySegment src) { _globalPriorityAt(index).copyFrom(src); return this; }
    public VkDeviceQueueGlobalPriorityCreateInfoEXT _globalPriority(MemorySegment src) { return _globalPriorityAt(0L, src); }
}
