...
public final class VkPhysicalDeviceBufferDeviceAddressFeaturesEXT extends GroupType {
    ...
    public static VkPhysicalDeviceBufferDeviceAddressFeaturesEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.ext.VKEXTBufferDeviceAddress.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_EXT); }
    public static VkPhysicalDeviceBufferDeviceAddressFeaturesEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT bufferDeviceAddressAt(long index, int value) { VH_bufferDeviceAddress.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT bufferDeviceAddressCaptureReplayAt(long index, int value) { VH_bufferDeviceAddressCaptureReplay.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT bufferDeviceAddressMultiDeviceAt(long index, int value) { VH_bufferDeviceAddressMultiDevice.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT bufferDeviceAddress(int value) { VH_bufferDeviceAddress.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT bufferDeviceAddressCaptureReplay(int value) { VH_bufferDeviceAddressCaptureReplay.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT bufferDeviceAddressMultiDevice(int value) { VH_bufferDeviceAddressMultiDevice.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _bufferDeviceAddressAt(long index, MemorySegment src) { _bufferDeviceAddressAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _bufferDeviceAddress(MemorySegment src) { return _bufferDeviceAddressAt(0L, src); }
    ...
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _bufferDeviceAddressCaptureReplayAt(long index, MemorySegment src) { _bufferDeviceAddressCaptureReplayAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _bufferDeviceAddressCaptureReplay(MemorySegment src) { return _bufferDeviceAddressCaptureReplayAt(0L, src); }
    ...
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _bufferDeviceAddressMultiDeviceAt(long index, MemorySegment src) { _bufferDeviceAddressMultiDeviceAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceBufferDeviceAddressFeaturesEXT _bufferDeviceAddressMultiDevice(MemorySegment src) { return _bufferDeviceAddressMultiDeviceAt(0L, src); }
}
