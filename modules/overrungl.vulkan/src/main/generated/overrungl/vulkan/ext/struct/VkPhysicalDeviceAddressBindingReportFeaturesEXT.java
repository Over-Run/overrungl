...
public final class VkPhysicalDeviceAddressBindingReportFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_reportAddressBinding = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("reportAddressBinding")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int reportAddressBinding(MemorySegment segment, long index) { return (int) VH_reportAddressBinding.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void reportAddressBinding(MemorySegment segment, long index, int value) { VH_reportAddressBinding.get().set(segment, 0L, index, value); }
