...
public final class VkPhysicalDeviceColorWriteEnableFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_colorWriteEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("colorWriteEnable")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int colorWriteEnable(MemorySegment segment, long index) { return (int) VH_colorWriteEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void colorWriteEnable(MemorySegment segment, long index, int value) { VH_colorWriteEnable.get().set(segment, 0L, index, value); }
