...
public final class VKEXTAcquireXlibDisplay {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkAcquireXlibDisplayEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG)));
        public static final Supplier<MethodHandle> MH_vkGetRandROutputDisplayEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, CanonicalTypes.C_LONG, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkAcquireXlibDisplayEXT(@NonNull VkPhysicalDevice physicalDevice, @NonNull MemorySegment dpy, long display) {
        ...
        return (int) Handles.MH_vkAcquireXlibDisplayEXT.get().invokeExact(physicalDevice.capabilities().PFN_vkAcquireXlibDisplayEXT, physicalDevice.segment(), dpy, display); }
    ...
    public static int vkGetRandROutputDisplayEXT(@NonNull VkPhysicalDevice physicalDevice, @NonNull MemorySegment dpy, long rrOutput, @NonNull MemorySegment pDisplay) {
        ...
        return (int) Handles.MH_vkGetRandROutputDisplayEXT.get().invoke(physicalDevice.capabilities().PFN_vkGetRandROutputDisplayEXT, physicalDevice.segment(), dpy, MemoryUtil.narrowingLong(CanonicalTypes.C_LONG, rrOutput), pDisplay); }
