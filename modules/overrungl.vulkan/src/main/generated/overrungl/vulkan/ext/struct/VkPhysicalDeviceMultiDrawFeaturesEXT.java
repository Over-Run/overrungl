...
public final class VkPhysicalDeviceMultiDrawFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_multiDraw = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("multiDraw")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int multiDraw(MemorySegment segment, long index) { return (int) VH_multiDraw.get().get(segment, 0L, index); }
    /// {@return `multiDraw`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void multiDraw(MemorySegment segment, long index, int value) { VH_multiDraw.get().set(segment, 0L, index, value); }
