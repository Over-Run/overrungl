...
public final class VKEXTDisplaySurfaceCounter {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceSurfaceCapabilities2EXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkGetPhysicalDeviceSurfaceCapabilities2EXT(@NonNull VkPhysicalDevice physicalDevice, long surface, @NonNull MemorySegment pSurfaceCapabilities) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceSurfaceCapabilities2EXT.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceSurfaceCapabilities2EXT, physicalDevice.segment(), surface, pSurfaceCapabilities); }
