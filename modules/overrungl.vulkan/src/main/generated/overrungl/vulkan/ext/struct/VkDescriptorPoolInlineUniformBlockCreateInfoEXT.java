...
public final class VkDescriptorPoolInlineUniformBlockCreateInfoEXT extends GroupType {
    /// The struct layout of `VkDescriptorPoolInlineUniformBlockCreateInfoEXT`.
    ...
    public static final Supplier<VarHandle> VH_maxInlineUniformBlockBindings = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxInlineUniformBlockBindings")));

    /// Creates `VkDescriptorPoolInlineUniformBlockCreateInfoEXT` with the given segment.
    ...
    /// Allocates a `VkDescriptorPoolInlineUniformBlockCreateInfoEXT` with the given segment allocator.
    ...
    /// Allocates a `VkDescriptorPoolInlineUniformBlockCreateInfoEXT` with the given segment allocator and count.
    /// @param allocator the segment allocator
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorPoolInlineUniformBlockCreateInfoEXT sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorPoolInlineUniformBlockCreateInfoEXT pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }

    /// {@return `maxInlineUniformBlockBindings` at the given index}
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxInlineUniformBlockBindings(MemorySegment segment, long index) { return (int) VH_maxInlineUniformBlockBindings.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxInlineUniformBlockBindings(MemorySegment segment, long index, int value) { VH_maxInlineUniformBlockBindings.get().set(segment, 0L, index, value); }
    /// Sets `maxInlineUniformBlockBindings` with the given value.
    /// @param value the value
    /// @return `this`
    public VkDescriptorPoolInlineUniformBlockCreateInfoEXT maxInlineUniformBlockBindings(int value) { maxInlineUniformBlockBindings(this.segment(), 0L, value); return this; }

    /// Creates a slice of `VkDescriptorPoolInlineUniformBlockCreateInfoEXT`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkDescriptorPoolInlineUniformBlockCreateInfoEXT`
    ...
    /// Visits `VkDescriptorPoolInlineUniformBlockCreateInfoEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorPoolInlineUniformBlockCreateInfoEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorPoolInlineUniformBlockCreateInfoEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorPoolInlineUniformBlockCreateInfoEXT maxInlineUniformBlockBindingsAt(long index, int value) { maxInlineUniformBlockBindings(this.segment(), index, value); return this; }
