...
public final class VkSwapchainPresentModeInfoEXT extends GroupType {
    ...
    /// Visits `VkSwapchainPresentModeInfoEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainPresentModeInfoEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainPresentModeInfoEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainPresentModeInfoEXT swapchainCountAt(long index, int value) { swapchainCount(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainPresentModeInfoEXT pPresentModesAt(long index, MemorySegment value) { pPresentModes(this.segment(), index, value); return this; }
