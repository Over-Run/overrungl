...
public final class VkAttachmentFeedbackLoopInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_feedbackLoopEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("feedbackLoopEnable")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int feedbackLoopEnable(MemorySegment segment, long index) { return (int) VH_feedbackLoopEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void feedbackLoopEnable(MemorySegment segment, long index, int value) { VH_feedbackLoopEnable.get().set(segment, 0L, index, value); }
