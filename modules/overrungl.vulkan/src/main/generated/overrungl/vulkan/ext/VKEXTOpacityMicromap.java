...
public final class VKEXTOpacityMicromap {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCreateMicromapEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkDestroyMicromapEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdBuildMicromapsEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkBuildMicromapsEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCopyMicromapEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCopyMicromapToMemoryEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCopyMemoryToMicromapEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkWriteMicromapsPropertiesEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, CanonicalTypes.SIZE_T, ValueLayout.ADDRESS, CanonicalTypes.SIZE_T)));
        public static final Supplier<MethodHandle> MH_vkCmdCopyMicromapEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdCopyMicromapToMemoryEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdCopyMemoryToMicromapEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdWriteMicromapsPropertiesEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT)));
        public static final Supplier<MethodHandle> MH_vkGetDeviceMicromapCompatibilityEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetMicromapBuildSizesEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkCreateMicromapEXT(@NonNull VkDevice device, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pMicromap) {
        ...
        return (int) Handles.MH_vkCreateMicromapEXT.get().invokeExact(device.capabilities().PFN_vkCreateMicromapEXT, device.segment(), pCreateInfo, pAllocator, pMicromap); }
    ...
    public static void vkDestroyMicromapEXT(@NonNull VkDevice device, long micromap, @NonNull MemorySegment pAllocator) {
        ...
        Handles.MH_vkDestroyMicromapEXT.get().invokeExact(device.capabilities().PFN_vkDestroyMicromapEXT, device.segment(), micromap, pAllocator); }
    ...
    public static void vkCmdBuildMicromapsEXT(@NonNull VkCommandBuffer commandBuffer, int infoCount, @NonNull MemorySegment pInfos) {
        ...
        Handles.MH_vkCmdBuildMicromapsEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdBuildMicromapsEXT, commandBuffer.segment(), infoCount, pInfos); }
    ...
    public static int vkBuildMicromapsEXT(@NonNull VkDevice device, long deferredOperation, int infoCount, @NonNull MemorySegment pInfos) {
        ...
        return (int) Handles.MH_vkBuildMicromapsEXT.get().invokeExact(device.capabilities().PFN_vkBuildMicromapsEXT, device.segment(), deferredOperation, infoCount, pInfos); }
    ...
    public static int vkCopyMicromapEXT(@NonNull VkDevice device, long deferredOperation, @NonNull MemorySegment pInfo) {
        ...
        return (int) Handles.MH_vkCopyMicromapEXT.get().invokeExact(device.capabilities().PFN_vkCopyMicromapEXT, device.segment(), deferredOperation, pInfo); }
    ...
    public static int vkCopyMicromapToMemoryEXT(@NonNull VkDevice device, long deferredOperation, @NonNull MemorySegment pInfo) {
        ...
        return (int) Handles.MH_vkCopyMicromapToMemoryEXT.get().invokeExact(device.capabilities().PFN_vkCopyMicromapToMemoryEXT, device.segment(), deferredOperation, pInfo); }
    ...
    public static int vkCopyMemoryToMicromapEXT(@NonNull VkDevice device, long deferredOperation, @NonNull MemorySegment pInfo) {
        ...
        return (int) Handles.MH_vkCopyMemoryToMicromapEXT.get().invokeExact(device.capabilities().PFN_vkCopyMemoryToMicromapEXT, device.segment(), deferredOperation, pInfo); }
    ...
    public static int vkWriteMicromapsPropertiesEXT(@NonNull VkDevice device, int micromapCount, @NonNull MemorySegment pMicromaps, int queryType, long dataSize, @NonNull MemorySegment pData, long stride) {
        ...
        return (int) Handles.MH_vkWriteMicromapsPropertiesEXT.get().invoke(device.capabilities().PFN_vkWriteMicromapsPropertiesEXT, device.segment(), micromapCount, pMicromaps, queryType, MemoryUtil.narrowingLong(CanonicalTypes.SIZE_T, dataSize), pData, MemoryUtil.narrowingLong(CanonicalTypes.SIZE_T, stride)); }
    ...
    public static void vkCmdCopyMicromapEXT(@NonNull VkCommandBuffer commandBuffer, @NonNull MemorySegment pInfo) {
        ...
        Handles.MH_vkCmdCopyMicromapEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdCopyMicromapEXT, commandBuffer.segment(), pInfo); }
    ...
    public static void vkCmdCopyMicromapToMemoryEXT(@NonNull VkCommandBuffer commandBuffer, @NonNull MemorySegment pInfo) {
        ...
        Handles.MH_vkCmdCopyMicromapToMemoryEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdCopyMicromapToMemoryEXT, commandBuffer.segment(), pInfo); }
    ...
    public static void vkCmdCopyMemoryToMicromapEXT(@NonNull VkCommandBuffer commandBuffer, @NonNull MemorySegment pInfo) {
        ...
        Handles.MH_vkCmdCopyMemoryToMicromapEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdCopyMemoryToMicromapEXT, commandBuffer.segment(), pInfo); }
    ...
    public static void vkCmdWriteMicromapsPropertiesEXT(@NonNull VkCommandBuffer commandBuffer, int micromapCount, @NonNull MemorySegment pMicromaps, int queryType, long queryPool, int firstQuery) {
        ...
        Handles.MH_vkCmdWriteMicromapsPropertiesEXT.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdWriteMicromapsPropertiesEXT, commandBuffer.segment(), micromapCount, pMicromaps, queryType, queryPool, firstQuery); }
    ...
    public static void vkGetDeviceMicromapCompatibilityEXT(@NonNull VkDevice device, @NonNull MemorySegment pVersionInfo, @NonNull MemorySegment pCompatibility) {
        ...
        Handles.MH_vkGetDeviceMicromapCompatibilityEXT.get().invokeExact(device.capabilities().PFN_vkGetDeviceMicromapCompatibilityEXT, device.segment(), pVersionInfo, pCompatibility); }
    ...
    public static void vkGetMicromapBuildSizesEXT(@NonNull VkDevice device, int buildType, @NonNull MemorySegment pBuildInfo, @NonNull MemorySegment pSizeInfo) {
        ...
        Handles.MH_vkGetMicromapBuildSizesEXT.get().invokeExact(device.capabilities().PFN_vkGetMicromapBuildSizesEXT, device.segment(), buildType, pBuildInfo, pSizeInfo); }
