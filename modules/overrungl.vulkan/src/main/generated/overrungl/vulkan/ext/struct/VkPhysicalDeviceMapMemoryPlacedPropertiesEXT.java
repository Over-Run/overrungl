...
public final class VkPhysicalDeviceMapMemoryPlacedPropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_minPlacedMemoryMapAlignment = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("minPlacedMemoryMapAlignment")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long minPlacedMemoryMapAlignment(MemorySegment segment, long index) { return (long) VH_minPlacedMemoryMapAlignment.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void minPlacedMemoryMapAlignment(MemorySegment segment, long index, long value) { VH_minPlacedMemoryMapAlignment.get().set(segment, 0L, index, value); }
