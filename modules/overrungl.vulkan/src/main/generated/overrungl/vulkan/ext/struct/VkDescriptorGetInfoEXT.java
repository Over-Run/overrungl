...
public final class VkDescriptorGetInfoEXT extends GroupType {
    ...
    /// Visits `VkDescriptorGetInfoEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorGetInfoEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorGetInfoEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorGetInfoEXT typeAt(long index, int value) { type(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkDescriptorGetInfoEXT dataAt(long index, MemorySegment value) { data(this.segment(), index, value); return this; }
    /// Accepts `data` with the given function.
    /// @param index the index of the struct buffer
    /// @param func the function
    /// @return `this`
    public VkDescriptorGetInfoEXT dataAt(long index, Consumer<overrungl.vulkan.ext.union.VkDescriptorDataEXT> func) { func.accept(overrungl.vulkan.ext.union.VkDescriptorDataEXT.of(dataAt(index))); return this; }
