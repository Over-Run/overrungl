...
public final class VkRenderPassSubpassFeedbackCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pSubpassFeedback = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pSubpassFeedback")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pSubpassFeedback(MemorySegment segment, long index) { return (MemorySegment) VH_pSubpassFeedback.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pSubpassFeedback(MemorySegment segment, long index, MemorySegment value) { VH_pSubpassFeedback.get().set(segment, 0L, index, value); }
