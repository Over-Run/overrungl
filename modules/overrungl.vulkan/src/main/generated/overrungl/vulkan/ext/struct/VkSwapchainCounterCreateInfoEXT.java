...
public final class VkSwapchainCounterCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_surfaceCounters = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("surfaceCounters")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int surfaceCounters(MemorySegment segment, long index) { return (int) VH_surfaceCounters.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void surfaceCounters(MemorySegment segment, long index, int value) { VH_surfaceCounters.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkSwapchainCounterCreateInfoEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainCounterCreateInfoEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainCounterCreateInfoEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkSwapchainCounterCreateInfoEXT surfaceCountersAt(long index, int value) { surfaceCounters(this.segment(), index, value); return this; }
