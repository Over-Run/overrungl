...
public final class VkExportMetalBufferInfoEXT extends GroupType {
    ...
    public static VkExportMetalBufferInfoEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.ext.VKEXTMetalObjects.VK_STRUCTURE_TYPE_EXPORT_METAL_BUFFER_INFO_EXT); }
    public static VkExportMetalBufferInfoEXT allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.ext.VKEXTMetalObjects.VK_STRUCTURE_TYPE_EXPORT_METAL_BUFFER_INFO_EXT);
        return s;
    }
    ...
    public VkExportMetalBufferInfoEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkExportMetalBufferInfoEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkExportMetalBufferInfoEXT memoryAt(long index, long value) { VH_memory.set(this.segment(), 0L, index, value); return this; }
    public VkExportMetalBufferInfoEXT mtlBufferAt(long index, MemorySegment value) { VH_mtlBuffer.set(this.segment(), 0L, index, value); return this; }
    public VkExportMetalBufferInfoEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkExportMetalBufferInfoEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkExportMetalBufferInfoEXT memory(long value) { VH_memory.set(this.segment(), 0L, 0L, value); return this; }
    public VkExportMetalBufferInfoEXT mtlBuffer(MemorySegment value) { VH_mtlBuffer.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkExportMetalBufferInfoEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkExportMetalBufferInfoEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkExportMetalBufferInfoEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkExportMetalBufferInfoEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkExportMetalBufferInfoEXT _memoryAt(long index, MemorySegment src) { _memoryAt(index).copyFrom(src); return this; }
    public VkExportMetalBufferInfoEXT _memory(MemorySegment src) { return _memoryAt(0L, src); }
    ...
    public VkExportMetalBufferInfoEXT _mtlBufferAt(long index, MemorySegment src) { _mtlBufferAt(index).copyFrom(src); return this; }
    public VkExportMetalBufferInfoEXT _mtlBuffer(MemorySegment src) { return _mtlBufferAt(0L, src); }
}
