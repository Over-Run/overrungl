...
public final class VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_graphicsPipelineLibrary = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("graphicsPipelineLibrary")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int graphicsPipelineLibrary(MemorySegment segment, long index) { return (int) VH_graphicsPipelineLibrary.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void graphicsPipelineLibrary(MemorySegment segment, long index, int value) { VH_graphicsPipelineLibrary.get().set(segment, 0L, index, value); }
