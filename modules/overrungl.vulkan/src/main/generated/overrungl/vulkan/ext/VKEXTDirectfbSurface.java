...
public final class VKEXTDirectfbSurface {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCreateDirectFBSurfaceEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceDirectFBPresentationSupportEXT = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkCreateDirectFBSurfaceEXT(@NonNull VkInstance instance, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pSurface) {
        ...
        return (int) Handles.MH_vkCreateDirectFBSurfaceEXT.get().invokeExact(instance.capabilities().PFN_vkCreateDirectFBSurfaceEXT, instance.segment(), pCreateInfo, pAllocator, pSurface); }
    ...
    public static int vkGetPhysicalDeviceDirectFBPresentationSupportEXT(@NonNull VkPhysicalDevice physicalDevice, int queueFamilyIndex, @NonNull MemorySegment dfb) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceDirectFBPresentationSupportEXT.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceDirectFBPresentationSupportEXT, physicalDevice.segment(), queueFamilyIndex, dfb); }
