...
public final class VkPhysicalDeviceLegacyDitheringFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_legacyDithering = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("legacyDithering")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int legacyDithering(MemorySegment segment, long index) { return (int) VH_legacyDithering.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void legacyDithering(MemorySegment segment, long index, int value) { VH_legacyDithering.get().set(segment, 0L, index, value); }
