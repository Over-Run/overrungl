...
public final class VkPhysicalDeviceCustomBorderColorPropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxCustomBorderColorSamplers = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxCustomBorderColorSamplers")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxCustomBorderColorSamplers(MemorySegment segment, long index) { return (int) VH_maxCustomBorderColorSamplers.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxCustomBorderColorSamplers(MemorySegment segment, long index, int value) { VH_maxCustomBorderColorSamplers.get().set(segment, 0L, index, value); }
