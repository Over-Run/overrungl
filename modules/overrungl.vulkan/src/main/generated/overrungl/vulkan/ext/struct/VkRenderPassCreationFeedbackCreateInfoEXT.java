...
public final class VkRenderPassCreationFeedbackCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pRenderPassFeedback = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pRenderPassFeedback")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pRenderPassFeedback(MemorySegment segment, long index) { return (MemorySegment) VH_pRenderPassFeedback.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pRenderPassFeedback(MemorySegment segment, long index, MemorySegment value) { VH_pRenderPassFeedback.get().set(segment, 0L, index, value); }
    ...
    /// Visits `VkRenderPassCreationFeedbackCreateInfoEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkRenderPassCreationFeedbackCreateInfoEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkRenderPassCreationFeedbackCreateInfoEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkRenderPassCreationFeedbackCreateInfoEXT pRenderPassFeedbackAt(long index, MemorySegment value) { pRenderPassFeedback(this.segment(), index, value); return this; }
