...
public final class VkQueueFamilyGlobalPriorityPropertiesEXT extends GroupType {
    /// The struct layout of `VkQueueFamilyGlobalPriorityPropertiesEXT`.
    ...
    public static final Supplier<VarHandle> VH_priorityCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("priorityCount")));
    ...
    public static final Supplier<VarHandle> VH_priorities = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("priorities"), PathElement.sequenceElement()));

    /// Creates `VkQueueFamilyGlobalPriorityPropertiesEXT` with the given segment.
    ...
    /// Allocates a `VkQueueFamilyGlobalPriorityPropertiesEXT` with the given segment allocator.
    /// @param allocator the segment allocator
    /// @return the allocated `VkQueueFamilyGlobalPriorityPropertiesEXT`
    ...
    /// Allocates a `VkQueueFamilyGlobalPriorityPropertiesEXT` with the given segment allocator and count.
    /// @param allocator the segment allocator
    ...
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }

    /// {@return `priorityCount` at the given index}
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int priorityCount(MemorySegment segment, long index) { return (int) VH_priorityCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void priorityCount(MemorySegment segment, long index, int value) { VH_priorityCount.get().set(segment, 0L, index, value); }
    /// Sets `priorityCount` with the given value.
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT priorityCount(int value) { priorityCount(this.segment(), 0L, value); return this; }
    ...
    public static int priorities(MemorySegment segment, long index, long index0) { return (int) VH_priorities.get().get(segment, 0L, index, index0); }
    /// {@return `priorities`}
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void priorities(MemorySegment segment, long index, long index0, int value) { VH_priorities.get().set(segment, 0L, index, index0, value); }
    /// Sets `priorities` with the given value.
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT priorities(MemorySegment value) { priorities(this.segment(), 0L, value); return this; }
    /// Sets `priorities` with the given value.
    /// @param index0 the Index 0 of the array
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT priorities(long index0, int value) { priorities(this.segment(), 0L, index0, value); return this; }

    /// Creates a slice of `VkQueueFamilyGlobalPriorityPropertiesEXT`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkQueueFamilyGlobalPriorityPropertiesEXT`
    ...
    /// Visits `VkQueueFamilyGlobalPriorityPropertiesEXT` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT priorityCountAt(long index, int value) { priorityCount(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT prioritiesAt(long index, MemorySegment value) { priorities(this.segment(), index, value); return this; }
    /// Sets `priorities` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param value the value
    /// @return `this`
    public VkQueueFamilyGlobalPriorityPropertiesEXT prioritiesAt(long index, long index0, int value) { priorities(this.segment(), index, index0, value); return this; }
