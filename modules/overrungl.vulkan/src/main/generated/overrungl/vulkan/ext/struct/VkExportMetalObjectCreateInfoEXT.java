...
public final class VkExportMetalObjectCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_exportObjectType = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("exportObjectType")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int exportObjectType(MemorySegment segment, long index) { return (int) VH_exportObjectType.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void exportObjectType(MemorySegment segment, long index, int value) { VH_exportObjectType.get().set(segment, 0L, index, value); }
