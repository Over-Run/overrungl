...
public final class VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_ycbcr2plane444Formats = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("ycbcr2plane444Formats")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int ycbcr2plane444Formats(MemorySegment segment, long index) { return (int) VH_ycbcr2plane444Formats.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void ycbcr2plane444Formats(MemorySegment segment, long index, int value) { VH_ycbcr2plane444Formats.get().set(segment, 0L, index, value); }
