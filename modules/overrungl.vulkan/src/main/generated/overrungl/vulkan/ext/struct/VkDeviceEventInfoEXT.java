...
public final class VkDeviceEventInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_deviceEvent = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("deviceEvent")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int deviceEvent(MemorySegment segment, long index) { return (int) VH_deviceEvent.get().get(segment, 0L, index); }
    /// {@return `deviceEvent`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void deviceEvent(MemorySegment segment, long index, int value) { VH_deviceEvent.get().set(segment, 0L, index, value); }
