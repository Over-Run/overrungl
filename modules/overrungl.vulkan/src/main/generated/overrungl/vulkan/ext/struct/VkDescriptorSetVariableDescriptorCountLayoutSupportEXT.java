...
public final class VkDescriptorSetVariableDescriptorCountLayoutSupportEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxVariableDescriptorCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxVariableDescriptorCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxVariableDescriptorCount(MemorySegment segment, long index) { return (int) VH_maxVariableDescriptorCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxVariableDescriptorCount(MemorySegment segment, long index, int value) { VH_maxVariableDescriptorCount.get().set(segment, 0L, index, value); }
