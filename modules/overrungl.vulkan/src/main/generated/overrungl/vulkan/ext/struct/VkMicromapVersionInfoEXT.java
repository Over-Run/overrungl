...
public final class VkMicromapVersionInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pVersionData = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pVersionData")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pVersionData(MemorySegment segment, long index) { return (MemorySegment) VH_pVersionData.get().get(segment, 0L, index); }
    /// {@return `pVersionData`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pVersionData(MemorySegment segment, long index, MemorySegment value) { VH_pVersionData.get().set(segment, 0L, index, value); }
