...
public final class VkMemoryMapPlacedInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pPlacedAddress = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pPlacedAddress")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pPlacedAddress(MemorySegment segment, long index) { return (MemorySegment) VH_pPlacedAddress.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pPlacedAddress(MemorySegment segment, long index, MemorySegment value) { VH_pPlacedAddress.get().set(segment, 0L, index, value); }
