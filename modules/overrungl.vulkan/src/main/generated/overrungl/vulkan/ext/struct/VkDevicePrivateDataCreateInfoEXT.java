...
public final class VkDevicePrivateDataCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_privateDataSlotRequestCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("privateDataSlotRequestCount")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int privateDataSlotRequestCount(MemorySegment segment, long index) { return (int) VH_privateDataSlotRequestCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void privateDataSlotRequestCount(MemorySegment segment, long index, int value) { VH_privateDataSlotRequestCount.get().set(segment, 0L, index, value); }
