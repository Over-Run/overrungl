...
/// Represents `VkDevicePrivateDataCreateInfoEXT`.
/// ## Layout
/// ```
...
public final class VkDevicePrivateDataCreateInfoEXT extends GroupType {
    ...
    public static VkDevicePrivateDataCreateInfoEXT allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.VK13.VK_STRUCTURE_TYPE_DEVICE_PRIVATE_DATA_CREATE_INFO); }
    public static VkDevicePrivateDataCreateInfoEXT allocInit(SegmentAllocator allocator, long count) {
    ...
    public VkDevicePrivateDataCreateInfoEXT sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkDevicePrivateDataCreateInfoEXT pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkDevicePrivateDataCreateInfoEXT privateDataSlotRequestCountAt(long index, int value) { VH_privateDataSlotRequestCount.set(this.segment(), 0L, index, value); return this; }
    public VkDevicePrivateDataCreateInfoEXT sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkDevicePrivateDataCreateInfoEXT pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkDevicePrivateDataCreateInfoEXT privateDataSlotRequestCount(int value) { VH_privateDataSlotRequestCount.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkDevicePrivateDataCreateInfoEXT _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkDevicePrivateDataCreateInfoEXT _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkDevicePrivateDataCreateInfoEXT _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkDevicePrivateDataCreateInfoEXT _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkDevicePrivateDataCreateInfoEXT _privateDataSlotRequestCountAt(long index, MemorySegment src) { _privateDataSlotRequestCountAt(index).copyFrom(src); return this; }
    public VkDevicePrivateDataCreateInfoEXT _privateDataSlotRequestCount(MemorySegment src) { return _privateDataSlotRequestCountAt(0L, src); }
}
