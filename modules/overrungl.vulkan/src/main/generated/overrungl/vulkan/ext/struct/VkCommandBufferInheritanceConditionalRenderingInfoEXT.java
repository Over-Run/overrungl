...
public final class VkCommandBufferInheritanceConditionalRenderingInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_conditionalRenderingEnable = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("conditionalRenderingEnable")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int conditionalRenderingEnable(MemorySegment segment, long index) { return (int) VH_conditionalRenderingEnable.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void conditionalRenderingEnable(MemorySegment segment, long index, int value) { VH_conditionalRenderingEnable.get().set(segment, 0L, index, value); }
