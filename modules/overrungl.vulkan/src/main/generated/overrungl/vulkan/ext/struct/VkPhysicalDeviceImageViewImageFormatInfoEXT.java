...
public final class VkPhysicalDeviceImageViewImageFormatInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_imageViewType = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("imageViewType")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int imageViewType(MemorySegment segment, long index) { return (int) VH_imageViewType.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void imageViewType(MemorySegment segment, long index, int value) { VH_imageViewType.get().set(segment, 0L, index, value); }
