...
public final class VkMetalSurfaceCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pLayer = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pLayer")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pLayer(MemorySegment segment, long index) { return (MemorySegment) VH_pLayer.get().get(segment, 0L, index); }
    /// {@return `pLayer`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pLayer(MemorySegment segment, long index, MemorySegment value) { VH_pLayer.get().set(segment, 0L, index, value); }
