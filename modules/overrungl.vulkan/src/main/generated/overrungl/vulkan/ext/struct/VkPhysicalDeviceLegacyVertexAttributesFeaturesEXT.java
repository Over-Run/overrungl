...
public final class VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_legacyVertexAttributes = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("legacyVertexAttributes")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int legacyVertexAttributes(MemorySegment segment, long index) { return (int) VH_legacyVertexAttributes.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void legacyVertexAttributes(MemorySegment segment, long index, int value) { VH_legacyVertexAttributes.get().set(segment, 0L, index, value); }
