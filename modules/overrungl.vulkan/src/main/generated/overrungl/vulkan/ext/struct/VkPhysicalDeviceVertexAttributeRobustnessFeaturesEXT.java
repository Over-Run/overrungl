...
public final class VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_vertexAttributeRobustness = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("vertexAttributeRobustness")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int vertexAttributeRobustness(MemorySegment segment, long index) { return (int) VH_vertexAttributeRobustness.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void vertexAttributeRobustness(MemorySegment segment, long index, int value) { VH_vertexAttributeRobustness.get().set(segment, 0L, index, value); }
