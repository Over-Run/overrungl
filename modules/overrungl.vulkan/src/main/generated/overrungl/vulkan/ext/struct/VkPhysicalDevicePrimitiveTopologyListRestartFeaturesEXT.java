...
public final class VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_primitiveTopologyListRestart = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("primitiveTopologyListRestart")));
    ...
    public static final Supplier<VarHandle> VH_primitiveTopologyPatchListRestart = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("primitiveTopologyPatchListRestart")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int primitiveTopologyListRestart(MemorySegment segment, long index) { return (int) VH_primitiveTopologyListRestart.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void primitiveTopologyListRestart(MemorySegment segment, long index, int value) { VH_primitiveTopologyListRestart.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int primitiveTopologyPatchListRestart(MemorySegment segment, long index) { return (int) VH_primitiveTopologyPatchListRestart.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void primitiveTopologyPatchListRestart(MemorySegment segment, long index, int value) { VH_primitiveTopologyPatchListRestart.get().set(segment, 0L, index, value); }
