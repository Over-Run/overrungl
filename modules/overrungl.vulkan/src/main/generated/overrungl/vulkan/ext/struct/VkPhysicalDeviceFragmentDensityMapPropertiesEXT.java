...
public final class VkPhysicalDeviceFragmentDensityMapPropertiesEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_fragmentDensityInvocations = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("fragmentDensityInvocations")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int fragmentDensityInvocations(MemorySegment segment, long index) { return (int) VH_fragmentDensityInvocations.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void fragmentDensityInvocations(MemorySegment segment, long index, int value) { VH_fragmentDensityInvocations.get().set(segment, 0L, index, value); }
