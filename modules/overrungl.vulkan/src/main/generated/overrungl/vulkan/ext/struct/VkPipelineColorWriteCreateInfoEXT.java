...
public final class VkPipelineColorWriteCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pColorWriteEnables = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pColorWriteEnables")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pColorWriteEnables(MemorySegment segment, long index) { return (MemorySegment) VH_pColorWriteEnables.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pColorWriteEnables(MemorySegment segment, long index, MemorySegment value) { VH_pColorWriteEnables.get().set(segment, 0L, index, value); }
