...
public final class VkPipelineRasterizationProvokingVertexStateCreateInfoEXT extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_provokingVertexMode = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("provokingVertexMode")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int provokingVertexMode(MemorySegment segment, long index) { return (int) VH_provokingVertexMode.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void provokingVertexMode(MemorySegment segment, long index, int value) { VH_provokingVertexMode.get().set(segment, 0L, index, value); }
