...
public final class VKCapabilitiesDevice {
    ...
    public final MemorySegment PFN_vkCmdEndRendering2KHR;
    ...
    public final MemorySegment PFN_vkGetNativeBufferPropertiesOHOS;
    public final MemorySegment PFN_vkGetMemoryNativeBufferOHOS;
    ...
    public final MemorySegment PFN_vkCmdDecompressMemoryEXT;
    public final MemorySegment PFN_vkCmdDecompressMemoryIndirectCountEXT;
    ...
    public final MemorySegment PFN_vkGetSwapchainGrallocUsageOHOS;
    public final MemorySegment PFN_vkAcquireImageOHOS;
    public final MemorySegment PFN_vkQueueSignalReleaseImageOHOS;
    ...
    public final MemorySegment PFN_vkCmdBeginCustomResolveEXT;
    ...
    public VKCapabilitiesDevice(MemorySegment device, VKLoadFunc func) {
        ...
        PFN_vkBindBufferMemory2 = func.invoke(device, "vkBindBufferMemory2");
        PFN_vkBindImageMemory2 = func.invoke(device, "vkBindImageMemory2");
        PFN_vkGetDeviceGroupPeerMemoryFeatures = func.invoke(device, "vkGetDeviceGroupPeerMemoryFeatures");
        PFN_vkCmdSetDeviceMask = func.invoke(device, "vkCmdSetDeviceMask");
        PFN_vkGetImageMemoryRequirements2 = func.invoke(device, "vkGetImageMemoryRequirements2");
        PFN_vkGetBufferMemoryRequirements2 = func.invoke(device, "vkGetBufferMemoryRequirements2");
        PFN_vkGetImageSparseMemoryRequirements2 = func.invoke(device, "vkGetImageSparseMemoryRequirements2");
        PFN_vkTrimCommandPool = func.invoke(device, "vkTrimCommandPool");
        PFN_vkGetDeviceQueue2 = func.invoke(device, "vkGetDeviceQueue2");
        PFN_vkCmdDispatchBase = func.invoke(device, "vkCmdDispatchBase");
        PFN_vkCreateDescriptorUpdateTemplate = func.invoke(device, "vkCreateDescriptorUpdateTemplate");
        PFN_vkDestroyDescriptorUpdateTemplate = func.invoke(device, "vkDestroyDescriptorUpdateTemplate");
        PFN_vkUpdateDescriptorSetWithTemplate = func.invoke(device, "vkUpdateDescriptorSetWithTemplate");
        PFN_vkGetDescriptorSetLayoutSupport = func.invoke(device, "vkGetDescriptorSetLayoutSupport");
        PFN_vkCreateSamplerYcbcrConversion = func.invoke(device, "vkCreateSamplerYcbcrConversion");
        PFN_vkDestroySamplerYcbcrConversion = func.invoke(device, "vkDestroySamplerYcbcrConversion");
        PFN_vkResetQueryPool = func.invoke(device, "vkResetQueryPool");
        PFN_vkGetSemaphoreCounterValue = func.invoke(device, "vkGetSemaphoreCounterValue");
        PFN_vkWaitSemaphores = func.invoke(device, "vkWaitSemaphores");
        PFN_vkSignalSemaphore = func.invoke(device, "vkSignalSemaphore");
        PFN_vkGetBufferDeviceAddress = func.invoke(device, "vkGetBufferDeviceAddress");
        PFN_vkGetBufferOpaqueCaptureAddress = func.invoke(device, "vkGetBufferOpaqueCaptureAddress");
        PFN_vkGetDeviceMemoryOpaqueCaptureAddress = func.invoke(device, "vkGetDeviceMemoryOpaqueCaptureAddress");
        PFN_vkCmdDrawIndirectCount = func.invoke(device, "vkCmdDrawIndirectCount");
        PFN_vkCmdDrawIndexedIndirectCount = func.invoke(device, "vkCmdDrawIndexedIndirectCount");
        PFN_vkCreateRenderPass2 = func.invoke(device, "vkCreateRenderPass2");
        PFN_vkCmdBeginRenderPass2 = func.invoke(device, "vkCmdBeginRenderPass2");
        PFN_vkCmdNextSubpass2 = func.invoke(device, "vkCmdNextSubpass2");
        PFN_vkCmdEndRenderPass2 = func.invoke(device, "vkCmdEndRenderPass2");
        PFN_vkCreatePrivateDataSlot = func.invoke(device, "vkCreatePrivateDataSlot");
        PFN_vkDestroyPrivateDataSlot = func.invoke(device, "vkDestroyPrivateDataSlot");
        PFN_vkSetPrivateData = func.invoke(device, "vkSetPrivateData");
        PFN_vkGetPrivateData = func.invoke(device, "vkGetPrivateData");
        PFN_vkCmdPipelineBarrier2 = func.invoke(device, "vkCmdPipelineBarrier2");
        PFN_vkCmdWriteTimestamp2 = func.invoke(device, "vkCmdWriteTimestamp2");
        PFN_vkQueueSubmit2 = func.invoke(device, "vkQueueSubmit2");
        PFN_vkCmdCopyBuffer2 = func.invoke(device, "vkCmdCopyBuffer2");
        PFN_vkCmdCopyImage2 = func.invoke(device, "vkCmdCopyImage2");
        PFN_vkCmdCopyBufferToImage2 = func.invoke(device, "vkCmdCopyBufferToImage2");
        PFN_vkCmdCopyImageToBuffer2 = func.invoke(device, "vkCmdCopyImageToBuffer2");
        PFN_vkGetDeviceBufferMemoryRequirements = func.invoke(device, "vkGetDeviceBufferMemoryRequirements");
        PFN_vkGetDeviceImageMemoryRequirements = func.invoke(device, "vkGetDeviceImageMemoryRequirements");
        PFN_vkGetDeviceImageSparseMemoryRequirements = func.invoke(device, "vkGetDeviceImageSparseMemoryRequirements");
        PFN_vkCmdSetEvent2 = func.invoke(device, "vkCmdSetEvent2");
        PFN_vkCmdResetEvent2 = func.invoke(device, "vkCmdResetEvent2");
        PFN_vkCmdWaitEvents2 = func.invoke(device, "vkCmdWaitEvents2");
        PFN_vkCmdBlitImage2 = func.invoke(device, "vkCmdBlitImage2");
        PFN_vkCmdResolveImage2 = func.invoke(device, "vkCmdResolveImage2");
        PFN_vkCmdBeginRendering = func.invoke(device, "vkCmdBeginRendering");
        PFN_vkCmdEndRendering = func.invoke(device, "vkCmdEndRendering");
        PFN_vkCmdSetCullMode = func.invoke(device, "vkCmdSetCullMode");
        PFN_vkCmdSetFrontFace = func.invoke(device, "vkCmdSetFrontFace");
        PFN_vkCmdSetPrimitiveTopology = func.invoke(device, "vkCmdSetPrimitiveTopology");
        PFN_vkCmdSetViewportWithCount = func.invoke(device, "vkCmdSetViewportWithCount");
        PFN_vkCmdSetScissorWithCount = func.invoke(device, "vkCmdSetScissorWithCount");
        PFN_vkCmdBindVertexBuffers2 = func.invoke(device, "vkCmdBindVertexBuffers2");
        PFN_vkCmdSetDepthTestEnable = func.invoke(device, "vkCmdSetDepthTestEnable");
        PFN_vkCmdSetDepthWriteEnable = func.invoke(device, "vkCmdSetDepthWriteEnable");
        PFN_vkCmdSetDepthCompareOp = func.invoke(device, "vkCmdSetDepthCompareOp");
        PFN_vkCmdSetDepthBoundsTestEnable = func.invoke(device, "vkCmdSetDepthBoundsTestEnable");
        PFN_vkCmdSetStencilTestEnable = func.invoke(device, "vkCmdSetStencilTestEnable");
        PFN_vkCmdSetStencilOp = func.invoke(device, "vkCmdSetStencilOp");
        PFN_vkCmdSetRasterizerDiscardEnable = func.invoke(device, "vkCmdSetRasterizerDiscardEnable");
        PFN_vkCmdSetDepthBiasEnable = func.invoke(device, "vkCmdSetDepthBiasEnable");
        PFN_vkCmdSetPrimitiveRestartEnable = func.invoke(device, "vkCmdSetPrimitiveRestartEnable");
        PFN_vkMapMemory2 = func.invoke(device, "vkMapMemory2");
        PFN_vkUnmapMemory2 = func.invoke(device, "vkUnmapMemory2");
        PFN_vkGetDeviceImageSubresourceLayout = func.invoke(device, "vkGetDeviceImageSubresourceLayout");
        PFN_vkGetImageSubresourceLayout2 = func.invoke(device, "vkGetImageSubresourceLayout2");
        PFN_vkCopyMemoryToImage = func.invoke(device, "vkCopyMemoryToImage");
        PFN_vkCopyImageToMemory = func.invoke(device, "vkCopyImageToMemory");
        PFN_vkCopyImageToImage = func.invoke(device, "vkCopyImageToImage");
        PFN_vkTransitionImageLayout = func.invoke(device, "vkTransitionImageLayout");
        PFN_vkCmdPushDescriptorSet = func.invoke(device, "vkCmdPushDescriptorSet");
        PFN_vkCmdPushDescriptorSetWithTemplate = func.invoke(device, "vkCmdPushDescriptorSetWithTemplate");
        PFN_vkCmdBindDescriptorSets2 = func.invoke(device, "vkCmdBindDescriptorSets2");
        PFN_vkCmdPushConstants2 = func.invoke(device, "vkCmdPushConstants2");
        PFN_vkCmdPushDescriptorSet2 = func.invoke(device, "vkCmdPushDescriptorSet2");
        PFN_vkCmdPushDescriptorSetWithTemplate2 = func.invoke(device, "vkCmdPushDescriptorSetWithTemplate2");
        PFN_vkCmdSetLineStipple = func.invoke(device, "vkCmdSetLineStipple");
        PFN_vkCmdBindIndexBuffer2 = func.invoke(device, "vkCmdBindIndexBuffer2");
        PFN_vkGetRenderingAreaGranularity = func.invoke(device, "vkGetRenderingAreaGranularity");
        PFN_vkCmdSetRenderingAttachmentLocations = func.invoke(device, "vkCmdSetRenderingAttachmentLocations");
        PFN_vkCmdSetRenderingInputAttachmentIndices = func.invoke(device, "vkCmdSetRenderingInputAttachmentIndices");
        ...
        PFN_vkReleaseSwapchainImagesKHR = func.invoke(device, "vkReleaseSwapchainImagesKHR");
        PFN_vkCmdSetLineStippleKHR = func.invoke(device, "vkCmdSetLineStippleKHR", "vkCmdSetLineStipple");
        PFN_vkGetCalibratedTimestampsKHR = func.invoke(device, "vkGetCalibratedTimestampsKHR");
        ...
        PFN_vkCmdEndRendering2KHR = func.invoke(device, "vkCmdEndRendering2KHR");
        ...
        PFN_vkGetRayTracingShaderGroupHandlesKHR = func.invoke(device, "vkGetRayTracingShaderGroupHandlesKHR");
        ...
        PFN_vkGetNativeBufferPropertiesOHOS = func.invoke(device, "vkGetNativeBufferPropertiesOHOS");
        PFN_vkGetMemoryNativeBufferOHOS = func.invoke(device, "vkGetMemoryNativeBufferOHOS");
        ...
        PFN_vkCmdDecompressMemoryEXT = func.invoke(device, "vkCmdDecompressMemoryEXT");
        PFN_vkCmdDecompressMemoryIndirectCountEXT = func.invoke(device, "vkCmdDecompressMemoryIndirectCountEXT");
        ...
        PFN_vkGetSwapchainGrallocUsageOHOS = func.invoke(device, "vkGetSwapchainGrallocUsageOHOS");
        PFN_vkAcquireImageOHOS = func.invoke(device, "vkAcquireImageOHOS");
        PFN_vkQueueSignalReleaseImageOHOS = func.invoke(device, "vkQueueSignalReleaseImageOHOS");
        ...
        PFN_vkCmdEndRendering2EXT = func.invoke(device, "vkCmdEndRendering2EXT", "vkCmdEndRendering2KHR");
        PFN_vkCmdBeginCustomResolveEXT = func.invoke(device, "vkCmdBeginCustomResolveEXT");
