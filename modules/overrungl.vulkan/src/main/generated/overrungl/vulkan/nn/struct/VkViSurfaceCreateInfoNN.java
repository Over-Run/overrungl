...
public final class VkViSurfaceCreateInfoNN extends GroupType {
    ...
    public static VkViSurfaceCreateInfoNN allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.nn.VKNNViSurface.VK_STRUCTURE_TYPE_VI_SURFACE_CREATE_INFO_NN); }
    public static VkViSurfaceCreateInfoNN allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.nn.VKNNViSurface.VK_STRUCTURE_TYPE_VI_SURFACE_CREATE_INFO_NN);
        return s;
    }
    ...
    public VkViSurfaceCreateInfoNN sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkViSurfaceCreateInfoNN pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkViSurfaceCreateInfoNN flagsAt(long index, int value) { VH_flags.set(this.segment(), 0L, index, value); return this; }
    public VkViSurfaceCreateInfoNN windowAt(long index, MemorySegment value) { VH_window.set(this.segment(), 0L, index, value); return this; }
    public VkViSurfaceCreateInfoNN sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkViSurfaceCreateInfoNN pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkViSurfaceCreateInfoNN flags(int value) { VH_flags.set(this.segment(), 0L, 0L, value); return this; }
    public VkViSurfaceCreateInfoNN window(MemorySegment value) { VH_window.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkViSurfaceCreateInfoNN _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkViSurfaceCreateInfoNN _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkViSurfaceCreateInfoNN _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkViSurfaceCreateInfoNN _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _flagsAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_flags, index), LAYOUT_flags); }
    public MemorySegment _flags() { return _flagsAt(0L); }
    public VkViSurfaceCreateInfoNN _flagsAt(long index, MemorySegment src) { _flagsAt(index).copyFrom(src); return this; }
    public VkViSurfaceCreateInfoNN _flags(MemorySegment src) { return _flagsAt(0L, src); }
    ...
    public VkViSurfaceCreateInfoNN _windowAt(long index, MemorySegment src) { _windowAt(index).copyFrom(src); return this; }
    public VkViSurfaceCreateInfoNN _window(MemorySegment src) { return _windowAt(0L, src); }
}
