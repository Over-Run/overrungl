...
public final class StdVideoH264HrdParameters extends GroupType {
    ...
    public static final StructLayout LAYOUT = LayoutBuilder.struct(
        ...
        MemoryLayout.sequenceLayout(32, ValueLayout.JAVA_BYTE).withName("cbr_flag"),
    ...
    public static final Supplier<VarHandle> VH_cpb_cnt_minus1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("cpb_cnt_minus1")));
    ...
    public static final Supplier<VarHandle> VH_bit_rate_value_minus1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("bit_rate_value_minus1"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_cpb_size_value_minus1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("cpb_size_value_minus1"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_cbr_flag = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("cbr_flag"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_cpb_removal_delay_length_minus1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("cpb_removal_delay_length_minus1")));
    ...
    public static final Supplier<VarHandle> VH_time_offset_length = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("time_offset_length")));
    ...
    public static byte cpb_cnt_minus1(MemorySegment segment, long index) { return (byte) VH_cpb_cnt_minus1.get().get(segment, 0L, index); }
    ...
    public static void cpb_cnt_minus1(MemorySegment segment, long index, byte value) { VH_cpb_cnt_minus1.get().set(segment, 0L, index, value); }
    ...
    public static int bit_rate_value_minus1(MemorySegment segment, long index, long index0) { return (int) VH_bit_rate_value_minus1.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void bit_rate_value_minus1(MemorySegment segment, long index, long index0, int value) { VH_bit_rate_value_minus1.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static int cpb_size_value_minus1(MemorySegment segment, long index, long index0) { return (int) VH_cpb_size_value_minus1.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void cpb_size_value_minus1(MemorySegment segment, long index, long index0, int value) { VH_cpb_size_value_minus1.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static byte cbr_flag(MemorySegment segment, long index, long index0) { return (byte) VH_cbr_flag.get().get(segment, 0L, index, index0); }
    /// {@return `cbr_flag`}
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void cbr_flag(MemorySegment segment, long index, long index0, byte value) { VH_cbr_flag.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int initial_cpb_removal_delay_length_minus1(MemorySegment segment, long index) { return (int) VH_initial_cpb_removal_delay_length_minus1.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void initial_cpb_removal_delay_length_minus1(MemorySegment segment, long index, int value) { VH_initial_cpb_removal_delay_length_minus1.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int cpb_removal_delay_length_minus1(MemorySegment segment, long index) { return (int) VH_cpb_removal_delay_length_minus1.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void cpb_removal_delay_length_minus1(MemorySegment segment, long index, int value) { VH_cpb_removal_delay_length_minus1.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int dpb_output_delay_length_minus1(MemorySegment segment, long index) { return (int) VH_dpb_output_delay_length_minus1.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void dpb_output_delay_length_minus1(MemorySegment segment, long index, int value) { VH_dpb_output_delay_length_minus1.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int time_offset_length(MemorySegment segment, long index) { return (int) VH_time_offset_length.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void time_offset_length(MemorySegment segment, long index, int value) { VH_time_offset_length.get().set(segment, 0L, index, value); }
