...
public final class StdVideoAV1LoopFilter extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_loop_filter_level = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("loop_filter_level"), PathElement.sequenceElement()));
    ...
    public static byte loop_filter_level(MemorySegment segment, long index, long index0) { return (byte) VH_loop_filter_level.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void loop_filter_level(MemorySegment segment, long index, long index0, byte value) { VH_loop_filter_level.get().set(segment, 0L, index, index0, value); }
