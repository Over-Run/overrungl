...
public final class StdVideoEncodeH265WeightTable extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_luma_log2_weight_denom = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("luma_log2_weight_denom")));
    ...
    public static final Supplier<VarHandle> VH_delta_chroma_log2_weight_denom = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("delta_chroma_log2_weight_denom")));
    ...
    public static final Supplier<VarHandle> VH_delta_luma_weight_l0 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("delta_luma_weight_l0"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_luma_offset_l0 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("luma_offset_l0"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_delta_chroma_weight_l0 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("delta_chroma_weight_l0"), PathElement.sequenceElement(), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_delta_chroma_offset_l0 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("delta_chroma_offset_l0"), PathElement.sequenceElement(), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_delta_luma_weight_l1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("delta_luma_weight_l1"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_luma_offset_l1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("luma_offset_l1"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_delta_chroma_weight_l1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("delta_chroma_weight_l1"), PathElement.sequenceElement(), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_delta_chroma_offset_l1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("delta_chroma_offset_l1"), PathElement.sequenceElement(), PathElement.sequenceElement()));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static byte luma_log2_weight_denom(MemorySegment segment, long index) { return (byte) VH_luma_log2_weight_denom.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void luma_log2_weight_denom(MemorySegment segment, long index, byte value) { VH_luma_log2_weight_denom.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static byte delta_chroma_log2_weight_denom(MemorySegment segment, long index) { return (byte) VH_delta_chroma_log2_weight_denom.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void delta_chroma_log2_weight_denom(MemorySegment segment, long index, byte value) { VH_delta_chroma_log2_weight_denom.get().set(segment, 0L, index, value); }
    ...
    public static byte delta_luma_weight_l0(MemorySegment segment, long index, long index0) { return (byte) VH_delta_luma_weight_l0.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void delta_luma_weight_l0(MemorySegment segment, long index, long index0, byte value) { VH_delta_luma_weight_l0.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static byte luma_offset_l0(MemorySegment segment, long index, long index0) { return (byte) VH_luma_offset_l0.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void luma_offset_l0(MemorySegment segment, long index, long index0, byte value) { VH_luma_offset_l0.get().set(segment, 0L, index, index0, value); }
    ...
    public static byte delta_chroma_weight_l0(MemorySegment segment, long index, long index0, long index1) { return (byte) VH_delta_chroma_weight_l0.get().get(segment, 0L, index, index0, index1); }
    ...
    /// @param index1 the Index 1 of the array
    /// @param value the value
    public static void delta_chroma_weight_l0(MemorySegment segment, long index, long index0, long index1, byte value) { VH_delta_chroma_weight_l0.get().set(segment, 0L, index, index0, index1, value); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    public static byte delta_chroma_offset_l0(MemorySegment segment, long index, long index0, long index1) { return (byte) VH_delta_chroma_offset_l0.get().get(segment, 0L, index, index0, index1); }
    ...
    /// @param index1 the Index 1 of the array
    /// @param value the value
    public static void delta_chroma_offset_l0(MemorySegment segment, long index, long index0, long index1, byte value) { VH_delta_chroma_offset_l0.get().set(segment, 0L, index, index0, index1, value); }
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static byte delta_luma_weight_l1(MemorySegment segment, long index, long index0) { return (byte) VH_delta_luma_weight_l1.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void delta_luma_weight_l1(MemorySegment segment, long index, long index0, byte value) { VH_delta_luma_weight_l1.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static byte luma_offset_l1(MemorySegment segment, long index, long index0) { return (byte) VH_luma_offset_l1.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void luma_offset_l1(MemorySegment segment, long index, long index0, byte value) { VH_luma_offset_l1.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    public static byte delta_chroma_weight_l1(MemorySegment segment, long index, long index0, long index1) { return (byte) VH_delta_chroma_weight_l1.get().get(segment, 0L, index, index0, index1); }
    ...
    /// @param index1 the Index 1 of the array
    /// @param value the value
    public static void delta_chroma_weight_l1(MemorySegment segment, long index, long index0, long index1, byte value) { VH_delta_chroma_weight_l1.get().set(segment, 0L, index, index0, index1, value); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    public static byte delta_chroma_offset_l1(MemorySegment segment, long index, long index0, long index1) { return (byte) VH_delta_chroma_offset_l1.get().get(segment, 0L, index, index0, index1); }
    ...
    /// @param index1 the Index 1 of the array
    /// @param value the value
    public static void delta_chroma_offset_l1(MemorySegment segment, long index, long index0, long index1, byte value) { VH_delta_chroma_offset_l1.get().set(segment, 0L, index, index0, index1, value); }
    ...
    /// Visits `StdVideoEncodeH265WeightTable` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable flagsAt(long index, MemorySegment value) { flags(this.segment(), index, value); return this; }
    /// Accepts `flags` with the given function.
    /// @param index the index of the struct buffer
    /// @param func the function
    /// @return `this`
    public StdVideoEncodeH265WeightTable flagsAt(long index, Consumer<overrungl.vulkan.video.StdVideoEncodeH265WeightTableFlags> func) { func.accept(overrungl.vulkan.video.StdVideoEncodeH265WeightTableFlags.of(flagsAt(index))); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable luma_log2_weight_denomAt(long index, byte value) { luma_log2_weight_denom(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_log2_weight_denomAt(long index, byte value) { delta_chroma_log2_weight_denom(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_luma_weight_l0At(long index, MemorySegment value) { delta_luma_weight_l0(this.segment(), index, value); return this; }
    /// Sets `delta_luma_weight_l0` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_luma_weight_l0At(long index, long index0, byte value) { delta_luma_weight_l0(this.segment(), index, index0, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable luma_offset_l0At(long index, MemorySegment value) { luma_offset_l0(this.segment(), index, value); return this; }
    /// Sets `luma_offset_l0` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable luma_offset_l0At(long index, long index0, byte value) { luma_offset_l0(this.segment(), index, index0, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_weight_l0At(long index, MemorySegment value) { delta_chroma_weight_l0(this.segment(), index, value); return this; }
    /// Sets `delta_chroma_weight_l0` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_weight_l0At(long index, long index0, long index1, byte value) { delta_chroma_weight_l0(this.segment(), index, index0, index1, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_offset_l0At(long index, MemorySegment value) { delta_chroma_offset_l0(this.segment(), index, value); return this; }
    /// Sets `delta_chroma_offset_l0` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_offset_l0At(long index, long index0, long index1, byte value) { delta_chroma_offset_l0(this.segment(), index, index0, index1, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_luma_weight_l1At(long index, MemorySegment value) { delta_luma_weight_l1(this.segment(), index, value); return this; }
    /// Sets `delta_luma_weight_l1` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_luma_weight_l1At(long index, long index0, byte value) { delta_luma_weight_l1(this.segment(), index, index0, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable luma_offset_l1At(long index, MemorySegment value) { luma_offset_l1(this.segment(), index, value); return this; }
    /// Sets `luma_offset_l1` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable luma_offset_l1At(long index, long index0, byte value) { luma_offset_l1(this.segment(), index, index0, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_weight_l1At(long index, MemorySegment value) { delta_chroma_weight_l1(this.segment(), index, value); return this; }
    /// Sets `delta_chroma_weight_l1` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_weight_l1At(long index, long index0, long index1, byte value) { delta_chroma_weight_l1(this.segment(), index, index0, index1, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_offset_l1At(long index, MemorySegment value) { delta_chroma_offset_l1(this.segment(), index, value); return this; }
    /// Sets `delta_chroma_offset_l1` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    /// @param value the value
    /// @return `this`
    public StdVideoEncodeH265WeightTable delta_chroma_offset_l1At(long index, long index0, long index1, byte value) { delta_chroma_offset_l1(this.segment(), index, index0, index1, value); return this; }
