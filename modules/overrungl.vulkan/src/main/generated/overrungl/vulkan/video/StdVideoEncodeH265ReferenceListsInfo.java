...
public final class StdVideoEncodeH265ReferenceListsInfo extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_list_entry_l0 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("list_entry_l0"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_list_entry_l1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("list_entry_l1"), PathElement.sequenceElement()));
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static byte list_entry_l0(MemorySegment segment, long index, long index0) { return (byte) VH_list_entry_l0.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void list_entry_l0(MemorySegment segment, long index, long index0, byte value) { VH_list_entry_l0.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static byte list_entry_l1(MemorySegment segment, long index, long index0) { return (byte) VH_list_entry_l1.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void list_entry_l1(MemorySegment segment, long index, long index0, byte value) { VH_list_entry_l1.get().set(segment, 0L, index, index0, value); }
