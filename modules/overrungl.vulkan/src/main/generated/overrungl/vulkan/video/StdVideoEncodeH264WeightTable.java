...
public final class StdVideoEncodeH264WeightTable extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_chroma_log2_weight_denom = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("chroma_log2_weight_denom")));
    ...
    public static final Supplier<VarHandle> VH_luma_weight_l0 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("luma_weight_l0"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_chroma_weight_l0 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("chroma_weight_l0"), PathElement.sequenceElement(), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_chroma_offset_l0 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("chroma_offset_l0"), PathElement.sequenceElement(), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_luma_weight_l1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("luma_weight_l1"), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_chroma_weight_l1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("chroma_weight_l1"), PathElement.sequenceElement(), PathElement.sequenceElement()));
    ...
    public static final Supplier<VarHandle> VH_chroma_offset_l1 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("chroma_offset_l1"), PathElement.sequenceElement(), PathElement.sequenceElement()));
    ...
    /// @return `this`
    public StdVideoEncodeH264WeightTable flags(Consumer<overrungl.vulkan.video.StdVideoEncodeH264WeightTableFlags> func) { func.accept(overrungl.vulkan.video.StdVideoEncodeH264WeightTableFlags.of(flags())); return this; }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static byte chroma_log2_weight_denom(MemorySegment segment, long index) { return (byte) VH_chroma_log2_weight_denom.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void chroma_log2_weight_denom(MemorySegment segment, long index, byte value) { VH_chroma_log2_weight_denom.get().set(segment, 0L, index, value); }
    ...
    public static byte luma_weight_l0(MemorySegment segment, long index, long index0) { return (byte) VH_luma_weight_l0.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void luma_weight_l0(MemorySegment segment, long index, long index0, byte value) { VH_luma_weight_l0.get().set(segment, 0L, index, index0, value); }
    ...
    public static byte chroma_weight_l0(MemorySegment segment, long index, long index0, long index1) { return (byte) VH_chroma_weight_l0.get().get(segment, 0L, index, index0, index1); }
    ...
    /// @param index1 the Index 1 of the array
    /// @param value the value
    public static void chroma_weight_l0(MemorySegment segment, long index, long index0, long index1, byte value) { VH_chroma_weight_l0.get().set(segment, 0L, index, index0, index1, value); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    public static byte chroma_offset_l0(MemorySegment segment, long index, long index0, long index1) { return (byte) VH_chroma_offset_l0.get().get(segment, 0L, index, index0, index1); }
    ...
    /// @param index1 the Index 1 of the array
    /// @param value the value
    public static void chroma_offset_l0(MemorySegment segment, long index, long index0, long index1, byte value) { VH_chroma_offset_l0.get().set(segment, 0L, index, index0, index1, value); }
    ...
    /// @param index the index of the struct buffer
    /// @param index0 the Index 0 of the array
    public static byte luma_weight_l1(MemorySegment segment, long index, long index0) { return (byte) VH_luma_weight_l1.get().get(segment, 0L, index, index0); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param value the value
    public static void luma_weight_l1(MemorySegment segment, long index, long index0, byte value) { VH_luma_weight_l1.get().set(segment, 0L, index, index0, value); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    public static byte chroma_weight_l1(MemorySegment segment, long index, long index0, long index1) { return (byte) VH_chroma_weight_l1.get().get(segment, 0L, index, index0, index1); }
    ...
    /// @param index1 the Index 1 of the array
    /// @param value the value
    public static void chroma_weight_l1(MemorySegment segment, long index, long index0, long index1, byte value) { VH_chroma_weight_l1.get().set(segment, 0L, index, index0, index1, value); }
    ...
    /// @param index0 the Index 0 of the array
    /// @param index1 the Index 1 of the array
    public static byte chroma_offset_l1(MemorySegment segment, long index, long index0, long index1) { return (byte) VH_chroma_offset_l1.get().get(segment, 0L, index, index0, index1); }
    ...
    /// @param index1 the Index 1 of the array
    /// @param value the value
    public static void chroma_offset_l1(MemorySegment segment, long index, long index0, long index1, byte value) { VH_chroma_offset_l1.get().set(segment, 0L, index, index0, index1, value); }
