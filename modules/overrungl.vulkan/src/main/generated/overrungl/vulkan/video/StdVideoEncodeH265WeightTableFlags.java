...
public final class StdVideoEncodeH265WeightTableFlags extends GroupType {
    ...
    public static short luma_weight_l0_flag(MemorySegment segment, long index) { return (short) VH_luma_weight_l0_flag.get().get(segment, 0L, index); }
    ...
    public static void luma_weight_l0_flag(MemorySegment segment, long index, short value) { VH_luma_weight_l0_flag.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static short chroma_weight_l0_flag(MemorySegment segment, long index) { return (short) VH_chroma_weight_l0_flag.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void chroma_weight_l0_flag(MemorySegment segment, long index, short value) { VH_chroma_weight_l0_flag.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static short luma_weight_l1_flag(MemorySegment segment, long index) { return (short) VH_luma_weight_l1_flag.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void luma_weight_l1_flag(MemorySegment segment, long index, short value) { VH_luma_weight_l1_flag.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static short chroma_weight_l1_flag(MemorySegment segment, long index) { return (short) VH_chroma_weight_l1_flag.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void chroma_weight_l1_flag(MemorySegment segment, long index, short value) { VH_chroma_weight_l1_flag.get().set(segment, 0L, index, value); }
