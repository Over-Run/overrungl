...
public final class VKNVXImageViewHandle {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetImageViewHandleNVX = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetImageViewHandle64NVX = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_LONG, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetImageViewAddressNVX = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkGetImageViewHandleNVX(@NonNull VkDevice device, @NonNull MemorySegment pInfo) {
        ...
        return (int) Handles.MH_vkGetImageViewHandleNVX.get().invokeExact(device.capabilities().PFN_vkGetImageViewHandleNVX, device.segment(), pInfo); }
    ...
    public static long vkGetImageViewHandle64NVX(@NonNull VkDevice device, @NonNull MemorySegment pInfo) {
        ...
        return (long) Handles.MH_vkGetImageViewHandle64NVX.get().invokeExact(device.capabilities().PFN_vkGetImageViewHandle64NVX, device.segment(), pInfo); }
    ...
    public static int vkGetImageViewAddressNVX(@NonNull VkDevice device, long imageView, @NonNull MemorySegment pProperties) {
        ...
        return (int) Handles.MH_vkGetImageViewAddressNVX.get().invokeExact(device.capabilities().PFN_vkGetImageViewAddressNVX, device.segment(), imageView, pProperties); }
