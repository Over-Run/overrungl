...
public final class VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_perViewPositionAllComponents = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("perViewPositionAllComponents")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int perViewPositionAllComponents(MemorySegment segment, long index) { return (int) VH_perViewPositionAllComponents.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void perViewPositionAllComponents(MemorySegment segment, long index, int value) { VH_perViewPositionAllComponents.get().set(segment, 0L, index, value); }
