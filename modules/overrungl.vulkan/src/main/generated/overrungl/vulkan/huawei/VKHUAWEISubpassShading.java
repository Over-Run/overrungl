...
public final class VKHUAWEISubpassShading {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdSubpassShadingHUAWEI = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(@NonNull VkDevice device, long renderpass, @NonNull MemorySegment pMaxWorkgroupSize) {
        ...
        return (int) Handles.MH_vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI.get().invokeExact(device.capabilities().PFN_vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI, device.segment(), renderpass, pMaxWorkgroupSize); }
    ...
    public static void vkCmdSubpassShadingHUAWEI(@NonNull VkCommandBuffer commandBuffer) {
        ...
        Handles.MH_vkCmdSubpassShadingHUAWEI.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdSubpassShadingHUAWEI, commandBuffer.segment()); }
