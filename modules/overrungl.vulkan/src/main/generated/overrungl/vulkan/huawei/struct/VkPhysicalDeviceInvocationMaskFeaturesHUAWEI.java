...
public final class VkPhysicalDeviceInvocationMaskFeaturesHUAWEI extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_invocationMask = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("invocationMask")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int invocationMask(MemorySegment segment, long index) { return (int) VH_invocationMask.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void invocationMask(MemorySegment segment, long index, int value) { VH_invocationMask.get().set(segment, 0L, index, value); }
