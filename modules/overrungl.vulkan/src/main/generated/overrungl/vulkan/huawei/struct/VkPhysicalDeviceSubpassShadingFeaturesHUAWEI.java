...
public final class VkPhysicalDeviceSubpassShadingFeaturesHUAWEI extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_subpassShading = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("subpassShading")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int subpassShading(MemorySegment segment, long index) { return (int) VH_subpassShading.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void subpassShading(MemorySegment segment, long index, int value) { VH_subpassShading.get().set(segment, 0L, index, value); }
