...
public final class VkPhysicalDeviceHdrVividFeaturesHUAWEI extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_hdrVivid = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("hdrVivid")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int hdrVivid(MemorySegment segment, long index) { return (int) VH_hdrVivid.get().get(segment, 0L, index); }
    /// {@return `hdrVivid`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void hdrVivid(MemorySegment segment, long index, int value) { VH_hdrVivid.get().set(segment, 0L, index, value); }
