...
public final class VkPhysicalDeviceSubpassShadingPropertiesHUAWEI extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxSubpassShadingWorkgroupSizeAspectRatio = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxSubpassShadingWorkgroupSizeAspectRatio")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxSubpassShadingWorkgroupSizeAspectRatio(MemorySegment segment, long index) { return (int) VH_maxSubpassShadingWorkgroupSizeAspectRatio.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxSubpassShadingWorkgroupSizeAspectRatio(MemorySegment segment, long index, int value) { VH_maxSubpassShadingWorkgroupSizeAspectRatio.get().set(segment, 0L, index, value); }
