...
public final class VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_clusterShadingRate = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("clusterShadingRate")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int clusterShadingRate(MemorySegment segment, long index) { return (int) VH_clusterShadingRate.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void clusterShadingRate(MemorySegment segment, long index, int value) { VH_clusterShadingRate.get().set(segment, 0L, index, value); }
