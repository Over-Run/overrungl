...
public final class VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_screenBufferImport = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("screenBufferImport")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int screenBufferImport(MemorySegment segment, long index) { return (int) VH_screenBufferImport.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void screenBufferImport(MemorySegment segment, long index, int value) { VH_screenBufferImport.get().set(segment, 0L, index, value); }
