...
public final class VkImportScreenBufferInfoQNX extends GroupType {
    ...
    public static VkImportScreenBufferInfoQNX allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.qnx.VKQNXExternalMemoryScreenBuffer.VK_STRUCTURE_TYPE_IMPORT_SCREEN_BUFFER_INFO_QNX); }
    public static VkImportScreenBufferInfoQNX allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.qnx.VKQNXExternalMemoryScreenBuffer.VK_STRUCTURE_TYPE_IMPORT_SCREEN_BUFFER_INFO_QNX);
        return s;
    }
    ...
    public VkImportScreenBufferInfoQNX sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkImportScreenBufferInfoQNX pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkImportScreenBufferInfoQNX bufferAt(long index, MemorySegment value) { VH_buffer.set(this.segment(), 0L, index, value); return this; }
    public VkImportScreenBufferInfoQNX sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkImportScreenBufferInfoQNX pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkImportScreenBufferInfoQNX buffer(MemorySegment value) { VH_buffer.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkImportScreenBufferInfoQNX _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkImportScreenBufferInfoQNX _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkImportScreenBufferInfoQNX _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkImportScreenBufferInfoQNX _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkImportScreenBufferInfoQNX _bufferAt(long index, MemorySegment src) { _bufferAt(index).copyFrom(src); return this; }
    public VkImportScreenBufferInfoQNX _buffer(MemorySegment src) { return _bufferAt(0L, src); }
}
