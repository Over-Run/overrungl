...
public final class VkImportScreenBufferInfoQNX extends GroupType {
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment buffer(MemorySegment segment, long index) { return (MemorySegment) VH_buffer.get().get(segment, 0L, index); }
    /// {@return `buffer`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void buffer(MemorySegment segment, long index, MemorySegment value) { VH_buffer.get().set(segment, 0L, index, value); }
