...
public final class VkPhysicalDeviceImageAlignmentControlFeaturesMESA extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_imageAlignmentControl = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("imageAlignmentControl")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int imageAlignmentControl(MemorySegment segment, long index) { return (int) VH_imageAlignmentControl.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void imageAlignmentControl(MemorySegment segment, long index, int value) { VH_imageAlignmentControl.get().set(segment, 0L, index, value); }
