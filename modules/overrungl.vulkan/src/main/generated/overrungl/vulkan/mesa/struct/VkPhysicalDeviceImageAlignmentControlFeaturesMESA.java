...
/// Represents `VkPhysicalDeviceImageAlignmentControlFeaturesMESA`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceImageAlignmentControlFeaturesMESA extends GroupType {
    ...
    public static VkPhysicalDeviceImageAlignmentControlFeaturesMESA allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.mesa.VKMESAImageAlignmentControl.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_FEATURES_MESA); }
    public static VkPhysicalDeviceImageAlignmentControlFeaturesMESA allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.mesa.VKMESAImageAlignmentControl.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_FEATURES_MESA);
        return s;
    }
    ...
    public int imageAlignmentControlAt(long index) { return (int) VH_imageAlignmentControl.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int imageAlignmentControl() { return (int) VH_imageAlignmentControl.get(this.segment(), 0L, 0L); }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA imageAlignmentControlAt(long index, int value) { VH_imageAlignmentControl.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA imageAlignmentControl(int value) { VH_imageAlignmentControl.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _imageAlignmentControlAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_imageAlignmentControl, index), LAYOUT_imageAlignmentControl); }
    public MemorySegment _imageAlignmentControl() { return _imageAlignmentControlAt(0L); }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA _imageAlignmentControlAt(long index, MemorySegment src) { _imageAlignmentControlAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceImageAlignmentControlFeaturesMESA _imageAlignmentControl(MemorySegment src) { return _imageAlignmentControlAt(0L, src); }
}
