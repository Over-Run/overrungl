...
public final class VkQueryPoolCreateInfoINTEL extends GroupType {
    /// The struct layout of `VkQueryPoolCreateInfoINTEL`.
    ...
    public static final Supplier<VarHandle> VH_performanceCountersSampling = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("performanceCountersSampling")));

    /// Creates `VkQueryPoolCreateInfoINTEL` with the given segment.
    ...
    /// Allocates a `VkQueryPoolCreateInfoINTEL` with the given segment allocator.
    /// @param allocator the segment allocator
    /// @return the allocated `VkQueryPoolCreateInfoINTEL`
    ...
    /// Allocates a `VkQueryPoolCreateInfoINTEL` with the given segment allocator and count.
    /// @param allocator the segment allocator
    ...
    /// @param value the value
    /// @return `this`
    public VkQueryPoolCreateInfoINTEL sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkQueryPoolCreateInfoINTEL pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }

    /// {@return `performanceCountersSampling` at the given index}
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int performanceCountersSampling(MemorySegment segment, long index) { return (int) VH_performanceCountersSampling.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void performanceCountersSampling(MemorySegment segment, long index, int value) { VH_performanceCountersSampling.get().set(segment, 0L, index, value); }
    /// Sets `performanceCountersSampling` with the given value.
    /// @param value the value
    /// @return `this`
    public VkQueryPoolCreateInfoINTEL performanceCountersSampling(int value) { performanceCountersSampling(this.segment(), 0L, value); return this; }

    /// Creates a slice of `VkQueryPoolCreateInfoINTEL`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkQueryPoolCreateInfoINTEL`
    ...
    /// Visits `VkQueryPoolCreateInfoINTEL` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkQueryPoolCreateInfoINTEL sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkQueryPoolCreateInfoINTEL pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkQueryPoolCreateInfoINTEL performanceCountersSamplingAt(long index, int value) { performanceCountersSampling(this.segment(), index, value); return this; }
