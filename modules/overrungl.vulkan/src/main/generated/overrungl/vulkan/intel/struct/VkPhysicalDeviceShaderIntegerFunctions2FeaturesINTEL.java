...
public final class VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_shaderIntegerFunctions2 = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderIntegerFunctions2")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderIntegerFunctions2(MemorySegment segment, long index) { return (int) VH_shaderIntegerFunctions2.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderIntegerFunctions2(MemorySegment segment, long index, int value) { VH_shaderIntegerFunctions2.get().set(segment, 0L, index, value); }
