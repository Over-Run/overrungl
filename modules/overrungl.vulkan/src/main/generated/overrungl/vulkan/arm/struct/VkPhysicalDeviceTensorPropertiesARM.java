...
public final class VkPhysicalDeviceTensorPropertiesARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxTensorDimensionCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxTensorDimensionCount")));
    ...
    public static final Supplier<VarHandle> VH_maxTensorElements = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxTensorElements")));
    ...
    public static final Supplier<VarHandle> VH_maxPerDimensionTensorElements = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxPerDimensionTensorElements")));
    ...
    public static final Supplier<VarHandle> VH_maxTensorStride = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxTensorStride")));
    ...
    public static final Supplier<VarHandle> VH_maxTensorSize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxTensorSize")));
    ...
    public static final Supplier<VarHandle> VH_maxTensorShaderAccessArrayLength = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxTensorShaderAccessArrayLength")));
    ...
    public static final Supplier<VarHandle> VH_maxTensorShaderAccessSize = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxTensorShaderAccessSize")));
    ...
    public static final Supplier<VarHandle> VH_maxDescriptorSetStorageTensors = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxDescriptorSetStorageTensors")));
    ...
    public static final Supplier<VarHandle> VH_maxPerStageDescriptorSetStorageTensors = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxPerStageDescriptorSetStorageTensors")));
    ...
    public static final Supplier<VarHandle> VH_maxDescriptorSetUpdateAfterBindStorageTensors = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxDescriptorSetUpdateAfterBindStorageTensors")));
    ...
    public static final Supplier<VarHandle> VH_maxPerStageDescriptorUpdateAfterBindStorageTensors = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxPerStageDescriptorUpdateAfterBindStorageTensors")));
    ...
    public static final Supplier<VarHandle> VH_shaderStorageTensorArrayNonUniformIndexingNative = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderStorageTensorArrayNonUniformIndexingNative")));
    ...
    public static final Supplier<VarHandle> VH_shaderTensorSupportedStages = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("shaderTensorSupportedStages")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxTensorDimensionCount(MemorySegment segment, long index) { return (int) VH_maxTensorDimensionCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxTensorDimensionCount(MemorySegment segment, long index, int value) { VH_maxTensorDimensionCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long maxTensorElements(MemorySegment segment, long index) { return (long) VH_maxTensorElements.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxTensorElements(MemorySegment segment, long index, long value) { VH_maxTensorElements.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long maxPerDimensionTensorElements(MemorySegment segment, long index) { return (long) VH_maxPerDimensionTensorElements.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxPerDimensionTensorElements(MemorySegment segment, long index, long value) { VH_maxPerDimensionTensorElements.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long maxTensorStride(MemorySegment segment, long index) { return (long) VH_maxTensorStride.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxTensorStride(MemorySegment segment, long index, long value) { VH_maxTensorStride.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long maxTensorSize(MemorySegment segment, long index) { return (long) VH_maxTensorSize.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxTensorSize(MemorySegment segment, long index, long value) { VH_maxTensorSize.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxTensorShaderAccessArrayLength(MemorySegment segment, long index) { return (int) VH_maxTensorShaderAccessArrayLength.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxTensorShaderAccessArrayLength(MemorySegment segment, long index, int value) { VH_maxTensorShaderAccessArrayLength.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxTensorShaderAccessSize(MemorySegment segment, long index) { return (int) VH_maxTensorShaderAccessSize.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxTensorShaderAccessSize(MemorySegment segment, long index, int value) { VH_maxTensorShaderAccessSize.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxDescriptorSetStorageTensors(MemorySegment segment, long index) { return (int) VH_maxDescriptorSetStorageTensors.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxDescriptorSetStorageTensors(MemorySegment segment, long index, int value) { VH_maxDescriptorSetStorageTensors.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxPerStageDescriptorSetStorageTensors(MemorySegment segment, long index) { return (int) VH_maxPerStageDescriptorSetStorageTensors.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxPerStageDescriptorSetStorageTensors(MemorySegment segment, long index, int value) { VH_maxPerStageDescriptorSetStorageTensors.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxDescriptorSetUpdateAfterBindStorageTensors(MemorySegment segment, long index) { return (int) VH_maxDescriptorSetUpdateAfterBindStorageTensors.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxDescriptorSetUpdateAfterBindStorageTensors(MemorySegment segment, long index, int value) { VH_maxDescriptorSetUpdateAfterBindStorageTensors.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxPerStageDescriptorUpdateAfterBindStorageTensors(MemorySegment segment, long index) { return (int) VH_maxPerStageDescriptorUpdateAfterBindStorageTensors.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxPerStageDescriptorUpdateAfterBindStorageTensors(MemorySegment segment, long index, int value) { VH_maxPerStageDescriptorUpdateAfterBindStorageTensors.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderStorageTensorArrayNonUniformIndexingNative(MemorySegment segment, long index) { return (int) VH_shaderStorageTensorArrayNonUniformIndexingNative.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderStorageTensorArrayNonUniformIndexingNative(MemorySegment segment, long index, int value) { VH_shaderStorageTensorArrayNonUniformIndexingNative.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int shaderTensorSupportedStages(MemorySegment segment, long index) { return (int) VH_shaderTensorSupportedStages.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void shaderTensorSupportedStages(MemorySegment segment, long index, int value) { VH_shaderTensorSupportedStages.get().set(segment, 0L, index, value); }
