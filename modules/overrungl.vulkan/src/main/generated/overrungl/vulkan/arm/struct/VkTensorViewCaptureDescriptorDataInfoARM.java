...
public final class VkTensorViewCaptureDescriptorDataInfoARM extends GroupType {
    ...
    /// Visits `VkTensorViewCaptureDescriptorDataInfoARM` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkTensorViewCaptureDescriptorDataInfoARM sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkTensorViewCaptureDescriptorDataInfoARM pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkTensorViewCaptureDescriptorDataInfoARM tensorViewAt(long index, long value) { tensorView(this.segment(), index, value); return this; }
