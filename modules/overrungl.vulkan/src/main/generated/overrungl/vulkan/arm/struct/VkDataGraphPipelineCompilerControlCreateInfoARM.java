...
public final class VkDataGraphPipelineCompilerControlCreateInfoARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pVendorOptions = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pVendorOptions")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pVendorOptions(MemorySegment segment, long index) { return (MemorySegment) VH_pVendorOptions.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pVendorOptions(MemorySegment segment, long index, MemorySegment value) { VH_pVendorOptions.get().set(segment, 0L, index, value); }
