...
public final class VkDataGraphProcessingEngineCreateInfoARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_processingEngineCount = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("processingEngineCount")));
    ...
    public static final Supplier<VarHandle> VH_pProcessingEngines = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pProcessingEngines")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int processingEngineCount(MemorySegment segment, long index) { return (int) VH_processingEngineCount.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void processingEngineCount(MemorySegment segment, long index, int value) { VH_processingEngineCount.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pProcessingEngines(MemorySegment segment, long index) { return (MemorySegment) VH_pProcessingEngines.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pProcessingEngines(MemorySegment segment, long index, MemorySegment value) { VH_pProcessingEngines.get().set(segment, 0L, index, value); }
