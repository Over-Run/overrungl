...
public final class VKARMDataGraph {
    ...
    public static final class Handles {
        public static final Supplier<MethodHandle> MH_vkCreateDataGraphPipelinesARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCreateDataGraphPipelineSessionARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetDataGraphPipelineSessionBindPointRequirementsARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetDataGraphPipelineSessionMemoryRequirementsARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkBindDataGraphPipelineSessionMemoryARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkDestroyDataGraphPipelineSessionARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkCmdDispatchDataGraphARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetDataGraphPipelineAvailablePropertiesARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetDataGraphPipelinePropertiesARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        public static final Supplier<MethodHandle> MH_vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM = StableValue.supplier(() -> downcallHandle(FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS)));
        private Handles() {}
    }
    ...
    public static int vkCreateDataGraphPipelinesARM(@NonNull VkDevice device, long deferredOperation, long pipelineCache, int createInfoCount, @NonNull MemorySegment pCreateInfos, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pPipelines) {
        ...
        return (int) Handles.MH_vkCreateDataGraphPipelinesARM.get().invokeExact(device.capabilities().PFN_vkCreateDataGraphPipelinesARM, device.segment(), deferredOperation, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines); }
    ...
    public static int vkCreateDataGraphPipelineSessionARM(@NonNull VkDevice device, @NonNull MemorySegment pCreateInfo, @NonNull MemorySegment pAllocator, @NonNull MemorySegment pSession) {
        ...
        return (int) Handles.MH_vkCreateDataGraphPipelineSessionARM.get().invokeExact(device.capabilities().PFN_vkCreateDataGraphPipelineSessionARM, device.segment(), pCreateInfo, pAllocator, pSession); }
    ...
    public static int vkGetDataGraphPipelineSessionBindPointRequirementsARM(@NonNull VkDevice device, @NonNull MemorySegment pInfo, @NonNull MemorySegment pBindPointRequirementCount, @NonNull MemorySegment pBindPointRequirements) {
        ...
        return (int) Handles.MH_vkGetDataGraphPipelineSessionBindPointRequirementsARM.get().invokeExact(device.capabilities().PFN_vkGetDataGraphPipelineSessionBindPointRequirementsARM, device.segment(), pInfo, pBindPointRequirementCount, pBindPointRequirements); }
    ...
    public static void vkGetDataGraphPipelineSessionMemoryRequirementsARM(@NonNull VkDevice device, @NonNull MemorySegment pInfo, @NonNull MemorySegment pMemoryRequirements) {
        ...
        Handles.MH_vkGetDataGraphPipelineSessionMemoryRequirementsARM.get().invokeExact(device.capabilities().PFN_vkGetDataGraphPipelineSessionMemoryRequirementsARM, device.segment(), pInfo, pMemoryRequirements); }
    ...
    public static int vkBindDataGraphPipelineSessionMemoryARM(@NonNull VkDevice device, int bindInfoCount, @NonNull MemorySegment pBindInfos) {
        ...
        return (int) Handles.MH_vkBindDataGraphPipelineSessionMemoryARM.get().invokeExact(device.capabilities().PFN_vkBindDataGraphPipelineSessionMemoryARM, device.segment(), bindInfoCount, pBindInfos); }
    ...
    public static void vkDestroyDataGraphPipelineSessionARM(@NonNull VkDevice device, long session, @NonNull MemorySegment pAllocator) {
        ...
        Handles.MH_vkDestroyDataGraphPipelineSessionARM.get().invokeExact(device.capabilities().PFN_vkDestroyDataGraphPipelineSessionARM, device.segment(), session, pAllocator); }
    ...
    public static void vkCmdDispatchDataGraphARM(@NonNull VkCommandBuffer commandBuffer, long session, @NonNull MemorySegment pInfo) {
        ...
        Handles.MH_vkCmdDispatchDataGraphARM.get().invokeExact(commandBuffer.capabilities().PFN_vkCmdDispatchDataGraphARM, commandBuffer.segment(), session, pInfo); }
    ...
    public static int vkGetDataGraphPipelineAvailablePropertiesARM(@NonNull VkDevice device, @NonNull MemorySegment pPipelineInfo, @NonNull MemorySegment pPropertiesCount, @NonNull MemorySegment pProperties) {
        ...
        return (int) Handles.MH_vkGetDataGraphPipelineAvailablePropertiesARM.get().invokeExact(device.capabilities().PFN_vkGetDataGraphPipelineAvailablePropertiesARM, device.segment(), pPipelineInfo, pPropertiesCount, pProperties); }
    ...
    public static int vkGetDataGraphPipelinePropertiesARM(@NonNull VkDevice device, @NonNull MemorySegment pPipelineInfo, int propertiesCount, @NonNull MemorySegment pProperties) {
        ...
        return (int) Handles.MH_vkGetDataGraphPipelinePropertiesARM.get().invokeExact(device.capabilities().PFN_vkGetDataGraphPipelinePropertiesARM, device.segment(), pPipelineInfo, propertiesCount, pProperties); }
    ...
    public static int vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM(@NonNull VkPhysicalDevice physicalDevice, int queueFamilyIndex, @NonNull MemorySegment pQueueFamilyDataGraphPropertyCount, @NonNull MemorySegment pQueueFamilyDataGraphProperties) {
        ...
        return (int) Handles.MH_vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM.get().invokeExact(physicalDevice.capabilities().PFN_vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM, physicalDevice.segment(), queueFamilyIndex, pQueueFamilyDataGraphPropertyCount, pQueueFamilyDataGraphProperties); }
