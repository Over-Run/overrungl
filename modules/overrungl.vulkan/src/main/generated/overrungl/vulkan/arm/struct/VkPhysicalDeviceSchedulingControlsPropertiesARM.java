...
public final class VkPhysicalDeviceSchedulingControlsPropertiesARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_schedulingControlsFlags = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("schedulingControlsFlags")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static long schedulingControlsFlags(MemorySegment segment, long index) { return (long) VH_schedulingControlsFlags.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void schedulingControlsFlags(MemorySegment segment, long index, long value) { VH_schedulingControlsFlags.get().set(segment, 0L, index, value); }
