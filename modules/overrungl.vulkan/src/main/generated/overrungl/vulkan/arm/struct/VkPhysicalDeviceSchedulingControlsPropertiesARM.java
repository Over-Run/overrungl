...
/// Represents `VkPhysicalDeviceSchedulingControlsPropertiesARM`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceSchedulingControlsPropertiesARM extends GroupType {
    ...
    public static VkPhysicalDeviceSchedulingControlsPropertiesARM allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.arm.VKARMSchedulingControls.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_PROPERTIES_ARM); }
    public static VkPhysicalDeviceSchedulingControlsPropertiesARM allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.arm.VKARMSchedulingControls.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_PROPERTIES_ARM);
        return s;
    }
    ...
    public long schedulingControlsFlagsAt(long index) { return (long) VH_schedulingControlsFlags.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public long schedulingControlsFlags() { return (long) VH_schedulingControlsFlags.get(this.segment(), 0L, 0L); }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM schedulingControlsFlagsAt(long index, long value) { VH_schedulingControlsFlags.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM schedulingControlsFlags(long value) { VH_schedulingControlsFlags.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _schedulingControlsFlagsAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_schedulingControlsFlags, index), LAYOUT_schedulingControlsFlags); }
    public MemorySegment _schedulingControlsFlags() { return _schedulingControlsFlagsAt(0L); }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM _schedulingControlsFlagsAt(long index, MemorySegment src) { _schedulingControlsFlagsAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceSchedulingControlsPropertiesARM _schedulingControlsFlags(MemorySegment src) { return _schedulingControlsFlagsAt(0L, src); }
}
