...
public final class VkDataGraphPipelinePropertyQueryResultARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_property = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("property")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int property(MemorySegment segment, long index) { return (int) VH_property.get().get(segment, 0L, index); }
    /// {@return `property`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void property(MemorySegment segment, long index, int value) { VH_property.get().set(segment, 0L, index, value); }
