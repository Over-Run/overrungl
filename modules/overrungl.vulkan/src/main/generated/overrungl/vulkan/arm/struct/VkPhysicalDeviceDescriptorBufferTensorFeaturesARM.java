...
public final class VkPhysicalDeviceDescriptorBufferTensorFeaturesARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_descriptorBufferTensorDescriptors = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("descriptorBufferTensorDescriptors")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int descriptorBufferTensorDescriptors(MemorySegment segment, long index) { return (int) VH_descriptorBufferTensorDescriptors.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void descriptorBufferTensorDescriptors(MemorySegment segment, long index, int value) { VH_descriptorBufferTensorDescriptors.get().set(segment, 0L, index, value); }
