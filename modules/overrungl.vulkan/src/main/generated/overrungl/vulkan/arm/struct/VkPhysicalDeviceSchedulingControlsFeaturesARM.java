...
public final class VkPhysicalDeviceSchedulingControlsFeaturesARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_schedulingControls = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("schedulingControls")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int schedulingControls(MemorySegment segment, long index) { return (int) VH_schedulingControls.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void schedulingControls(MemorySegment segment, long index, int value) { VH_schedulingControls.get().set(segment, 0L, index, value); }
