...
public final class VkDataGraphPipelineSessionBindPointRequirementARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_bindPointType = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("bindPointType")));
    ...
    public static final Supplier<VarHandle> VH_numObjects = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("numObjects")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int bindPointType(MemorySegment segment, long index) { return (int) VH_bindPointType.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void bindPointType(MemorySegment segment, long index, int value) { VH_bindPointType.get().set(segment, 0L, index, value); }
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int numObjects(MemorySegment segment, long index) { return (int) VH_numObjects.get().get(segment, 0L, index); }
    /// {@return `numObjects`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void numObjects(MemorySegment segment, long index, int value) { VH_numObjects.get().set(segment, 0L, index, value); }
