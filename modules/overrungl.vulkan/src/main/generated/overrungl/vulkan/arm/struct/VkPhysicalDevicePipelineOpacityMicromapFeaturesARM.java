...
public final class VkPhysicalDevicePipelineOpacityMicromapFeaturesARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pipelineOpacityMicromap = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pipelineOpacityMicromap")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int pipelineOpacityMicromap(MemorySegment segment, long index) { return (int) VH_pipelineOpacityMicromap.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pipelineOpacityMicromap(MemorySegment segment, long index, int value) { VH_pipelineOpacityMicromap.get().set(segment, 0L, index, value); }
