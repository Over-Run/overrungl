...
public final class VkPhysicalDeviceRenderPassStripedFeaturesARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_renderPassStriped = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("renderPassStriped")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int renderPassStriped(MemorySegment segment, long index) { return (int) VH_renderPassStriped.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void renderPassStriped(MemorySegment segment, long index, int value) { VH_renderPassStriped.get().set(segment, 0L, index, value); }
