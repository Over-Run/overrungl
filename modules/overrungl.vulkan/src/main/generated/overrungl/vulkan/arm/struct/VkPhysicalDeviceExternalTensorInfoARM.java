...
public final class VkPhysicalDeviceExternalTensorInfoARM extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_pDescription = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("pDescription")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment pDescription(MemorySegment segment, long index) { return (MemorySegment) VH_pDescription.get().get(segment, 0L, index); }
    /// {@return `pDescription`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void pDescription(MemorySegment segment, long index, MemorySegment value) { VH_pDescription.get().set(segment, 0L, index, value); }
