...
/// Represents `VkPhysicalDeviceFormatPackFeaturesARM`.
/// ## Layout
/// ```
...
public final class VkPhysicalDeviceFormatPackFeaturesARM extends GroupType {
    ...
    public static VkPhysicalDeviceFormatPackFeaturesARM allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.arm.VKARMFormatPack.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM); }
    public static VkPhysicalDeviceFormatPackFeaturesARM allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.arm.VKARMFormatPack.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM);
        return s;
    }
    ...
    public int formatPackAt(long index) { return (int) VH_formatPack.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int formatPack() { return (int) VH_formatPack.get(this.segment(), 0L, 0L); }
    public VkPhysicalDeviceFormatPackFeaturesARM sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceFormatPackFeaturesARM pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceFormatPackFeaturesARM formatPackAt(long index, int value) { VH_formatPack.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceFormatPackFeaturesARM sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceFormatPackFeaturesARM pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceFormatPackFeaturesARM formatPack(int value) { VH_formatPack.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceFormatPackFeaturesARM _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceFormatPackFeaturesARM _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceFormatPackFeaturesARM _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceFormatPackFeaturesARM _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _formatPackAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_formatPack, index), LAYOUT_formatPack); }
    public MemorySegment _formatPack() { return _formatPackAt(0L); }
    public VkPhysicalDeviceFormatPackFeaturesARM _formatPackAt(long index, MemorySegment src) { _formatPackAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceFormatPackFeaturesARM _formatPack(MemorySegment src) { return _formatPackAt(0L, src); }
}
