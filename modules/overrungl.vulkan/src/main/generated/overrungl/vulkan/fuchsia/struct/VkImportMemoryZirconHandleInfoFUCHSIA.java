...
/// Represents `VkImportMemoryZirconHandleInfoFUCHSIA`.
/// ## Layout
/// ```
...
public final class VkImportMemoryZirconHandleInfoFUCHSIA extends GroupType {
    ...
    public static VkImportMemoryZirconHandleInfoFUCHSIA allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.fuchsia.VKFUCHSIAExternalMemory.VK_STRUCTURE_TYPE_IMPORT_MEMORY_ZIRCON_HANDLE_INFO_FUCHSIA); }
    public static VkImportMemoryZirconHandleInfoFUCHSIA allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.fuchsia.VKFUCHSIAExternalMemory.VK_STRUCTURE_TYPE_IMPORT_MEMORY_ZIRCON_HANDLE_INFO_FUCHSIA);
        return s;
    }
    ...
    public VkImportMemoryZirconHandleInfoFUCHSIA sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA handleTypeAt(long index, int value) { VH_handleType.set(this.segment(), 0L, index, value); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA handleAt(long index, int value) { VH_handle.set(this.segment(), 0L, index, value); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA handleType(int value) { VH_handleType.set(this.segment(), 0L, 0L, value); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA handle(int value) { VH_handle.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkImportMemoryZirconHandleInfoFUCHSIA _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkImportMemoryZirconHandleInfoFUCHSIA _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkImportMemoryZirconHandleInfoFUCHSIA _handleTypeAt(long index, MemorySegment src) { _handleTypeAt(index).copyFrom(src); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA _handleType(MemorySegment src) { return _handleTypeAt(0L, src); }
    ...
    public VkImportMemoryZirconHandleInfoFUCHSIA _handleAt(long index, MemorySegment src) { _handleAt(index).copyFrom(src); return this; }
    public VkImportMemoryZirconHandleInfoFUCHSIA _handle(MemorySegment src) { return _handleAt(0L, src); }
}
