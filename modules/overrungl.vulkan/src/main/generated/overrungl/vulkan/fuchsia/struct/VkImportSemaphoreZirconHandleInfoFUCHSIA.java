...
public final class VkImportSemaphoreZirconHandleInfoFUCHSIA extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_zirconHandle = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("zirconHandle")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int zirconHandle(MemorySegment segment, long index) { return (int) VH_zirconHandle.get().get(segment, 0L, index); }
    /// {@return `zirconHandle`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void zirconHandle(MemorySegment segment, long index, int value) { VH_zirconHandle.get().set(segment, 0L, index, value); }
