...
/// Represents `VkBufferCollectionCreateInfoFUCHSIA`.
/// ## Layout
/// ```
...
public final class VkBufferCollectionCreateInfoFUCHSIA extends GroupType {
    ...
    public static VkBufferCollectionCreateInfoFUCHSIA allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.fuchsia.VKFUCHSIABufferCollection.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_CREATE_INFO_FUCHSIA); }
    public static VkBufferCollectionCreateInfoFUCHSIA allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.fuchsia.VKFUCHSIABufferCollection.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_CREATE_INFO_FUCHSIA);
        return s;
    }
    ...
    public int collectionTokenAt(long index) { return (int) VH_collectionToken.get(this.segment(), 0L, index); }
    public int sType() { return (int) VH_sType.get(this.segment(), 0L, 0L); }
    public MemorySegment pNext() { return (MemorySegment) VH_pNext.get(this.segment(), 0L, 0L); }
    public int collectionToken() { return (int) VH_collectionToken.get(this.segment(), 0L, 0L); }
    public VkBufferCollectionCreateInfoFUCHSIA sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkBufferCollectionCreateInfoFUCHSIA pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkBufferCollectionCreateInfoFUCHSIA collectionTokenAt(long index, int value) { VH_collectionToken.set(this.segment(), 0L, index, value); return this; }
    public VkBufferCollectionCreateInfoFUCHSIA sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferCollectionCreateInfoFUCHSIA pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkBufferCollectionCreateInfoFUCHSIA collectionToken(int value) { VH_collectionToken.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkBufferCollectionCreateInfoFUCHSIA _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkBufferCollectionCreateInfoFUCHSIA _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkBufferCollectionCreateInfoFUCHSIA _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkBufferCollectionCreateInfoFUCHSIA _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    public MemorySegment _collectionTokenAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_collectionToken, index), LAYOUT_collectionToken); }
    public MemorySegment _collectionToken() { return _collectionTokenAt(0L); }
    public VkBufferCollectionCreateInfoFUCHSIA _collectionTokenAt(long index, MemorySegment src) { _collectionTokenAt(index).copyFrom(src); return this; }
    public VkBufferCollectionCreateInfoFUCHSIA _collectionToken(MemorySegment src) { return _collectionTokenAt(0L, src); }
}
