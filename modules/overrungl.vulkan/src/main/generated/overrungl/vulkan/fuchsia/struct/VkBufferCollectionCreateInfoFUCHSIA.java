...
public final class VkBufferCollectionCreateInfoFUCHSIA extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_collectionToken = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("collectionToken")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int collectionToken(MemorySegment segment, long index) { return (int) VH_collectionToken.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void collectionToken(MemorySegment segment, long index, int value) { VH_collectionToken.get().set(segment, 0L, index, value); }
