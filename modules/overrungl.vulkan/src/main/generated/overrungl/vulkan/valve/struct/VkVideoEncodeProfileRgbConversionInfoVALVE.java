...
public final class VkVideoEncodeProfileRgbConversionInfoVALVE extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_performEncodeRgbConversion = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("performEncodeRgbConversion")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int performEncodeRgbConversion(MemorySegment segment, long index) { return (int) VH_performEncodeRgbConversion.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void performEncodeRgbConversion(MemorySegment segment, long index, int value) { VH_performEncodeRgbConversion.get().set(segment, 0L, index, value); }
