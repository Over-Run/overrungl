...
public final class VkPipelineFragmentDensityMapLayeredCreateInfoVALVE extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_maxFragmentDensityMapLayers = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("maxFragmentDensityMapLayers")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int maxFragmentDensityMapLayers(MemorySegment segment, long index) { return (int) VH_maxFragmentDensityMapLayers.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void maxFragmentDensityMapLayers(MemorySegment segment, long index, int value) { VH_maxFragmentDensityMapLayers.get().set(segment, 0L, index, value); }
