...
public final class VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE extends GroupType {
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int videoEncodeRgbConversion(MemorySegment segment, long index) { return (int) VH_videoEncodeRgbConversion.get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void videoEncodeRgbConversion(MemorySegment segment, long index, int value) { VH_videoEncodeRgbConversion.set(segment, 0L, index, value); }
