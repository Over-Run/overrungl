...
///     void* pNext;
///     (uint32_t) VkBool32 videoEncodeRgbConversion;
/// };
/// ```
public final class VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE extends GroupType {
    /// The struct layout of `VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE`.
    ...
    /// The byte offset of `videoEncodeRgbConversion`.
    ...
    /// The memory layout of `videoEncodeRgbConversion`.
    ...
    /// The [VarHandle] of `videoEncodeRgbConversion` of type `(MemorySegment base, long baseOffset, long index)MemorySegment`.
    public static final Supplier<VarHandle> VH_videoEncodeRgbConversion = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("videoEncodeRgbConversion")));

    /// Creates `VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE` with the given segment.
    ...
    /// Allocates a `VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE` with the given segment allocator.
    /// @param allocator the segment allocator
    /// @return the allocated `VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE`
    ...
    /// Allocates a `VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE` with the given segment allocator and count.
    /// @param allocator the segment allocator
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE sType(int value) { sType(this.segment(), 0L, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE pNext(MemorySegment value) { pNext(this.segment(), 0L, value); return this; }

    /// {@return `videoEncodeRgbConversion` at the given index}
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int videoEncodeRgbConversion(MemorySegment segment, long index) { return (int) VH_videoEncodeRgbConversion.get().get(segment, 0L, index); }
    /// {@return `videoEncodeRgbConversion`}
    public int videoEncodeRgbConversion() { return videoEncodeRgbConversion(this.segment(), 0L); }
    /// Sets `videoEncodeRgbConversion` with the given value at the given index.
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void videoEncodeRgbConversion(MemorySegment segment, long index, int value) { VH_videoEncodeRgbConversion.get().set(segment, 0L, index, value); }
    /// Sets `videoEncodeRgbConversion` with the given value.
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE videoEncodeRgbConversion(int value) { videoEncodeRgbConversion(this.segment(), 0L, value); return this; }

    /// Creates a slice of `VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE`.
    /// @param index the index of the struct buffer
    /// @return the slice of `VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE`
    ...
    /// Visits `VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE` buffer at the given index.
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE sTypeAt(long index, int value) { sType(this.segment(), index, value); return this; }
    ...
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE pNextAt(long index, MemorySegment value) { pNext(this.segment(), index, value); return this; }

    /// {@return `videoEncodeRgbConversion` at the given index}
    /// @param index the index of the struct buffer
    public int videoEncodeRgbConversionAt(long index) { return videoEncodeRgbConversion(this.segment(), index); }
    /// Sets `videoEncodeRgbConversion` with the given value at the given index.
    /// @param index the index of the struct buffer
    /// @param value the value
    /// @return `this`
    public VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE videoEncodeRgbConversionAt(long index, int value) { videoEncodeRgbConversion(this.segment(), index, value); return this; }
