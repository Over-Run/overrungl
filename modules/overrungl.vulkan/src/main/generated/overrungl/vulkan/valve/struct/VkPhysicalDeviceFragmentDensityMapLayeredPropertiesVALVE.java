...
public final class VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE extends GroupType {
    ...
    public static VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE allocInit(SegmentAllocator allocator) { return alloc(allocator).sType(overrungl.vulkan.valve.VKVALVEFragmentDensityMapLayered.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_PROPERTIES_VALVE); }
    public static VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE allocInit(SegmentAllocator allocator, long count) {
        var s = alloc(allocator, count);
        for (long i = 0; i < count; i++) s.sTypeAt(i, overrungl.vulkan.valve.VKVALVEFragmentDensityMapLayered.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_PROPERTIES_VALVE);
        return s;
    }
    ...
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE sTypeAt(long index, int value) { VH_sType.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE pNextAt(long index, MemorySegment value) { VH_pNext.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE maxFragmentDensityMapLayersAt(long index, int value) { VH_maxFragmentDensityMapLayers.set(this.segment(), 0L, index, value); return this; }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE sType(int value) { VH_sType.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE pNext(MemorySegment value) { VH_pNext.set(this.segment(), 0L, 0L, value); return this; }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE maxFragmentDensityMapLayers(int value) { VH_maxFragmentDensityMapLayers.set(this.segment(), 0L, 0L, value); return this; }
    public MemorySegment _sTypeAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_sType, index), LAYOUT_sType); }
    public MemorySegment _sType() { return _sTypeAt(0L); }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE _sTypeAt(long index, MemorySegment src) { _sTypeAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE _sType(MemorySegment src) { return _sTypeAt(0L, src); }
    public MemorySegment _pNextAt(long index) { return this.segment().asSlice(LAYOUT.scale(OFFSET_pNext, index), LAYOUT_pNext); }
    public MemorySegment _pNext() { return _pNextAt(0L); }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE _pNextAt(long index, MemorySegment src) { _pNextAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE _pNext(MemorySegment src) { return _pNextAt(0L, src); }
    ...
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE _maxFragmentDensityMapLayersAt(long index, MemorySegment src) { _maxFragmentDensityMapLayersAt(index).copyFrom(src); return this; }
    public VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE _maxFragmentDensityMapLayers(MemorySegment src) { return _maxFragmentDensityMapLayersAt(0L, src); }
}
