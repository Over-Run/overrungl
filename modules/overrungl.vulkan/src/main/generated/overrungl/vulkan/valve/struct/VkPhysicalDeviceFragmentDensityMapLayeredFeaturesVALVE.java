...
public final class VkPhysicalDeviceFragmentDensityMapLayeredFeaturesVALVE extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_fragmentDensityMapLayered = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("fragmentDensityMapLayered")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int fragmentDensityMapLayered(MemorySegment segment, long index) { return (int) VH_fragmentDensityMapLayered.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void fragmentDensityMapLayered(MemorySegment segment, long index, int value) { VH_fragmentDensityMapLayered.get().set(segment, 0L, index, value); }
