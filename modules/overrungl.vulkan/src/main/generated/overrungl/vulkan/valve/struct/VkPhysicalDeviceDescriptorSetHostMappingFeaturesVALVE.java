...
public final class VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_descriptorSetHostMapping = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("descriptorSetHostMapping")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static int descriptorSetHostMapping(MemorySegment segment, long index) { return (int) VH_descriptorSetHostMapping.get().get(segment, 0L, index); }
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void descriptorSetHostMapping(MemorySegment segment, long index, int value) { VH_descriptorSetHostMapping.get().set(segment, 0L, index, value); }
