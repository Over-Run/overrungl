...
public final class CharPtr extends GroupType {
    ...
    public static char value(MemorySegment segment, long index) { return (char) VH_value.get().get(segment, 0L, index); }
    /// {@return `value`}
    ...
    public static void value(MemorySegment segment, long index, char value) { VH_value.get().set(segment, 0L, index, value); }
