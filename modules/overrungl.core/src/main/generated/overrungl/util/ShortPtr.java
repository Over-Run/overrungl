...
public final class ShortPtr extends GroupType {
    ...
    public static short value(MemorySegment segment, long index) { return (short) VH_value.get().get(segment, 0L, index); }
    /// {@return `value`}
    ...
    public static void value(MemorySegment segment, long index, short value) { VH_value.get().set(segment, 0L, index, value); }
