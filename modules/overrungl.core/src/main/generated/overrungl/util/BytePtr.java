...
public final class BytePtr extends GroupType {
    ...
    public static byte value(MemorySegment segment, long index) { return (byte) VH_value.get().get(segment, 0L, index); }
    /// {@return `value`}
    ...
    public static void value(MemorySegment segment, long index, byte value) { VH_value.get().set(segment, 0L, index, value); }
