...
public final class DoublePtr extends GroupType {
    ...
    public static double value(MemorySegment segment, long index) { return (double) VH_value.get().get(segment, 0L, index); }
    /// {@return `value`}
    ...
    public static void value(MemorySegment segment, long index, double value) { VH_value.get().set(segment, 0L, index, value); }
