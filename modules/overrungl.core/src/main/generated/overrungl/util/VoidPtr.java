...
public final class VoidPtr extends GroupType {
    ...
    public static MemorySegment value(MemorySegment segment, long index) { return (MemorySegment) VH_value.get().get(segment, 0L, index); }
    /// {@return `value`}
    ...
    public static void value(MemorySegment segment, long index, MemorySegment value) { VH_value.get().set(segment, 0L, index, value); }
