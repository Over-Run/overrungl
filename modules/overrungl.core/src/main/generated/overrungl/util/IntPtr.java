...
public final class IntPtr extends GroupType {
    ...
    public static int value(MemorySegment segment, long index) { return (int) VH_value.get().get(segment, 0L, index); }
    /// {@return `value`}
    ...
    public static void value(MemorySegment segment, long index, int value) { VH_value.get().set(segment, 0L, index, value); }
