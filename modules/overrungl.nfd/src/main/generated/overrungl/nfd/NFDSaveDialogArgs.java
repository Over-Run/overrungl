...
public final class NFDSaveDialogArgs extends GroupType {
    ...
    public static final Supplier<VarHandle> VH_defaultName = StableValue.supplier(() -> LAYOUT.arrayElementVarHandle(PathElement.groupElement("defaultName")));
    ...
    /// @param segment the segment of the struct
    /// @param index the index of the struct buffer
    public static MemorySegment defaultName(MemorySegment segment, long index) { return (MemorySegment) VH_defaultName.get().get(segment, 0L, index); }
    /// {@return `defaultName`}
    ...
    /// @param index the index of the struct buffer
    /// @param value the value
    public static void defaultName(MemorySegment segment, long index, MemorySegment value) { VH_defaultName.get().set(segment, 0L, index, value); }
